...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"esf-renewal-company-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "esf-renewal-company-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ESFRenewalCompanyClp.class.getName())) {
	...
	public static Object translateInputESFRenewalCompany(BaseModel<?> oldModel) {
	...
	public static Object translateOutputESFRenewalCompany(BaseModel<?> oldModel) {
		ESFRenewalCompanyClp newModel = new ESFRenewalCompanyClp();
