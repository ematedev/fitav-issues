...
/**
 * Provides the local service interface for VW_ESFListaIncarichiTessera. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_ESFListaIncarichiTesseraLocalServiceUtil
...
public interface VW_ESFListaIncarichiTesseraLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_ESFListaIncarichiTesseraLocalServiceUtil} to access the v w_ e s f lista incarichi tessera local service. Add custom service methods to {@link it.ethica.esf.renewal.service.impl.VW_ESFListaIncarichiTesseraLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
