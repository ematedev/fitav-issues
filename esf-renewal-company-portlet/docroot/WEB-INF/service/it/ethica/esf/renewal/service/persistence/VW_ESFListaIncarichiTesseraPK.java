 ...
 * @author Ethica
 */
public class VW_ESFListaIncarichiTesseraPK implements Comparable<VW_ESFListaIncarichiTesseraPK>,
	Serializable {
	...
	public VW_ESFListaIncarichiTesseraPK() {
	}

	public VW_ESFListaIncarichiTesseraPK(int AnniPrecedenti,
		int AnnoFineIncarico, int AnnoInizioIncarico, int AnnoCorrente,
		String NomeRuolo, Date startDate, long esfUserId,
		long esfOrganizationId, String lastName, String firstName) {
	...
	@Override
	public int compareTo(VW_ESFListaIncarichiTesseraPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VW_ESFListaIncarichiTesseraPK)) {
			return false;
		}

		VW_ESFListaIncarichiTesseraPK pk = (VW_ESFListaIncarichiTesseraPK)obj;
