...
create index IX_8B6EC1C9 on ESFRenewalCompany (status);
create index IX_53F13FFA on ESFRenewalCompany (status, year);
create index IX_5DBC9894 on ESFRenewalCompany (year);