...
public class ESFSportTypePersistenceImpl extends BasePersistenceImpl<ESFSportType>
	 ...
	 */
	@Override
	public List<ESFSportType> filterFindByGroupId(long groupId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<ESFSportType> filterFindByGroupId(long groupId, int start,
	...
	public List<ESFSportType> filterFindByGroupId(long groupId, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_ESFSPORTTYPE_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_ESFSPORTTYPE_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_ESFSPORTTYPE_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(ESFSportTypeModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, ESFSportTypeImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, ESFSportTypeImpl.class);
			}
			...
			return (List<ESFSportType>)QueryUtil.list(q, getDialect(), start,
				end);
		}
		catch (Exception e) {
			throw processException(e);
	 ...
	 */
	@Override
	public ESFSportType[] filterFindByGroupId_PrevAndNext(long esfSportTypeId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchSportTypeException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(esfSportTypeId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, esfSportType,
					groupId, orderByComparator, true);

			array[1] = esfSportType;

			array[2] = filterGetByGroupId_PrevAndNext(session, esfSportType,
	...
	protected ESFSportType filterGetByGroupId_PrevAndNext(Session session,
		ESFSportType esfSportType, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_ESFSPORTTYPE_WHERE);
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "esfSportType.esfSportTypeId";
	private static final String _FILTER_SQL_SELECT_ESFSPORTTYPE_WHERE = "SELECT DISTINCT {esfSportType.*} FROM ESF_ESFSportType esfSportType WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFSPORTTYPE_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {ESF_ESFSportType.*} FROM (SELECT DISTINCT esfSportType.esfSportTypeId FROM ESF_ESFSportType esfSportType WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFSPORTTYPE_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN ESF_ESFSportType ON TEMP_TABLE.esfSportTypeId = ESF_ESFSportType.esfSportTypeId";
	private static final String _FILTER_SQL_COUNT_ESFSPORTTYPE_WHERE = "SELECT COUNT(DISTINCT esfSportType.esfSportTypeId) AS COUNT_VALUE FROM ESF_ESFSportType esfSportType WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "esfSportType";
	private static final String _FILTER_ENTITY_TABLE = "ESF_ESFSportType";
	private static final String _ORDER_BY_ENTITY_ALIAS = "esfSportType.";
	private static final String _ORDER_BY_ENTITY_TABLE = "ESF_ESFSportType.";
