...
<%
	...
	boolean cunUpdate=ESFNationalDelegationPermission.contains(permissionChecker, esfUserId, ActionKeys.ESFNATIONALDELEGATION_SHOOTER_UPDATE); 
...
<%}
		...
		<div>
			...
			<h4> <liferay-ui:message key="privacy1-info" /> </h4>
				...
				<aui:input name="privacy1" type="checkbox" checked="<%=true%>" label="agree" disabled="true" />
		...
		<div>
			<h4> <liferay-ui:message key="privacy2-info" /> </h4>
				...
				<aui:input  name="privacy2" type="checkbox" checked="<%=privacy2%>" label="agree" />
		...
		<div>
			<h4> <liferay-ui:message key="privacy3-info" /> </h4>
				...
				<aui:input  name="privacy3" type="checkbox" checked="<%=privacy3%>" label="agree" />
