...
<%
		List<ESFOrganization> allOrganization = 
		 ESFOrganizationLocalServiceUtil.findAllLeafOrganizations(currentOrganizationId,code,name);
%>
<liferay-ui:search-container delta="5" emptyResultsMessage="no-results" iteratorURL="<%=viewassURL%>">
	<liferay-ui:search-container-results
		results="<%=ListUtil.subList(allOrganization, searchContainer.getStart(), searchContainer.getEnd())%>"
		total="<%=allOrganization.size()%>" />
