...
<liferay-ui:search-container delta="5" emptyResultsMessage="no-results" iteratorURL="<%=viewassURL%>">
	<liferay-ui:search-container-results
		results="<%=ESFOrganizationLocalServiceUtil.getAllEsfOrganizationDisabledStartEnd(name,code,searchContainer.getStart(),searchContainer.getEnd())%>"
		total="<%=ESFOrganizationLocalServiceUtil.getAllEsfOrganizationDisabled(name,code)%>" />
