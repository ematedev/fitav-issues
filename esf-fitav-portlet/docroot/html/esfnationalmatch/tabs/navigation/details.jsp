...
<%@page import="it.ethica.esf.permission.ESFShooterModelPermission"%>
		...
		<div id="idOne">
			...
			<div  class="btn-field-align">
				...
				<div id="showNotModificableCF">
					<aui:input name="fiscalCodeNotModificable" inlineField="true" type="text" value="<%=esfUser.getFiscalCode() %>" disabled="true" label="fiscalCode"/>
					<%if(showBottons){ %>
...
%>
	...
	%>	
		<aui:input name="ckisarmy" type="checkbox" onChange="showMilitary();" checked="false" />
	<%
		}
	%>
	<div id="army-content">
