...
%>
	...
	<div class="lfr-form-row lfr-form-row-inline">
		<div class="row-fields">	
			<liferay-util:include page='<%= jspPhoneTL %>' servletContext="<%= application%>" >
				<liferay-util:param name="isAssociation" value="<%= isAssociation %>"></liferay-util:param>
	...
	for (int i = ESFKeys.MinElemIncludePage.MINPHONEUSER; i < ESFKeys.MinElemIncludePage.MAXPHONEUSER; i++){ 
...
var maxS = '<%= ESFKeys.MinElemIncludePage.MAXPHONEUSER %>'; 
var minS = '<%= ESFKeys.MinElemIncludePage.MINPHONEUSER %>'; 
