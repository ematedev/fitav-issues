...
<liferay-ui:icon-menu>
	...
	<c:if test="<%= ESFGunPermission.containsRifle(permissionChecker, esfGunKind.getEsfGunKindId(), ActionKeys.ESFGUN_UPDATE) %>">
...
<%if(false){ %>
<c:if test="<%= ESFGunPermission.containsRifle(permissionChecker, esfGunKind.getEsfGunKindId(), ActionKeys.ESFGUN_PERMISSION) %>">
...
<%} %>
	<c:if test="<%= ESFGunPermission.containsRifle(permissionChecker, esfGunKind.getEsfGunKindId(), ActionKeys.ESFGUN_DELETE) %>">
