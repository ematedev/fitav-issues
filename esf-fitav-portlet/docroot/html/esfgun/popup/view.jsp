...
<liferay-ui:search-container emptyResultsMessage="no-result"
	...
	<liferay-ui:search-container-results>
		...
		ESFUserLocalServiceUtil.getAllShooterByLikeF_C_S(
			name, lastName, "", 
		...
		List<ESFUser> esfusers =
			ESFUserLocalServiceUtil.getAllShooterByLikeF_C_S(
					name, lastName, "",currentOrganizationId);
	...
	<liferay-ui:search-container-row
		...
		<%
			String userCard = "";
			if(Validator.isNotNull(esfUser.getEsfUserId()) && Validator.isNotNull(allEsfCards.get(esfUser.getEsfUserId())) &&
					Validator.isNotNull(allEsfCards.get(esfUser.getEsfUserId()).getCode())){
				userCard = allEsfCards.get(esfUser.getEsfUserId()).getCode();
			}
		...
		<%
			String orgName = "";
			if(Validator.isNotNull(esfUser.getEsfUserId()) && Validator.isNotNull(allEsfCards.get(esfUser.getEsfUserId())) &&
					Validator.isNotNull(ESFOrganizationLocalServiceUtil.fetchESFOrganization(allEsfCards.get(esfUser.getEsfUserId()).getEsfOrganizationId()))){
