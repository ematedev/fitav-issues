...
public class ESFSportTypeCacheModel implements CacheModel<ESFSportType>,
	...
	public ESFSportType toEntityModel() {
		...
		esfSportTypeImpl.setNational(national);

		if (code == null) {
			esfSportTypeImpl.setCode(StringPool.BLANK);
		}
		else {
			esfSportTypeImpl.setCode(code);
		}

		esfSportTypeImpl.setIsChangeCategory(isChangeCategory);
		esfSportTypeImpl.setIsOlimpic(isOlimpic);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		national = objectInput.readBoolean();
		code = objectInput.readUTF();
		isChangeCategory = objectInput.readBoolean();
		isOlimpic = objectInput.readBoolean();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeBoolean(national);
		...
		objectOutput.writeBoolean(isChangeCategory);
		objectOutput.writeBoolean(isOlimpic);
	}
