...
public class ESFNationalDelegationModelImpl extends BaseModelImpl<ESFNationalDelegation>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "nominationDate", Types.TIMESTAMP },
			{ "refusalDate", Types.TIMESTAMP },
			{ "taskId", Types.BIGINT },
	...
	public void setEsfShooterQualificationId(long esfShooterQualificationId) {
		_columnBitmask |= ESFSHOOTERQUALIFICATIONID_COLUMN_BITMASK;

		if (!_setOriginalEsfShooterQualificationId) {
			_setOriginalEsfShooterQualificationId = true;

			_originalEsfShooterQualificationId = _esfShooterQualificationId;
		}

		_esfShooterQualificationId = esfShooterQualificationId;
	}

	public long getOriginalEsfShooterQualificationId() {
	...
	public Object clone() {
		...
		esfNationalDelegationImpl.setEsfShooterQualificationId(getEsfShooterQualificationId());
		...
		esfNationalDelegationImpl.setNominationDate(getNominationDate());
		esfNationalDelegationImpl.setRefusalDate(getRefusalDate());
		esfNationalDelegationImpl.setTaskId(getTaskId());
		esfNationalDelegationImpl.setRefusal(getRefusal());
	...
	public void resetOriginalValues() {
		...
		esfNationalDelegationModelImpl._originalEsfShooterQualificationId = esfNationalDelegationModelImpl._esfShooterQualificationId;

		esfNationalDelegationModelImpl._setOriginalEsfShooterQualificationId = false;
	...
	public CacheModel<ESFNationalDelegation> toCacheModel() {
		...
		esfNationalDelegationCacheModel.esfShooterQualificationId = getEsfShooterQualificationId();
		...
		Date nominationDate = getNominationDate();

		if (nominationDate != null) {
			esfNationalDelegationCacheModel.nominationDate = nominationDate.getTime();
		}
		else {
			esfNationalDelegationCacheModel.nominationDate = Long.MIN_VALUE;
		}

		Date refusalDate = getRefusalDate();

		if (refusalDate != null) {
			esfNationalDelegationCacheModel.refusalDate = refusalDate.getTime();
		}
		else {
			esfNationalDelegationCacheModel.refusalDate = Long.MIN_VALUE;
		}

		esfNationalDelegationCacheModel.taskId = getTaskId();

		esfNationalDelegationCacheModel.refusal = getRefusal();

		String refusal = esfNationalDelegationCacheModel.refusal;

		if ((refusal != null) && (refusal.length() == 0)) {
			esfNationalDelegationCacheModel.refusal = null;
		}
	...
	private long _originalEsfShooterQualificationId;
	private boolean _setOriginalEsfShooterQualificationId;
