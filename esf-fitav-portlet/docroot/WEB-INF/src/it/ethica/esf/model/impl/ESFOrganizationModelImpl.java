...
public class ESFOrganizationModelImpl extends BaseModelImpl<ESFOrganization>
	...
	public Object clone() {
		...
		esfOrganizationImpl.setConstitutiveAct(getConstitutiveAct());
		esfOrganizationImpl.setRegisteredStatus(getRegisteredStatus());
		esfOrganizationImpl.setPlanimetrySportsStand(getPlanimetrySportsStand());
		esfOrganizationImpl.setCertificateFITAV(getCertificateFITAV());
		esfOrganizationImpl.setNote(getNote());
		esfOrganizationImpl.setIsSimplyOrganizzation(getIsSimplyOrganizzation());
		esfOrganizationImpl.setWebSite(getWebSite());
		esfOrganizationImpl.setIncludeConiReport(getIncludeConiReport());
		esfOrganizationImpl.setOrganizzationCategory(getOrganizzationCategory());
	...
	public CacheModel<ESFOrganization> toCacheModel() {
		...
		esfOrganizationCacheModel.constitutiveAct = getConstitutiveAct();

		esfOrganizationCacheModel.registeredStatus = getRegisteredStatus();

		esfOrganizationCacheModel.planimetrySportsStand = getPlanimetrySportsStand();

		esfOrganizationCacheModel.certificateFITAV = getCertificateFITAV();

		esfOrganizationCacheModel.note = getNote();

		String note = esfOrganizationCacheModel.note;

		if ((note != null) && (note.length() == 0)) {
			esfOrganizationCacheModel.note = null;
		}

		esfOrganizationCacheModel.isSimplyOrganizzation = getIsSimplyOrganizzation();

		esfOrganizationCacheModel.webSite = getWebSite();

		String webSite = esfOrganizationCacheModel.webSite;

		if ((webSite != null) && (webSite.length() == 0)) {
			esfOrganizationCacheModel.webSite = null;
		}

		esfOrganizationCacheModel.includeConiReport = getIncludeConiReport();

		esfOrganizationCacheModel.organizzationCategory = getOrganizzationCategory();

		String organizzationCategory = esfOrganizationCacheModel.organizzationCategory;

		if ((organizzationCategory != null) &&
				(organizzationCategory.length() == 0)) {
			esfOrganizationCacheModel.organizzationCategory = null;
		}
