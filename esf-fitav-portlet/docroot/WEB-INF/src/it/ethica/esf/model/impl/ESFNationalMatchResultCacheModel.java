...
public class ESFNationalMatchResultCacheModel implements CacheModel<ESFNationalMatchResult>,
	...
	public ESFNationalMatchResult toEntityModel() {
		...
		esfNationalMatchResultImpl.setEsfSportTypeId(esfSportTypeId);

		if (userNationality == null) {
			esfNationalMatchResultImpl.setUserNationality(StringPool.BLANK);
		}
		else {
			esfNationalMatchResultImpl.setUserNationality(userNationality);
		}

		esfNationalMatchResultImpl.setEsfUserQualification(esfUserQualification);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		userNationality = objectInput.readUTF();
		esfUserQualification = objectInput.readLong();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (userNationality == null) {
			...
			objectOutput.writeUTF(userNationality);
		}

		objectOutput.writeLong(esfUserQualification);
	}
	...
	public long esfUserQualification;
}