...
public class ESFSportAssociationPortlet extends MVCPortlet {
	...
	public void editESFOrganization(
		...
		try {
			ESFOrganization esfOrganization=ESFOrganizationLocalServiceUtil.addESFOrganization(
				...
				firstAffiliationDate, esfEntityState, 0, 0, 
				constitutiveAct, registeredStatus, planimetrySportsStand, certificateFITAV,isSimplyOrganizzation,
			...
			e.printStackTrace();
		    SessionErrors.add(request, "error-insert-association");
	...
	private static Log _log =
			LogFactoryUtil.getLog(ESFSportAssociationPortlet.class);
}
