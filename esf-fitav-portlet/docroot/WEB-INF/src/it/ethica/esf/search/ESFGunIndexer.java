...
import it.ethica.esf.permission.ESFGunCategorizationPermission;
import it.ethica.esf.permission.ESFGunModelPermission;
import it.ethica.esf.permission.ESFOrganizationModelPermission;
...
public class ESFGunIndexer extends BaseIndexer {
	...
	public boolean hasPermission(PermissionChecker permissionChecker,
		...
		return ESFGunCategorizationPermission.contains(permissionChecker, entryClassPK,
				ActionKeys.ESFGUN_ADD);
	}
	...
	protected Document doGetDocument(Object obj) throws Exception {
		...
		String content = UserLocalServiceUtil
				.getUser(entry.getEsfUserId()).getFullName();
		
		document.addDate(Field.MODIFIED_DATE, entry.getModifiedDate());
		document.addText(Field.CONTENT, content);
		document.addText(Field.TITLE, entry.getFullName());
