...
public class ESFDocumentPersistenceImpl extends BasePersistenceImpl<ESFDocument>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFDOCUMENTTYPEID =
		new FinderPath(ESFDocumentModelImpl.ENTITY_CACHE_ENABLED,
			ESFDocumentModelImpl.FINDER_CACHE_ENABLED, ESFDocumentImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByEsfDocumentTypeId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFDOCUMENTTYPEID =
		new FinderPath(ESFDocumentModelImpl.ENTITY_CACHE_ENABLED,
			ESFDocumentModelImpl.FINDER_CACHE_ENABLED, ESFDocumentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByEsfDocumentTypeId", new String[] { Long.class.getName() },
			ESFDocumentModelImpl.ESFDOCUMENTTYPEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ESFDOCUMENTTYPEID = new FinderPath(ESFDocumentModelImpl.ENTITY_CACHE_ENABLED,
			ESFDocumentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByEsfDocumentTypeId", new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<ESFDocument> findByEsfDocumentTypeId(long esfDocumentTypeId)
		throws SystemException {
		return findByEsfDocumentTypeId(esfDocumentTypeId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ESFDocument> findByEsfDocumentTypeId(long esfDocumentTypeId,
		int start, int end) throws SystemException {
		return findByEsfDocumentTypeId(esfDocumentTypeId, start, end, null);
	}
	...
	public List<ESFDocument> findByEsfDocumentTypeId(long esfDocumentTypeId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFDOCUMENTTYPEID;
			finderArgs = new Object[] { esfDocumentTypeId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFDOCUMENTTYPEID;
			finderArgs = new Object[] {
					esfDocumentTypeId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFDocument esfDocument : list) {
				if ((esfDocumentTypeId != esfDocument.getEsfDocumentTypeId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ESFDOCUMENTTYPEID_ESFDOCUMENTTYPEID_2);
	 ...
	 */
	@Override
	public ESFDocument findByEsfDocumentTypeId_First(long esfDocumentTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchDocumentException, SystemException {
		ESFDocument esfDocument = fetchByEsfDocumentTypeId_First(esfDocumentTypeId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFDocument fetchByEsfDocumentTypeId_First(long esfDocumentTypeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFDocument> list = findByEsfDocumentTypeId(esfDocumentTypeId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public ESFDocument findByEsfDocumentTypeId_Last(long esfDocumentTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchDocumentException, SystemException {
		ESFDocument esfDocument = fetchByEsfDocumentTypeId_Last(esfDocumentTypeId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFDocument fetchByEsfDocumentTypeId_Last(long esfDocumentTypeId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByEsfDocumentTypeId(esfDocumentTypeId);

		if (count == 0) {
			return null;
		}

		List<ESFDocument> list = findByEsfDocumentTypeId(esfDocumentTypeId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public ESFDocument[] findByEsfDocumentTypeId_PrevAndNext(
		...
		try {
			...
			array[0] = getByEsfDocumentTypeId_PrevAndNext(session, esfDocument,
					esfDocumentTypeId, orderByComparator, true);

			array[1] = esfDocument;

			array[2] = getByEsfDocumentTypeId_PrevAndNext(session, esfDocument,
					esfDocumentTypeId, orderByComparator, false);
	...
	protected ESFDocument getByEsfDocumentTypeId_PrevAndNext(Session session,
		ESFDocument esfDocument, long esfDocumentTypeId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByEsfDocumentTypeId(long esfDocumentTypeId)
		throws SystemException {
		for (ESFDocument esfDocument : findByEsfDocumentTypeId(
				esfDocumentTypeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(esfDocument);
		}
	}
	...
	public int countByEsfDocumentTypeId(long esfDocumentTypeId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ESFDOCUMENTTYPEID;

		Object[] finderArgs = new Object[] { esfDocumentTypeId };
	...
	public ESFDocument updateImpl(it.ethica.esf.model.ESFDocument esfDocument)
		...
		if (isNew || !ESFDocumentModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfDocumentModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFDOCUMENTTYPEID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfDocumentModelImpl.getOriginalEsfDocumentTypeId()
					};
				...
				args = new Object[] { esfDocumentModelImpl.getEsfDocumentTypeId() };
