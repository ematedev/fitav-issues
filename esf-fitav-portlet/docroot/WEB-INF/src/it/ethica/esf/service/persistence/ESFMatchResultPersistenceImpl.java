...
public class ESFMatchResultPersistenceImpl extends BasePersistenceImpl<ESFMatchResult>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID =
		new FinderPath(ESFMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			ESFMatchResultModelImpl.FINDER_CACHE_ENABLED,
			ESFMatchResultImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findBymatchId_PartecipantId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID =
		new FinderPath(ESFMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			ESFMatchResultModelImpl.FINDER_CACHE_ENABLED,
			ESFMatchResultImpl.class,
			...
			ESFMatchResultModelImpl.ESFPARTECIPANTID_COLUMN_BITMASK |
			ESFMatchResultModelImpl.ESFMATCHID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_MATCHID_PARTECIPANTID = new FinderPath(ESFMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			ESFMatchResultModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countBymatchId_PartecipantId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<ESFMatchResult> findBymatchId_PartecipantId(
		long esfPartecipantId, long esfMatchId) throws SystemException {
		return findBymatchId_PartecipantId(esfPartecipantId, esfMatchId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ESFMatchResult> findBymatchId_PartecipantId(
		...
		throws SystemException {
		return findBymatchId_PartecipantId(esfPartecipantId, esfMatchId, start,
			end, null);
	}
	...
	public List<ESFMatchResult> findBymatchId_PartecipantId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID;
			finderArgs = new Object[] { esfPartecipantId, esfMatchId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID;
			finderArgs = new Object[] {
					esfPartecipantId, esfMatchId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFMatchResult esfMatchResult : list) {
				if ((esfPartecipantId != esfMatchResult.getEsfPartecipantId()) ||
						(esfMatchId != esfMatchResult.getEsfMatchId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_MATCHID_PARTECIPANTID_ESFPARTECIPANTID_2);

			query.append(_FINDER_COLUMN_MATCHID_PARTECIPANTID_ESFMATCHID_2);
	 ...
	 */
	@Override
	public ESFMatchResult findBymatchId_PartecipantId_First(
		long esfPartecipantId, long esfMatchId,
		OrderByComparator orderByComparator)
		throws NoSuchMatchResultException, SystemException {
		ESFMatchResult esfMatchResult = fetchBymatchId_PartecipantId_First(esfPartecipantId,
	 ...
	 */
	@Override
	public ESFMatchResult fetchBymatchId_PartecipantId_First(
		long esfPartecipantId, long esfMatchId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFMatchResult> list = findBymatchId_PartecipantId(esfPartecipantId,
	 ...
	 */
	@Override
	public ESFMatchResult findBymatchId_PartecipantId_Last(
		long esfPartecipantId, long esfMatchId,
		OrderByComparator orderByComparator)
		throws NoSuchMatchResultException, SystemException {
		ESFMatchResult esfMatchResult = fetchBymatchId_PartecipantId_Last(esfPartecipantId,
				esfMatchId, orderByComparator);
	 ...
	 */
	@Override
	public ESFMatchResult fetchBymatchId_PartecipantId_Last(
		long esfPartecipantId, long esfMatchId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countBymatchId_PartecipantId(esfPartecipantId, esfMatchId);
	 ...
	 */
	@Override
	public ESFMatchResult[] findBymatchId_PartecipantId_PrevAndNext(
		...
		try {
			...
			array[0] = getBymatchId_PartecipantId_PrevAndNext(session,
					esfMatchResult, esfPartecipantId, esfMatchId,
					orderByComparator, true);

			array[1] = esfMatchResult;

			array[2] = getBymatchId_PartecipantId_PrevAndNext(session,
					esfMatchResult, esfPartecipantId, esfMatchId,
	...
	protected ESFMatchResult getBymatchId_PartecipantId_PrevAndNext(
		Session session, ESFMatchResult esfMatchResult, long esfPartecipantId,
	...
	public void removeBymatchId_PartecipantId(long esfPartecipantId,
		...
		for (ESFMatchResult esfMatchResult : findBymatchId_PartecipantId(
				esfPartecipantId, esfMatchId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(esfMatchResult);
		}
	}
	...
	public int countBymatchId_PartecipantId(long esfPartecipantId,
		long esfMatchId) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_MATCHID_PARTECIPANTID;

		Object[] finderArgs = new Object[] { esfPartecipantId, esfMatchId };
	...
	private static final String _FINDER_COLUMN_MATCHID_PARTECIPANTID_ESFPARTECIPANTID_2 =
		"esfMatchResult.esfPartecipantId = ? AND ";
	private static final String _FINDER_COLUMN_MATCHID_PARTECIPANTID_ESFMATCHID_2 =
		"esfMatchResult.esfMatchId = ?";
	...
	public ESFMatchResult updateImpl(
		...
		if (isNew || !ESFMatchResultModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfMatchResultModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfMatchResultModelImpl.getOriginalEsfPartecipantId(),
						esfMatchResultModelImpl.getOriginalEsfMatchId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_MATCHID_PARTECIPANTID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MATCHID_PARTECIPANTID,
					args);

				args = new Object[] {
						esfMatchResultModelImpl.getEsfPartecipantId(),
						esfMatchResultModelImpl.getEsfMatchId()
					};
