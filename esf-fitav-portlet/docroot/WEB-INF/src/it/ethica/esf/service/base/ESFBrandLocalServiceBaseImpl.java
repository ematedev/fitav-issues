...
import it.ethica.esf.service.ESFBrandLocalService;
...
/**
 * Provides the base implementation for the e s f brand local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFBrandLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFBrandLocalServiceImpl
 * @see it.ethica.esf.service.ESFBrandLocalServiceUtil
 * @generated
 */
public abstract class ESFBrandLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFBrandLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFBrandLocalServiceUtil} to access the e s f brand local service.
	 */
	...
	@Override
	public ESFBrand addESFBrand(ESFBrand esfBrand) throws SystemException {
		esfBrand.setNew(true);

		return esfBrandPersistence.update(esfBrand);
	}
	 ...
	 */
	@Override
	public ESFBrand createESFBrand(long brandId) {
		return esfBrandPersistence.create(brandId);
	}
	...
	@Override
	public ESFBrand deleteESFBrand(long brandId)
		throws PortalException, SystemException {
		return esfBrandPersistence.remove(brandId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFBrand deleteESFBrand(ESFBrand esfBrand) throws SystemException {
		return esfBrandPersistence.remove(esfBrand);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFBrand.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfBrandPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfBrandPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfBrandPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfBrandPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFBrand fetchESFBrand(long brandId) throws SystemException {
		return esfBrandPersistence.fetchByPrimaryKey(brandId);
	}
	 ...
	 */
	@Override
	public ESFBrand getESFBrand(long brandId)
		throws PortalException, SystemException {
		return esfBrandPersistence.findByPrimaryKey(brandId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfBrandPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFBrand> getESFBrands(int start, int end)
		throws SystemException {
		return esfBrandPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFBrandsCount() throws SystemException {
		return esfBrandPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFBrand updateESFBrand(ESFBrand esfBrand) throws SystemException {
		return esfBrandPersistence.update(esfBrand);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFBrand",
			esfBrandLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFBrand");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfBrandPersistence.getDataSource();
	...
	private ESFBrandLocalServiceClpInvoker _clpInvoker = new ESFBrandLocalServiceClpInvoker();
}