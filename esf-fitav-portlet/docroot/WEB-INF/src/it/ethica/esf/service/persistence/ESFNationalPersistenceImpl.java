...
public class ESFNationalPersistenceImpl extends BasePersistenceImpl<ESFNational>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, ESFNationalImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, ESFNationalImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			ESFNationalModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
			new String[] { String.class.getName() });

	/**
	 * Returns all the e s f nationals where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<ESFNational> findByUuid(String uuid) throws SystemException {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the e s f nationals where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<ESFNational> findByUuid(String uuid, int start, int end)
		throws SystemException {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the e s f nationals where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFNationalModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ESFNational> findByUuid(String uuid, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFNational esfNational : list) {
				if (!Validator.equals(uuid, esfNational.getUuid())) {
					list = null;
	...
	/**
	 * Returns the first e s f national in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public ESFNational findByUuid_First(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = fetchByUuid_First(uuid, orderByComparator);
	 ...
	 */
	@Override
	public ESFNational fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFNational> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last e s f national in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFNational findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 */
	@Override
	public ESFNational fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFNational> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the e s f nationals before and after the current e s f national in the ordered set where uuid = &#63;.
	 *
	 ...
	 */
	@Override
	public ESFNational[] findByUuid_PrevAndNext(long esfNationalId,
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, esfNational, uuid,
					orderByComparator, true);

			array[1] = esfNational;

			array[2] = getByUuid_PrevAndNext(session, esfNational, uuid,
	...
	protected ESFNational getByUuid_PrevAndNext(Session session,
		ESFNational esfNational, String uuid,
	...
	/**
	 * Removes all the e s f nationals where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (ESFNational esfNational : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of e s f nationals where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "esfNational.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "esfNational.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(esfNational.uuid IS NULL OR esfNational.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, ESFNationalImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			ESFNationalModelImpl.UUID_COLUMN_BITMASK |
			ESFNationalModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() });

	/**
	 * Returns the e s f national where uuid = &#63; and groupId = &#63; or throws a {@link it.ethica.esf.NoSuchNationalException} if it could not be found.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public ESFNational findByUUID_G(String uuid, long groupId)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = fetchByUUID_G(uuid, groupId);
	...
	/**
	 * Returns the e s f national where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public ESFNational fetchByUUID_G(String uuid, long groupId)
		throws SystemException {
		return fetchByUUID_G(uuid, groupId, true);
	}

	/**
	 * Returns the e s f national where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	...
	public ESFNational fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof ESFNational) {
			ESFNational esfNational = (ESFNational)result;

			if (!Validator.equals(uuid, esfNational.getUuid()) ||
					(groupId != esfNational.getGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					ESFNational esfNational = list.get(0);

					result = esfNational;

					cacheResult(esfNational);

					if ((esfNational.getUuid() == null) ||
							!esfNational.getUuid().equals(uuid) ||
							(esfNational.getGroupId() != groupId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, esfNational);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (ESFNational)result;
		}
	}

	/**
	 * Removes the e s f national where uuid = &#63; and groupId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public ESFNational removeByUUID_G(String uuid, long groupId)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = findByUUID_G(uuid, groupId);

		return remove(esfNational);
	}

	/**
	 * Returns the number of e s f nationals where uuid = &#63; and groupId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the number of matching e s f nationals
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "esfNational.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "esfNational.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(esfNational.uuid IS NULL OR esfNational.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "esfNational.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, ESFNationalImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			ESFNationalModelImpl.UUID_COLUMN_BITMASK |
			ESFNationalModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(ESFNationalModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() });

	/**
	 * Returns all the e s f nationals where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<ESFNational> findByUuid_C(String uuid, long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the e s f nationals where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFNationalModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the e s f nationals where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFNationalModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ESFNational> findByUuid_C(String uuid, long companyId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFNational esfNational : list) {
				if (!Validator.equals(uuid, esfNational.getUuid()) ||
						(companyId != esfNational.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first e s f national in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFNational findByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = fetchByUuid_C_First(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFNational fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFNational> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last e s f national in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFNational findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalException, SystemException {
		ESFNational esfNational = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFNational fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFNational> list = findByUuid_C(uuid, companyId, count - 1,
	...
	/**
	 * Returns the e s f nationals before and after the current e s f national in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param esfNationalId the primary key of the current e s f national
	 * @param uuid the uuid
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public ESFNational[] findByUuid_C_PrevAndNext(long esfNationalId,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, esfNational, uuid,
					companyId, orderByComparator, true);

			array[1] = esfNational;

			array[2] = getByUuid_C_PrevAndNext(session, esfNational, uuid,
	...
	protected ESFNational getByUuid_C_PrevAndNext(Session session,
		ESFNational esfNational, String uuid, long companyId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the e s f nationals where uuid = &#63; and companyId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByUuid_C(String uuid, long companyId)
		throws SystemException {
		for (ESFNational esfNational : findByUuid_C(uuid, companyId,
	...
	/**
	 * Returns the number of e s f nationals where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the number of matching e s f nationals
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "esfNational.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "esfNational.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(esfNational.uuid IS NULL OR esfNational.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "esfNational.companyId = ?";
	...
	public void cacheResult(ESFNational esfNational) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { esfNational.getUuid(), esfNational.getGroupId() },
			esfNational);
	...
	public void clearCache(ESFNational esfNational) {
		...
		clearUniqueFindersCache(esfNational);
	}
	...
	protected void cacheUniqueFindersCache(ESFNational esfNational) {
		if (esfNational.isNew()) {
			Object[] args = new Object[] {
					esfNational.getUuid(), esfNational.getGroupId()
				};
			...
			ESFNationalModelImpl esfNationalModelImpl = (ESFNationalModelImpl)esfNational;

			if ((esfNationalModelImpl.getColumnBitmask() &
	...
	protected void clearUniqueFindersCache(ESFNational esfNational) {
		ESFNationalModelImpl esfNationalModelImpl = (ESFNationalModelImpl)esfNational;
		...
		if ((esfNationalModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_UUID_G.getColumnBitmask()) != 0) {
			args = new Object[] {
					esfNationalModelImpl.getOriginalUuid(),
					esfNationalModelImpl.getOriginalGroupId()
				};
	...
	public ESFNational updateImpl(it.ethica.esf.model.ESFNational esfNational)
		...
		if (Validator.isNull(esfNational.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !ESFNationalModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfNationalModelImpl.getColumnBitmask() &
				...
				args = new Object[] { esfNationalModelImpl.getUuid() };
			...
			if ((esfNationalModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfNationalModelImpl.getOriginalUuid(),
						esfNationalModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] {
						esfNationalModelImpl.getUuid(),
						esfNationalModelImpl.getCompanyId()
					};
		...
		clearUniqueFindersCache(esfNational);
		cacheUniqueFindersCache(esfNational);
	...
	protected ESFNational toUnwrappedModel(ESFNational esfNational) {
		...
		esfNationalImpl.setUuid(esfNational.getUuid());
