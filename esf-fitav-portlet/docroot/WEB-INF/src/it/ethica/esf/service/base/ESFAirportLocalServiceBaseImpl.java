...
import it.ethica.esf.service.ESFAirportLocalService;
...
/**
 * Provides the base implementation for the e s f airport local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFAirportLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFAirportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFAirportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFAirportLocalServiceUtil} to access the e s f airport local service.
	 */
	...
	@Override
	public ESFAirport addESFAirport(ESFAirport esfAirport)
		throws SystemException {
		esfAirport.setNew(true);

		return esfAirportPersistence.update(esfAirport);
	}
	 ...
	 */
	@Override
	public ESFAirport createESFAirport(long esfAirportId) {
		return esfAirportPersistence.create(esfAirportId);
	}
	...
	@Override
	public ESFAirport deleteESFAirport(long esfAirportId)
		throws PortalException, SystemException {
		return esfAirportPersistence.remove(esfAirportId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFAirport deleteESFAirport(ESFAirport esfAirport)
		throws SystemException {
		return esfAirportPersistence.remove(esfAirport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFAirport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfAirportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfAirportPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfAirportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFAirport fetchESFAirport(long esfAirportId)
		throws SystemException {
		return esfAirportPersistence.fetchByPrimaryKey(esfAirportId);
	}
	 ...
	 */
	@Override
	public ESFAirport getESFAirport(long esfAirportId)
		throws PortalException, SystemException {
		return esfAirportPersistence.findByPrimaryKey(esfAirportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfAirportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFAirport> getESFAirports(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFAirportsCount() throws SystemException {
		return esfAirportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFAirport updateESFAirport(ESFAirport esfAirport)
		throws SystemException {
		return esfAirportPersistence.update(esfAirport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFAirport",
			esfAirportLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFAirport");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfAirportPersistence.getDataSource();
	...
	private ESFAirportLocalServiceClpInvoker _clpInvoker = new ESFAirportLocalServiceClpInvoker();
}