...
import it.ethica.esf.service.ESFMatchTypeLocalService;
...
/**
 * Provides the base implementation for the e s f match type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFMatchTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFMatchTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFMatchTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFMatchTypeLocalServiceUtil} to access the e s f match type local service.
	 */
	...
	@Override
	public ESFMatchType addESFMatchType(ESFMatchType esfMatchType)
		throws SystemException {
		esfMatchType.setNew(true);

		return esfMatchTypePersistence.update(esfMatchType);
	}
	 ...
	 */
	@Override
	public ESFMatchType createESFMatchType(long esfMatchTypeId) {
		return esfMatchTypePersistence.create(esfMatchTypeId);
	}
	...
	@Override
	public ESFMatchType deleteESFMatchType(long esfMatchTypeId)
		throws PortalException, SystemException {
		return esfMatchTypePersistence.remove(esfMatchTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFMatchType deleteESFMatchType(ESFMatchType esfMatchType)
		throws SystemException {
		return esfMatchTypePersistence.remove(esfMatchType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFMatchType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfMatchTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfMatchTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFMatchType fetchESFMatchType(long esfMatchTypeId)
		throws SystemException {
		return esfMatchTypePersistence.fetchByPrimaryKey(esfMatchTypeId);
	}
	 ...
	 */
	@Override
	public ESFMatchType getESFMatchType(long esfMatchTypeId)
		throws PortalException, SystemException {
		return esfMatchTypePersistence.findByPrimaryKey(esfMatchTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfMatchTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFMatchType> getESFMatchTypes(int start, int end)
		throws SystemException {
		return esfMatchTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFMatchTypesCount() throws SystemException {
		return esfMatchTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFMatchType updateESFMatchType(ESFMatchType esfMatchType)
		throws SystemException {
		return esfMatchTypePersistence.update(esfMatchType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFMatchType",
			esfMatchTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfMatchTypePersistence.getDataSource();
	...
	private ESFMatchTypeLocalServiceClpInvoker _clpInvoker = new ESFMatchTypeLocalServiceClpInvoker();
}