...
import it.ethica.esf.service.ESFShooterQualificationESFTournamentLocalService;
...
/**
 * Provides the base implementation for the e s f shooter qualification e s f tournament local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFShooterQualificationESFTournamentLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFShooterQualificationESFTournamentLocalServiceImpl
 * @see it.ethica.esf.service.ESFShooterQualificationESFTournamentLocalServiceUtil
 * @generated
 */
public abstract class ESFShooterQualificationESFTournamentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ESFShooterQualificationESFTournamentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFShooterQualificationESFTournamentLocalServiceUtil} to access the e s f shooter qualification e s f tournament local service.
	 */

	/**
	 * Adds the e s f shooter qualification e s f tournament to the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public ESFShooterQualificationESFTournament addESFShooterQualificationESFTournament(
		...
		return esfShooterQualificationESFTournamentPersistence.update(esfShooterQualificationESFTournament);
	}
	 ...
	 */
	@Override
	public ESFShooterQualificationESFTournament createESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournamentPK esfShooterQualificationESFTournamentPK) {
		return esfShooterQualificationESFTournamentPersistence.create(esfShooterQualificationESFTournamentPK);
	}

	/**
	 * Deletes the e s f shooter qualification e s f tournament with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public ESFShooterQualificationESFTournament deleteESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournamentPK esfShooterQualificationESFTournamentPK)
		throws PortalException, SystemException {
		return esfShooterQualificationESFTournamentPersistence.remove(esfShooterQualificationESFTournamentPK);
	}

	/**
	 * Deletes the e s f shooter qualification e s f tournament from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfShooterQualificationESFTournament the e s f shooter qualification e s f tournament
	 * @return the e s f shooter qualification e s f tournament that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ESFShooterQualificationESFTournament deleteESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournament esfShooterQualificationESFTournament)
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.remove(esfShooterQualificationESFTournament);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFShooterQualificationESFTournament.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFShooterQualificationESFTournament fetchESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournamentPK esfShooterQualificationESFTournamentPK)
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.fetchByPrimaryKey(esfShooterQualificationESFTournamentPK);
	}

	/**
	 * Returns the e s f shooter qualification e s f tournament matching the UUID and group.
	 *
	 * @param uuid the e s f shooter qualification e s f tournament's UUID
	 ...
	 */
	@Override
	public ESFShooterQualificationESFTournament fetchESFShooterQualificationESFTournamentByUuidAndGroupId(
		String uuid, long groupId) throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.fetchByUUID_G(uuid,
			groupId);
	}

	/**
	 * Returns the e s f shooter qualification e s f tournament with the primary key.
	 *
	 * @param esfShooterQualificationESFTournamentPK the primary key of the e s f shooter qualification e s f tournament
	 ...
	 */
	@Override
	public ESFShooterQualificationESFTournament getESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournamentPK esfShooterQualificationESFTournamentPK)
		throws PortalException, SystemException {
		return esfShooterQualificationESFTournamentPersistence.findByPrimaryKey(esfShooterQualificationESFTournamentPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfShooterQualificationESFTournamentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws PortalException if a matching e s f shooter qualification e s f tournament could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFShooterQualificationESFTournament getESFShooterQualificationESFTournamentByUuidAndGroupId(
		String uuid, long groupId) throws PortalException, SystemException {
		return esfShooterQualificationESFTournamentPersistence.findByUUID_G(uuid,
			groupId);
	}
	 ...
	 */
	@Override
	public List<ESFShooterQualificationESFTournament> getESFShooterQualificationESFTournaments(
		int start, int end) throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.findAll(start,
			end);
	}
	 ...
	 */
	@Override
	public int getESFShooterQualificationESFTournamentsCount()
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.countAll();
	}

	/**
	 * Updates the e s f shooter qualification e s f tournament in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfShooterQualificationESFTournament the e s f shooter qualification e s f tournament
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFShooterQualificationESFTournament updateESFShooterQualificationESFTournament(
		ESFShooterQualificationESFTournament esfShooterQualificationESFTournament)
		throws SystemException {
		return esfShooterQualificationESFTournamentPersistence.update(esfShooterQualificationESFTournament);
	}
	...
	/**
	 * Returns the e s f raduno local service.
	 *
	 * @return the e s f raduno local service
	 */
	public it.ethica.esf.service.ESFRadunoLocalService getESFRadunoLocalService() {
		return esfRadunoLocalService;
	}

	/**
	 * Sets the e s f raduno local service.
	 *
	 * @param esfRadunoLocalService the e s f raduno local service
	 */
	public void setESFRadunoLocalService(
		it.ethica.esf.service.ESFRadunoLocalService esfRadunoLocalService) {
		this.esfRadunoLocalService = esfRadunoLocalService;
	}

	/**
	 * Returns the e s f raduno persistence.
	 *
	 * @return the e s f raduno persistence
	 */
	public ESFRadunoPersistence getESFRadunoPersistence() {
		return esfRadunoPersistence;
	}

	/**
	 * Sets the e s f raduno persistence.
	 *
	 * @param esfRadunoPersistence the e s f raduno persistence
	 */
	public void setESFRadunoPersistence(
		ESFRadunoPersistence esfRadunoPersistence) {
		this.esfRadunoPersistence = esfRadunoPersistence;
	}
	 ...
	 */
	public it.ethica.esf.service.ESFRadunoFilesLocalService getESFRadunoFilesLocalService() {
		return esfRadunoFilesLocalService;
	}

	/**
	 * Sets the e s f raduno files local service.
	 *
	 * @param esfRadunoFilesLocalService the e s f raduno files local service
	 */
	public void setESFRadunoFilesLocalService(
		it.ethica.esf.service.ESFRadunoFilesLocalService esfRadunoFilesLocalService) {
		this.esfRadunoFilesLocalService = esfRadunoFilesLocalService;
	}

	/**
	 * Returns the e s f raduno files persistence.
	 *
	 * @return the e s f raduno files persistence
	 */
	public ESFRadunoFilesPersistence getESFRadunoFilesPersistence() {
		return esfRadunoFilesPersistence;
	}

	/**
	 * Sets the e s f raduno files persistence.
	 *
	 * @param esfRadunoFilesPersistence the e s f raduno files persistence
	 */
	public void setESFRadunoFilesPersistence(
		ESFRadunoFilesPersistence esfRadunoFilesPersistence) {
		this.esfRadunoFilesPersistence = esfRadunoFilesPersistence;
	}
	 ...
	 */
	public it.ethica.esf.service.ESFRadunoSottotipiRadunoLocalService getESFRadunoSottotipiRadunoLocalService() {
		return esfRadunoSottotipiRadunoLocalService;
	}

	/**
	 * Sets the e s f raduno sottotipi raduno local service.
	 *
	 * @param esfRadunoSottotipiRadunoLocalService the e s f raduno sottotipi raduno local service
	 */
	public void setESFRadunoSottotipiRadunoLocalService(
		it.ethica.esf.service.ESFRadunoSottotipiRadunoLocalService esfRadunoSottotipiRadunoLocalService) {
		this.esfRadunoSottotipiRadunoLocalService = esfRadunoSottotipiRadunoLocalService;
	}

	/**
	 * Returns the e s f raduno sottotipi raduno persistence.
	 *
	 * @return the e s f raduno sottotipi raduno persistence
	 */
	public ESFRadunoSottotipiRadunoPersistence getESFRadunoSottotipiRadunoPersistence() {
		return esfRadunoSottotipiRadunoPersistence;
	}

	/**
	 * Sets the e s f raduno sottotipi raduno persistence.
	 *
	 * @param esfRadunoSottotipiRadunoPersistence the e s f raduno sottotipi raduno persistence
	 */
	public void setESFRadunoSottotipiRadunoPersistence(
		ESFRadunoSottotipiRadunoPersistence esfRadunoSottotipiRadunoPersistence) {
		this.esfRadunoSottotipiRadunoPersistence = esfRadunoSottotipiRadunoPersistence;
	}

	/**
	 * Returns the e s f raduno sottotipo local service.
	 *
	 * @return the e s f raduno sottotipo local service
	 */
	public it.ethica.esf.service.ESFRadunoSottotipoLocalService getESFRadunoSottotipoLocalService() {
		return esfRadunoSottotipoLocalService;
	}

	/**
	 * Sets the e s f raduno sottotipo local service.
	 *
	 * @param esfRadunoSottotipoLocalService the e s f raduno sottotipo local service
	 */
	public void setESFRadunoSottotipoLocalService(
		it.ethica.esf.service.ESFRadunoSottotipoLocalService esfRadunoSottotipoLocalService) {
		this.esfRadunoSottotipoLocalService = esfRadunoSottotipoLocalService;
	}

	/**
	 * Returns the e s f raduno sottotipo persistence.
	 *
	 * @return the e s f raduno sottotipo persistence
	 */
	public ESFRadunoSottotipoPersistence getESFRadunoSottotipoPersistence() {
		return esfRadunoSottotipoPersistence;
	}

	/**
	 * Sets the e s f raduno sottotipo persistence.
	 *
	 * @param esfRadunoSottotipoPersistence the e s f raduno sottotipo persistence
	 */
	...
	/**
	 * Returns the e s f raduno tipo local service.
	 *
	 * @return the e s f raduno tipo local service
	 */
	public it.ethica.esf.service.ESFRadunoTipoLocalService getESFRadunoTipoLocalService() {
		return esfRadunoTipoLocalService;
	}

	/**
	 * Sets the e s f raduno tipo local service.
	 *
	 * @param esfRadunoTipoLocalService the e s f raduno tipo local service
	 */
	public void setESFRadunoTipoLocalService(
		it.ethica.esf.service.ESFRadunoTipoLocalService esfRadunoTipoLocalService) {
		this.esfRadunoTipoLocalService = esfRadunoTipoLocalService;
	}

	/**
	 * Returns the e s f raduno tipo persistence.
	 *
	 * @return the e s f raduno tipo persistence
	 */
	public ESFRadunoTipoPersistence getESFRadunoTipoPersistence() {
		return esfRadunoTipoPersistence;
	}

	/**
	 * Sets the e s f raduno tipo persistence.
	 *
	 * @param esfRadunoTipoPersistence the e s f raduno tipo persistence
	 */
	public void setESFRadunoTipoPersistence(
		ESFRadunoTipoPersistence esfRadunoTipoPersistence) {
		this.esfRadunoTipoPersistence = esfRadunoTipoPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFShooterQualificationESFTournament",
			esfShooterQualificationESFTournamentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfShooterQualificationESFTournamentPersistence.getDataSource();
	...
	@BeanReference(type = it.ethica.esf.service.ESFRadunoLocalService.class)
	...
	protected ESFRadunoSottotipiRadunoPersistence esfRadunoSottotipiRadunoPersistence;
	@BeanReference(type = it.ethica.esf.service.ESFRadunoSottotipoLocalService.class)
	...
	protected ESFRadunoTipoPersistence esfRadunoTipoPersistence;
	...
	private ESFShooterQualificationESFTournamentLocalServiceClpInvoker _clpInvoker =
		new ESFShooterQualificationESFTournamentLocalServiceClpInvoker();
}