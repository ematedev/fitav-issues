...
import it.ethica.esf.service.ESFFornitureLocalService;
...
/**
 * Provides the base implementation for the e s f forniture local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFFornitureLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFFornitureLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFFornitureLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFFornitureLocalServiceUtil} to access the e s f forniture local service.
	 */
	...
	@Override
	public ESFForniture addESFForniture(ESFForniture esfForniture)
		throws SystemException {
		esfForniture.setNew(true);

		return esfForniturePersistence.update(esfForniture);
	}
	 ...
	 */
	@Override
	public ESFForniture createESFForniture(long esfFornitureId) {
		return esfForniturePersistence.create(esfFornitureId);
	}
	...
	public ESFForniture deleteESFForniture(long esfFornitureId)
		...
		return esfForniturePersistence.remove(esfFornitureId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFForniture deleteESFForniture(ESFForniture esfForniture)
		throws SystemException {
		return esfForniturePersistence.remove(esfForniture);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFForniture.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfForniturePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfForniturePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFForniture fetchESFForniture(long esfFornitureId)
		throws SystemException {
		return esfForniturePersistence.fetchByPrimaryKey(esfFornitureId);
	}
	 ...
	 */
	@Override
	public ESFForniture fetchESFFornitureByUuidAndCompanyId(String uuid,
		long companyId) throws SystemException {
		return esfForniturePersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFForniture fetchESFFornitureByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfForniturePersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFForniture getESFForniture(long esfFornitureId)
		throws PortalException, SystemException {
		return esfForniturePersistence.findByPrimaryKey(esfFornitureId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfForniturePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFForniture getESFFornitureByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfForniturePersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFForniture getESFFornitureByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return esfForniturePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFForniture> getESFFornitures(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFFornituresCount() throws SystemException {
		return esfForniturePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFForniture updateESFForniture(ESFForniture esfForniture)
		throws SystemException {
		return esfForniturePersistence.update(esfForniture);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFForniture",
			esfFornitureLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfForniturePersistence.getDataSource();
	...
	private ESFFornitureLocalServiceClpInvoker _clpInvoker = new ESFFornitureLocalServiceClpInvoker();
}