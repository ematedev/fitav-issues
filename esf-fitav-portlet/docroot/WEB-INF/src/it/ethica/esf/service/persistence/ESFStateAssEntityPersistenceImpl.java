...
public class ESFStateAssEntityPersistenceImpl extends BasePersistenceImpl<ESFStateAssEntity>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(ESFStateAssEntityModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateAssEntityModelImpl.FINDER_CACHE_ENABLED,
			ESFStateAssEntityImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFStateAssEntityModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateAssEntityModelImpl.FINDER_CACHE_ENABLED,
			ESFStateAssEntityImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			ESFStateAssEntityModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(ESFStateAssEntityModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateAssEntityModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ESFStateAssEntity> findByUuid(String uuid)
	 ...
	 */
	@Override
	public List<ESFStateAssEntity> findByUuid(String uuid, int start, int end)
		throws SystemException {
	...
	public List<ESFStateAssEntity> findByUuid(String uuid, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFStateAssEntity esfStateAssEntity : list) {
				if (!Validator.equals(uuid, esfStateAssEntity.getUuid())) {
					list = null;
	 ...
	 */
	@Override
	public ESFStateAssEntity findByUuid_First(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateAssEntityException, SystemException {
		ESFStateAssEntity esfStateAssEntity = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFStateAssEntity fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFStateAssEntity> list = findByUuid(uuid, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ESFStateAssEntity findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateAssEntityException, SystemException {
		ESFStateAssEntity esfStateAssEntity = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFStateAssEntity fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFStateAssEntity> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFStateAssEntity[] findByUuid_PrevAndNext(
		ESFStateAssEntityPK esfStateAssEntityPK, String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateAssEntityException, SystemException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, esfStateAssEntity, uuid,
					orderByComparator, true);

			array[1] = esfStateAssEntity;

			array[2] = getByUuid_PrevAndNext(session, esfStateAssEntity, uuid,
	...
	protected ESFStateAssEntity getByUuid_PrevAndNext(Session session,
		ESFStateAssEntity esfStateAssEntity, String uuid,
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (ESFStateAssEntity esfStateAssEntity : findByUuid(uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "esfStateAssEntity.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "esfStateAssEntity.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(esfStateAssEntity.uuid IS NULL OR esfStateAssEntity.uuid = '')";
	...
	public ESFStateAssEntity create(ESFStateAssEntityPK esfStateAssEntityPK) {
		...
		esfStateAssEntity.setUuid(uuid);
	...
	public ESFStateAssEntity updateImpl(
		...
		if (Validator.isNull(esfStateAssEntity.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !ESFStateAssEntityModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfStateAssEntityModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfStateAssEntityModelImpl.getOriginalUuid()
					};
				...
				args = new Object[] { esfStateAssEntityModelImpl.getUuid() };
	...
	protected ESFStateAssEntity toUnwrappedModel(
		...
		esfStateAssEntityImpl.setUuid(esfStateAssEntity.getUuid());
