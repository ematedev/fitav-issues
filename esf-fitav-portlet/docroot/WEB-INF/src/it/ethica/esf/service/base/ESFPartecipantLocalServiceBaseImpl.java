...
import it.ethica.esf.service.ESFPartecipantLocalService;
...
/**
 * Provides the base implementation for the e s f partecipant local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFPartecipantLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFPartecipantLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFPartecipantLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFPartecipantLocalServiceUtil} to access the e s f partecipant local service.
	 */
	...
	@Override
	public ESFPartecipant addESFPartecipant(ESFPartecipant esfPartecipant)
		throws SystemException {
		esfPartecipant.setNew(true);

		return esfPartecipantPersistence.update(esfPartecipant);
	}
	 ...
	 */
	@Override
	public ESFPartecipant createESFPartecipant(long esfPartecipantId) {
		return esfPartecipantPersistence.create(esfPartecipantId);
	}
	...
	@Override
	public ESFPartecipant deleteESFPartecipant(long esfPartecipantId)
		throws PortalException, SystemException {
		return esfPartecipantPersistence.remove(esfPartecipantId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFPartecipant deleteESFPartecipant(ESFPartecipant esfPartecipant)
		throws SystemException {
		return esfPartecipantPersistence.remove(esfPartecipant);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFPartecipant.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPartecipantPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPartecipantPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFPartecipant fetchESFPartecipant(long esfPartecipantId)
		throws SystemException {
		return esfPartecipantPersistence.fetchByPrimaryKey(esfPartecipantId);
	}
	 ...
	 */
	@Override
	public ESFPartecipant fetchESFPartecipantByUuidAndCompanyId(String uuid,
		long companyId) throws SystemException {
		return esfPartecipantPersistence.fetchByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFPartecipant fetchESFPartecipantByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfPartecipantPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFPartecipant getESFPartecipant(long esfPartecipantId)
		throws PortalException, SystemException {
		return esfPartecipantPersistence.findByPrimaryKey(esfPartecipantId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfPartecipantPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFPartecipant getESFPartecipantByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfPartecipantPersistence.findByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFPartecipant getESFPartecipantByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return esfPartecipantPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFPartecipant> getESFPartecipants(int start, int end)
		throws SystemException {
		return esfPartecipantPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFPartecipantsCount() throws SystemException {
		return esfPartecipantPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPartecipant updateESFPartecipant(ESFPartecipant esfPartecipant)
		throws SystemException {
		return esfPartecipantPersistence.update(esfPartecipant);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFPartecipant",
			esfPartecipantLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfPartecipantPersistence.getDataSource();
	...
	private ESFPartecipantLocalServiceClpInvoker _clpInvoker = new ESFPartecipantLocalServiceClpInvoker();
}