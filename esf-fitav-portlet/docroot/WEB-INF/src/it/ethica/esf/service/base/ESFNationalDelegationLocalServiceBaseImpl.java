...
import it.ethica.esf.service.ESFNationalDelegationLocalService;
...
/**
 * Provides the base implementation for the e s f national delegation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFNationalDelegationLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFNationalDelegationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFNationalDelegationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFNationalDelegationLocalServiceUtil} to access the e s f national delegation local service.
	 */
	...
	@Override
	public ESFNationalDelegation addESFNationalDelegation(
		ESFNationalDelegation esfNationalDelegation) throws SystemException {
		esfNationalDelegation.setNew(true);

		return esfNationalDelegationPersistence.update(esfNationalDelegation);
	}
	 ...
	 */
	@Override
	public ESFNationalDelegation createESFNationalDelegation(
		long esfNationalDelgationId) {
		return esfNationalDelegationPersistence.create(esfNationalDelgationId);
	}
	...
	public ESFNationalDelegation deleteESFNationalDelegation(
		long esfNationalDelgationId) throws PortalException, SystemException {
		return esfNationalDelegationPersistence.remove(esfNationalDelgationId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFNationalDelegation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfNationalDelegationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNationalDelegationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFNationalDelegation fetchESFNationalDelegation(
		long esfNationalDelgationId) throws SystemException {
		return esfNationalDelegationPersistence.fetchByPrimaryKey(esfNationalDelgationId);
	}
	 ...
	 */
	@Override
	public ESFNationalDelegation getESFNationalDelegation(
		long esfNationalDelgationId) throws PortalException, SystemException {
		return esfNationalDelegationPersistence.findByPrimaryKey(esfNationalDelgationId);
	}
	 ...
	 */
	@Override
	public List<ESFNationalDelegation> getESFNationalDelegations(int start,
		int end) throws SystemException {
		return esfNationalDelegationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFNationalDelegationsCount() throws SystemException {
		return esfNationalDelegationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFNationalDelegation updateESFNationalDelegation(
		ESFNationalDelegation esfNationalDelegation) throws SystemException {
		return esfNationalDelegationPersistence.update(esfNationalDelegation);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFNationalDelegation",
			esfNationalDelegationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfNationalDelegationPersistence.getDataSource();
	...
	private ESFNationalDelegationLocalServiceClpInvoker _clpInvoker = new ESFNationalDelegationLocalServiceClpInvoker();
}