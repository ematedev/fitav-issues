...
import it.ethica.esf.service.ESFShootingDirectorLocalService;
...
/**
 * Provides the base implementation for the e s f shooting director local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFShootingDirectorLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFShootingDirectorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFShootingDirectorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFShootingDirectorLocalServiceUtil} to access the e s f shooting director local service.
	 */
	...
	@Override
	public ESFShootingDirector addESFShootingDirector(
		ESFShootingDirector esfShootingDirector) throws SystemException {
		esfShootingDirector.setNew(true);

		return esfShootingDirectorPersistence.update(esfShootingDirector);
	}
	 ...
	 */
	@Override
	public ESFShootingDirector createESFShootingDirector(
		long esfShootingDirectorId) {
		return esfShootingDirectorPersistence.create(esfShootingDirectorId);
	}
	...
	@Override
	public ESFShootingDirector deleteESFShootingDirector(
		long esfShootingDirectorId) throws PortalException, SystemException {
		return esfShootingDirectorPersistence.remove(esfShootingDirectorId);
	}
	...
	public ESFShootingDirector deleteESFShootingDirector(
		ESFShootingDirector esfShootingDirector) throws SystemException {
		return esfShootingDirectorPersistence.remove(esfShootingDirector);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFShootingDirector.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfShootingDirectorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShootingDirectorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFShootingDirector fetchESFShootingDirector(
		long esfShootingDirectorId) throws SystemException {
		return esfShootingDirectorPersistence.fetchByPrimaryKey(esfShootingDirectorId);
	}
	 ...
	 */
	@Override
	public ESFShootingDirector getESFShootingDirector(
		long esfShootingDirectorId) throws PortalException, SystemException {
		return esfShootingDirectorPersistence.findByPrimaryKey(esfShootingDirectorId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfShootingDirectorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFShootingDirector> getESFShootingDirectors(int start, int end)
		throws SystemException {
		return esfShootingDirectorPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFShootingDirectorsCount() throws SystemException {
		return esfShootingDirectorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFShootingDirector updateESFShootingDirector(
		ESFShootingDirector esfShootingDirector) throws SystemException {
		return esfShootingDirectorPersistence.update(esfShootingDirector);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFShootingDirector",
			esfShootingDirectorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfShootingDirectorPersistence.getDataSource();
	...
	private ESFShootingDirectorLocalServiceClpInvoker _clpInvoker = new ESFShootingDirectorLocalServiceClpInvoker();
}