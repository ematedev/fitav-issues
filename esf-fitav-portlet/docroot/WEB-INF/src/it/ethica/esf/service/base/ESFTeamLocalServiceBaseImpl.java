...
import it.ethica.esf.service.ESFTeamLocalService;
...
/**
 * Provides the base implementation for the e s f team local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFTeamLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFTeamLocalServiceImpl
 * @see it.ethica.esf.service.ESFTeamLocalServiceUtil
 * @generated
 */
public abstract class ESFTeamLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFTeamLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFTeamLocalServiceUtil} to access the e s f team local service.
	 */

	/**
	 * Adds the e s f team to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfTeam the e s f team
	 * @return the e s f team that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFTeam addESFTeam(ESFTeam esfTeam) throws SystemException {
		esfTeam.setNew(true);
	 ...
	 */
	@Override
	public ESFTeam createESFTeam(long esfTeamId) {
		return esfTeamPersistence.create(esfTeamId);
	}

	/**
	 * Deletes the e s f team with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfTeamId the primary key of the e s f team
	 * @return the e s f team that was removed
	 * @throws PortalException if a e s f team with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFTeam deleteESFTeam(long esfTeamId)
		throws PortalException, SystemException {
		return esfTeamPersistence.remove(esfTeamId);
	}

	/**
	 * Deletes the e s f team from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfTeam the e s f team
	 * @return the e s f team that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFTeam deleteESFTeam(ESFTeam esfTeam) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFTeam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfTeamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfTeamPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfTeamPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfTeamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfTeamPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFTeam fetchESFTeam(long esfTeamId) throws SystemException {
		return esfTeamPersistence.fetchByPrimaryKey(esfTeamId);
	}

	/**
	 * Returns the e s f team with the primary key.
	 *
	 * @param esfTeamId the primary key of the e s f team
	 ...
	 */
	@Override
	public ESFTeam getESFTeam(long esfTeamId)
		throws PortalException, SystemException {
		return esfTeamPersistence.findByPrimaryKey(esfTeamId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfTeamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFTeam> getESFTeams(int start, int end)
		throws SystemException {
		return esfTeamPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFTeamsCount() throws SystemException {
		return esfTeamPersistence.countAll();
	}

	/**
	 * Updates the e s f team in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfTeam the e s f team
	 * @return the e s f team that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFTeam updateESFTeam(ESFTeam esfTeam) throws SystemException {
		return esfTeamPersistence.update(esfTeam);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFTeam",
			esfTeamLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFTeam");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfTeamPersistence.getDataSource();
	...
	private ESFTeamLocalServiceClpInvoker _clpInvoker = new ESFTeamLocalServiceClpInvoker();
}