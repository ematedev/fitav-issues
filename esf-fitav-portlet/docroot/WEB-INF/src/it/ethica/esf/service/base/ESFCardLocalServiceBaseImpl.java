...
/**
 * Provides the base implementation for the e s f card local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCardLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFCardLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFCardLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCardLocalServiceUtil} to access the e s f card local service.
	 */
	...
	@Override
	public ESFCard addESFCard(ESFCard esfCard) throws SystemException {
		esfCard.setNew(true);

		return esfCardPersistence.update(esfCard);
	}
	 ...
	 */
	@Override
	public ESFCard createESFCard(long esfCardId) {
		return esfCardPersistence.create(esfCardId);
	}
	...
	@Override
	public ESFCard deleteESFCard(long esfCardId)
		throws PortalException, SystemException {
		return esfCardPersistence.remove(esfCardId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCard deleteESFCard(ESFCard esfCard) throws SystemException {
		return esfCardPersistence.remove(esfCard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCard.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfCardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCardPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfCardPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfCardPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFCard fetchESFCard(long esfCardId) throws SystemException {
		return esfCardPersistence.fetchByPrimaryKey(esfCardId);
	}
	 ...
	 */
	@Override
	public ESFCard fetchESFCardByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return esfCardPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFCard fetchESFCardByUuidAndGroupId(String uuid, long groupId)
		throws SystemException {
		return esfCardPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFCard getESFCard(long esfCardId)
		throws PortalException, SystemException {
		return esfCardPersistence.findByPrimaryKey(esfCardId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFCard getESFCardByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return esfCardPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFCard getESFCardByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return esfCardPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFCard> getESFCards(int start, int end)
		throws SystemException {
		return esfCardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFCardsCount() throws SystemException {
		return esfCardPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCard updateESFCard(ESFCard esfCard) throws SystemException {
		return esfCardPersistence.update(esfCard);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCard",
			esfCardLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCardPersistence.getDataSource();
	...
	private ESFCardLocalServiceClpInvoker _clpInvoker = new ESFCardLocalServiceClpInvoker();
}