...
import it.ethica.esf.service.ESFConfigurationLocalService;
...
/**
 * Provides the base implementation for the e s f configuration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFConfigurationLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFConfigurationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFConfigurationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFConfigurationLocalServiceUtil} to access the e s f configuration local service.
	 */
	...
	public ESFConfiguration addESFConfiguration(
		ESFConfiguration esfConfiguration) throws SystemException {
		esfConfiguration.setNew(true);

		return esfConfigurationPersistence.update(esfConfiguration);
	}
	 ...
	 */
	@Override
	public ESFConfiguration createESFConfiguration(long esfConfigurationId) {
		return esfConfigurationPersistence.create(esfConfigurationId);
	}
	...
	@Override
	public ESFConfiguration deleteESFConfiguration(long esfConfigurationId)
		throws PortalException, SystemException {
		return esfConfigurationPersistence.remove(esfConfigurationId);
	}
	...
	public ESFConfiguration deleteESFConfiguration(
		ESFConfiguration esfConfiguration) throws SystemException {
		return esfConfigurationPersistence.remove(esfConfiguration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFConfiguration.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfConfigurationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfConfigurationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFConfiguration fetchESFConfiguration(long esfConfigurationId)
		throws SystemException {
		return esfConfigurationPersistence.fetchByPrimaryKey(esfConfigurationId);
	}
	 ...
	 */
	@Override
	public ESFConfiguration getESFConfiguration(long esfConfigurationId)
		throws PortalException, SystemException {
		return esfConfigurationPersistence.findByPrimaryKey(esfConfigurationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfConfigurationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFConfiguration> getESFConfigurations(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFConfigurationsCount() throws SystemException {
		return esfConfigurationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFConfiguration",
			esfConfigurationLocalService);
	}
	...
	private ESFConfigurationLocalServiceClpInvoker _clpInvoker = new ESFConfigurationLocalServiceClpInvoker();
}