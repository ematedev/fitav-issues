...
import it.ethica.esf.service.ESFCategoryLocalService;
...
/**
 * Provides the base implementation for the e s f category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCategoryLocalServiceUtil} to access the e s f category local service.
	 */
	...
	@Override
	public ESFCategory addESFCategory(ESFCategory esfCategory)
		throws SystemException {
		esfCategory.setNew(true);

		return esfCategoryPersistence.update(esfCategory);
	}
	 ...
	 */
	@Override
	public ESFCategory createESFCategory(long esfCategoryId) {
		return esfCategoryPersistence.create(esfCategoryId);
	}
	...
	@Override
	public ESFCategory deleteESFCategory(long esfCategoryId)
		throws PortalException, SystemException {
		return esfCategoryPersistence.remove(esfCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCategory deleteESFCategory(ESFCategory esfCategory)
		throws SystemException {
		return esfCategoryPersistence.remove(esfCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFCategory fetchESFCategory(long esfCategoryId)
		throws SystemException {
		return esfCategoryPersistence.fetchByPrimaryKey(esfCategoryId);
	}
	 ...
	 */
	@Override
	public ESFCategory getESFCategory(long esfCategoryId)
		throws PortalException, SystemException {
		return esfCategoryPersistence.findByPrimaryKey(esfCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFCategory> getESFCategories(int start, int end)
		throws SystemException {
		return esfCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFCategoriesCount() throws SystemException {
		return esfCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCategory updateESFCategory(ESFCategory esfCategory)
		throws SystemException {
		return esfCategoryPersistence.update(esfCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCategory",
			esfCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCategoryPersistence.getDataSource();
	...
	private ESFCategoryLocalServiceClpInvoker _clpInvoker = new ESFCategoryLocalServiceClpInvoker();
}