...
public class ESFDescriptionLocalServiceClpInvoker {
	public ESFDescriptionLocalServiceClpInvoker() {
		...
		_methodName431 = "findAllByNational";

		_methodParameterTypes431 = new String[] { "boolean" };

		_methodName432 = "addEsfDescription";
		...
		_methodName433 = "updateEsfDescription";
		...
		_methodName434 = "deleteEsfDescription";

		_methodParameterTypes434 = new String[] {
				"long", "javax.portlet.ActionRequest"
			};

		_methodName435 = "getESFDescriptionsByMatchUser";

		_methodParameterTypes435 = new String[] { "java.util.List" };
	}
