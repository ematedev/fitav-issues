...
import it.ethica.esf.model.impl.CountryImpl;
import it.ethica.esf.model.impl.CountryModelImpl;
...
public class CountryPersistenceImpl extends BasePersistenceImpl<Country>
	 ...
	 */
	@Override
	public Country create(String idCountry) {
		Country country = new CountryImpl();

		country.setNew(true);
		country.setPrimaryKey(idCountry);
	 ...
	 */
	@Override
	public Country remove(String idCountry)
	...
	@Override
	public Country updateImpl(it.ethica.esf.model.Country country)
	...
	protected Country toUnwrappedModel(Country country) {
		...
		countryImpl.setIdCountry(country.getIdCountry());
	 ...
	 */
	@Override
	public Country findByPrimaryKey(String idCountry)
		throws NoSuchCountryException, SystemException {
	 ...
	 */
	@Override
	public Country fetchByPrimaryKey(String idCountry)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.it.ethica.esf.model.Country")));
