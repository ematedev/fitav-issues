...
import it.ethica.esf.service.ESFgunUserLocalService;
...
/**
 * Provides the base implementation for the e s fgun user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFgunUserLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFgunUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFgunUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFgunUserLocalServiceUtil} to access the e s fgun user local service.
	 */
	...
	@Override
	public ESFgunUser addESFgunUser(ESFgunUser esFgunUser)
		throws SystemException {
		esFgunUser.setNew(true);

		return esFgunUserPersistence.update(esFgunUser);
	}
	 ...
	 */
	@Override
	public ESFgunUser createESFgunUser(long esfGunUserId) {
		return esFgunUserPersistence.create(esfGunUserId);
	}
	...
	@Override
	public ESFgunUser deleteESFgunUser(long esfGunUserId)
		throws PortalException, SystemException {
		return esFgunUserPersistence.remove(esfGunUserId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFgunUser deleteESFgunUser(ESFgunUser esFgunUser)
		throws SystemException {
		return esFgunUserPersistence.remove(esFgunUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFgunUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esFgunUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esFgunUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esFgunUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFgunUser fetchESFgunUser(long esfGunUserId)
		throws SystemException {
		return esFgunUserPersistence.fetchByPrimaryKey(esfGunUserId);
	}
	 ...
	 */
	@Override
	public ESFgunUser getESFgunUser(long esfGunUserId)
		throws PortalException, SystemException {
		return esFgunUserPersistence.findByPrimaryKey(esfGunUserId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esFgunUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFgunUser> getESFgunUsers(int start, int end)
		throws SystemException {
		return esFgunUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFgunUsersCount() throws SystemException {
		return esFgunUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFgunUser updateESFgunUser(ESFgunUser esFgunUser)
		throws SystemException {
		return esFgunUserPersistence.update(esFgunUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFgunUser",
			esFgunUserLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFgunUser");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esFgunUserPersistence.getDataSource();
	...
	private ESFgunUserLocalServiceClpInvoker _clpInvoker = new ESFgunUserLocalServiceClpInvoker();
}