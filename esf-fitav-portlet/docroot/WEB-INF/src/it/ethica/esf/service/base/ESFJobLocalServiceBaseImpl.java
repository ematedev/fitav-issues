...
import it.ethica.esf.service.ESFJobLocalService;
...
/**
 * Provides the base implementation for the e s f job local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFJobLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFJobLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFJobLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFJobLocalServiceUtil} to access the e s f job local service.
	 */
	...
	@Override
	public ESFJob addESFJob(ESFJob esfJob) throws SystemException {
		esfJob.setNew(true);

		return esfJobPersistence.update(esfJob);
	}
	 ...
	 */
	@Override
	public ESFJob createESFJob(long esfJobId) {
		return esfJobPersistence.create(esfJobId);
	}
	...
	@Override
	public ESFJob deleteESFJob(long esfJobId)
		throws PortalException, SystemException {
		return esfJobPersistence.remove(esfJobId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFJob deleteESFJob(ESFJob esfJob) throws SystemException {
		return esfJobPersistence.remove(esfJob);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFJob.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfJobPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfJobPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfJobPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfJobPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFJob fetchESFJob(long esfJobId) throws SystemException {
		return esfJobPersistence.fetchByPrimaryKey(esfJobId);
	}
	 ...
	 */
	@Override
	public ESFJob getESFJob(long esfJobId)
		throws PortalException, SystemException {
		return esfJobPersistence.findByPrimaryKey(esfJobId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfJobPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFJob> getESFJobs(int start, int end)
		throws SystemException {
		return esfJobPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFJobsCount() throws SystemException {
		return esfJobPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFJob updateESFJob(ESFJob esfJob) throws SystemException {
		return esfJobPersistence.update(esfJob);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFJob",
			esfJobLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFJob");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfJobPersistence.getDataSource();
	...
	private ESFJobLocalServiceClpInvoker _clpInvoker = new ESFJobLocalServiceClpInvoker();
}