...
/**
 * Provides the base implementation for the v w_ azzurri local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.VW_AzzurriLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.VW_AzzurriLocalServiceImpl
 * @see it.ethica.esf.service.VW_AzzurriLocalServiceUtil
 * @generated
 */
public abstract class VW_AzzurriLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VW_AzzurriLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.VW_AzzurriLocalServiceUtil} to access the v w_ azzurri local service.
	 */
	...
	@Override
	public VW_Azzurri addVW_Azzurri(VW_Azzurri vw_Azzurri)
		throws SystemException {
		vw_Azzurri.setNew(true);

		return vw_AzzurriPersistence.update(vw_Azzurri);
	}
	 ...
	 */
	@Override
	public VW_Azzurri createVW_Azzurri(VW_AzzurriPK vw_AzzurriPK) {
		return vw_AzzurriPersistence.create(vw_AzzurriPK);
	}
	...
	@Override
	public VW_Azzurri deleteVW_Azzurri(VW_AzzurriPK vw_AzzurriPK)
		throws PortalException, SystemException {
		return vw_AzzurriPersistence.remove(vw_AzzurriPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VW_Azzurri deleteVW_Azzurri(VW_Azzurri vw_Azzurri)
		throws SystemException {
		return vw_AzzurriPersistence.remove(vw_Azzurri);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VW_Azzurri.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_AzzurriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vw_AzzurriPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_AzzurriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VW_Azzurri fetchVW_Azzurri(VW_AzzurriPK vw_AzzurriPK)
		throws SystemException {
		return vw_AzzurriPersistence.fetchByPrimaryKey(vw_AzzurriPK);
	}
	 ...
	 */
	@Override
	public VW_Azzurri getVW_Azzurri(VW_AzzurriPK vw_AzzurriPK)
		throws PortalException, SystemException {
		return vw_AzzurriPersistence.findByPrimaryKey(vw_AzzurriPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_AzzurriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VW_Azzurri> getVW_Azzurris(int start, int end)
		throws SystemException {
		return vw_AzzurriPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVW_AzzurrisCount() throws SystemException {
		return vw_AzzurriPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VW_Azzurri updateVW_Azzurri(VW_Azzurri vw_Azzurri)
		throws SystemException {
		return vw_AzzurriPersistence.update(vw_Azzurri);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.VW_Azzurri",
			vw_AzzurriLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.VW_Azzurri");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_AzzurriPersistence.getDataSource();
	...
	private VW_AzzurriLocalServiceClpInvoker _clpInvoker = new VW_AzzurriLocalServiceClpInvoker();
}