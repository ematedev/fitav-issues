...
import it.ethica.esf.service.ESFCountryLocalService;
...
/**
 * Provides the base implementation for the e s f country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCountryLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFCountryLocalServiceImpl
 * @see it.ethica.esf.service.ESFCountryLocalServiceUtil
 * @generated
 */
public abstract class ESFCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFCountryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCountryLocalServiceUtil} to access the e s f country local service.
	 */
	...
	@Override
	public ESFCountry addESFCountry(ESFCountry esfCountry)
		throws SystemException {
		esfCountry.setNew(true);

		return esfCountryPersistence.update(esfCountry);
	}
	 ...
	 */
	@Override
	public ESFCountry createESFCountry(String idCountry) {
		return esfCountryPersistence.create(idCountry);
	}
	...
	@Override
	public ESFCountry deleteESFCountry(String idCountry)
		throws PortalException, SystemException {
		return esfCountryPersistence.remove(idCountry);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCountry deleteESFCountry(ESFCountry esfCountry)
		throws SystemException {
		return esfCountryPersistence.remove(esfCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCountry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCountryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFCountry fetchESFCountry(String idCountry)
		throws SystemException {
		return esfCountryPersistence.fetchByPrimaryKey(idCountry);
	}
	 ...
	 */
	@Override
	public ESFCountry getESFCountry(String idCountry)
		throws PortalException, SystemException {
		return esfCountryPersistence.findByPrimaryKey(idCountry);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFCountry> getESFCountries(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFCountriesCount() throws SystemException {
		return esfCountryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCountry updateESFCountry(ESFCountry esfCountry)
		throws SystemException {
		return esfCountryPersistence.update(esfCountry);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCountry",
			esfCountryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFCountry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCountryPersistence.getDataSource();
	...
	private ESFCountryLocalServiceClpInvoker _clpInvoker = new ESFCountryLocalServiceClpInvoker();
}