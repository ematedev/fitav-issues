...
import it.ethica.esf.service.ESFCodeOrgLocalService;
...
/**
 * Provides the base implementation for the e s f code org local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCodeOrgLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFCodeOrgLocalServiceImpl
 * @see it.ethica.esf.service.ESFCodeOrgLocalServiceUtil
 * @generated
 */
public abstract class ESFCodeOrgLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFCodeOrgLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCodeOrgLocalServiceUtil} to access the e s f code org local service.
	 */

	/**
	 * Adds the e s f code org to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfCodeOrg the e s f code org
	 * @return the e s f code org that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCodeOrg addESFCodeOrg(ESFCodeOrg esfCodeOrg)
		throws SystemException {
		esfCodeOrg.setNew(true);

		return esfCodeOrgPersistence.update(esfCodeOrg);
	}
	 ...
	 */
	@Override
	public ESFCodeOrg createESFCodeOrg(long esfCodeOrgId) {
		return esfCodeOrgPersistence.create(esfCodeOrgId);
	}

	/**
	 * Deletes the e s f code org with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfCodeOrgId the primary key of the e s f code org
	 * @return the e s f code org that was removed
	 * @throws PortalException if a e s f code org with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCodeOrg deleteESFCodeOrg(long esfCodeOrgId)
		throws PortalException, SystemException {
		return esfCodeOrgPersistence.remove(esfCodeOrgId);
	}

	/**
	 * Deletes the e s f code org from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfCodeOrg the e s f code org
	 * @return the e s f code org that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCodeOrg deleteESFCodeOrg(ESFCodeOrg esfCodeOrg)
		throws SystemException {
		return esfCodeOrgPersistence.remove(esfCodeOrg);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCodeOrg.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCodeOrgPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCodeOrgPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCodeOrgPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFCodeOrg fetchESFCodeOrg(long esfCodeOrgId)
		throws SystemException {
		return esfCodeOrgPersistence.fetchByPrimaryKey(esfCodeOrgId);
	}

	/**
	 * Returns the e s f code org with the primary key.
	 *
	 * @param esfCodeOrgId the primary key of the e s f code org
	 ...
	 */
	@Override
	public ESFCodeOrg getESFCodeOrg(long esfCodeOrgId)
		throws PortalException, SystemException {
		return esfCodeOrgPersistence.findByPrimaryKey(esfCodeOrgId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCodeOrgPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFCodeOrg> getESFCodeOrgs(int start, int end)
		throws SystemException {
		return esfCodeOrgPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFCodeOrgsCount() throws SystemException {
		return esfCodeOrgPersistence.countAll();
	}

	/**
	 * Updates the e s f code org in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfCodeOrg the e s f code org
	 * @return the e s f code org that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCodeOrg updateESFCodeOrg(ESFCodeOrg esfCodeOrg)
		throws SystemException {
		return esfCodeOrgPersistence.update(esfCodeOrg);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCodeOrg",
			esfCodeOrgLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFCodeOrg");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCodeOrgPersistence.getDataSource();
	...
	private ESFCodeOrgLocalServiceClpInvoker _clpInvoker = new ESFCodeOrgLocalServiceClpInvoker();
}