...
import it.ethica.esf.service.ESFRadunoSottotipiRadunoLocalService;
...
/**
 * Provides the base implementation for the e s f raduno sottotipi raduno local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRadunoSottotipiRadunoLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFRadunoSottotipiRadunoLocalServiceImpl
 * @see it.ethica.esf.service.ESFRadunoSottotipiRadunoLocalServiceUtil
 * @generated
 */
public abstract class ESFRadunoSottotipiRadunoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFRadunoSottotipiRadunoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRadunoSottotipiRadunoLocalServiceUtil} to access the e s f raduno sottotipi raduno local service.
	 */
	...
	@Override
	public ESFRadunoSottotipiRaduno addESFRadunoSottotipiRaduno(
		ESFRadunoSottotipiRaduno esfRadunoSottotipiRaduno)
		throws SystemException {
		esfRadunoSottotipiRaduno.setNew(true);

		return esfRadunoSottotipiRadunoPersistence.update(esfRadunoSottotipiRaduno);
	}
	 ...
	 */
	@Override
	public ESFRadunoSottotipiRaduno createESFRadunoSottotipiRaduno(
		long id_esf_raduno_sottotipi_raduno) {
		return esfRadunoSottotipiRadunoPersistence.create(id_esf_raduno_sottotipi_raduno);
	}
	...
	@Override
	public ESFRadunoSottotipiRaduno deleteESFRadunoSottotipiRaduno(
		long id_esf_raduno_sottotipi_raduno)
		throws PortalException, SystemException {
		return esfRadunoSottotipiRadunoPersistence.remove(id_esf_raduno_sottotipi_raduno);
	}
	...
	public ESFRadunoSottotipiRaduno deleteESFRadunoSottotipiRaduno(
		ESFRadunoSottotipiRaduno esfRadunoSottotipiRaduno)
		throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.remove(esfRadunoSottotipiRaduno);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRadunoSottotipiRaduno.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRadunoSottotipiRaduno fetchESFRadunoSottotipiRaduno(
		long id_esf_raduno_sottotipi_raduno) throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.fetchByPrimaryKey(id_esf_raduno_sottotipi_raduno);
	}
	 ...
	 */
	@Override
	public ESFRadunoSottotipiRaduno getESFRadunoSottotipiRaduno(
		long id_esf_raduno_sottotipi_raduno)
		throws PortalException, SystemException {
		return esfRadunoSottotipiRadunoPersistence.findByPrimaryKey(id_esf_raduno_sottotipi_raduno);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRadunoSottotipiRadunoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRadunoSottotipiRaduno> getESFRadunoSottotipiRadunos(
		int start, int end) throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRadunoSottotipiRadunosCount() throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRadunoSottotipiRaduno updateESFRadunoSottotipiRaduno(
		ESFRadunoSottotipiRaduno esfRadunoSottotipiRaduno)
		throws SystemException {
		return esfRadunoSottotipiRadunoPersistence.update(esfRadunoSottotipiRaduno);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRadunoSottotipiRaduno",
			esfRadunoSottotipiRadunoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRadunoSottotipiRadunoPersistence.getDataSource();
	...
	private ESFRadunoSottotipiRadunoLocalServiceClpInvoker _clpInvoker = new ESFRadunoSottotipiRadunoLocalServiceClpInvoker();
}