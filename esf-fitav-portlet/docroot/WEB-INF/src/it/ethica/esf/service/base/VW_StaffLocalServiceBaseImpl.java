...
import it.ethica.esf.service.VW_StaffLocalService;
...
/**
 * Provides the base implementation for the v w_ staff local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.VW_StaffLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class VW_StaffLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VW_StaffLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.VW_StaffLocalServiceUtil} to access the v w_ staff local service.
	 */
	...
	@Override
	public VW_Staff addVW_Staff(VW_Staff vw_Staff) throws SystemException {
		vw_Staff.setNew(true);

		return vw_StaffPersistence.update(vw_Staff);
	}
	 ...
	 */
	@Override
	public VW_Staff createVW_Staff(VW_StaffPK vw_StaffPK) {
		return vw_StaffPersistence.create(vw_StaffPK);
	}
	...
	@Override
	public VW_Staff deleteVW_Staff(VW_StaffPK vw_StaffPK)
		throws PortalException, SystemException {
		return vw_StaffPersistence.remove(vw_StaffPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VW_Staff deleteVW_Staff(VW_Staff vw_Staff) throws SystemException {
		return vw_StaffPersistence.remove(vw_Staff);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VW_Staff.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vw_StaffPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vw_StaffPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vw_StaffPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_StaffPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VW_Staff fetchVW_Staff(VW_StaffPK vw_StaffPK)
		throws SystemException {
		return vw_StaffPersistence.fetchByPrimaryKey(vw_StaffPK);
	}
	 ...
	 */
	@Override
	public VW_Staff getVW_Staff(VW_StaffPK vw_StaffPK)
		throws PortalException, SystemException {
		return vw_StaffPersistence.findByPrimaryKey(vw_StaffPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_StaffPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VW_Staff> getVW_Staffs(int start, int end)
		throws SystemException {
		return vw_StaffPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVW_StaffsCount() throws SystemException {
		return vw_StaffPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VW_Staff updateVW_Staff(VW_Staff vw_Staff) throws SystemException {
		return vw_StaffPersistence.update(vw_Staff);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.VW_Staff",
			vw_StaffLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.VW_Staff");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_StaffPersistence.getDataSource();
	...
	private VW_StaffLocalServiceClpInvoker _clpInvoker = new VW_StaffLocalServiceClpInvoker();
}