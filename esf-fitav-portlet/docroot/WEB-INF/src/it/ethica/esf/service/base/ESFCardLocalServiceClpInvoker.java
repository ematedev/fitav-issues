...
public class ESFCardLocalServiceClpInvoker {
	public ESFCardLocalServiceClpInvoker() {
		...
		_methodName414 = "getEsfCardByEsfUserId";

		_methodParameterTypes414 = new String[] { "long" };

		_methodName415 = "addESFCard";
		...
		_methodName416 = "getAllESFCardsByEsfUserId";

		_methodParameterTypes416 = new String[] { "long" };

		_methodName417 = "createMultiESFCard";

		_methodParameterTypes417 = new String[] {
				"long", "int", "com.liferay.portal.service.ServiceContext"
			};

		_methodName418 = "addSelectedCard";
		...
		_methodName419 = "findAllESFCardsChildOrg";

		_methodParameterTypes419 = new String[] { "long" };

		_methodName420 = "findAllESFCardsReg_Prov";

		_methodParameterTypes420 = new String[] { "long" };

		_methodName421 = "findAllESFCardsReg_ProvFree";

		_methodParameterTypes421 = new String[] { "long" };

		_methodName422 = "getAllFreeCard";

		_methodParameterTypes422 = new String[] {  };

		_methodName423 = "findAllFreeCardInt";

		_methodParameterTypes423 = new String[] {  };

		_methodName424 = "findAllFreeCards";

		_methodParameterTypes424 = new String[] { "int", "int" };

		_methodName425 = "addMultiESFCard";
		...
		_methodName426 = "deleteESFCard";

		_methodParameterTypes426 = new String[] {
				"long", "com.liferay.portal.service.ServiceContext"
			};

		_methodName427 = "deleteESFCard";

		_methodParameterTypes427 = new String[] {
				"long[][]", "com.liferay.portal.service.ServiceContext"
			};

		_methodName428 = "updateESFCard";
		...
		_methodName429 = "findAllESFCardsByCode_Organization";

		_methodParameterTypes429 = new String[] { "java.lang.String", "long" };

		_methodName430 = "findAllESFCardsByC_U_O";

		_methodParameterTypes430 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName431 = "findAllESFCardsByState";

		_methodParameterTypes431 = new String[] { "int" };

		_methodName432 = "findAllESFCardsByState";

		_methodParameterTypes432 = new String[] { "int", "int", "int" };

		_methodName433 = "findAllByOrganizationId";

		_methodParameterTypes433 = new String[] { "long", "boolean", "int" };

		_methodName434 = "findAllByOrganizationId";

		_methodParameterTypes434 = new String[] {
				"long", "boolean", "int", "int", "int"
			};

		_methodName435 = "findAllESFCardsByOrganizationId";

		_methodParameterTypes435 = new String[] { "long", "boolean", "int" };

		_methodName436 = "findAllESFCardsByOrganizationId";

		_methodParameterTypes436 = new String[] {
				"long", "boolean", "int", "int", "int"
			};

		_methodName437 = "findAllESFCardsByRootOrganizationId";

		_methodParameterTypes437 = new String[] { "long", "int" };

		_methodName438 = "findAllESFCardsByRootOrganizationId";

		_methodParameterTypes438 = new String[] { "long", "int", "int", "int" };

		_methodName439 = "findESFCardByO_C";

		_methodParameterTypes439 = new String[] { "long", "long", "int" };

		_methodName440 = "findAllNotAssignedESFCardsByO_S";

		_methodParameterTypes440 = new String[] { "long", "boolean", "int" };

		_methodName441 = "findAllNotAssignedESFCardsByO_S";

		_methodParameterTypes441 = new String[] {
				"long", "boolean", "int", "int", "int"
			};

		_methodName442 = "findAllNotAssignedESFCardsByO_U_S";

		_methodParameterTypes442 = new String[] {
				"long", "long", "boolean", "int", "int", "int"
			};

		_methodName443 = "findAllNotAssignedESFCardsByO_U_S";

		_methodParameterTypes443 = new String[] { "long", "boolean", "long", "int" };

		_methodName445 = "findAllESFCardsByU_O_S";

		_methodParameterTypes445 = new String[] { "long", "long", "int" };

		_methodName446 = "findAllESFCardsByU_S_Y";

		_methodParameterTypes446 = new String[] { "long", "java.util.Date" };

		_methodName447 = "findAllESFCardsByU_S_Y";

		_methodParameterTypes447 = new String[] {
				"long", "java.util.Date", "int", "int"
			};

		_methodName448 = "findAllESFCardsByU_S";

		_methodParameterTypes448 = new String[] { "long", "int" };

		_methodName449 = "findCardByUser";

		_methodParameterTypes449 = new String[] { "long" };

		_methodName450 = "getAllEsfCardByLikeC";

		_methodParameterTypes450 = new String[] {
				"java.lang.String", "int", "int", "int"
			};

		_methodName451 = "getAllEsfCardByLikeC";

		_methodParameterTypes451 = new String[] { "java.lang.String", "int" };

		_methodName452 = "getEsfCardByCode";

		_methodParameterTypes452 = new String[] { "java.lang.String", "int" };

		_methodName453 = "checkCode";

		_methodParameterTypes453 = new String[] {
				"java.lang.String", "com.liferay.portal.service.ServiceContext"
			};

		_methodName455 = "buildCode";

		_methodParameterTypes455 = new String[] { "java.lang.String", "long" };

		_methodName456 = "findActualUserCards";

		_methodParameterTypes456 = new String[] { "long" };

		_methodName457 = "findShooterByCardActiveInMatch";

		_methodParameterTypes457 = new String[] {
				"java.lang.String", "java.lang.String", "java.lang.String"
			};

		_methodName458 = "addESFCardOldCode";
