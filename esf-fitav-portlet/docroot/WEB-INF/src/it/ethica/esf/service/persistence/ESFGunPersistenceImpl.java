...
public class ESFGunPersistenceImpl extends BasePersistenceImpl<ESFGun>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFGunModelImpl.ENTITY_CACHE_ENABLED,
			...
			ESFGunModelImpl.NAME_COLUMN_BITMASK);
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_CODE = new FinderPath(ESFGunModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunModelImpl.FINDER_CACHE_ENABLED, ESFGunImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByCode",
			new String[] { String.class.getName() },
			ESFGunModelImpl.CODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CODE = new FinderPath(ESFGunModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public ESFGun findByCode(String code)
		throws NoSuchGunException, SystemException {
		ESFGun esfGun = fetchByCode(code);
	 ...
	 */
	@Override
	public ESFGun fetchByCode(String code) throws SystemException {
	 ...
	 */
	@Override
	public ESFGun fetchByCode(String code, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result instanceof ESFGun) {
			...
			if (!Validator.equals(code, esfGun.getCode())) {
				result = null;
			}
		}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFGunPersistenceImpl.fetchByCode(String, boolean) with parameters (" +
	 ...
	 */
	@Override
	public ESFGun removeByCode(String code)
		throws NoSuchGunException, SystemException {
		ESFGun esfGun = findByCode(code);
	...
	private static final String _FINDER_COLUMN_CODE_CODE_1 = "esfGun.code IS NULL";
	private static final String _FINDER_COLUMN_CODE_CODE_2 = "esfGun.code = ?";
	private static final String _FINDER_COLUMN_CODE_CODE_3 = "(esfGun.code IS NULL OR esfGun.code = '')";
	...
	public void cacheResult(ESFGun esfGun) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CODE,
			new Object[] { esfGun.getCode() }, esfGun);
	...
	protected void cacheUniqueFindersCache(ESFGun esfGun) {
		if (esfGun.isNew()) {
			...
			args = new Object[] { esfGun.getCode() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_CODE, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_CODE, args, esfGun);
		}
		else {
			...
			if ((esfGunModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { esfGun.getCode() };
	...
	protected void clearUniqueFindersCache(ESFGun esfGun) {
		...
		if ((esfGunModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_CODE.getColumnBitmask()) != 0) {
			args = new Object[] { esfGunModelImpl.getOriginalCode() };
	...
	protected ESFGun toUnwrappedModel(ESFGun esfGun) {
		...
		esfGunImpl.setRegistrationNumber(esfGun.getRegistrationNumber());
		esfGunImpl.setCatridgeCaliber(esfGun.getCatridgeCaliber());
		esfGunImpl.setIsFavoriteGun(esfGun.isIsFavoriteGun());
		esfGunImpl.setTypeId(esfGun.getTypeId());
		esfGunImpl.setMeasures(esfGun.getMeasures());
		esfGunImpl.setNote(esfGun.getNote());
		esfGunImpl.setName(esfGun.getName());
