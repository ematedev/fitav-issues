...
import it.ethica.esf.service.ESFCatridgeLocalService;
...
/**
 * Provides the base implementation for the e s f catridge local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCatridgeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFCatridgeLocalServiceImpl
 * @see it.ethica.esf.service.ESFCatridgeLocalServiceUtil
 * @generated
 */
public abstract class ESFCatridgeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFCatridgeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCatridgeLocalServiceUtil} to access the e s f catridge local service.
	 */
	...
	@Override
	public ESFCatridge addESFCatridge(ESFCatridge esfCatridge)
		throws SystemException {
		esfCatridge.setNew(true);

		return esfCatridgePersistence.update(esfCatridge);
	}
	 ...
	 */
	@Override
	public ESFCatridge createESFCatridge(long esfCatridgeId) {
		return esfCatridgePersistence.create(esfCatridgeId);
	}
	...
	@Override
	public ESFCatridge deleteESFCatridge(long esfCatridgeId)
		throws PortalException, SystemException {
		return esfCatridgePersistence.remove(esfCatridgeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCatridge deleteESFCatridge(ESFCatridge esfCatridge)
		throws SystemException {
		return esfCatridgePersistence.remove(esfCatridge);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCatridge.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCatridgePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCatridgePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCatridgePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFCatridge fetchESFCatridge(long esfCatridgeId)
		throws SystemException {
		return esfCatridgePersistence.fetchByPrimaryKey(esfCatridgeId);
	}
	 ...
	 */
	@Override
	public ESFCatridge getESFCatridge(long esfCatridgeId)
		throws PortalException, SystemException {
		return esfCatridgePersistence.findByPrimaryKey(esfCatridgeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCatridgePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public int getESFCatridgesCount() throws SystemException {
		return esfCatridgePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCatridge updateESFCatridge(ESFCatridge esfCatridge)
		throws SystemException {
		return esfCatridgePersistence.update(esfCatridge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCatridge",
			esfCatridgeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCatridgePersistence.getDataSource();
	...
	private ESFCatridgeLocalServiceClpInvoker _clpInvoker = new ESFCatridgeLocalServiceClpInvoker();
}