...
import it.ethica.esf.service.ESFNotOlimpicMatchResultLocalService;
...
import it.ethica.esf.service.persistence.ESFEventMatchResultPersistence;
...
import it.ethica.esf.service.persistence.ESFNotOlimpicMatchResultPersistence;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFNotOlimpicMatchResultLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFNotOlimpicMatchResultLocalServiceImpl
 * @see it.ethica.esf.service.ESFNotOlimpicMatchResultLocalServiceUtil
 * @generated
 */
public abstract class ESFNotOlimpicMatchResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFNotOlimpicMatchResultLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFNotOlimpicMatchResultLocalServiceUtil} to access the e s f not olimpic match result local service.
	 */

	/**
	 * Adds the e s f not olimpic match result to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfNotOlimpicMatchResult the e s f not olimpic match result
	 * @return the e s f not olimpic match result that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFNotOlimpicMatchResult addESFNotOlimpicMatchResult(
		ESFNotOlimpicMatchResult esfNotOlimpicMatchResult)
		throws SystemException {
		esfNotOlimpicMatchResult.setNew(true);

		return esfNotOlimpicMatchResultPersistence.update(esfNotOlimpicMatchResult);
	}
	 ...
	 */
	@Override
	public ESFNotOlimpicMatchResult createESFNotOlimpicMatchResult(
		long ESFNotOlimpicMatchResultId) {
		return esfNotOlimpicMatchResultPersistence.create(ESFNotOlimpicMatchResultId);
	}

	/**
	 * Deletes the e s f not olimpic match result with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a e s f not olimpic match result with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFNotOlimpicMatchResult deleteESFNotOlimpicMatchResult(
		long ESFNotOlimpicMatchResultId)
		throws PortalException, SystemException {
		return esfNotOlimpicMatchResultPersistence.remove(ESFNotOlimpicMatchResultId);
	}

	/**
	 * Deletes the e s f not olimpic match result from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfNotOlimpicMatchResult the e s f not olimpic match result
	 * @return the e s f not olimpic match result that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ESFNotOlimpicMatchResult deleteESFNotOlimpicMatchResult(
		ESFNotOlimpicMatchResult esfNotOlimpicMatchResult)
		throws SystemException {
		return esfNotOlimpicMatchResultPersistence.remove(esfNotOlimpicMatchResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFNotOlimpicMatchResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNotOlimpicMatchResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNotOlimpicMatchResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFNotOlimpicMatchResult fetchESFNotOlimpicMatchResult(
		long ESFNotOlimpicMatchResultId) throws SystemException {
		return esfNotOlimpicMatchResultPersistence.fetchByPrimaryKey(ESFNotOlimpicMatchResultId);
	}

	/**
	 * Returns the e s f not olimpic match result with the primary key.
	 *
	 * @param ESFNotOlimpicMatchResultId the primary key of the e s f not olimpic match result
	 ...
	 */
	@Override
	public ESFNotOlimpicMatchResult getESFNotOlimpicMatchResult(
		long ESFNotOlimpicMatchResultId)
		throws PortalException, SystemException {
		return esfNotOlimpicMatchResultPersistence.findByPrimaryKey(ESFNotOlimpicMatchResultId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfNotOlimpicMatchResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFNotOlimpicMatchResult> getESFNotOlimpicMatchResults(
		int start, int end) throws SystemException {
		return esfNotOlimpicMatchResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFNotOlimpicMatchResultsCount() throws SystemException {
		return esfNotOlimpicMatchResultPersistence.countAll();
	}

	/**
	 * Updates the e s f not olimpic match result in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfNotOlimpicMatchResult the e s f not olimpic match result
	 * @return the e s f not olimpic match result that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFNotOlimpicMatchResult updateESFNotOlimpicMatchResult(
		ESFNotOlimpicMatchResult esfNotOlimpicMatchResult)
		throws SystemException {
		return esfNotOlimpicMatchResultPersistence.update(esfNotOlimpicMatchResult);
	}
	...
	/**
	 * Returns the e s f event match result local service.
	 *
	 * @return the e s f event match result local service
	 */
	public it.ethica.esf.service.ESFEventMatchResultLocalService getESFEventMatchResultLocalService() {
		return esfEventMatchResultLocalService;
	}

	/**
	 * Sets the e s f event match result local service.
	 *
	 * @param esfEventMatchResultLocalService the e s f event match result local service
	 */
	public void setESFEventMatchResultLocalService(
		it.ethica.esf.service.ESFEventMatchResultLocalService esfEventMatchResultLocalService) {
		this.esfEventMatchResultLocalService = esfEventMatchResultLocalService;
	}

	/**
	 * Returns the e s f event match result persistence.
	 *
	 * @return the e s f event match result persistence
	 */
	public ESFEventMatchResultPersistence getESFEventMatchResultPersistence() {
		return esfEventMatchResultPersistence;
	}

	/**
	 * Sets the e s f event match result persistence.
	 *
	 * @param esfEventMatchResultPersistence the e s f event match result persistence
	 */
	public void setESFEventMatchResultPersistence(
		ESFEventMatchResultPersistence esfEventMatchResultPersistence) {
		this.esfEventMatchResultPersistence = esfEventMatchResultPersistence;
	}
	...
	/**
	 * Returns the e s f not olimpic match result local service.
	 *
	 * @return the e s f not olimpic match result local service
	 */
	public it.ethica.esf.service.ESFNotOlimpicMatchResultLocalService getESFNotOlimpicMatchResultLocalService() {
		return esfNotOlimpicMatchResultLocalService;
	}

	/**
	 * Sets the e s f not olimpic match result local service.
	 *
	 * @param esfNotOlimpicMatchResultLocalService the e s f not olimpic match result local service
	 */
	public void setESFNotOlimpicMatchResultLocalService(
		it.ethica.esf.service.ESFNotOlimpicMatchResultLocalService esfNotOlimpicMatchResultLocalService) {
		this.esfNotOlimpicMatchResultLocalService = esfNotOlimpicMatchResultLocalService;
	}

	/**
	 * Returns the e s f not olimpic match result persistence.
	 *
	 * @return the e s f not olimpic match result persistence
	 */
	public ESFNotOlimpicMatchResultPersistence getESFNotOlimpicMatchResultPersistence() {
		return esfNotOlimpicMatchResultPersistence;
	}

	/**
	 * Sets the e s f not olimpic match result persistence.
	 *
	 * @param esfNotOlimpicMatchResultPersistence the e s f not olimpic match result persistence
	 */
	public void setESFNotOlimpicMatchResultPersistence(
		ESFNotOlimpicMatchResultPersistence esfNotOlimpicMatchResultPersistence) {
		this.esfNotOlimpicMatchResultPersistence = esfNotOlimpicMatchResultPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFNotOlimpicMatchResult",
			esfNotOlimpicMatchResultLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFNotOlimpicMatchResult");
	}
	...
	protected Class<?> getModelClass() {
		return ESFNotOlimpicMatchResult.class;
	}

	protected String getModelClassName() {
		return ESFNotOlimpicMatchResult.class.getName();
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfNotOlimpicMatchResultPersistence.getDataSource();
	...
	@BeanReference(type = it.ethica.esf.service.ESFEventMatchResultLocalService.class)
	protected it.ethica.esf.service.ESFEventMatchResultLocalService esfEventMatchResultLocalService;
	@BeanReference(type = ESFEventMatchResultPersistence.class)
	protected ESFEventMatchResultPersistence esfEventMatchResultPersistence;
	...
	@BeanReference(type = it.ethica.esf.service.ESFNotOlimpicMatchResultLocalService.class)
	protected it.ethica.esf.service.ESFNotOlimpicMatchResultLocalService esfNotOlimpicMatchResultLocalService;
	@BeanReference(type = ESFNotOlimpicMatchResultPersistence.class)
	protected ESFNotOlimpicMatchResultPersistence esfNotOlimpicMatchResultPersistence;
	...
	private ESFNotOlimpicMatchResultLocalServiceClpInvoker _clpInvoker = new ESFNotOlimpicMatchResultLocalServiceClpInvoker();
}