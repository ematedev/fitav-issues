...
import it.ethica.esf.service.ESFFornitureTypeLocalService;
...
/**
 * Provides the base implementation for the e s f forniture type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFFornitureTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFFornitureTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFFornitureTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFFornitureTypeLocalServiceUtil} to access the e s f forniture type local service.
	 */
	...
	@Override
	public ESFFornitureType addESFFornitureType(
		ESFFornitureType esfFornitureType) throws SystemException {
		esfFornitureType.setNew(true);

		return esfFornitureTypePersistence.update(esfFornitureType);
	}
	 ...
	 */
	@Override
	public ESFFornitureType createESFFornitureType(long esfFornitureTypeId) {
		return esfFornitureTypePersistence.create(esfFornitureTypeId);
	}
	...
	public ESFFornitureType deleteESFFornitureType(long esfFornitureTypeId)
		...
		return esfFornitureTypePersistence.remove(esfFornitureTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFFornitureType deleteESFFornitureType(
		ESFFornitureType esfFornitureType) throws SystemException {
		return esfFornitureTypePersistence.remove(esfFornitureType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFFornitureType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfFornitureTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFornitureTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFFornitureType fetchESFFornitureType(long esfFornitureTypeId)
		throws SystemException {
		return esfFornitureTypePersistence.fetchByPrimaryKey(esfFornitureTypeId);
	}
	 ...
	 */
	@Override
	public ESFFornitureType fetchESFFornitureTypeByUuidAndCompanyId(
		String uuid, long companyId) throws SystemException {
		return esfFornitureTypePersistence.fetchByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFFornitureType fetchESFFornitureTypeByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfFornitureTypePersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFFornitureType getESFFornitureType(long esfFornitureTypeId)
		throws PortalException, SystemException {
		return esfFornitureTypePersistence.findByPrimaryKey(esfFornitureTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfFornitureTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFFornitureType getESFFornitureTypeByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfFornitureTypePersistence.findByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFFornitureType getESFFornitureTypeByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return esfFornitureTypePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFFornitureType> getESFFornitureTypes(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFFornitureTypesCount() throws SystemException {
		return esfFornitureTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFFornitureType updateESFFornitureType(
		ESFFornitureType esfFornitureType) throws SystemException {
		return esfFornitureTypePersistence.update(esfFornitureType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFFornitureType",
			esfFornitureTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfFornitureTypePersistence.getDataSource();
	...
	private ESFFornitureTypeLocalServiceClpInvoker _clpInvoker = new ESFFornitureTypeLocalServiceClpInvoker();
}