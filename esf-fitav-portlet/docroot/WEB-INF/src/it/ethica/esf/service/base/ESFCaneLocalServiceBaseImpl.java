...
import it.ethica.esf.service.ESFCaneLocalService;
...
/**
 * Provides the base implementation for the e s f cane local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCaneLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFCaneLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFCaneLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCaneLocalServiceUtil} to access the e s f cane local service.
	 */
	...
	@Override
	public ESFCane addESFCane(ESFCane esfCane) throws SystemException {
		esfCane.setNew(true);

		return esfCanePersistence.update(esfCane);
	}
	 ...
	 */
	@Override
	public ESFCane createESFCane(long esfCaneId) {
		return esfCanePersistence.create(esfCaneId);
	}
	...
	@Override
	public ESFCane deleteESFCane(long esfCaneId)
		throws PortalException, SystemException {
		return esfCanePersistence.remove(esfCaneId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCane deleteESFCane(ESFCane esfCane) throws SystemException {
		return esfCanePersistence.remove(esfCane);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCane.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfCanePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCanePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfCanePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCanePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfCanePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFCane fetchESFCane(long esfCaneId) throws SystemException {
		return esfCanePersistence.fetchByPrimaryKey(esfCaneId);
	}
	 ...
	 */
	@Override
	public ESFCane getESFCane(long esfCaneId)
		throws PortalException, SystemException {
		return esfCanePersistence.findByPrimaryKey(esfCaneId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCanePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public int getESFCanesCount() throws SystemException {
		return esfCanePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCane updateESFCane(ESFCane esfCane) throws SystemException {
		return esfCanePersistence.update(esfCane);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCane",
			esfCaneLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFCane");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCanePersistence.getDataSource();
	...
	private ESFCaneLocalServiceClpInvoker _clpInvoker = new ESFCaneLocalServiceClpInvoker();
}