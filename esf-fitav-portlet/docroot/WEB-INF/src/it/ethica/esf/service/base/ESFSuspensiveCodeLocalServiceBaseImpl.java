...
import it.ethica.esf.service.ESFSuspensiveCodeLocalService;
...
/**
 * Provides the base implementation for the e s f suspensive code local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFSuspensiveCodeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFSuspensiveCodeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFSuspensiveCodeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFSuspensiveCodeLocalServiceUtil} to access the e s f suspensive code local service.
	 */
	...
	@Override
	public ESFSuspensiveCode addESFSuspensiveCode(
		ESFSuspensiveCode esfSuspensiveCode) throws SystemException {
		esfSuspensiveCode.setNew(true);

		return esfSuspensiveCodePersistence.update(esfSuspensiveCode);
	}
	 ...
	 */
	@Override
	public ESFSuspensiveCode createESFSuspensiveCode(long esfSuspensiveCodeId) {
		return esfSuspensiveCodePersistence.create(esfSuspensiveCodeId);
	}
	...
	@Override
	public ESFSuspensiveCode deleteESFSuspensiveCode(long esfSuspensiveCodeId)
		throws PortalException, SystemException {
		return esfSuspensiveCodePersistence.remove(esfSuspensiveCodeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFSuspensiveCode deleteESFSuspensiveCode(
		ESFSuspensiveCode esfSuspensiveCode) throws SystemException {
		return esfSuspensiveCodePersistence.remove(esfSuspensiveCode);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFSuspensiveCode.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfSuspensiveCodePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfSuspensiveCodePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFSuspensiveCode fetchESFSuspensiveCode(long esfSuspensiveCodeId)
		throws SystemException {
		return esfSuspensiveCodePersistence.fetchByPrimaryKey(esfSuspensiveCodeId);
	}
	 ...
	 */
	@Override
	public ESFSuspensiveCode getESFSuspensiveCode(long esfSuspensiveCodeId)
		throws PortalException, SystemException {
		return esfSuspensiveCodePersistence.findByPrimaryKey(esfSuspensiveCodeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfSuspensiveCodePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFSuspensiveCode> getESFSuspensiveCodes(int start, int end)
		throws SystemException {
		return esfSuspensiveCodePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFSuspensiveCodesCount() throws SystemException {
		return esfSuspensiveCodePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFSuspensiveCode updateESFSuspensiveCode(
		ESFSuspensiveCode esfSuspensiveCode) throws SystemException {
		return esfSuspensiveCodePersistence.update(esfSuspensiveCode);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFSuspensiveCode",
			esfSuspensiveCodeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfSuspensiveCodePersistence.getDataSource();
	...
	private ESFSuspensiveCodeLocalServiceClpInvoker _clpInvoker = new ESFSuspensiveCodeLocalServiceClpInvoker();
}