...
/**
 * Provides the base implementation for the e s f national match result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFNationalMatchResultLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFNationalMatchResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFNationalMatchResultLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFNationalMatchResultLocalServiceUtil} to access the e s f national match result local service.
	 */
	...
	@Override
	public ESFNationalMatchResult addESFNationalMatchResult(
		ESFNationalMatchResult esfNationalMatchResult)
		throws SystemException {
		esfNationalMatchResult.setNew(true);

		return esfNationalMatchResultPersistence.update(esfNationalMatchResult);
	}
	 ...
	 */
	@Override
	public ESFNationalMatchResult createESFNationalMatchResult(
		long esfNationalMatchResultId) {
		return esfNationalMatchResultPersistence.create(esfNationalMatchResultId);
	}
	...
	@Override
	public ESFNationalMatchResult deleteESFNationalMatchResult(
		long esfNationalMatchResultId) throws PortalException, SystemException {
		return esfNationalMatchResultPersistence.remove(esfNationalMatchResultId);
	}
	...
	public ESFNationalMatchResult deleteESFNationalMatchResult(
		ESFNationalMatchResult esfNationalMatchResult)
		throws SystemException {
		return esfNationalMatchResultPersistence.remove(esfNationalMatchResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFNationalMatchResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNationalMatchResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNationalMatchResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFNationalMatchResult fetchESFNationalMatchResult(
		long esfNationalMatchResultId) throws SystemException {
		return esfNationalMatchResultPersistence.fetchByPrimaryKey(esfNationalMatchResultId);
	}
	 ...
	 */
	@Override
	public ESFNationalMatchResult getESFNationalMatchResult(
		long esfNationalMatchResultId) throws PortalException, SystemException {
		return esfNationalMatchResultPersistence.findByPrimaryKey(esfNationalMatchResultId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfNationalMatchResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFNationalMatchResult> getESFNationalMatchResults(int start,
		int end) throws SystemException {
		return esfNationalMatchResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFNationalMatchResultsCount() throws SystemException {
		return esfNationalMatchResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFNationalMatchResult updateESFNationalMatchResult(
		ESFNationalMatchResult esfNationalMatchResult)
		throws SystemException {
		return esfNationalMatchResultPersistence.update(esfNationalMatchResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFNationalMatchResult",
			esfNationalMatchResultLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfNationalMatchResultPersistence.getDataSource();
	...
	private ESFNationalMatchResultLocalServiceClpInvoker _clpInvoker = new ESFNationalMatchResultLocalServiceClpInvoker();
}