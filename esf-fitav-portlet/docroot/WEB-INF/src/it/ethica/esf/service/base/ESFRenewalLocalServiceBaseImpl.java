...
import it.ethica.esf.service.ESFRenewalLocalService;
...
/**
 * Provides the base implementation for the e s f renewal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRenewalLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFRenewalLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFRenewalLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRenewalLocalServiceUtil} to access the e s f renewal local service.
	 */
	...
	@Override
	public ESFRenewal addESFRenewal(ESFRenewal esfRenewal)
		throws SystemException {
		esfRenewal.setNew(true);

		return esfRenewalPersistence.update(esfRenewal);
	}
	 ...
	 */
	@Override
	public ESFRenewal createESFRenewal(long esfRenewalId) {
		return esfRenewalPersistence.create(esfRenewalId);
	}
	...
	@Override
	public ESFRenewal deleteESFRenewal(long esfRenewalId)
		throws PortalException, SystemException {
		return esfRenewalPersistence.remove(esfRenewalId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRenewal deleteESFRenewal(ESFRenewal esfRenewal)
		throws SystemException {
		return esfRenewalPersistence.remove(esfRenewal);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRenewal.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRenewalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfRenewalPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRenewalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRenewal fetchESFRenewal(long esfRenewalId)
		throws SystemException {
		return esfRenewalPersistence.fetchByPrimaryKey(esfRenewalId);
	}
	 ...
	 */
	@Override
	public ESFRenewal getESFRenewal(long esfRenewalId)
		throws PortalException, SystemException {
		return esfRenewalPersistence.findByPrimaryKey(esfRenewalId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRenewalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRenewal> getESFRenewals(int start, int end)
		throws SystemException {
		return esfRenewalPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRenewalsCount() throws SystemException {
		return esfRenewalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRenewal updateESFRenewal(ESFRenewal esfRenewal)
		throws SystemException {
		return esfRenewalPersistence.update(esfRenewal);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRenewal",
			esfRenewalLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFRenewal");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRenewalPersistence.getDataSource();
	...
	private ESFRenewalLocalServiceClpInvoker _clpInvoker = new ESFRenewalLocalServiceClpInvoker();
}