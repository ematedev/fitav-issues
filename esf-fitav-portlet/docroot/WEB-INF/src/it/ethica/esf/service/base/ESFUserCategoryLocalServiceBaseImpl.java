...
import it.ethica.esf.service.ESFUserCategoryLocalService;
...
/**
 * Provides the base implementation for the e s f user category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFUserCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFUserCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFUserCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFUserCategoryLocalServiceUtil} to access the e s f user category local service.
	 */
	...
	@Override
	public ESFUserCategory addESFUserCategory(ESFUserCategory esfUserCategory)
		throws SystemException {
		esfUserCategory.setNew(true);

		return esfUserCategoryPersistence.update(esfUserCategory);
	}
	 ...
	 */
	@Override
	public ESFUserCategory createESFUserCategory(long esfUserCategoryId) {
		return esfUserCategoryPersistence.create(esfUserCategoryId);
	}
	...
	@Override
	public ESFUserCategory deleteESFUserCategory(long esfUserCategoryId)
		throws PortalException, SystemException {
		return esfUserCategoryPersistence.remove(esfUserCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFUserCategory deleteESFUserCategory(
		ESFUserCategory esfUserCategory) throws SystemException {
		return esfUserCategoryPersistence.remove(esfUserCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFUserCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfUserCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfUserCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFUserCategory fetchESFUserCategory(long esfUserCategoryId)
		throws SystemException {
		return esfUserCategoryPersistence.fetchByPrimaryKey(esfUserCategoryId);
	}
	 ...
	 */
	@Override
	public ESFUserCategory getESFUserCategory(long esfUserCategoryId)
		throws PortalException, SystemException {
		return esfUserCategoryPersistence.findByPrimaryKey(esfUserCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfUserCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFUserCategory> getESFUserCategories(int start, int end)
		throws SystemException {
		return esfUserCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFUserCategoriesCount() throws SystemException {
		return esfUserCategoryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFUserCategory",
			esfUserCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfUserCategoryPersistence.getDataSource();
	...
	private ESFUserCategoryLocalServiceClpInvoker _clpInvoker = new ESFUserCategoryLocalServiceClpInvoker();
}