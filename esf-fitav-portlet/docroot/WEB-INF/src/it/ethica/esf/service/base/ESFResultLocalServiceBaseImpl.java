...
import it.ethica.esf.service.ESFResultLocalService;
...
/**
 * Provides the base implementation for the e s f result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFResultLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFResultLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFResultLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFResultLocalServiceUtil} to access the e s f result local service.
	 */
	...
	@Override
	public ESFResult addESFResult(ESFResult esfResult)
		throws SystemException {
		esfResult.setNew(true);

		return esfResultPersistence.update(esfResult);
	}
	 ...
	 */
	@Override
	public ESFResult createESFResult(long esfResultId) {
		return esfResultPersistence.create(esfResultId);
	}
	...
	@Override
	public ESFResult deleteESFResult(long esfResultId)
		throws PortalException, SystemException {
		return esfResultPersistence.remove(esfResultId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFResult deleteESFResult(ESFResult esfResult)
		throws SystemException {
		return esfResultPersistence.remove(esfResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfResultPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFResult fetchESFResult(long esfResultId) throws SystemException {
		return esfResultPersistence.fetchByPrimaryKey(esfResultId);
	}
	 ...
	 */
	@Override
	public ESFResult getESFResult(long esfResultId)
		throws PortalException, SystemException {
		return esfResultPersistence.findByPrimaryKey(esfResultId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFResult> getESFResults(int start, int end)
		throws SystemException {
		return esfResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFResultsCount() throws SystemException {
		return esfResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFResult updateESFResult(ESFResult esfResult)
		throws SystemException {
		return esfResultPersistence.update(esfResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFResult",
			esfResultLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFResult");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfResultPersistence.getDataSource();
	...
	private ESFResultLocalServiceClpInvoker _clpInvoker = new ESFResultLocalServiceClpInvoker();
}