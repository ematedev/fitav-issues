...
import it.ethica.esf.service.ESFNationalLocalService;
...
/**
 * Provides the base implementation for the e s f national local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFNationalLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFNationalLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFNationalLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFNationalLocalServiceUtil} to access the e s f national local service.
	 */
	...
	@Override
	public ESFNational addESFNational(ESFNational esfNational)
		throws SystemException {
		esfNational.setNew(true);

		return esfNationalPersistence.update(esfNational);
	}
	 ...
	 */
	@Override
	public ESFNational createESFNational(long esfNationalId) {
		return esfNationalPersistence.create(esfNationalId);
	}
	...
	@Override
	public ESFNational deleteESFNational(long esfNationalId)
		throws PortalException, SystemException {
		return esfNationalPersistence.remove(esfNationalId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFNational deleteESFNational(ESFNational esfNational)
		throws SystemException {
		return esfNationalPersistence.remove(esfNational);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFNational.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNationalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfNationalPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfNationalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFNational fetchESFNational(long esfNationalId)
		throws SystemException {
		return esfNationalPersistence.fetchByPrimaryKey(esfNationalId);
	}
	 ...
	 */
	@Override
	public ESFNational getESFNational(long esfNationalId)
		throws PortalException, SystemException {
		return esfNationalPersistence.findByPrimaryKey(esfNationalId);
	}
	 ...
	 */
	@Override
	public List<ESFNational> getESFNationals(int start, int end)
		throws SystemException {
		return esfNationalPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFNationalsCount() throws SystemException {
		return esfNationalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFNational updateESFNational(ESFNational esfNational)
		throws SystemException {
		return esfNationalPersistence.update(esfNational);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFNational",
			esfNationalLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFNational");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfNationalPersistence.getDataSource();
	...
	private ESFNationalLocalServiceClpInvoker _clpInvoker = new ESFNationalLocalServiceClpInvoker();
}