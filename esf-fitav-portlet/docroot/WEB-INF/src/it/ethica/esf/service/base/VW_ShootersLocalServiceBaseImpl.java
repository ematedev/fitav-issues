...
import it.ethica.esf.service.VW_ShootersLocalService;
...
/**
 * Provides the base implementation for the v w_ shooters local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.VW_ShootersLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.VW_ShootersLocalServiceImpl
 * @see it.ethica.esf.service.VW_ShootersLocalServiceUtil
 * @generated
 */
public abstract class VW_ShootersLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VW_ShootersLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.VW_ShootersLocalServiceUtil} to access the v w_ shooters local service.
	 */
	...
	@Override
	public VW_Shooters addVW_Shooters(VW_Shooters vw_Shooters)
		throws SystemException {
		vw_Shooters.setNew(true);

		return vw_ShootersPersistence.update(vw_Shooters);
	}
	 ...
	 */
	@Override
	public VW_Shooters createVW_Shooters(VW_ShootersPK vw_ShootersPK) {
		return vw_ShootersPersistence.create(vw_ShootersPK);
	}
	...
	@Override
	public VW_Shooters deleteVW_Shooters(VW_ShootersPK vw_ShootersPK)
		throws PortalException, SystemException {
		return vw_ShootersPersistence.remove(vw_ShootersPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VW_Shooters deleteVW_Shooters(VW_Shooters vw_Shooters)
		throws SystemException {
		return vw_ShootersPersistence.remove(vw_Shooters);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VW_Shooters.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_ShootersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vw_ShootersPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_ShootersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VW_Shooters fetchVW_Shooters(VW_ShootersPK vw_ShootersPK)
		throws SystemException {
		return vw_ShootersPersistence.fetchByPrimaryKey(vw_ShootersPK);
	}
	 ...
	 */
	@Override
	public VW_Shooters getVW_Shooters(VW_ShootersPK vw_ShootersPK)
		throws PortalException, SystemException {
		return vw_ShootersPersistence.findByPrimaryKey(vw_ShootersPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_ShootersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VW_Shooters> getVW_Shooterses(int start, int end)
		throws SystemException {
		return vw_ShootersPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVW_ShootersesCount() throws SystemException {
		return vw_ShootersPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VW_Shooters updateVW_Shooters(VW_Shooters vw_Shooters)
		throws SystemException {
		return vw_ShootersPersistence.update(vw_Shooters);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.VW_Shooters",
			vw_ShootersLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.VW_Shooters");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_ShootersPersistence.getDataSource();
	...
	private VW_ShootersLocalServiceClpInvoker _clpInvoker = new VW_ShootersLocalServiceClpInvoker();
}