...
public class ESFGunTypePersistenceImpl extends BasePersistenceImpl<ESFGunType>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_NAME = new FinderPath(ESFGunTypeModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunTypeModelImpl.FINDER_CACHE_ENABLED, ESFGunTypeImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByname",
			new String[] { String.class.getName() },
			ESFGunTypeModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(ESFGunTypeModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public ESFGunType findByname(String name)
		throws NoSuchGunTypeException, SystemException {
		ESFGunType esfGunType = fetchByname(name);
	 ...
	 */
	@Override
	public ESFGunType fetchByname(String name) throws SystemException {
	 ...
	 */
	@Override
	public ESFGunType fetchByname(String name, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result instanceof ESFGunType) {
			...
			if (!Validator.equals(name, esfGunType.getName())) {
				result = null;
			}
		}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFGunTypePersistenceImpl.fetchByname(String, boolean) with parameters (" +
	 ...
	 */
	@Override
	public ESFGunType removeByname(String name)
		throws NoSuchGunTypeException, SystemException {
		ESFGunType esfGunType = findByname(name);
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "esfGunType.name IS NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "esfGunType.name = ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(esfGunType.name IS NULL OR esfGunType.name = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER = new FinderPath(ESFGunTypeModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunTypeModelImpl.FINDER_CACHE_ENABLED, ESFGunTypeImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByisCatridgeProducer",
			new String[] { Boolean.class.getName() },
			ESFGunTypeModelImpl.ISCATRIDGEPRODUCTOR_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ISCATRIDGEPRODUCER = new FinderPath(ESFGunTypeModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByisCatridgeProducer",
			new String[] { Boolean.class.getName() });
	 ...
	 */
	@Override
	public ESFGunType findByisCatridgeProducer(boolean isCatridgeProductor)
		throws NoSuchGunTypeException, SystemException {
		ESFGunType esfGunType = fetchByisCatridgeProducer(isCatridgeProductor);
		...
		if (esfGunType == null) {
			...
			msg.append("isCatridgeProductor=");
			msg.append(isCatridgeProductor);
	 ...
	 */
	@Override
	public ESFGunType fetchByisCatridgeProducer(boolean isCatridgeProductor)
		throws SystemException {
		return fetchByisCatridgeProducer(isCatridgeProductor, true);
	}
	...
	public ESFGunType fetchByisCatridgeProducer(boolean isCatridgeProductor,
		boolean retrieveFromCache) throws SystemException {
		Object[] finderArgs = new Object[] { isCatridgeProductor };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
					finderArgs, this);
		}
		...
		if (result instanceof ESFGunType) {
			...
			if ((isCatridgeProductor != esfGunType.getIsCatridgeProductor())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_ISCATRIDGEPRODUCER_ISCATRIDGEPRODUCTOR_2);
			...
			try {
				...
				qPos.add(isCatridgeProductor);

				List<ESFGunType> list = q.list();

				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFGunTypePersistenceImpl.fetchByisCatridgeProducer(boolean, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((esfGunType.getIsCatridgeProductor() != isCatridgeProductor)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
							finderArgs, esfGunType);
					}
				}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
					finderArgs);
	 ...
	 */
	@Override
	public ESFGunType removeByisCatridgeProducer(boolean isCatridgeProductor)
		throws NoSuchGunTypeException, SystemException {
		ESFGunType esfGunType = findByisCatridgeProducer(isCatridgeProductor);
	 ...
	 */
	@Override
	public int countByisCatridgeProducer(boolean isCatridgeProductor)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ISCATRIDGEPRODUCER;
	...
	private static final String _FINDER_COLUMN_ISCATRIDGEPRODUCER_ISCATRIDGEPRODUCTOR_2 =
		"esfGunType.isCatridgeProductor = ?";
	...
	public void cacheResult(ESFGunType esfGunType) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAME,
			new Object[] { esfGunType.getName() }, esfGunType);

		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
			new Object[] { esfGunType.getIsCatridgeProductor() }, esfGunType);
	...
	protected void cacheUniqueFindersCache(ESFGunType esfGunType) {
		if (esfGunType.isNew()) {
			...
			args = new Object[] { esfGunType.getName() };
			...
			args = new Object[] { esfGunType.getIsCatridgeProductor() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_ISCATRIDGEPRODUCER,
				args, Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
				args, esfGunType);
		}
			...
			if ((esfGunTypeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { esfGunType.getName() };
			...
			if ((esfGunTypeModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { esfGunType.getIsCatridgeProductor() };
	...
	protected void clearUniqueFindersCache(ESFGunType esfGunType) {
		...
		if ((esfGunTypeModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_NAME.getColumnBitmask()) != 0) {
			args = new Object[] { esfGunTypeModelImpl.getOriginalName() };
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ISCATRIDGEPRODUCER,
			args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER,
			args);
		...
		if ((esfGunTypeModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_ISCATRIDGEPRODUCER.getColumnBitmask()) != 0) {
			args = new Object[] {
					esfGunTypeModelImpl.getOriginalIsCatridgeProductor()
				};
	...
	protected ESFGunType toUnwrappedModel(ESFGunType esfGunType) {
		...
		esfGunTypeImpl.setIsCatridgeProductor(esfGunType.isIsCatridgeProductor());
