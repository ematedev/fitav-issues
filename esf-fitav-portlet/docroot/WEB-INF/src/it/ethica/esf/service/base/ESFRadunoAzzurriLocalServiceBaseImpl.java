...
import it.ethica.esf.service.ESFRadunoAzzurriLocalService;
...
/**
 * Provides the base implementation for the e s f raduno azzurri local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRadunoAzzurriLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFRadunoAzzurriLocalServiceImpl
 * @see it.ethica.esf.service.ESFRadunoAzzurriLocalServiceUtil
 * @generated
 */
public abstract class ESFRadunoAzzurriLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFRadunoAzzurriLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRadunoAzzurriLocalServiceUtil} to access the e s f raduno azzurri local service.
	 */

	/**
	 * Adds the e s f raduno azzurri to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfRadunoAzzurri the e s f raduno azzurri
	 * @return the e s f raduno azzurri that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRadunoAzzurri addESFRadunoAzzurri(
		ESFRadunoAzzurri esfRadunoAzzurri) throws SystemException {
		esfRadunoAzzurri.setNew(true);

		return esfRadunoAzzurriPersistence.update(esfRadunoAzzurri);
	}
	 ...
	 */
	@Override
	public ESFRadunoAzzurri createESFRadunoAzzurri(
		ESFRadunoAzzurriPK esfRadunoAzzurriPK) {
		return esfRadunoAzzurriPersistence.create(esfRadunoAzzurriPK);
	}

	/**
	 * Deletes the e s f raduno azzurri with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfRadunoAzzurriPK the primary key of the e s f raduno azzurri
	 * @return the e s f raduno azzurri that was removed
	 * @throws PortalException if a e s f raduno azzurri with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRadunoAzzurri deleteESFRadunoAzzurri(
		ESFRadunoAzzurriPK esfRadunoAzzurriPK)
		throws PortalException, SystemException {
		return esfRadunoAzzurriPersistence.remove(esfRadunoAzzurriPK);
	}

	/**
	 * Deletes the e s f raduno azzurri from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfRadunoAzzurri the e s f raduno azzurri
	 * @return the e s f raduno azzurri that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ESFRadunoAzzurri deleteESFRadunoAzzurri(
		ESFRadunoAzzurri esfRadunoAzzurri) throws SystemException {
		return esfRadunoAzzurriPersistence.remove(esfRadunoAzzurri);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRadunoAzzurri.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfRadunoAzzurriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoAzzurriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRadunoAzzurri fetchESFRadunoAzzurri(
		ESFRadunoAzzurriPK esfRadunoAzzurriPK) throws SystemException {
		return esfRadunoAzzurriPersistence.fetchByPrimaryKey(esfRadunoAzzurriPK);
	}

	/**
	 * Returns the e s f raduno azzurri with the primary key.
	 *
	 * @param esfRadunoAzzurriPK the primary key of the e s f raduno azzurri
	 ...
	 */
	@Override
	public ESFRadunoAzzurri getESFRadunoAzzurri(
		ESFRadunoAzzurriPK esfRadunoAzzurriPK)
		throws PortalException, SystemException {
		return esfRadunoAzzurriPersistence.findByPrimaryKey(esfRadunoAzzurriPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRadunoAzzurriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRadunoAzzurri> getESFRadunoAzzurris(int start, int end)
		throws SystemException {
		return esfRadunoAzzurriPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRadunoAzzurrisCount() throws SystemException {
		return esfRadunoAzzurriPersistence.countAll();
	}

	/**
	 * Updates the e s f raduno azzurri in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfRadunoAzzurri the e s f raduno azzurri
	 * @return the e s f raduno azzurri that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRadunoAzzurri updateESFRadunoAzzurri(
		ESFRadunoAzzurri esfRadunoAzzurri) throws SystemException {
		return esfRadunoAzzurriPersistence.update(esfRadunoAzzurri);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRadunoAzzurri",
			esfRadunoAzzurriLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRadunoAzzurriPersistence.getDataSource();
	...
	private ESFRadunoAzzurriLocalServiceClpInvoker _clpInvoker = new ESFRadunoAzzurriLocalServiceClpInvoker();
}