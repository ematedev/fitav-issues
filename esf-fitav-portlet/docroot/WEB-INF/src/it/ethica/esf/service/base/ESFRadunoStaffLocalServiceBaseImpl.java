...
import it.ethica.esf.service.ESFRadunoStaffLocalService;
...
/**
 * Provides the base implementation for the e s f raduno staff local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRadunoStaffLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFRadunoStaffLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFRadunoStaffLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRadunoStaffLocalServiceUtil} to access the e s f raduno staff local service.
	 */
	...
	@Override
	public ESFRadunoStaff addESFRadunoStaff(ESFRadunoStaff esfRadunoStaff)
		throws SystemException {
		esfRadunoStaff.setNew(true);

		return esfRadunoStaffPersistence.update(esfRadunoStaff);
	}
	 ...
	 */
	@Override
	public ESFRadunoStaff createESFRadunoStaff(
		ESFRadunoStaffPK esfRadunoStaffPK) {
		return esfRadunoStaffPersistence.create(esfRadunoStaffPK);
	}
	...
	@Override
	public ESFRadunoStaff deleteESFRadunoStaff(
		ESFRadunoStaffPK esfRadunoStaffPK)
		throws PortalException, SystemException {
		return esfRadunoStaffPersistence.remove(esfRadunoStaffPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRadunoStaff deleteESFRadunoStaff(ESFRadunoStaff esfRadunoStaff)
		throws SystemException {
		return esfRadunoStaffPersistence.remove(esfRadunoStaff);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRadunoStaff.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoStaffPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoStaffPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRadunoStaff fetchESFRadunoStaff(ESFRadunoStaffPK esfRadunoStaffPK)
		throws SystemException {
		return esfRadunoStaffPersistence.fetchByPrimaryKey(esfRadunoStaffPK);
	}
	 ...
	 */
	@Override
	public ESFRadunoStaff getESFRadunoStaff(ESFRadunoStaffPK esfRadunoStaffPK)
		throws PortalException, SystemException {
		return esfRadunoStaffPersistence.findByPrimaryKey(esfRadunoStaffPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRadunoStaffPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRadunoStaff> getESFRadunoStaffs(int start, int end)
		throws SystemException {
		return esfRadunoStaffPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRadunoStaffsCount() throws SystemException {
		return esfRadunoStaffPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRadunoStaff updateESFRadunoStaff(ESFRadunoStaff esfRadunoStaff)
		throws SystemException {
		return esfRadunoStaffPersistence.update(esfRadunoStaff);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRadunoStaff",
			esfRadunoStaffLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFRadunoStaff");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRadunoStaffPersistence.getDataSource();
	...
	private ESFRadunoStaffLocalServiceClpInvoker _clpInvoker = new ESFRadunoStaffLocalServiceClpInvoker();
}