...
import it.ethica.esf.service.ESFPartecipantTypeLocalService;
...
/**
 * Provides the base implementation for the e s f partecipant type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFPartecipantTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFPartecipantTypeLocalServiceImpl
 * @see it.ethica.esf.service.ESFPartecipantTypeLocalServiceUtil
 * @generated
 */
public abstract class ESFPartecipantTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFPartecipantTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFPartecipantTypeLocalServiceUtil} to access the e s f partecipant type local service.
	 */
	...
	@Override
	public ESFPartecipantType addESFPartecipantType(
		ESFPartecipantType esfPartecipantType) throws SystemException {
		esfPartecipantType.setNew(true);

		return esfPartecipantTypePersistence.update(esfPartecipantType);
	}
	 ...
	 */
	@Override
	public ESFPartecipantType createESFPartecipantType(
		long esfPartecipantTypeId) {
		return esfPartecipantTypePersistence.create(esfPartecipantTypeId);
	}
	...
	@Override
	public ESFPartecipantType deleteESFPartecipantType(
		long esfPartecipantTypeId) throws PortalException, SystemException {
		return esfPartecipantTypePersistence.remove(esfPartecipantTypeId);
	}
	...
	public ESFPartecipantType deleteESFPartecipantType(
		ESFPartecipantType esfPartecipantType) throws SystemException {
		return esfPartecipantTypePersistence.remove(esfPartecipantType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFPartecipantType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfPartecipantTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPartecipantTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFPartecipantType fetchESFPartecipantType(long esfPartecipantTypeId)
		throws SystemException {
		return esfPartecipantTypePersistence.fetchByPrimaryKey(esfPartecipantTypeId);
	}
	 ...
	 */
	@Override
	public ESFPartecipantType getESFPartecipantType(long esfPartecipantTypeId)
		throws PortalException, SystemException {
		return esfPartecipantTypePersistence.findByPrimaryKey(esfPartecipantTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfPartecipantTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFPartecipantType> getESFPartecipantTypes(int start, int end)
		throws SystemException {
		return esfPartecipantTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFPartecipantTypesCount() throws SystemException {
		return esfPartecipantTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPartecipantType updateESFPartecipantType(
		ESFPartecipantType esfPartecipantType) throws SystemException {
		return esfPartecipantTypePersistence.update(esfPartecipantType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFPartecipantType",
			esfPartecipantTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfPartecipantTypePersistence.getDataSource();
	...
	private ESFPartecipantTypeLocalServiceClpInvoker _clpInvoker = new ESFPartecipantTypeLocalServiceClpInvoker();
}