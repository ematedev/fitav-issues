...
public class ESFDescriptionPersistenceImpl extends BasePersistenceImpl<ESFDescription>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(ESFDescriptionModelImpl.ENTITY_CACHE_ENABLED,
			ESFDescriptionModelImpl.FINDER_CACHE_ENABLED,
			ESFDescriptionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFDescriptionModelImpl.ENTITY_CACHE_ENABLED,
			ESFDescriptionModelImpl.FINDER_CACHE_ENABLED,
			ESFDescriptionImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			ESFDescriptionModelImpl.UUID_COLUMN_BITMASK |
			ESFDescriptionModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(ESFDescriptionModelImpl.ENTITY_CACHE_ENABLED,
			ESFDescriptionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
			new String[] { String.class.getName() });

	/**
	 * Returns all the e s f descriptions where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<ESFDescription> findByUuid(String uuid)
		throws SystemException {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the e s f descriptions where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<ESFDescription> findByUuid(String uuid, int start, int end)
		throws SystemException {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the e s f descriptions where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFDescriptionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ESFDescription> findByUuid(String uuid, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFDescription esfDescription : list) {
				if (!Validator.equals(uuid, esfDescription.getUuid())) {
					list = null;
	...
	/**
	 * Returns the first e s f description in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public ESFDescription findByUuid_First(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchDescriptionException, SystemException {
		ESFDescription esfDescription = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFDescription fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFDescription> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last e s f description in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFDescription findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchDescriptionException, SystemException {
		ESFDescription esfDescription = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 */
	@Override
	public ESFDescription fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFDescription> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the e s f descriptions before and after the current e s f description in the ordered set where uuid = &#63;.
	 *
	 ...
	 */
	@Override
	public ESFDescription[] findByUuid_PrevAndNext(long esfDescriptionId,
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, esfDescription, uuid,
					orderByComparator, true);

			array[1] = esfDescription;

			array[2] = getByUuid_PrevAndNext(session, esfDescription, uuid,
	...
	protected ESFDescription getByUuid_PrevAndNext(Session session,
		ESFDescription esfDescription, String uuid,
	...
	/**
	 * Removes all the e s f descriptions where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (ESFDescription esfDescription : findByUuid(uuid,
	...
	/**
	 * Returns the number of e s f descriptions where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "esfDescription.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "esfDescription.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(esfDescription.uuid IS NULL OR esfDescription.uuid = '')";
	...
	public ESFDescription updateImpl(
		...
		if (Validator.isNull(esfDescription.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !ESFDescriptionModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfDescriptionModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfDescriptionModelImpl.getOriginalUuid()
					};
				...
				args = new Object[] { esfDescriptionModelImpl.getUuid() };
	...
	protected ESFDescription toUnwrappedModel(ESFDescription esfDescription) {
		...
		esfDescriptionImpl.setUuid(esfDescription.getUuid());
