...
import it.ethica.esf.service.ESFFornitureUserLocalService;
...
/**
 * Provides the base implementation for the e s f forniture user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFFornitureUserLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFFornitureUserLocalServiceImpl
 * @see it.ethica.esf.service.ESFFornitureUserLocalServiceUtil
 * @generated
 */
public abstract class ESFFornitureUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFFornitureUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFFornitureUserLocalServiceUtil} to access the e s f forniture user local service.
	 */
	...
	@Override
	public ESFFornitureUser addESFFornitureUser(
		ESFFornitureUser esfFornitureUser) throws SystemException {
		esfFornitureUser.setNew(true);

		return esfFornitureUserPersistence.update(esfFornitureUser);
	}
	 ...
	 */
	@Override
	public ESFFornitureUser createESFFornitureUser(long esfFornitureUserID) {
		return esfFornitureUserPersistence.create(esfFornitureUserID);
	}
	...
	@Override
	public ESFFornitureUser deleteESFFornitureUser(long esfFornitureUserID)
		throws PortalException, SystemException {
		return esfFornitureUserPersistence.remove(esfFornitureUserID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFFornitureUser deleteESFFornitureUser(
		ESFFornitureUser esfFornitureUser) throws SystemException {
		return esfFornitureUserPersistence.remove(esfFornitureUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFFornitureUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfFornitureUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFornitureUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFFornitureUser fetchESFFornitureUser(long esfFornitureUserID)
		throws SystemException {
		return esfFornitureUserPersistence.fetchByPrimaryKey(esfFornitureUserID);
	}
	 ...
	 */
	@Override
	public ESFFornitureUser getESFFornitureUser(long esfFornitureUserID)
		throws PortalException, SystemException {
		return esfFornitureUserPersistence.findByPrimaryKey(esfFornitureUserID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfFornitureUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFFornitureUser> getESFFornitureUsers(int start, int end)
		throws SystemException {
		return esfFornitureUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFFornitureUsersCount() throws SystemException {
		return esfFornitureUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFFornitureUser updateESFFornitureUser(
		ESFFornitureUser esfFornitureUser) throws SystemException {
		return esfFornitureUserPersistence.update(esfFornitureUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFFornitureUser",
			esfFornitureUserLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFFornitureUser");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfFornitureUserPersistence.getDataSource();
	...
	private ESFFornitureUserLocalServiceClpInvoker _clpInvoker = new ESFFornitureUserLocalServiceClpInvoker();
}