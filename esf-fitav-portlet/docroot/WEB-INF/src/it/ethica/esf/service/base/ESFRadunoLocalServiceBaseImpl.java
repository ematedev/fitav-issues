...
import it.ethica.esf.service.ESFRadunoLocalService;
...
/**
 * Provides the base implementation for the e s f raduno local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRadunoLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFRadunoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFRadunoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRadunoLocalServiceUtil} to access the e s f raduno local service.
	 */
	...
	@Override
	public ESFRaduno addESFRaduno(ESFRaduno esfRaduno)
		throws SystemException {
		esfRaduno.setNew(true);

		return esfRadunoPersistence.update(esfRaduno);
	}
	 ...
	 */
	@Override
	public ESFRaduno createESFRaduno(long id_esf_raduno) {
		return esfRadunoPersistence.create(id_esf_raduno);
	}
	...
	@Override
	public ESFRaduno deleteESFRaduno(long id_esf_raduno)
		throws PortalException, SystemException {
		return esfRadunoPersistence.remove(id_esf_raduno);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRaduno deleteESFRaduno(ESFRaduno esfRaduno)
		throws SystemException {
		return esfRadunoPersistence.remove(esfRaduno);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRaduno.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfRadunoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRaduno fetchESFRaduno(long id_esf_raduno)
		throws SystemException {
		return esfRadunoPersistence.fetchByPrimaryKey(id_esf_raduno);
	}
	 ...
	 */
	@Override
	public ESFRaduno getESFRaduno(long id_esf_raduno)
		throws PortalException, SystemException {
		return esfRadunoPersistence.findByPrimaryKey(id_esf_raduno);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRadunoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRaduno> getESFRadunos(int start, int end)
		throws SystemException {
		return esfRadunoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRadunosCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRaduno updateESFRaduno(ESFRaduno esfRaduno)
		throws SystemException {
		return esfRadunoPersistence.update(esfRaduno);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRaduno",
			esfRadunoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFRaduno");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRadunoPersistence.getDataSource();
	...
	private ESFRadunoLocalServiceClpInvoker _clpInvoker = new ESFRadunoLocalServiceClpInvoker();
}