...
import it.ethica.esf.service.vw_datidirettoretiroLocalService;
...
/**
 * Provides the base implementation for the vw_datidirettoretiro local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.vw_datidirettoretiroLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.vw_datidirettoretiroLocalServiceImpl
 * @see it.ethica.esf.service.vw_datidirettoretiroLocalServiceUtil
 * @generated
 */
public abstract class vw_datidirettoretiroLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements vw_datidirettoretiroLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.vw_datidirettoretiroLocalServiceUtil} to access the vw_datidirettoretiro local service.
	 */
	...
	@Override
	public vw_datidirettoretiro addvw_datidirettoretiro(
		vw_datidirettoretiro vw_datidirettoretiro) throws SystemException {
		vw_datidirettoretiro.setNew(true);

		return vw_datidirettoretiroPersistence.update(vw_datidirettoretiro);
	}
	 ...
	 */
	@Override
	public vw_datidirettoretiro createvw_datidirettoretiro(
		vw_datidirettoretiroPK vw_datidirettoretiroPK) {
		return vw_datidirettoretiroPersistence.create(vw_datidirettoretiroPK);
	}
	...
	@Override
	public vw_datidirettoretiro deletevw_datidirettoretiro(
		vw_datidirettoretiroPK vw_datidirettoretiroPK)
		throws PortalException, SystemException {
		return vw_datidirettoretiroPersistence.remove(vw_datidirettoretiroPK);
	}
	...
	public vw_datidirettoretiro deletevw_datidirettoretiro(
		vw_datidirettoretiro vw_datidirettoretiro) throws SystemException {
		return vw_datidirettoretiroPersistence.remove(vw_datidirettoretiro);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vw_datidirettoretiro.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vw_datidirettoretiroPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_datidirettoretiroPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public vw_datidirettoretiro fetchvw_datidirettoretiro(
		vw_datidirettoretiroPK vw_datidirettoretiroPK)
		throws SystemException {
		return vw_datidirettoretiroPersistence.fetchByPrimaryKey(vw_datidirettoretiroPK);
	}
	 ...
	 */
	@Override
	public vw_datidirettoretiro getvw_datidirettoretiro(
		vw_datidirettoretiroPK vw_datidirettoretiroPK)
		throws PortalException, SystemException {
		return vw_datidirettoretiroPersistence.findByPrimaryKey(vw_datidirettoretiroPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_datidirettoretiroPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<vw_datidirettoretiro> getvw_datidirettoretiros(int start,
		int end) throws SystemException {
		return vw_datidirettoretiroPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getvw_datidirettoretirosCount() throws SystemException {
		return vw_datidirettoretiroPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public vw_datidirettoretiro updatevw_datidirettoretiro(
		vw_datidirettoretiro vw_datidirettoretiro) throws SystemException {
		return vw_datidirettoretiroPersistence.update(vw_datidirettoretiro);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.vw_datidirettoretiro",
			vw_datidirettoretiroLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_datidirettoretiroPersistence.getDataSource();
	...
	private vw_datidirettoretiroLocalServiceClpInvoker _clpInvoker = new vw_datidirettoretiroLocalServiceClpInvoker();
}