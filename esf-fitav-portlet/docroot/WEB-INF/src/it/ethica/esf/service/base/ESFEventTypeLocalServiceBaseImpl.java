...
import it.ethica.esf.service.ESFEventTypeLocalService;
...
/**
 * Provides the base implementation for the e s f event type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFEventTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFEventTypeLocalServiceImpl
 * @see it.ethica.esf.service.ESFEventTypeLocalServiceUtil
 * @generated
 */
public abstract class ESFEventTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFEventTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFEventTypeLocalServiceUtil} to access the e s f event type local service.
	 */
	...
	@Override
	public ESFEventType addESFEventType(ESFEventType esfEventType)
		throws SystemException {
		esfEventType.setNew(true);

		return esfEventTypePersistence.update(esfEventType);
	}
	 ...
	 */
	@Override
	public ESFEventType createESFEventType(long esfEventTypeId) {
		return esfEventTypePersistence.create(esfEventTypeId);
	}
	...
	@Override
	public ESFEventType deleteESFEventType(long esfEventTypeId)
		throws PortalException, SystemException {
		return esfEventTypePersistence.remove(esfEventTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFEventType deleteESFEventType(ESFEventType esfEventType)
		throws SystemException {
		return esfEventTypePersistence.remove(esfEventType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFEventType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfEventTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfEventTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFEventType fetchESFEventType(long esfEventTypeId)
		throws SystemException {
		return esfEventTypePersistence.fetchByPrimaryKey(esfEventTypeId);
	}
	 ...
	 */
	@Override
	public ESFEventType getESFEventType(long esfEventTypeId)
		throws PortalException, SystemException {
		return esfEventTypePersistence.findByPrimaryKey(esfEventTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfEventTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFEventType> getESFEventTypes(int start, int end)
		throws SystemException {
		return esfEventTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFEventTypesCount() throws SystemException {
		return esfEventTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFEventType updateESFEventType(ESFEventType esfEventType)
		throws SystemException {
		return esfEventTypePersistence.update(esfEventType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFEventType",
			esfEventTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfEventTypePersistence.getDataSource();
	...
	private ESFEventTypeLocalServiceClpInvoker _clpInvoker = new ESFEventTypeLocalServiceClpInvoker();
}