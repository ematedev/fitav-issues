...
import it.ethica.esf.service.ESFDepartureLocalService;
...
/**
 * Provides the base implementation for the e s f departure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFDepartureLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFDepartureLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFDepartureLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFDepartureLocalServiceUtil} to access the e s f departure local service.
	 */
	...
	@Override
	public ESFDeparture addESFDeparture(ESFDeparture esfDeparture)
		throws SystemException {
		esfDeparture.setNew(true);

		return esfDeparturePersistence.update(esfDeparture);
	}
	 ...
	 */
	@Override
	public ESFDeparture createESFDeparture(long esfDepartureId) {
		return esfDeparturePersistence.create(esfDepartureId);
	}
	...
	@Override
	public ESFDeparture deleteESFDeparture(long esfDepartureId)
		throws PortalException, SystemException {
		return esfDeparturePersistence.remove(esfDepartureId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFDeparture deleteESFDeparture(ESFDeparture esfDeparture)
		throws SystemException {
		return esfDeparturePersistence.remove(esfDeparture);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFDeparture.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDeparturePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDeparturePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFDeparture fetchESFDeparture(long esfDepartureId)
		throws SystemException {
		return esfDeparturePersistence.fetchByPrimaryKey(esfDepartureId);
	}
	 ...
	 */
	@Override
	public ESFDeparture getESFDeparture(long esfDepartureId)
		throws PortalException, SystemException {
		return esfDeparturePersistence.findByPrimaryKey(esfDepartureId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfDeparturePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFDeparture> getESFDepartures(int start, int end)
		throws SystemException {
		return esfDeparturePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFDeparturesCount() throws SystemException {
		return esfDeparturePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFDeparture updateESFDeparture(ESFDeparture esfDeparture)
		throws SystemException {
		return esfDeparturePersistence.update(esfDeparture);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFDeparture",
			esfDepartureLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfDeparturePersistence.getDataSource();
	...
	private ESFDepartureLocalServiceClpInvoker _clpInvoker = new ESFDepartureLocalServiceClpInvoker();
}