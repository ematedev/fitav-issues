...
import it.ethica.esf.service.ESFPublicAuthorityLocalService;
...
/**
 * Provides the base implementation for the e s f public authority local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFPublicAuthorityLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFPublicAuthorityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFPublicAuthorityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFPublicAuthorityLocalServiceUtil} to access the e s f public authority local service.
	 */
	...
	@Override
	public ESFPublicAuthority addESFPublicAuthority(
		ESFPublicAuthority esfPublicAuthority) throws SystemException {
		esfPublicAuthority.setNew(true);

		return esfPublicAuthorityPersistence.update(esfPublicAuthority);
	}
	 ...
	 */
	@Override
	public ESFPublicAuthority createESFPublicAuthority(
		long esfPublicAuthorityId) {
		return esfPublicAuthorityPersistence.create(esfPublicAuthorityId);
	}
	...
	@Override
	public ESFPublicAuthority deleteESFPublicAuthority(
		long esfPublicAuthorityId) throws PortalException, SystemException {
		return esfPublicAuthorityPersistence.remove(esfPublicAuthorityId);
	}
	...
	public ESFPublicAuthority deleteESFPublicAuthority(
		ESFPublicAuthority esfPublicAuthority) throws SystemException {
		return esfPublicAuthorityPersistence.remove(esfPublicAuthority);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFPublicAuthority.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfPublicAuthorityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPublicAuthorityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFPublicAuthority fetchESFPublicAuthority(long esfPublicAuthorityId)
		throws SystemException {
		return esfPublicAuthorityPersistence.fetchByPrimaryKey(esfPublicAuthorityId);
	}
	 ...
	 */
	@Override
	public ESFPublicAuthority getESFPublicAuthority(long esfPublicAuthorityId)
		throws PortalException, SystemException {
		return esfPublicAuthorityPersistence.findByPrimaryKey(esfPublicAuthorityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfPublicAuthorityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFPublicAuthority> getESFPublicAuthorities(int start, int end)
		throws SystemException {
		return esfPublicAuthorityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFPublicAuthoritiesCount() throws SystemException {
		return esfPublicAuthorityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPublicAuthority updateESFPublicAuthority(
		ESFPublicAuthority esfPublicAuthority) throws SystemException {
		return esfPublicAuthorityPersistence.update(esfPublicAuthority);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFPublicAuthority",
			esfPublicAuthorityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfPublicAuthorityPersistence.getDataSource();
	...
	private ESFPublicAuthorityLocalServiceClpInvoker _clpInvoker = new ESFPublicAuthorityLocalServiceClpInvoker();
}