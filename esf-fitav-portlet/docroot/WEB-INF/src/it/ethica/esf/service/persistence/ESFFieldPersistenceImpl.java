...
public class ESFFieldPersistenceImpl extends BasePersistenceImpl<ESFField>
	...
	protected ESFField toUnwrappedModel(ESFField esfField) {
		...
		esfFieldImpl.setBillboard(esfField.getBillboard());
		esfFieldImpl.setBillboardStations(esfField.isBillboardStations());
		esfFieldImpl.setBackgroundRampart(esfField.isBackgroundRampart());
		esfFieldImpl.setBackgroundNet(esfField.isBackgroundNet());
		esfFieldImpl.setBackgroundLeadRecovery(esfField.isBackgroundLeadRecovery());
		esfFieldImpl.setDisabledAccess(esfField.isDisabledAccess());
		esfFieldImpl.setNote(esfField.getNote());
	...
	private static final String _FILTER_SQL_SELECT_ESFFIELD_WHERE = "SELECT DISTINCT {esfField.*} FROM ESFField esfField WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFFIELD_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {ESFField.*} FROM (SELECT DISTINCT esfField.esfFieldId FROM ESFField esfField WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFFIELD_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN ESFField ON TEMP_TABLE.esfFieldId = ESFField.esfFieldId";
	private static final String _FILTER_SQL_COUNT_ESFFIELD_WHERE = "SELECT COUNT(DISTINCT esfField.esfFieldId) AS COUNT_VALUE FROM ESFField esfField WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "esfField";
	private static final String _FILTER_ENTITY_TABLE = "ESFField";
	private static final String _ORDER_BY_ENTITY_ALIAS = "esfField.";
	private static final String _ORDER_BY_ENTITY_TABLE = "ESFField.";
