...
import it.ethica.esf.service.ESFDocumentTypeLocalService;
...
/**
 * Provides the base implementation for the e s f document type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFDocumentTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFDocumentTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFDocumentTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFDocumentTypeLocalServiceUtil} to access the e s f document type local service.
	 */
	...
	@Override
	public ESFDocumentType addESFDocumentType(ESFDocumentType esfDocumentType)
		throws SystemException {
		esfDocumentType.setNew(true);

		return esfDocumentTypePersistence.update(esfDocumentType);
	}
	 ...
	 */
	@Override
	public ESFDocumentType createESFDocumentType(long esfDocumentTypeId) {
		return esfDocumentTypePersistence.create(esfDocumentTypeId);
	}
	...
	@Override
	public ESFDocumentType deleteESFDocumentType(long esfDocumentTypeId)
		throws PortalException, SystemException {
		return esfDocumentTypePersistence.remove(esfDocumentTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFDocumentType deleteESFDocumentType(
		ESFDocumentType esfDocumentType) throws SystemException {
		return esfDocumentTypePersistence.remove(esfDocumentType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFDocumentType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDocumentTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDocumentTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFDocumentType fetchESFDocumentType(long esfDocumentTypeId)
		throws SystemException {
		return esfDocumentTypePersistence.fetchByPrimaryKey(esfDocumentTypeId);
	}
	 ...
	 */
	@Override
	public ESFDocumentType getESFDocumentType(long esfDocumentTypeId)
		throws PortalException, SystemException {
		return esfDocumentTypePersistence.findByPrimaryKey(esfDocumentTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfDocumentTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFDocumentType> getESFDocumentTypes(int start, int end)
		throws SystemException {
		return esfDocumentTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFDocumentTypesCount() throws SystemException {
		return esfDocumentTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFDocumentType updateESFDocumentType(
		ESFDocumentType esfDocumentType) throws SystemException {
		return esfDocumentTypePersistence.update(esfDocumentType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFDocumentType",
			esfDocumentTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfDocumentTypePersistence.getDataSource();
	...
	private ESFDocumentTypeLocalServiceClpInvoker _clpInvoker = new ESFDocumentTypeLocalServiceClpInvoker();
}