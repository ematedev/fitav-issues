...
import it.ethica.esf.service.ESFLentFieldLocalService;
...
/**
 * Provides the base implementation for the e s f lent field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFLentFieldLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFLentFieldLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFLentFieldLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFLentFieldLocalServiceUtil} to access the e s f lent field local service.
	 */
	...
	@Override
	public ESFLentField addESFLentField(ESFLentField esfLentField)
		throws SystemException {
		esfLentField.setNew(true);

		return esfLentFieldPersistence.update(esfLentField);
	}
	 ...
	 */
	@Override
	public ESFLentField createESFLentField(long lentFieldId) {
		return esfLentFieldPersistence.create(lentFieldId);
	}
	...
	@Override
	public ESFLentField deleteESFLentField(long lentFieldId)
		throws PortalException, SystemException {
		return esfLentFieldPersistence.remove(lentFieldId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFLentField deleteESFLentField(ESFLentField esfLentField)
		throws SystemException {
		return esfLentFieldPersistence.remove(esfLentField);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFLentField.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfLentFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfLentFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFLentField fetchESFLentField(long lentFieldId)
		throws SystemException {
		return esfLentFieldPersistence.fetchByPrimaryKey(lentFieldId);
	}
	 ...
	 */
	@Override
	public ESFLentField getESFLentField(long lentFieldId)
		throws PortalException, SystemException {
		return esfLentFieldPersistence.findByPrimaryKey(lentFieldId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfLentFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFLentField> getESFLentFields(int start, int end)
		throws SystemException {
		return esfLentFieldPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFLentFieldsCount() throws SystemException {
		return esfLentFieldPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFLentField updateESFLentField(ESFLentField esfLentField)
		throws SystemException {
		return esfLentFieldPersistence.update(esfLentField);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFLentField",
			esfLentFieldLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfLentFieldPersistence.getDataSource();
	...
	private ESFLentFieldLocalServiceClpInvoker _clpInvoker = new ESFLentFieldLocalServiceClpInvoker();
}