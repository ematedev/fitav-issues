...
public class ESFUserESFUserRoleLocalServiceClpInvoker {
	public ESFUserESFUserRoleLocalServiceClpInvoker() {
		...
		_methodName406 = "findESFUserESFRolesByEsfUserRoleId";

		_methodParameterTypes406 = new String[] { "long" };

		_methodName407 = "findESFUserESFRolesByEsfOrganizzationId";

		_methodParameterTypes407 = new String[] { "long" };

		_methodName408 = "findESFUserESFRolesAll";

		_methodParameterTypes408 = new String[] {  };

		_methodName409 = "findESFUserESFRoleByPrimaryKey";

		_methodParameterTypes409 = new String[] {
				"long", "long", "long", "java.util.Date"
			};

		_methodName410 = "findESFUserESFRoleByU_R_O";

		_methodParameterTypes410 = new String[] { "long", "long", "long" };

		_methodName411 = "findESFUserESFRoleByO_R";

		_methodParameterTypes411 = new String[] { "long", "long" };

		_methodName412 = "getAllESFUserESFUserRoleByESFUserId";

		_methodParameterTypes412 = new String[] { "long", "int", "int" };

		_methodName413 = "getESFUserESFUserRoleByESFUserId_ED";

		_methodParameterTypes413 = new String[] { "long" };

		_methodName414 = "getESFUserESFUserRoleByOrganizationId";

		_methodParameterTypes414 = new String[] { "long" };

		_methodName415 = "getESFUserESFUserRoleByOrganizationId";

		_methodParameterTypes415 = new String[] { "long", "int", "int" };

		_methodName416 = "getESFUserESFUserRoleAllStaff";

		_methodParameterTypes416 = new String[] { "long" };

		_methodName417 = "getESFUserESFUserRoleAllStaff";

		_methodParameterTypes417 = new String[] { "long", "int", "int" };

		_methodName418 = "getESFUserESFUserRoleAllNationalStaff";

		_methodParameterTypes418 = new String[] { "long", "int", "int" };

		_methodName419 = "getESFUserESFUserRoleAllNationalStaff";

		_methodParameterTypes419 = new String[] { "long" };

		_methodName420 = "getESFUserESFUserRoleStaff";

		_methodParameterTypes420 = new String[] { "long", "int", "int" };

		_methodName421 = "getESFUserESFUserRoleStaff";

		_methodParameterTypes421 = new String[] { "long" };

		_methodName422 = "getAllESFUserESFUserRoleCountByESFUserId";

		_methodParameterTypes422 = new String[] { "long" };

		_methodName423 = "addESFUserESFRole";

		_methodParameterTypes423 = new String[] {
				"long", "long", "long", "java.util.Date"
			};

		_methodName424 = "addESFUserESFRoleMigr";

		_methodParameterTypes424 = new String[] {
				"long", "long", "long", "java.util.Date", "java.util.Date"
			};

		_methodName425 = "updateESFUserESFRole";
		...
		_methodName426 = "getESFUSerRoleByR_ED";

		_methodParameterTypes426 = new String[] { "long" };

		_methodName427 = "findbyBDOUserRolenoEnd";

		_methodParameterTypes427 = new String[] { "long", "long" };

		_methodName428 = "findbyBDORole";

		_methodParameterTypes428 = new String[] { "long" };

		_methodName429 = "findStaffRole";

		_methodParameterTypes429 = new String[] { "long" };

		_methodName430 = "findESFUserESFRoleByO_R_D_NOL";

		_methodParameterTypes430 = new String[] { "long", "long", "java.sql.Date" };
	}
