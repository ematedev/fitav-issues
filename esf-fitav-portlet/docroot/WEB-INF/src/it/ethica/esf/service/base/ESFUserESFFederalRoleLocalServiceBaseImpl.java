...
import it.ethica.esf.service.ESFUserESFFederalRoleLocalService;
...
/**
 * Provides the base implementation for the e s f user e s f federal role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFUserESFFederalRoleLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFUserESFFederalRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFUserESFFederalRoleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFUserESFFederalRoleLocalServiceUtil} to access the e s f user e s f federal role local service.
	 */
	...
	@Override
	public ESFUserESFFederalRole addESFUserESFFederalRole(
		ESFUserESFFederalRole esfUserESFFederalRole) throws SystemException {
		esfUserESFFederalRole.setNew(true);

		return esfUserESFFederalRolePersistence.update(esfUserESFFederalRole);
	}
	 ...
	 */
	@Override
	public ESFUserESFFederalRole createESFUserESFFederalRole(
		ESFUserESFFederalRolePK esfUserESFFederalRolePK) {
		return esfUserESFFederalRolePersistence.create(esfUserESFFederalRolePK);
	}
	...
	@Override
	public ESFUserESFFederalRole deleteESFUserESFFederalRole(
		ESFUserESFFederalRolePK esfUserESFFederalRolePK)
		throws PortalException, SystemException {
		return esfUserESFFederalRolePersistence.remove(esfUserESFFederalRolePK);
	}
	...
	public ESFUserESFFederalRole deleteESFUserESFFederalRole(
		ESFUserESFFederalRole esfUserESFFederalRole) throws SystemException {
		return esfUserESFFederalRolePersistence.remove(esfUserESFFederalRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFUserESFFederalRole.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfUserESFFederalRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfUserESFFederalRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFUserESFFederalRole fetchESFUserESFFederalRole(
		ESFUserESFFederalRolePK esfUserESFFederalRolePK)
		throws SystemException {
		return esfUserESFFederalRolePersistence.fetchByPrimaryKey(esfUserESFFederalRolePK);
	}
	 ...
	 */
	@Override
	public ESFUserESFFederalRole getESFUserESFFederalRole(
		ESFUserESFFederalRolePK esfUserESFFederalRolePK)
		throws PortalException, SystemException {
		return esfUserESFFederalRolePersistence.findByPrimaryKey(esfUserESFFederalRolePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfUserESFFederalRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFUserESFFederalRole> getESFUserESFFederalRoles(int start,
		int end) throws SystemException {
		return esfUserESFFederalRolePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFUserESFFederalRolesCount() throws SystemException {
		return esfUserESFFederalRolePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFUserESFFederalRole updateESFUserESFFederalRole(
		ESFUserESFFederalRole esfUserESFFederalRole) throws SystemException {
		return esfUserESFFederalRolePersistence.update(esfUserESFFederalRole);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFUserESFFederalRole",
			esfUserESFFederalRoleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfUserESFFederalRolePersistence.getDataSource();
	...
	private ESFUserESFFederalRoleLocalServiceClpInvoker _clpInvoker = new ESFUserESFFederalRoleLocalServiceClpInvoker();
}