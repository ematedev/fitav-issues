...
import it.ethica.esf.service.ESFShooterCategoryESFMatchLocalService;
...
/**
 * Provides the base implementation for the e s f shooter category e s f match local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFShooterCategoryESFMatchLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFShooterCategoryESFMatchLocalServiceImpl
 * @see it.ethica.esf.service.ESFShooterCategoryESFMatchLocalServiceUtil
 * @generated
 */
public abstract class ESFShooterCategoryESFMatchLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ESFShooterCategoryESFMatchLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFShooterCategoryESFMatchLocalServiceUtil} to access the e s f shooter category e s f match local service.
	 */
	...
	@Override
	public ESFShooterCategoryESFMatch addESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatch esfShooterCategoryESFMatch)
		throws SystemException {
		esfShooterCategoryESFMatch.setNew(true);

		return esfShooterCategoryESFMatchPersistence.update(esfShooterCategoryESFMatch);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch createESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatchPK esfShooterCategoryESFMatchPK) {
		return esfShooterCategoryESFMatchPersistence.create(esfShooterCategoryESFMatchPK);
	}
	...
	@Override
	public ESFShooterCategoryESFMatch deleteESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatchPK esfShooterCategoryESFMatchPK)
		throws PortalException, SystemException {
		return esfShooterCategoryESFMatchPersistence.remove(esfShooterCategoryESFMatchPK);
	}
	...
	public ESFShooterCategoryESFMatch deleteESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatch esfShooterCategoryESFMatch)
		throws SystemException {
		return esfShooterCategoryESFMatchPersistence.remove(esfShooterCategoryESFMatch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFShooterCategoryESFMatch.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterCategoryESFMatchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterCategoryESFMatchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFShooterCategoryESFMatch fetchESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatchPK esfShooterCategoryESFMatchPK)
		throws SystemException {
		return esfShooterCategoryESFMatchPersistence.fetchByPrimaryKey(esfShooterCategoryESFMatchPK);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch fetchESFShooterCategoryESFMatchByUuidAndCompanyId(
		String uuid, long companyId) throws SystemException {
		return esfShooterCategoryESFMatchPersistence.fetchByUuid_C_First(uuid,
			companyId, null);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch fetchESFShooterCategoryESFMatchByUuidAndGroupId(
		String uuid, long groupId) throws SystemException {
		return esfShooterCategoryESFMatchPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch getESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatchPK esfShooterCategoryESFMatchPK)
		throws PortalException, SystemException {
		return esfShooterCategoryESFMatchPersistence.findByPrimaryKey(esfShooterCategoryESFMatchPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfShooterCategoryESFMatchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch getESFShooterCategoryESFMatchByUuidAndCompanyId(
		String uuid, long companyId) throws PortalException, SystemException {
		return esfShooterCategoryESFMatchPersistence.findByUuid_C_First(uuid,
			companyId, null);
	}
	 ...
	 */
	@Override
	public ESFShooterCategoryESFMatch getESFShooterCategoryESFMatchByUuidAndGroupId(
		String uuid, long groupId) throws PortalException, SystemException {
		return esfShooterCategoryESFMatchPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFShooterCategoryESFMatch> getESFShooterCategoryESFMatchs(
		int start, int end) throws SystemException {
		return esfShooterCategoryESFMatchPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFShooterCategoryESFMatchsCount() throws SystemException {
		return esfShooterCategoryESFMatchPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFShooterCategoryESFMatch updateESFShooterCategoryESFMatch(
		ESFShooterCategoryESFMatch esfShooterCategoryESFMatch)
		throws SystemException {
		return esfShooterCategoryESFMatchPersistence.update(esfShooterCategoryESFMatch);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFShooterCategoryESFMatch",
			esfShooterCategoryESFMatchLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfShooterCategoryESFMatchPersistence.getDataSource();
	...
	private ESFShooterCategoryESFMatchLocalServiceClpInvoker _clpInvoker = new ESFShooterCategoryESFMatchLocalServiceClpInvoker();
}