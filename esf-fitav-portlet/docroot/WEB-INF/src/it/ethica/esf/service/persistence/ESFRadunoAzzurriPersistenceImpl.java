...
public class ESFRadunoAzzurriPersistenceImpl extends BasePersistenceImpl<ESFRadunoAzzurri>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_FINDBYIDRADUNO =
		new FinderPath(ESFRadunoAzzurriModelImpl.ENTITY_CACHE_ENABLED,
			ESFRadunoAzzurriModelImpl.FINDER_CACHE_ENABLED,
			ESFRadunoAzzurriImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_FINDBYIDRADUNO =
		new FinderPath(ESFRadunoAzzurriModelImpl.ENTITY_CACHE_ENABLED,
			...
			ESFRadunoAzzurriModelImpl.ID_ESF_RADUNO_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_FINDBYIDRADUNO = new FinderPath(ESFRadunoAzzurriModelImpl.ENTITY_CACHE_ENABLED,
			ESFRadunoAzzurriModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ESFRadunoAzzurri> findByfindByIdRaduno(long id_esf_raduno)
		throws SystemException {
	...
	public List<ESFRadunoAzzurri> findByfindByIdRaduno(long id_esf_raduno,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFRadunoAzzurri esfRadunoAzzurri : list) {
				if ((id_esf_raduno != esfRadunoAzzurri.getId_esf_raduno())) {
					list = null;
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(ESFRadunoAzzurriModelImpl.ORDER_BY_JPQL);
			}
	 ...
	 */
	@Override
	public ESFRadunoAzzurri findByfindByIdRaduno_First(long id_esf_raduno,
		OrderByComparator orderByComparator)
		throws NoSuchRadunoAzzurriException, SystemException {
		ESFRadunoAzzurri esfRadunoAzzurri = fetchByfindByIdRaduno_First(id_esf_raduno,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRadunoAzzurri fetchByfindByIdRaduno_First(long id_esf_raduno,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFRadunoAzzurri> list = findByfindByIdRaduno(id_esf_raduno, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRadunoAzzurri findByfindByIdRaduno_Last(long id_esf_raduno,
		OrderByComparator orderByComparator)
		throws NoSuchRadunoAzzurriException, SystemException {
		ESFRadunoAzzurri esfRadunoAzzurri = fetchByfindByIdRaduno_Last(id_esf_raduno,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRadunoAzzurri fetchByfindByIdRaduno_Last(long id_esf_raduno,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFRadunoAzzurri> list = findByfindByIdRaduno(id_esf_raduno,
	 ...
	 */
	@Override
	public ESFRadunoAzzurri[] findByfindByIdRaduno_PrevAndNext(
		ESFRadunoAzzurriPK esfRadunoAzzurriPK, long id_esf_raduno,
		OrderByComparator orderByComparator)
		throws NoSuchRadunoAzzurriException, SystemException {
		ESFRadunoAzzurri esfRadunoAzzurri = findByPrimaryKey(esfRadunoAzzurriPK);
		...
		try {
			...
			ESFRadunoAzzurri[] array = new ESFRadunoAzzurriImpl[3];

			array[0] = getByfindByIdRaduno_PrevAndNext(session,
					esfRadunoAzzurri, id_esf_raduno, orderByComparator, true);

			array[1] = esfRadunoAzzurri;

			array[2] = getByfindByIdRaduno_PrevAndNext(session,
					esfRadunoAzzurri, id_esf_raduno, orderByComparator, false);
	...
	protected ESFRadunoAzzurri getByfindByIdRaduno_PrevAndNext(
		Session session, ESFRadunoAzzurri esfRadunoAzzurri, long id_esf_raduno,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(esfRadunoAzzurri);
	...
	public void removeByfindByIdRaduno(long id_esf_raduno)
		throws SystemException {
		for (ESFRadunoAzzurri esfRadunoAzzurri : findByfindByIdRaduno(
	...
	private static final String _FINDER_COLUMN_FINDBYIDRADUNO_ID_ESF_RADUNO_2 = "esfRadunoAzzurri.id.id_esf_raduno = ?";
	...
	public ESFRadunoAzzurri updateImpl(
		...
		if (isNew || !ESFRadunoAzzurriModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfRadunoAzzurriModelImpl.getColumnBitmask() &
				...
				args = new Object[] { esfRadunoAzzurriModelImpl.getId_esf_raduno() };
