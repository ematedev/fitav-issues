...
import it.ethica.esf.service.ESFJunioresLocalService;
...
/**
 * Provides the base implementation for the e s f juniores local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFJunioresLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFJunioresLocalServiceImpl
 * @see it.ethica.esf.service.ESFJunioresLocalServiceUtil
 * @generated
 */
public abstract class ESFJunioresLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFJunioresLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFJunioresLocalServiceUtil} to access the e s f juniores local service.
	 */
	...
	@Override
	public ESFJuniores addESFJuniores(ESFJuniores esfJuniores)
		throws SystemException {
		esfJuniores.setNew(true);

		return esfJunioresPersistence.update(esfJuniores);
	}
	 ...
	 */
	@Override
	public ESFJuniores createESFJuniores(long ESFUserId) {
		return esfJunioresPersistence.create(ESFUserId);
	}
	...
	@Override
	public ESFJuniores deleteESFJuniores(long ESFUserId)
		throws PortalException, SystemException {
		return esfJunioresPersistence.remove(ESFUserId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFJuniores deleteESFJuniores(ESFJuniores esfJuniores)
		throws SystemException {
		return esfJunioresPersistence.remove(esfJuniores);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFJuniores.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfJunioresPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfJunioresPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfJunioresPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFJuniores fetchESFJuniores(long ESFUserId)
		throws SystemException {
		return esfJunioresPersistence.fetchByPrimaryKey(ESFUserId);
	}
	 ...
	 */
	@Override
	public ESFJuniores getESFJuniores(long ESFUserId)
		throws PortalException, SystemException {
		return esfJunioresPersistence.findByPrimaryKey(ESFUserId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfJunioresPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFJuniores> getESFJunioreses(int start, int end)
		throws SystemException {
		return esfJunioresPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFJunioresesCount() throws SystemException {
		return esfJunioresPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFJuniores updateESFJuniores(ESFJuniores esfJuniores)
		throws SystemException {
		return esfJunioresPersistence.update(esfJuniores);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFJuniores",
			esfJunioresLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFJuniores");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfJunioresPersistence.getDataSource();
	...
	private ESFJunioresLocalServiceClpInvoker _clpInvoker = new ESFJunioresLocalServiceClpInvoker();
}