...
import it.ethica.esf.service.ESFMatchLocalService;
...
/**
 * Provides the base implementation for the e s f match local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFMatchLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFMatchLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFMatchLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFMatchLocalServiceUtil} to access the e s f match local service.
	 */
	...
	@Override
	public ESFMatch addESFMatch(ESFMatch esfMatch) throws SystemException {
		esfMatch.setNew(true);

		return esfMatchPersistence.update(esfMatch);
	}
	 ...
	 */
	@Override
	public ESFMatch createESFMatch(long esfMatchId) {
		return esfMatchPersistence.create(esfMatchId);
	}
	...
	public ESFMatch deleteESFMatch(long esfMatchId)
		...
		return esfMatchPersistence.remove(esfMatchId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFMatch deleteESFMatch(ESFMatch esfMatch) throws SystemException {
		return esfMatchPersistence.remove(esfMatch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFMatch.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfMatchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfMatchPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfMatchPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfMatchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFMatch fetchESFMatch(long esfMatchId) throws SystemException {
		return esfMatchPersistence.fetchByPrimaryKey(esfMatchId);
	}
	 ...
	 */
	@Override
	public ESFMatch fetchESFMatchByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return esfMatchPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFMatch fetchESFMatchByUuidAndGroupId(String uuid, long groupId)
		throws SystemException {
		return esfMatchPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFMatch getESFMatch(long esfMatchId)
		throws PortalException, SystemException {
		return esfMatchPersistence.findByPrimaryKey(esfMatchId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfMatchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFMatch getESFMatchByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return esfMatchPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFMatch getESFMatchByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return esfMatchPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFMatch> getESFMatchs(int start, int end)
		throws SystemException {
		return esfMatchPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFMatchsCount() throws SystemException {
		return esfMatchPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFMatch updateESFMatch(ESFMatch esfMatch) throws SystemException {
		return esfMatchPersistence.update(esfMatch);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFMatch",
			esfMatchLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFMatch");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfMatchPersistence.getDataSource();
	...
	private ESFMatchLocalServiceClpInvoker _clpInvoker = new ESFMatchLocalServiceClpInvoker();
}