...
import it.ethica.esf.service.persistence.ESFEntityStateFinderUtil;
...
public class ESFEntityStateLocalServiceImpl
	...
	/*
	 * Ricerca tutti gli entitySate per className e ClassPk
	 * senza il vincolo della ednDate null
	 * per stabilire se erano presenti altre affiliazioni per la società con classPk indicato
	 */
	public List<ESFEntityState> findESFEntityStateCName_CPk(
		String className, long classPk)
		throws SystemException {

		return esfEntityStatePersistence.findByESFEntityStateCName_CPk(
			className, classPk);
	...
	public ESFEntityState addEntityState(
		...
		long esfEntityStateId = counterLocalService.increment(ESFEntityState.class.getName());
	...
	public List<ESFEntityState> findESShooterLastCardActive( long shooterId)
		...
		return ESFEntityStateFinderUtil.findESShooterLastCardActive( shooterId);
	}
