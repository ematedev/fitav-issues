...
import it.ethica.esf.service.ESFUnitserviceLocalService;
...
/**
 * Provides the base implementation for the e s f unitservice local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFUnitserviceLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFUnitserviceLocalServiceImpl
 * @see it.ethica.esf.service.ESFUnitserviceLocalServiceUtil
 * @generated
 */
public abstract class ESFUnitserviceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFUnitserviceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFUnitserviceLocalServiceUtil} to access the e s f unitservice local service.
	 */

	/**
	 * Adds the e s f unitservice to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfUnitservice the e s f unitservice
	 * @return the e s f unitservice that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFUnitservice addESFUnitservice(ESFUnitservice esfUnitservice)
		throws SystemException {
		esfUnitservice.setNew(true);

		return esfUnitservicePersistence.update(esfUnitservice);
	}
	 ...
	 */
	@Override
	public ESFUnitservice createESFUnitservice(long esfUnitserviceId) {
		return esfUnitservicePersistence.create(esfUnitserviceId);
	}

	/**
	 * Deletes the e s f unitservice with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfUnitserviceId the primary key of the e s f unitservice
	 * @return the e s f unitservice that was removed
	 * @throws PortalException if a e s f unitservice with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public ESFUnitservice deleteESFUnitservice(long esfUnitserviceId)
		...
		return esfUnitservicePersistence.remove(esfUnitserviceId);
	}

	/**
	 * Deletes the e s f unitservice from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfUnitservice the e s f unitservice
	 * @return the e s f unitservice that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFUnitservice deleteESFUnitservice(ESFUnitservice esfUnitservice)
		throws SystemException {
		return esfUnitservicePersistence.remove(esfUnitservice);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFUnitservice.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfUnitservicePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfUnitservicePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFUnitservice fetchESFUnitservice(long esfUnitserviceId)
		throws SystemException {
		return esfUnitservicePersistence.fetchByPrimaryKey(esfUnitserviceId);
	}

	/**
	 * Returns the e s f unitservice with the matching UUID and company.
	 *
	 * @param uuid the e s f unitservice's UUID
	 * @param  companyId the primary key of the company
	 * @return the matching e s f unitservice, or <code>null</code> if a matching e s f unitservice could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFUnitservice fetchESFUnitserviceByUuidAndCompanyId(String uuid,
		long companyId) throws SystemException {
		return esfUnitservicePersistence.fetchByUuid_C_First(uuid, companyId,
			null);
	}

	/**
	 * Returns the e s f unitservice matching the UUID and group.
	 *
	 * @param uuid the e s f unitservice's UUID
	 ...
	 */
	@Override
	public ESFUnitservice fetchESFUnitserviceByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfUnitservicePersistence.fetchByUUID_G(uuid, groupId);
	}

	/**
	 * Returns the e s f unitservice with the primary key.
	 *
	 * @param esfUnitserviceId the primary key of the e s f unitservice
	 ...
	 */
	@Override
	public ESFUnitservice getESFUnitservice(long esfUnitserviceId)
		throws PortalException, SystemException {
		return esfUnitservicePersistence.findByPrimaryKey(esfUnitserviceId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfUnitservicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws PortalException if a matching e s f unitservice could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFUnitservice getESFUnitserviceByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfUnitservicePersistence.findByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFUnitservice getESFUnitserviceByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return esfUnitservicePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFUnitservice> getESFUnitservices(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getESFUnitservicesCount() throws SystemException {
		return esfUnitservicePersistence.countAll();
	}

	/**
	 * Updates the e s f unitservice in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfUnitservice the e s f unitservice
	 * @return the e s f unitservice that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFUnitservice updateESFUnitservice(ESFUnitservice esfUnitservice)
		throws SystemException {
		return esfUnitservicePersistence.update(esfUnitservice);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFUnitservice",
			esfUnitserviceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfUnitservicePersistence.getDataSource();
	...
	private ESFUnitserviceLocalServiceClpInvoker _clpInvoker = new ESFUnitserviceLocalServiceClpInvoker();
}