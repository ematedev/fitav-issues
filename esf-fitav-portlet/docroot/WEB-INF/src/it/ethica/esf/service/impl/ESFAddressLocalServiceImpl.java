...
public class ESFAddressLocalServiceImpl extends ESFAddressLocalServiceBaseImpl {
	...
	public ESFAddress addESFAddress(
		...
		boolean primary, boolean isNotNational, ServiceContext serviceContext)
		...
		try {
			...
			esfAddress.setIsNotNational(isNotNational);
	...
	public ESFAddress updateESFAddress(
			...
			String zip, int typeId, boolean mailing, boolean primary, boolean isNotNational,
