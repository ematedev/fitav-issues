...
public class ESFSuspensiveShootingDirectorLocalServiceClpInvoker {
	public ESFSuspensiveShootingDirectorLocalServiceClpInvoker() {
		...
		_methodName452 = "findAll";

		_methodParameterTypes452 = new String[] { "int", "int" };

		_methodName453 = "countTotal";

		_methodParameterTypes453 = new String[] {  };

		_methodName454 = "findSuspensive";

		_methodParameterTypes454 = new String[] { "java.util.Date", "long" };
	}
