...
public class ESFSuspensiveShootingDirectorLocalServiceClpInvoker {
	public ESFSuspensiveShootingDirectorLocalServiceClpInvoker() {
		...
		_methodName411 = "countByUserId";

		_methodParameterTypes411 = new String[] { "long" };

		_methodName412 = "findAll";

		_methodParameterTypes412 = new String[] { "int", "int" };

		_methodName413 = "countTotal";

		_methodParameterTypes413 = new String[] {  };

		_methodName414 = "findSuspensive";

		_methodParameterTypes414 = new String[] { "java.util.Date", "long" };
	}
