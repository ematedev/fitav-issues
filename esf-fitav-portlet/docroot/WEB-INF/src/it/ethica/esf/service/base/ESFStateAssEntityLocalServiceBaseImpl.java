...
import it.ethica.esf.service.ESFStateAssEntityLocalService;
...
/**
 * Provides the base implementation for the e s f state ass entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFStateAssEntityLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFStateAssEntityLocalServiceImpl
 * @see it.ethica.esf.service.ESFStateAssEntityLocalServiceUtil
 * @generated
 */
public abstract class ESFStateAssEntityLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFStateAssEntityLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFStateAssEntityLocalServiceUtil} to access the e s f state ass entity local service.
	 */
	...
	public ESFStateAssEntity addESFStateAssEntity(
		ESFStateAssEntity esfStateAssEntity) throws SystemException {
		esfStateAssEntity.setNew(true);

		return esfStateAssEntityPersistence.update(esfStateAssEntity);
	}
	 ...
	 */
	@Override
	public ESFStateAssEntity createESFStateAssEntity(
		ESFStateAssEntityPK esfStateAssEntityPK) {
		return esfStateAssEntityPersistence.create(esfStateAssEntityPK);
	}
	...
	public ESFStateAssEntity deleteESFStateAssEntity(
		...
		return esfStateAssEntityPersistence.remove(esfStateAssEntityPK);
	}
	...
	public ESFStateAssEntity deleteESFStateAssEntity(
		ESFStateAssEntity esfStateAssEntity) throws SystemException {
		return esfStateAssEntityPersistence.remove(esfStateAssEntity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFStateAssEntity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfStateAssEntityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfStateAssEntityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFStateAssEntity fetchESFStateAssEntity(
		ESFStateAssEntityPK esfStateAssEntityPK) throws SystemException {
		return esfStateAssEntityPersistence.fetchByPrimaryKey(esfStateAssEntityPK);
	}
	 ...
	 */
	@Override
	public ESFStateAssEntity getESFStateAssEntity(
		ESFStateAssEntityPK esfStateAssEntityPK)
		throws PortalException, SystemException {
		return esfStateAssEntityPersistence.findByPrimaryKey(esfStateAssEntityPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfStateAssEntityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFStateAssEntity> getESFStateAssEntities(int start, int end)
		throws SystemException {
		return esfStateAssEntityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFStateAssEntitiesCount() throws SystemException {
		return esfStateAssEntityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFStateAssEntity updateESFStateAssEntity(
		ESFStateAssEntity esfStateAssEntity) throws SystemException {
		return esfStateAssEntityPersistence.update(esfStateAssEntity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFStateAssEntity",
			esfStateAssEntityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfStateAssEntityPersistence.getDataSource();
	...
	private ESFStateAssEntityLocalServiceClpInvoker _clpInvoker = new ESFStateAssEntityLocalServiceClpInvoker();
}