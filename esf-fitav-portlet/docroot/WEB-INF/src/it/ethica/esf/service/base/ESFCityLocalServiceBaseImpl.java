...
import it.ethica.esf.service.ESFCityLocalService;
...
/**
 * Provides the base implementation for the e s f city local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFCityLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFCityLocalServiceImpl
 * @see it.ethica.esf.service.ESFCityLocalServiceUtil
 * @generated
 */
public abstract class ESFCityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFCityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFCityLocalServiceUtil} to access the e s f city local service.
	 */

	/**
	 * Adds the e s f city to the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public ESFCity addESFCity(ESFCity esfCity) throws SystemException {
		esfCity.setNew(true);

		return esfCityPersistence.update(esfCity);
	}
	 ...
	 */
	@Override
	public ESFCity createESFCity(ESFCityPK esfCityPK) {
		return esfCityPersistence.create(esfCityPK);
	}

	/**
	 * Deletes the e s f city with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public ESFCity deleteESFCity(ESFCityPK esfCityPK)
		throws PortalException, SystemException {
		return esfCityPersistence.remove(esfCityPK);
	}

	/**
	 * Deletes the e s f city from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfCity the e s f city
	 * @return the e s f city that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFCity deleteESFCity(ESFCity esfCity) throws SystemException {
		return esfCityPersistence.remove(esfCity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFCity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfCityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfCityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfCityPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfCityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfCityPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFCity fetchESFCity(ESFCityPK esfCityPK) throws SystemException {
		return esfCityPersistence.fetchByPrimaryKey(esfCityPK);
	}

	/**
	 * Returns the e s f city with the primary key.
	 *
	 * @param esfCityPK the primary key of the e s f city
	 ...
	 */
	@Override
	public ESFCity getESFCity(ESFCityPK esfCityPK)
		throws PortalException, SystemException {
		return esfCityPersistence.findByPrimaryKey(esfCityPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfCityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFCity> getESFCities(int start, int end)
		throws SystemException {
		return esfCityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFCitiesCount() throws SystemException {
		return esfCityPersistence.countAll();
	}

	/**
	 * Updates the e s f city in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfCity the e s f city
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFCity updateESFCity(ESFCity esfCity) throws SystemException {
		return esfCityPersistence.update(esfCity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFCity",
			esfCityLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFCity");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfCityPersistence.getDataSource();
	...
	private ESFCityLocalServiceClpInvoker _clpInvoker = new ESFCityLocalServiceClpInvoker();
}