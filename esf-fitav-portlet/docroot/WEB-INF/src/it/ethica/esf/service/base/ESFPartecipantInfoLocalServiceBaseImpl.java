...
import it.ethica.esf.service.ESFPartecipantInfoLocalService;
...
/**
 * Provides the base implementation for the e s f partecipant info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFPartecipantInfoLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFPartecipantInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFPartecipantInfoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFPartecipantInfoLocalServiceUtil} to access the e s f partecipant info local service.
	 */
	...
	@Override
	public ESFPartecipantInfo addESFPartecipantInfo(
		ESFPartecipantInfo esfPartecipantInfo) throws SystemException {
		esfPartecipantInfo.setNew(true);

		return esfPartecipantInfoPersistence.update(esfPartecipantInfo);
	}
	 ...
	 */
	@Override
	public ESFPartecipantInfo createESFPartecipantInfo(
		long esfPartecipantInfoId) {
		return esfPartecipantInfoPersistence.create(esfPartecipantInfoId);
	}
	...
	@Override
	public ESFPartecipantInfo deleteESFPartecipantInfo(
		long esfPartecipantInfoId) throws PortalException, SystemException {
		return esfPartecipantInfoPersistence.remove(esfPartecipantInfoId);
	}
	...
	public ESFPartecipantInfo deleteESFPartecipantInfo(
		ESFPartecipantInfo esfPartecipantInfo) throws SystemException {
		return esfPartecipantInfoPersistence.remove(esfPartecipantInfo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFPartecipantInfo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfPartecipantInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPartecipantInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFPartecipantInfo fetchESFPartecipantInfo(long esfPartecipantInfoId)
		throws SystemException {
		return esfPartecipantInfoPersistence.fetchByPrimaryKey(esfPartecipantInfoId);
	}
	 ...
	 */
	@Override
	public ESFPartecipantInfo getESFPartecipantInfo(long esfPartecipantInfoId)
		throws PortalException, SystemException {
		return esfPartecipantInfoPersistence.findByPrimaryKey(esfPartecipantInfoId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfPartecipantInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFPartecipantInfo> getESFPartecipantInfos(int start, int end)
		throws SystemException {
		return esfPartecipantInfoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFPartecipantInfosCount() throws SystemException {
		return esfPartecipantInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPartecipantInfo updateESFPartecipantInfo(
		ESFPartecipantInfo esfPartecipantInfo) throws SystemException {
		return esfPartecipantInfoPersistence.update(esfPartecipantInfo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFPartecipantInfo",
			esfPartecipantInfoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfPartecipantInfoPersistence.getDataSource();
	...
	private ESFPartecipantInfoLocalServiceClpInvoker _clpInvoker = new ESFPartecipantInfoLocalServiceClpInvoker();
}