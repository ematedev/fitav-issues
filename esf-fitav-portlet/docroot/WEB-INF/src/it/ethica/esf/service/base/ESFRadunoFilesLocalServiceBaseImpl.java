...
import it.ethica.esf.service.ESFRadunoFilesLocalService;
...
/**
 * Provides the base implementation for the e s f raduno files local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRadunoFilesLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFRadunoFilesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFRadunoFilesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRadunoFilesLocalServiceUtil} to access the e s f raduno files local service.
	 */
	...
	@Override
	public ESFRadunoFiles addESFRadunoFiles(ESFRadunoFiles esfRadunoFiles)
		throws SystemException {
		esfRadunoFiles.setNew(true);

		return esfRadunoFilesPersistence.update(esfRadunoFiles);
	}
	 ...
	 */
	@Override
	public ESFRadunoFiles createESFRadunoFiles(long id_esf_raduno_files) {
		return esfRadunoFilesPersistence.create(id_esf_raduno_files);
	}
	...
	@Override
	public ESFRadunoFiles deleteESFRadunoFiles(long id_esf_raduno_files)
		throws PortalException, SystemException {
		return esfRadunoFilesPersistence.remove(id_esf_raduno_files);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRadunoFiles deleteESFRadunoFiles(ESFRadunoFiles esfRadunoFiles)
		throws SystemException {
		return esfRadunoFilesPersistence.remove(esfRadunoFiles);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRadunoFiles.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoFilesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRadunoFilesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRadunoFiles fetchESFRadunoFiles(long id_esf_raduno_files)
		throws SystemException {
		return esfRadunoFilesPersistence.fetchByPrimaryKey(id_esf_raduno_files);
	}
	 ...
	 */
	@Override
	public ESFRadunoFiles getESFRadunoFiles(long id_esf_raduno_files)
		throws PortalException, SystemException {
		return esfRadunoFilesPersistence.findByPrimaryKey(id_esf_raduno_files);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRadunoFilesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRadunoFiles> getESFRadunoFileses(int start, int end)
		throws SystemException {
		return esfRadunoFilesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRadunoFilesesCount() throws SystemException {
		return esfRadunoFilesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRadunoFiles updateESFRadunoFiles(ESFRadunoFiles esfRadunoFiles)
		throws SystemException {
		return esfRadunoFilesPersistence.update(esfRadunoFiles);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRadunoFiles",
			esfRadunoFilesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRadunoFilesPersistence.getDataSource();
	...
	private ESFRadunoFilesLocalServiceClpInvoker _clpInvoker = new ESFRadunoFilesLocalServiceClpInvoker();
}