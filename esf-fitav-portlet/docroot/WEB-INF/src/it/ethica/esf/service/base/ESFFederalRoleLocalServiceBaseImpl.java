...
import it.ethica.esf.service.ESFFederalRoleLocalService;
...
/**
 * Provides the base implementation for the e s f federal role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFFederalRoleLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFFederalRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFFederalRoleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFFederalRoleLocalServiceUtil} to access the e s f federal role local service.
	 */
	...
	@Override
	public ESFFederalRole addESFFederalRole(ESFFederalRole esfFederalRole)
		throws SystemException {
		esfFederalRole.setNew(true);

		return esfFederalRolePersistence.update(esfFederalRole);
	}
	 ...
	 */
	@Override
	public ESFFederalRole createESFFederalRole(long esfFederalRoleId) {
		return esfFederalRolePersistence.create(esfFederalRoleId);
	}
	...
	@Override
	public ESFFederalRole deleteESFFederalRole(long esfFederalRoleId)
		throws PortalException, SystemException {
		return esfFederalRolePersistence.remove(esfFederalRoleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFFederalRole deleteESFFederalRole(ESFFederalRole esfFederalRole)
		throws SystemException {
		return esfFederalRolePersistence.remove(esfFederalRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFFederalRole.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFederalRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFederalRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFFederalRole fetchESFFederalRole(long esfFederalRoleId)
		throws SystemException {
		return esfFederalRolePersistence.fetchByPrimaryKey(esfFederalRoleId);
	}
	 ...
	 */
	@Override
	public ESFFederalRole fetchESFFederalRoleByUuidAndCompanyId(String uuid,
		long companyId) throws SystemException {
		return esfFederalRolePersistence.fetchByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFFederalRole fetchESFFederalRoleByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfFederalRolePersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFFederalRole getESFFederalRole(long esfFederalRoleId)
		throws PortalException, SystemException {
		return esfFederalRolePersistence.findByPrimaryKey(esfFederalRoleId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfFederalRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFFederalRole getESFFederalRoleByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfFederalRolePersistence.findByUuid_C_First(uuid, companyId,
			null);
	}
	 ...
	 */
	@Override
	public ESFFederalRole getESFFederalRoleByUuidAndGroupId(String uuid,
		long groupId) throws PortalException, SystemException {
		return esfFederalRolePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFFederalRole> getESFFederalRoles(int start, int end)
		throws SystemException {
		return esfFederalRolePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFFederalRolesCount() throws SystemException {
		return esfFederalRolePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFFederalRole updateESFFederalRole(ESFFederalRole esfFederalRole)
		throws SystemException {
		return esfFederalRolePersistence.update(esfFederalRole);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFFederalRole",
			esfFederalRoleLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfFederalRolePersistence.getDataSource();
	...
	private ESFFederalRoleLocalServiceClpInvoker _clpInvoker = new ESFFederalRoleLocalServiceClpInvoker();
}