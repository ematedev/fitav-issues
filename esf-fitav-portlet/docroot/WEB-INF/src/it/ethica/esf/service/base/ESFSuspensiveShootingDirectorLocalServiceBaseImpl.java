...
import it.ethica.esf.service.ESFSuspensiveShootingDirectorLocalService;
...
/**
 * Provides the base implementation for the e s f suspensive shooting director local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFSuspensiveShootingDirectorLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFSuspensiveShootingDirectorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ESFSuspensiveShootingDirectorLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFSuspensiveShootingDirectorLocalServiceUtil} to access the e s f suspensive shooting director local service.
	 */
	...
	@Override
	public ESFSuspensiveShootingDirector addESFSuspensiveShootingDirector(
		ESFSuspensiveShootingDirector esfSuspensiveShootingDirector)
		throws SystemException {
		esfSuspensiveShootingDirector.setNew(true);

		return esfSuspensiveShootingDirectorPersistence.update(esfSuspensiveShootingDirector);
	}
	 ...
	 */
	@Override
	public ESFSuspensiveShootingDirector createESFSuspensiveShootingDirector(
		long esfSuspensiveShooingDirectorId) {
		return esfSuspensiveShootingDirectorPersistence.create(esfSuspensiveShooingDirectorId);
	}
	...
	@Override
	public ESFSuspensiveShootingDirector deleteESFSuspensiveShootingDirector(
		long esfSuspensiveShooingDirectorId)
		throws PortalException, SystemException {
		return esfSuspensiveShootingDirectorPersistence.remove(esfSuspensiveShooingDirectorId);
	}
	...
	public ESFSuspensiveShootingDirector deleteESFSuspensiveShootingDirector(
		ESFSuspensiveShootingDirector esfSuspensiveShootingDirector)
		throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.remove(esfSuspensiveShootingDirector);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFSuspensiveShootingDirector.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFSuspensiveShootingDirector fetchESFSuspensiveShootingDirector(
		long esfSuspensiveShooingDirectorId) throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.fetchByPrimaryKey(esfSuspensiveShooingDirectorId);
	}
	 ...
	 */
	@Override
	public ESFSuspensiveShootingDirector getESFSuspensiveShootingDirector(
		long esfSuspensiveShooingDirectorId)
		throws PortalException, SystemException {
		return esfSuspensiveShootingDirectorPersistence.findByPrimaryKey(esfSuspensiveShooingDirectorId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfSuspensiveShootingDirectorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFSuspensiveShootingDirector> getESFSuspensiveShootingDirectors(
		int start, int end) throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.findAll(start, end);
	}
	...
	public int getESFSuspensiveShootingDirectorsCount()
		throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFSuspensiveShootingDirector updateESFSuspensiveShootingDirector(
		ESFSuspensiveShootingDirector esfSuspensiveShootingDirector)
		throws SystemException {
		return esfSuspensiveShootingDirectorPersistence.update(esfSuspensiveShootingDirector);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFSuspensiveShootingDirector",
			esfSuspensiveShootingDirectorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfSuspensiveShootingDirectorPersistence.getDataSource();
	...
	private ESFSuspensiveShootingDirectorLocalServiceClpInvoker _clpInvoker = new ESFSuspensiveShootingDirectorLocalServiceClpInvoker();
}