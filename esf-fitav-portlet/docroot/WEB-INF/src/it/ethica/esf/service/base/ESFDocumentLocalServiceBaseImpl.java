...
import it.ethica.esf.service.ESFDocumentLocalService;
...
/**
 * Provides the base implementation for the e s f document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFDocumentLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFDocumentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFDocumentLocalServiceUtil} to access the e s f document local service.
	 */
	...
	@Override
	public ESFDocument addESFDocument(ESFDocument esfDocument)
		throws SystemException {
		esfDocument.setNew(true);

		return esfDocumentPersistence.update(esfDocument);
	}
	 ...
	 */
	@Override
	public ESFDocument createESFDocument(long esfDocumentId) {
		return esfDocumentPersistence.create(esfDocumentId);
	}
	...
	@Override
	public ESFDocument deleteESFDocument(long esfDocumentId)
		throws PortalException, SystemException {
		return esfDocumentPersistence.remove(esfDocumentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFDocument deleteESFDocument(ESFDocument esfDocument)
		throws SystemException {
		return esfDocumentPersistence.remove(esfDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFDocument.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfDocumentPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFDocument fetchESFDocument(long esfDocumentId)
		throws SystemException {
		return esfDocumentPersistence.fetchByPrimaryKey(esfDocumentId);
	}
	 ...
	 */
	@Override
	public ESFDocument getESFDocument(long esfDocumentId)
		throws PortalException, SystemException {
		return esfDocumentPersistence.findByPrimaryKey(esfDocumentId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFDocument> getESFDocuments(int start, int end)
		throws SystemException {
		return esfDocumentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFDocumentsCount() throws SystemException {
		return esfDocumentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFDocument updateESFDocument(ESFDocument esfDocument)
		throws SystemException {
		return esfDocumentPersistence.update(esfDocument);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFDocument",
			esfDocumentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFDocument");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfDocumentPersistence.getDataSource();
	...
	private ESFDocumentLocalServiceClpInvoker _clpInvoker = new ESFDocumentLocalServiceClpInvoker();
}