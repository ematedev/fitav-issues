...
import it.ethica.esf.service.ESFMatchResultLocalService;
...
/**
 * Provides the base implementation for the e s f match result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFMatchResultLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFMatchResultLocalServiceImpl
 * @see it.ethica.esf.service.ESFMatchResultLocalServiceUtil
 * @generated
 */
public abstract class ESFMatchResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFMatchResultLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFMatchResultLocalServiceUtil} to access the e s f match result local service.
	 */
	...
	@Override
	public ESFMatchResult addESFMatchResult(ESFMatchResult esfMatchResult)
		throws SystemException {
		esfMatchResult.setNew(true);

		return esfMatchResultPersistence.update(esfMatchResult);
	}
	 ...
	 */
	@Override
	public ESFMatchResult createESFMatchResult(long esfMatchResultId) {
		return esfMatchResultPersistence.create(esfMatchResultId);
	}
	...
	@Override
	public ESFMatchResult deleteESFMatchResult(long esfMatchResultId)
		throws PortalException, SystemException {
		return esfMatchResultPersistence.remove(esfMatchResultId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFMatchResult deleteESFMatchResult(ESFMatchResult esfMatchResult)
		throws SystemException {
		return esfMatchResultPersistence.remove(esfMatchResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFMatchResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfMatchResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfMatchResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFMatchResult fetchESFMatchResult(long esfMatchResultId)
		throws SystemException {
		return esfMatchResultPersistence.fetchByPrimaryKey(esfMatchResultId);
	}
	 ...
	 */
	@Override
	public ESFMatchResult getESFMatchResult(long esfMatchResultId)
		throws PortalException, SystemException {
		return esfMatchResultPersistence.findByPrimaryKey(esfMatchResultId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfMatchResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFMatchResult> getESFMatchResults(int start, int end)
		throws SystemException {
		return esfMatchResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFMatchResultsCount() throws SystemException {
		return esfMatchResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFMatchResult updateESFMatchResult(ESFMatchResult esfMatchResult)
		throws SystemException {
		return esfMatchResultPersistence.update(esfMatchResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFMatchResult",
			esfMatchResultLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfMatchResultPersistence.getDataSource();
	...
	private ESFMatchResultLocalServiceClpInvoker _clpInvoker = new ESFMatchResultLocalServiceClpInvoker();
}