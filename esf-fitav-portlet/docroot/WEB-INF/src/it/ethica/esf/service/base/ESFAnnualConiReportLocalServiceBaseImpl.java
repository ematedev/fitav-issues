...
import it.ethica.esf.service.ESFAnnualConiReportLocalService;
...
/**
 * Provides the base implementation for the e s f annual coni report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFAnnualConiReportLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFAnnualConiReportLocalServiceImpl
 * @see it.ethica.esf.service.ESFAnnualConiReportLocalServiceUtil
 * @generated
 */
public abstract class ESFAnnualConiReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFAnnualConiReportLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFAnnualConiReportLocalServiceUtil} to access the e s f annual coni report local service.
	 */
	...
	@Override
	public ESFAnnualConiReport addESFAnnualConiReport(
		ESFAnnualConiReport esfAnnualConiReport) throws SystemException {
		esfAnnualConiReport.setNew(true);

		return esfAnnualConiReportPersistence.update(esfAnnualConiReport);
	}
	 ...
	 */
	@Override
	public ESFAnnualConiReport createESFAnnualConiReport(
		long annualConiReportId) {
		return esfAnnualConiReportPersistence.create(annualConiReportId);
	}
	...
	@Override
	public ESFAnnualConiReport deleteESFAnnualConiReport(
		long annualConiReportId) throws PortalException, SystemException {
		return esfAnnualConiReportPersistence.remove(annualConiReportId);
	}
	...
	public ESFAnnualConiReport deleteESFAnnualConiReport(
		ESFAnnualConiReport esfAnnualConiReport) throws SystemException {
		return esfAnnualConiReportPersistence.remove(esfAnnualConiReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFAnnualConiReport.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfAnnualConiReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfAnnualConiReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFAnnualConiReport fetchESFAnnualConiReport(long annualConiReportId)
		throws SystemException {
		return esfAnnualConiReportPersistence.fetchByPrimaryKey(annualConiReportId);
	}
	 ...
	 */
	@Override
	public ESFAnnualConiReport getESFAnnualConiReport(long annualConiReportId)
		throws PortalException, SystemException {
		return esfAnnualConiReportPersistence.findByPrimaryKey(annualConiReportId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfAnnualConiReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFAnnualConiReport> getESFAnnualConiReports(int start, int end)
		throws SystemException {
		return esfAnnualConiReportPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFAnnualConiReportsCount() throws SystemException {
		return esfAnnualConiReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFAnnualConiReport updateESFAnnualConiReport(
		ESFAnnualConiReport esfAnnualConiReport) throws SystemException {
		return esfAnnualConiReportPersistence.update(esfAnnualConiReport);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFAnnualConiReport",
			esfAnnualConiReportLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfAnnualConiReportPersistence.getDataSource();
	...
	private ESFAnnualConiReportLocalServiceClpInvoker _clpInvoker = new ESFAnnualConiReportLocalServiceClpInvoker();
}