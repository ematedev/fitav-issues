...
import it.ethica.esf.service.ESFSpecificLocalService;
...
/**
 * Provides the base implementation for the e s f specific local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFSpecificLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFSpecificLocalServiceImpl
 * @see it.ethica.esf.service.ESFSpecificLocalServiceUtil
 * @generated
 */
public abstract class ESFSpecificLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFSpecificLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFSpecificLocalServiceUtil} to access the e s f specific local service.
	 */
	...
	@Override
	public ESFSpecific addESFSpecific(ESFSpecific esfSpecific)
		throws SystemException {
		esfSpecific.setNew(true);

		return esfSpecificPersistence.update(esfSpecific);
	}
	 ...
	 */
	@Override
	public ESFSpecific createESFSpecific(long esfSpecificId) {
		return esfSpecificPersistence.create(esfSpecificId);
	}
	...
	@Override
	public ESFSpecific deleteESFSpecific(long esfSpecificId)
		throws PortalException, SystemException {
		return esfSpecificPersistence.remove(esfSpecificId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFSpecific deleteESFSpecific(ESFSpecific esfSpecific)
		throws SystemException {
		return esfSpecificPersistence.remove(esfSpecific);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFSpecific.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfSpecificPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfSpecificPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfSpecificPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFSpecific fetchESFSpecific(long esfSpecificId)
		throws SystemException {
		return esfSpecificPersistence.fetchByPrimaryKey(esfSpecificId);
	}
	 ...
	 */
	@Override
	public ESFSpecific fetchESFSpecificByUuidAndCompanyId(String uuid,
		long companyId) throws SystemException {
		return esfSpecificPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFSpecific fetchESFSpecificByUuidAndGroupId(String uuid,
		long groupId) throws SystemException {
		return esfSpecificPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFSpecific getESFSpecific(long esfSpecificId)
		throws PortalException, SystemException {
		return esfSpecificPersistence.findByPrimaryKey(esfSpecificId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfSpecificPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFSpecific getESFSpecificByUuidAndCompanyId(String uuid,
		long companyId) throws PortalException, SystemException {
		return esfSpecificPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public ESFSpecific getESFSpecificByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return esfSpecificPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ESFSpecific> getESFSpecifics(int start, int end)
		throws SystemException {
		return esfSpecificPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFSpecificsCount() throws SystemException {
		return esfSpecificPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFSpecific updateESFSpecific(ESFSpecific esfSpecific)
		throws SystemException {
		return esfSpecificPersistence.update(esfSpecific);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFSpecific",
			esfSpecificLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFSpecific");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfSpecificPersistence.getDataSource();
	...
	private ESFSpecificLocalServiceClpInvoker _clpInvoker = new ESFSpecificLocalServiceClpInvoker();
}