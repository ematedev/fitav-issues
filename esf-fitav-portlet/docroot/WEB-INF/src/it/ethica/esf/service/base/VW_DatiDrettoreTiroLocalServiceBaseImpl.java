...
import it.ethica.esf.service.VW_DatiDrettoreTiroLocalService;
...
/**
 * Provides the base implementation for the v w_ dati drettore tiro local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.VW_DatiDrettoreTiroLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.VW_DatiDrettoreTiroLocalServiceImpl
 * @see it.ethica.esf.service.VW_DatiDrettoreTiroLocalServiceUtil
 * @generated
 */
public abstract class VW_DatiDrettoreTiroLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VW_DatiDrettoreTiroLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.VW_DatiDrettoreTiroLocalServiceUtil} to access the v w_ dati drettore tiro local service.
	 */
	...
	@Override
	public VW_DatiDrettoreTiro addVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiro vw_DatiDrettoreTiro) throws SystemException {
		vw_DatiDrettoreTiro.setNew(true);

		return vw_DatiDrettoreTiroPersistence.update(vw_DatiDrettoreTiro);
	}
	 ...
	 */
	@Override
	public VW_DatiDrettoreTiro createVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiroPK vw_DatiDrettoreTiroPK) {
		return vw_DatiDrettoreTiroPersistence.create(vw_DatiDrettoreTiroPK);
	}
	...
	@Override
	public VW_DatiDrettoreTiro deleteVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiroPK vw_DatiDrettoreTiroPK)
		throws PortalException, SystemException {
		return vw_DatiDrettoreTiroPersistence.remove(vw_DatiDrettoreTiroPK);
	}
	...
	public VW_DatiDrettoreTiro deleteVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiro vw_DatiDrettoreTiro) throws SystemException {
		return vw_DatiDrettoreTiroPersistence.remove(vw_DatiDrettoreTiro);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VW_DatiDrettoreTiro.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vw_DatiDrettoreTiroPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_DatiDrettoreTiroPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VW_DatiDrettoreTiro fetchVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiroPK vw_DatiDrettoreTiroPK) throws SystemException {
		return vw_DatiDrettoreTiroPersistence.fetchByPrimaryKey(vw_DatiDrettoreTiroPK);
	}
	 ...
	 */
	@Override
	public VW_DatiDrettoreTiro getVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiroPK vw_DatiDrettoreTiroPK)
		throws PortalException, SystemException {
		return vw_DatiDrettoreTiroPersistence.findByPrimaryKey(vw_DatiDrettoreTiroPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_DatiDrettoreTiroPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VW_DatiDrettoreTiro> getVW_DatiDrettoreTiros(int start, int end)
		throws SystemException {
		return vw_DatiDrettoreTiroPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVW_DatiDrettoreTirosCount() throws SystemException {
		return vw_DatiDrettoreTiroPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VW_DatiDrettoreTiro updateVW_DatiDrettoreTiro(
		VW_DatiDrettoreTiro vw_DatiDrettoreTiro) throws SystemException {
		return vw_DatiDrettoreTiroPersistence.update(vw_DatiDrettoreTiro);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.VW_DatiDrettoreTiro",
			vw_DatiDrettoreTiroLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_DatiDrettoreTiroPersistence.getDataSource();
	...
	private VW_DatiDrettoreTiroLocalServiceClpInvoker _clpInvoker = new VW_DatiDrettoreTiroLocalServiceClpInvoker();
}