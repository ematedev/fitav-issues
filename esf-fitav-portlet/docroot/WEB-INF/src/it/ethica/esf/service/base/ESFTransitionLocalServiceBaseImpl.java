...
import it.ethica.esf.service.ESFTransitionLocalService;
...
/**
 * Provides the base implementation for the e s f transition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFTransitionLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFTransitionLocalServiceImpl
 * @see it.ethica.esf.service.ESFTransitionLocalServiceUtil
 * @generated
 */
public abstract class ESFTransitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFTransitionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFTransitionLocalServiceUtil} to access the e s f transition local service.
	 */
	...
	@Override
	public ESFTransition addESFTransition(ESFTransition esfTransition)
		throws SystemException {
		esfTransition.setNew(true);

		return esfTransitionPersistence.update(esfTransition);
	}
	 ...
	 */
	@Override
	public ESFTransition createESFTransition(long esfTransitionId) {
		return esfTransitionPersistence.create(esfTransitionId);
	}
	...
	@Override
	public ESFTransition deleteESFTransition(long esfTransitionId)
		throws PortalException, SystemException {
		return esfTransitionPersistence.remove(esfTransitionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFTransition deleteESFTransition(ESFTransition esfTransition)
		throws SystemException {
		return esfTransitionPersistence.remove(esfTransition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFTransition.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfTransitionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfTransitionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFTransition fetchESFTransition(long esfTransitionId)
		throws SystemException {
		return esfTransitionPersistence.fetchByPrimaryKey(esfTransitionId);
	}
	 ...
	 */
	@Override
	public ESFTransition getESFTransition(long esfTransitionId)
		throws PortalException, SystemException {
		return esfTransitionPersistence.findByPrimaryKey(esfTransitionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfTransitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFTransition> getESFTransitions(int start, int end)
		throws SystemException {
		return esfTransitionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFTransitionsCount() throws SystemException {
		return esfTransitionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFTransition updateESFTransition(ESFTransition esfTransition)
		throws SystemException {
		return esfTransitionPersistence.update(esfTransition);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFTransition",
			esfTransitionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfTransitionPersistence.getDataSource();
	...
	private ESFTransitionLocalServiceClpInvoker _clpInvoker = new ESFTransitionLocalServiceClpInvoker();
}