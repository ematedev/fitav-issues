...
import it.ethica.esf.service.ESFElectronicLocalService;
...
/**
 * Provides the base implementation for the e s f electronic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFElectronicLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFElectronicLocalServiceImpl
 * @see it.ethica.esf.service.ESFElectronicLocalServiceUtil
 * @generated
 */
public abstract class ESFElectronicLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFElectronicLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFElectronicLocalServiceUtil} to access the e s f electronic local service.
	 */

	/**
	 * Adds the e s f electronic to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfElectronic the e s f electronic
	 * @return the e s f electronic that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFElectronic addESFElectronic(ESFElectronic esfElectronic)
		throws SystemException {
		esfElectronic.setNew(true);

		return esfElectronicPersistence.update(esfElectronic);
	}
	 ...
	 */
	@Override
	public ESFElectronic createESFElectronic(long electronicId) {
		return esfElectronicPersistence.create(electronicId);
	}

	/**
	 * Deletes the e s f electronic with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param electronicId the primary key of the e s f electronic
	 * @return the e s f electronic that was removed
	 * @throws PortalException if a e s f electronic with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFElectronic deleteESFElectronic(long electronicId)
		throws PortalException, SystemException {
		return esfElectronicPersistence.remove(electronicId);
	}

	/**
	 * Deletes the e s f electronic from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfElectronic the e s f electronic
	 * @return the e s f electronic that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFElectronic deleteESFElectronic(ESFElectronic esfElectronic)
		throws SystemException {
		return esfElectronicPersistence.remove(esfElectronic);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFElectronic.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfElectronicPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfElectronicPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFElectronic fetchESFElectronic(long electronicId)
		throws SystemException {
		return esfElectronicPersistence.fetchByPrimaryKey(electronicId);
	}

	/**
	 * Returns the e s f electronic with the primary key.
	 *
	 * @param electronicId the primary key of the e s f electronic
	 ...
	 */
	@Override
	public ESFElectronic getESFElectronic(long electronicId)
		throws PortalException, SystemException {
		return esfElectronicPersistence.findByPrimaryKey(electronicId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfElectronicPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFElectronic> getESFElectronics(int start, int end)
		throws SystemException {
		return esfElectronicPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFElectronicsCount() throws SystemException {
		return esfElectronicPersistence.countAll();
	}

	/**
	 * Updates the e s f electronic in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfElectronic the e s f electronic
	 * @return the e s f electronic that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFElectronic updateESFElectronic(ESFElectronic esfElectronic)
		throws SystemException {
		return esfElectronicPersistence.update(esfElectronic);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFElectronic",
			esfElectronicLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfElectronicPersistence.getDataSource();
	...
	private ESFElectronicLocalServiceClpInvoker _clpInvoker = new ESFElectronicLocalServiceClpInvoker();
}