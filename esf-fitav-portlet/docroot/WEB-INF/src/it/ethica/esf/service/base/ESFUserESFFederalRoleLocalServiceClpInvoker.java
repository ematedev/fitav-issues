...
public class ESFUserESFFederalRoleLocalServiceClpInvoker {
	public ESFUserESFFederalRoleLocalServiceClpInvoker() {
		...
		_methodName394 = "findByEsfFederalRoleId";

		_methodParameterTypes394 = new String[] { "long" };

		_methodName395 = "findByEsfUserId";

		_methodParameterTypes395 = new String[] { "long" };

		_methodName396 = "findByEsfUserIdAndActive";

		_methodParameterTypes396 = new String[] { "long", "boolean" };

		_methodName397 = "findByEsfUserIdAndEsfFederalRoleIdActive";

		_methodParameterTypes397 = new String[] { "long", "long", "boolean" };
	}
