...
public class ESFUserESFFederalRoleLocalServiceClpInvoker {
	public ESFUserESFFederalRoleLocalServiceClpInvoker() {
		...
		_methodName430 = "findByEsfFederalRoleId";

		_methodParameterTypes430 = new String[] { "long" };

		_methodName431 = "findByEsfUserId";

		_methodParameterTypes431 = new String[] { "long" };

		_methodName432 = "findByEsfUserIdAndActive";

		_methodParameterTypes432 = new String[] { "long", "boolean" };

		_methodName433 = "findByEsfUserIdAndEsfFederalRoleIdActive";

		_methodParameterTypes433 = new String[] { "long", "long", "boolean" };
	}
