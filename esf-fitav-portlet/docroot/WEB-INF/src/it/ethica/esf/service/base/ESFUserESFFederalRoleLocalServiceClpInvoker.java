...
public class ESFUserESFFederalRoleLocalServiceClpInvoker {
	public ESFUserESFFederalRoleLocalServiceClpInvoker() {
		...
		_methodName402 = "findByEsfFederalRoleId";

		_methodParameterTypes402 = new String[] { "long" };

		_methodName403 = "findByEsfUserId";

		_methodParameterTypes403 = new String[] { "long" };

		_methodName404 = "findByEsfUserIdAndActive";

		_methodParameterTypes404 = new String[] { "long", "boolean" };

		_methodName405 = "findByEsfUserIdAndEsfFederalRoleIdActive";

		_methodParameterTypes405 = new String[] { "long", "long", "boolean" };
	}
