...
public class ESFUserESFFederalRoleLocalServiceClpInvoker {
	public ESFUserESFFederalRoleLocalServiceClpInvoker() {
		...
		_methodName407 = "findByEsfUserId";

		_methodParameterTypes407 = new String[] { "long" };

		_methodName408 = "findByEsfUserIdAndActive";

		_methodParameterTypes408 = new String[] { "long", "boolean" };

		_methodName409 = "findByEsfUserIdAndEsfFederalRoleIdActive";

		_methodParameterTypes409 = new String[] { "long", "long", "boolean" };
	}
