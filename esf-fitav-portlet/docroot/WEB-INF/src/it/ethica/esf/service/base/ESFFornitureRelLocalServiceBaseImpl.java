...
import it.ethica.esf.service.ESFFornitureRelLocalService;
...
/**
 * Provides the base implementation for the e s f forniture rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFFornitureRelLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFFornitureRelLocalServiceImpl
 * @see it.ethica.esf.service.ESFFornitureRelLocalServiceUtil
 * @generated
 */
public abstract class ESFFornitureRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFFornitureRelLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFFornitureRelLocalServiceUtil} to access the e s f forniture rel local service.
	 */
	...
	@Override
	public ESFFornitureRel addESFFornitureRel(ESFFornitureRel esfFornitureRel)
		throws SystemException {
		esfFornitureRel.setNew(true);

		return esfFornitureRelPersistence.update(esfFornitureRel);
	}
	 ...
	 */
	@Override
	public ESFFornitureRel createESFFornitureRel(
		ESFFornitureRelPK esfFornitureRelPK) {
		return esfFornitureRelPersistence.create(esfFornitureRelPK);
	}
	...
	@Override
	public ESFFornitureRel deleteESFFornitureRel(
		ESFFornitureRelPK esfFornitureRelPK)
		throws PortalException, SystemException {
		return esfFornitureRelPersistence.remove(esfFornitureRelPK);
	}
	...
	@Override
	public ESFFornitureRel deleteESFFornitureRel(
		ESFFornitureRel esfFornitureRel) throws SystemException {
		return esfFornitureRelPersistence.remove(esfFornitureRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFFornitureRel.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFornitureRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfFornitureRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFFornitureRel fetchESFFornitureRel(
		ESFFornitureRelPK esfFornitureRelPK) throws SystemException {
		return esfFornitureRelPersistence.fetchByPrimaryKey(esfFornitureRelPK);
	}
	 ...
	 */
	@Override
	public ESFFornitureRel getESFFornitureRel(
		ESFFornitureRelPK esfFornitureRelPK)
		throws PortalException, SystemException {
		return esfFornitureRelPersistence.findByPrimaryKey(esfFornitureRelPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfFornitureRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFFornitureRel> getESFFornitureRels(int start, int end)
		throws SystemException {
		return esfFornitureRelPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFFornitureRelsCount() throws SystemException {
		return esfFornitureRelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFFornitureRel updateESFFornitureRel(
		ESFFornitureRel esfFornitureRel) throws SystemException {
		return esfFornitureRelPersistence.update(esfFornitureRel);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFFornitureRel",
			esfFornitureRelLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfFornitureRelPersistence.getDataSource();
	...
	private ESFFornitureRelLocalServiceClpInvoker _clpInvoker = new ESFFornitureRelLocalServiceClpInvoker();
}