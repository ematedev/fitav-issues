...
import it.ethica.esf.service.ESFProvinceLocalService;
...
/**
 * Provides the base implementation for the e s f province local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFProvinceLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFProvinceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFProvinceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFProvinceLocalServiceUtil} to access the e s f province local service.
	 */
	...
	@Override
	public ESFProvince addESFProvince(ESFProvince esfProvince)
		throws SystemException {
		esfProvince.setNew(true);

		return esfProvincePersistence.update(esfProvince);
	}
	 ...
	 */
	@Override
	public ESFProvince createESFProvince(ESFProvincePK esfProvincePK) {
		return esfProvincePersistence.create(esfProvincePK);
	}
	...
	@Override
	public ESFProvince deleteESFProvince(ESFProvincePK esfProvincePK)
		throws PortalException, SystemException {
		return esfProvincePersistence.remove(esfProvincePK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFProvince deleteESFProvince(ESFProvince esfProvince)
		throws SystemException {
		return esfProvincePersistence.remove(esfProvince);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFProvince.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfProvincePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfProvincePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfProvincePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFProvince fetchESFProvince(ESFProvincePK esfProvincePK)
		throws SystemException {
		return esfProvincePersistence.fetchByPrimaryKey(esfProvincePK);
	}
	 ...
	 */
	@Override
	public ESFProvince getESFProvince(ESFProvincePK esfProvincePK)
		throws PortalException, SystemException {
		return esfProvincePersistence.findByPrimaryKey(esfProvincePK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfProvincePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFProvince> getESFProvinces(int start, int end)
		throws SystemException {
		return esfProvincePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFProvincesCount() throws SystemException {
		return esfProvincePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFProvince updateESFProvince(ESFProvince esfProvince)
		throws SystemException {
		return esfProvincePersistence.update(esfProvince);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFProvince",
			esfProvinceLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFProvince");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfProvincePersistence.getDataSource();
	...
	private ESFProvinceLocalServiceClpInvoker _clpInvoker = new ESFProvinceLocalServiceClpInvoker();
}