...
public class ESFNationalMatchResultPersistenceImpl extends BasePersistenceImpl<ESFNationalMatchResult>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFMATCHID_ESFSPORTTYPEID =
		new FinderPath(ESFNationalMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), Long.class.getName() },
			ESFNationalMatchResultModelImpl.ESFMATCHID_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.ESFSPORTTYPEID_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.POSITION_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<ESFNationalMatchResult> findByESFMatchId_ESFSportTypeId(
	...
	public List<ESFNationalMatchResult> findByESFMatchId_ESFSportTypeId(
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFNationalMatchResult esfNationalMatchResult : list) {
				if ((esfMatchId != esfNationalMatchResult.getEsfMatchId()) ||
						(esfSportTypeId != esfNationalMatchResult.getEsfSportTypeId())) {
					list = null;
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_ESFSportTypeId_First(
		long esfMatchId, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_ESFSportTypeId_First(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_ESFSportTypeId_First(
		long esfMatchId, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFNationalMatchResult> list = findByESFMatchId_ESFSportTypeId(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_ESFSportTypeId_Last(
		long esfMatchId, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_ESFSportTypeId_Last(esfMatchId,
				esfSportTypeId, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_ESFSportTypeId_Last(
		long esfMatchId, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public ESFNationalMatchResult[] findByESFMatchId_ESFSportTypeId_PrevAndNext(
		...
		try {
			...
			array[0] = getByESFMatchId_ESFSportTypeId_PrevAndNext(session,
					esfNationalMatchResult, esfMatchId, esfSportTypeId,
					orderByComparator, true);
	...
	protected ESFNationalMatchResult getByESFMatchId_ESFSportTypeId_PrevAndNext(
		Session session, ESFNationalMatchResult esfNationalMatchResult,
		long esfMatchId, long esfSportTypeId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByESFMatchId_ESFSportTypeId(long esfMatchId,
		...
		for (ESFNationalMatchResult esfNationalMatchResult : findByESFMatchId_ESFSportTypeId(
	...
	private static final String _FINDER_COLUMN_ESFMATCHID_ESFSPORTTYPEID_ESFSPORTTYPEID_2 =
		"esfNationalMatchResult.esfSportTypeId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MATCHID_USERID =
		new FinderPath(ESFNationalMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			...
			ESFNationalMatchResultModelImpl.ESFUSERID_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.POSITION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_MATCHID_USERID = new FinderPath(ESFNationalMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			ESFNationalMatchResultModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ESFNationalMatchResult> findBymatchId_userId(long esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult findBymatchId_userId_First(long esfMatchId,
		long esfUserId, OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchBymatchId_userId_First(esfMatchId,
				esfUserId, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchBymatchId_userId_First(long esfMatchId,
		long esfUserId, OrderByComparator orderByComparator)
		throws SystemException {
		List<ESFNationalMatchResult> list = findBymatchId_userId(esfMatchId,
				esfUserId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult findBymatchId_userId_Last(long esfMatchId,
		long esfUserId, OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchBymatchId_userId_Last(esfMatchId,
				esfUserId, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchBymatchId_userId_Last(long esfMatchId,
		long esfUserId, OrderByComparator orderByComparator)
		throws SystemException {
	 ...
	 */
	@Override
	public ESFNationalMatchResult[] findBymatchId_userId_PrevAndNext(
		long esfNationalMatchResultId, long esfMatchId, long esfUserId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = findByPrimaryKey(esfNationalMatchResultId);
	...
	protected ESFNationalMatchResult getBymatchId_userId_PrevAndNext(
		Session session, ESFNationalMatchResult esfNationalMatchResult,
		long esfMatchId, long esfUserId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeBymatchId_userId(long esfMatchId, long esfUserId)
		throws SystemException {
		for (ESFNationalMatchResult esfNationalMatchResult : findBymatchId_userId(
				esfMatchId, esfUserId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(esfNationalMatchResult);
		}
	...
	private static final String _FINDER_COLUMN_MATCHID_USERID_ESFMATCHID_2 = "esfNationalMatchResult.esfMatchId = ? AND ";
	private static final String _FINDER_COLUMN_MATCHID_USERID_ESFUSERID_2 = "esfNationalMatchResult.esfUserId = ?";
	 ...
	 */
	@Override
	public List<ESFNationalMatchResult> findByESFMatchId_ExternalShooter_ESFSportTypeId(
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_ExternalShooter_ESFSportTypeId_First(
		long esfMatchId, boolean externalShooter, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_ExternalShooter_ESFSportTypeId_First(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_ExternalShooter_ESFSportTypeId_First(
		long esfMatchId, boolean externalShooter, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFNationalMatchResult> list = findByESFMatchId_ExternalShooter_ESFSportTypeId(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_ExternalShooter_ESFSportTypeId_Last(
		long esfMatchId, boolean externalShooter, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_ExternalShooter_ESFSportTypeId_Last(esfMatchId,
				externalShooter, esfSportTypeId, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_ExternalShooter_ESFSportTypeId_Last(
		long esfMatchId, boolean externalShooter, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public ESFNationalMatchResult[] findByESFMatchId_ExternalShooter_ESFSportTypeId_PrevAndNext(
		long esfNationalMatchResultId, long esfMatchId,
	...
	protected ESFNationalMatchResult getByESFMatchId_ExternalShooter_ESFSportTypeId_PrevAndNext(
		Session session, ESFNationalMatchResult esfNationalMatchResult,
		long esfMatchId, boolean externalShooter, long esfSportTypeId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByESFMatchId_ExternalShooter_ESFSportTypeId(
		long esfMatchId, boolean externalShooter, long esfSportTypeId)
		throws SystemException {
		for (ESFNationalMatchResult esfNationalMatchResult : findByESFMatchId_ExternalShooter_ESFSportTypeId(
	...
	private static final String _FINDER_COLUMN_ESFMATCHID_EXTERNALSHOOTER_ESFSPORTTYPEID_EXTERNALSHOOTER_2 =
		"esfNationalMatchResult.externalShooter = ? AND ";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFMATCHID_QUALIFICATIONID_ESFSPORTTYPEID =
		new FinderPath(ESFNationalMatchResultModelImpl.ENTITY_CACHE_ENABLED,
			...
			ESFNationalMatchResultModelImpl.ESFMATCHID_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.ESFUSERQUALIFICATION_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.ESFSPORTTYPEID_COLUMN_BITMASK |
			ESFNationalMatchResultModelImpl.POSITION_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<ESFNationalMatchResult> findByESFMatchId_QualificationId_ESFSportTypeId(
	...
	public List<ESFNationalMatchResult> findByESFMatchId_QualificationId_ESFSportTypeId(
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFNationalMatchResult esfNationalMatchResult : list) {
				if ((esfMatchId != esfNationalMatchResult.getEsfMatchId()) ||
						(esfUserQualification != esfNationalMatchResult.getEsfUserQualification()) ||
						(esfSportTypeId != esfNationalMatchResult.getEsfSportTypeId())) {
					list = null;
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_QualificationId_ESFSportTypeId_First(
		long esfMatchId, long esfUserQualification, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_QualificationId_ESFSportTypeId_First(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_QualificationId_ESFSportTypeId_First(
		long esfMatchId, long esfUserQualification, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFNationalMatchResult> list = findByESFMatchId_QualificationId_ESFSportTypeId(esfMatchId,
	 ...
	 */
	@Override
	public ESFNationalMatchResult findByESFMatchId_QualificationId_ESFSportTypeId_Last(
		long esfMatchId, long esfUserQualification, long esfSportTypeId,
		OrderByComparator orderByComparator)
		throws NoSuchNationalMatchResultException, SystemException {
		ESFNationalMatchResult esfNationalMatchResult = fetchByESFMatchId_QualificationId_ESFSportTypeId_Last(esfMatchId,
				esfUserQualification, esfSportTypeId, orderByComparator);
	 ...
	 */
	@Override
	public ESFNationalMatchResult fetchByESFMatchId_QualificationId_ESFSportTypeId_Last(
		long esfMatchId, long esfUserQualification, long esfSportTypeId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public ESFNationalMatchResult[] findByESFMatchId_QualificationId_ESFSportTypeId_PrevAndNext(
		long esfNationalMatchResultId, long esfMatchId,
		...
		try {
			...
			array[0] = getByESFMatchId_QualificationId_ESFSportTypeId_PrevAndNext(session,
					esfNationalMatchResult, esfMatchId, esfUserQualification,
					esfSportTypeId, orderByComparator, true);
	...
	protected ESFNationalMatchResult getByESFMatchId_QualificationId_ESFSportTypeId_PrevAndNext(
		Session session, ESFNationalMatchResult esfNationalMatchResult,
		long esfMatchId, long esfUserQualification, long esfSportTypeId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByESFMatchId_QualificationId_ESFSportTypeId(
		long esfMatchId, long esfUserQualification, long esfSportTypeId)
		throws SystemException {
		for (ESFNationalMatchResult esfNationalMatchResult : findByESFMatchId_QualificationId_ESFSportTypeId(
				esfMatchId, esfUserQualification, esfSportTypeId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(esfNationalMatchResult);
		}
	...
	private static final String _FINDER_COLUMN_ESFMATCHID_QUALIFICATIONID_ESFSPORTTYPEID_ESFUSERQUALIFICATION_2 =
		"esfNationalMatchResult.esfUserQualification = ? AND ";
	...
	public ESFNationalMatchResult updateImpl(
		...
		if (isNew || !ESFNationalMatchResultModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfNationalMatchResultModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfNationalMatchResultModelImpl.getOriginalEsfMatchId(),
						esfNationalMatchResultModelImpl.getOriginalEsfSportTypeId()
					};
				...
				args = new Object[] {
						esfNationalMatchResultModelImpl.getEsfMatchId(),
						esfNationalMatchResultModelImpl.getEsfSportTypeId()
					};
			...
			if ((esfNationalMatchResultModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfNationalMatchResultModelImpl.getOriginalEsfMatchId(),
						esfNationalMatchResultModelImpl.getOriginalEsfUserQualification(),
						esfNationalMatchResultModelImpl.getOriginalEsfSportTypeId()
					};
				...
				args = new Object[] {
						esfNationalMatchResultModelImpl.getEsfMatchId(),
						esfNationalMatchResultModelImpl.getEsfUserQualification(),
						esfNationalMatchResultModelImpl.getEsfSportTypeId()
					};
	...
	protected ESFNationalMatchResult toUnwrappedModel(
		...
		esfNationalMatchResultImpl.setEsfSportTypeId(esfNationalMatchResult.getEsfSportTypeId());
		esfNationalMatchResultImpl.setUserNationality(esfNationalMatchResult.getUserNationality());
		esfNationalMatchResultImpl.setEsfUserQualification(esfNationalMatchResult.getEsfUserQualification());
