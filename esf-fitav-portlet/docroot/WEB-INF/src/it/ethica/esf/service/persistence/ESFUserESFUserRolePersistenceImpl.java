...
public class ESFUserESFUserRolePersistenceImpl extends BasePersistenceImpl<ESFUserESFUserRole>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFO_R_YEAR =
		new FinderPath(ESFUserESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			ESFUserESFUserRoleModelImpl.FINDER_CACHE_ENABLED,
			ESFUserESFUserRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByESFO_R_YEAR",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFO_R_YEAR =
		new FinderPath(ESFUserESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			ESFUserESFUserRoleModelImpl.FINDER_CACHE_ENABLED,
			ESFUserESFUserRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByESFO_R_YEAR",
			new String[] { Long.class.getName(), Long.class.getName() },
			ESFUserESFUserRoleModelImpl.ESFORGANIZATIONID_COLUMN_BITMASK |
			ESFUserESFUserRoleModelImpl.ESFUSERROLEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ESFO_R_YEAR = new FinderPath(ESFUserESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			ESFUserESFUserRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByESFO_R_YEAR",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<ESFUserESFUserRole> findByESFO_R_YEAR(long esfOrganizationId,
		long esfUserRoleId) throws SystemException {
		return findByESFO_R_YEAR(esfOrganizationId, esfUserRoleId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ESFUserESFUserRole> findByESFO_R_YEAR(long esfOrganizationId,
		long esfUserRoleId, int start, int end) throws SystemException {
		return findByESFO_R_YEAR(esfOrganizationId, esfUserRoleId, start, end,
			null);
	}
	...
	public List<ESFUserESFUserRole> findByESFO_R_YEAR(long esfOrganizationId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFO_R_YEAR;
			finderArgs = new Object[] { esfOrganizationId, esfUserRoleId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFO_R_YEAR;
			finderArgs = new Object[] {
					esfOrganizationId, esfUserRoleId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ESFO_R_YEAR_ESFORGANIZATIONID_2);

			query.append(_FINDER_COLUMN_ESFO_R_YEAR_ESFUSERROLEID_2);
	 ...
	 */
	@Override
	public ESFUserESFUserRole findByESFO_R_YEAR_First(long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator)
		throws NoSuchUserESFUserRoleException, SystemException {
		ESFUserESFUserRole esfUserESFUserRole = fetchByESFO_R_YEAR_First(esfOrganizationId,
				esfUserRoleId, orderByComparator);
	 ...
	 */
	@Override
	public ESFUserESFUserRole fetchByESFO_R_YEAR_First(long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator)
		throws SystemException {
		List<ESFUserESFUserRole> list = findByESFO_R_YEAR(esfOrganizationId,
				esfUserRoleId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ESFUserESFUserRole findByESFO_R_YEAR_Last(long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator)
		throws NoSuchUserESFUserRoleException, SystemException {
		ESFUserESFUserRole esfUserESFUserRole = fetchByESFO_R_YEAR_Last(esfOrganizationId,
				esfUserRoleId, orderByComparator);
	 ...
	 */
	@Override
	public ESFUserESFUserRole fetchByESFO_R_YEAR_Last(long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByESFO_R_YEAR(esfOrganizationId, esfUserRoleId);
	 ...
	 */
	@Override
	public ESFUserESFUserRole[] findByESFO_R_YEAR_PrevAndNext(
		ESFUserESFUserRolePK esfUserESFUserRolePK, long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator)
		throws NoSuchUserESFUserRoleException, SystemException {
		ESFUserESFUserRole esfUserESFUserRole = findByPrimaryKey(esfUserESFUserRolePK);
		...
		try {
			...
			array[0] = getByESFO_R_YEAR_PrevAndNext(session,
					esfUserESFUserRole, esfOrganizationId, esfUserRoleId,
					orderByComparator, true);

			array[1] = esfUserESFUserRole;

			array[2] = getByESFO_R_YEAR_PrevAndNext(session,
					esfUserESFUserRole, esfOrganizationId, esfUserRoleId,
					orderByComparator, false);
	...
	protected ESFUserESFUserRole getByESFO_R_YEAR_PrevAndNext(Session session,
		ESFUserESFUserRole esfUserESFUserRole, long esfOrganizationId,
		long esfUserRoleId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByESFO_R_YEAR(long esfOrganizationId, long esfUserRoleId)
		throws SystemException {
		for (ESFUserESFUserRole esfUserESFUserRole : findByESFO_R_YEAR(
				esfOrganizationId, esfUserRoleId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(esfUserESFUserRole);
		}
	 ...
	 */
	@Override
	public int countByESFO_R_YEAR(long esfOrganizationId, long esfUserRoleId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ESFO_R_YEAR;
	...
	private static final String _FINDER_COLUMN_ESFO_R_YEAR_ESFORGANIZATIONID_2 = "esfUserESFUserRole.id.esfOrganizationId = ? AND ";
	private static final String _FINDER_COLUMN_ESFO_R_YEAR_ESFUSERROLEID_2 = "esfUserESFUserRole.id.esfUserRoleId = ? AND esfUserESFUserRole.endDate is null";
	...
	public ESFUserESFUserRole updateImpl(
		...
		if (isNew || !ESFUserESFUserRoleModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfUserESFUserRoleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFO_R_YEAR.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfUserESFUserRoleModelImpl.getOriginalEsfOrganizationId(),
						esfUserESFUserRoleModelImpl.getOriginalEsfUserRoleId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ESFO_R_YEAR,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFO_R_YEAR,
					args);
