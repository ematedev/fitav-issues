...
import it.ethica.esf.service.ESFRegionLocalService;
...
/**
 * Provides the base implementation for the e s f region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFRegionLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFRegionLocalServiceImpl
 * @see it.ethica.esf.service.ESFRegionLocalServiceUtil
 * @generated
 */
public abstract class ESFRegionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFRegionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFRegionLocalServiceUtil} to access the e s f region local service.
	 */
	...
	@Override
	public ESFRegion addESFRegion(ESFRegion esfRegion)
		throws SystemException {
		esfRegion.setNew(true);

		return esfRegionPersistence.update(esfRegion);
	}
	 ...
	 */
	@Override
	public ESFRegion createESFRegion(ESFRegionPK esfRegionPK) {
		return esfRegionPersistence.create(esfRegionPK);
	}
	...
	@Override
	public ESFRegion deleteESFRegion(ESFRegionPK esfRegionPK)
		throws PortalException, SystemException {
		return esfRegionPersistence.remove(esfRegionPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFRegion deleteESFRegion(ESFRegion esfRegion)
		throws SystemException {
		return esfRegionPersistence.remove(esfRegion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFRegion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfRegionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFRegion fetchESFRegion(ESFRegionPK esfRegionPK)
		throws SystemException {
		return esfRegionPersistence.fetchByPrimaryKey(esfRegionPK);
	}
	 ...
	 */
	@Override
	public ESFRegion getESFRegion(ESFRegionPK esfRegionPK)
		throws PortalException, SystemException {
		return esfRegionPersistence.findByPrimaryKey(esfRegionPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFRegion> getESFRegions(int start, int end)
		throws SystemException {
		return esfRegionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFRegionsCount() throws SystemException {
		return esfRegionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFRegion updateESFRegion(ESFRegion esfRegion)
		throws SystemException {
		return esfRegionPersistence.update(esfRegion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFRegion",
			esfRegionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFRegion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfRegionPersistence.getDataSource();
	...
	private ESFRegionLocalServiceClpInvoker _clpInvoker = new ESFRegionLocalServiceClpInvoker();
}