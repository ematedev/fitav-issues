...
import it.ethica.esf.service.ESFShooterQualificationLocalService;
...
/**
 * Provides the base implementation for the e s f shooter qualification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFShooterQualificationLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFShooterQualificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFShooterQualificationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFShooterQualificationLocalServiceUtil} to access the e s f shooter qualification local service.
	 */
	...
	public ESFShooterQualification addESFShooterQualification(
		...
		return esfShooterQualificationPersistence.update(esfShooterQualification);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification createESFShooterQualification(
		long esfShooterQualificationId) {
		return esfShooterQualificationPersistence.create(esfShooterQualificationId);
	}
	...
	public ESFShooterQualification deleteESFShooterQualification(
		long esfShooterQualificationId) throws PortalException, SystemException {
		return esfShooterQualificationPersistence.remove(esfShooterQualificationId);
	}
	...
	public ESFShooterQualification deleteESFShooterQualification(
		ESFShooterQualification esfShooterQualification)
		throws SystemException {
		return esfShooterQualificationPersistence.remove(esfShooterQualification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFShooterQualification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterQualificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShooterQualificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFShooterQualification fetchESFShooterQualification(
		long esfShooterQualificationId) throws SystemException {
		return esfShooterQualificationPersistence.fetchByPrimaryKey(esfShooterQualificationId);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification fetchESFShooterQualificationByUuidAndCompanyId(
		String uuid, long companyId) throws SystemException {
		return esfShooterQualificationPersistence.fetchByUuid_C_First(uuid,
			companyId, null);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification fetchESFShooterQualificationByUuidAndGroupId(
		String uuid, long groupId) throws SystemException {
		return esfShooterQualificationPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification getESFShooterQualification(
		long esfShooterQualificationId) throws PortalException, SystemException {
		return esfShooterQualificationPersistence.findByPrimaryKey(esfShooterQualificationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfShooterQualificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification getESFShooterQualificationByUuidAndCompanyId(
		String uuid, long companyId) throws PortalException, SystemException {
		return esfShooterQualificationPersistence.findByUuid_C_First(uuid,
			companyId, null);
	}
	 ...
	 */
	@Override
	public ESFShooterQualification getESFShooterQualificationByUuidAndGroupId(
		String uuid, long groupId) throws PortalException, SystemException {
		return esfShooterQualificationPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public int getESFShooterQualificationsCount() throws SystemException {
		return esfShooterQualificationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFShooterQualification",
			esfShooterQualificationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfShooterQualificationPersistence.getDataSource();
	...
	private ESFShooterQualificationLocalServiceClpInvoker _clpInvoker = new ESFShooterQualificationLocalServiceClpInvoker();
}