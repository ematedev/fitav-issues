...
import it.ethica.esf.service.ESFDescriptionLocalService;
...
/**
 * Provides the base implementation for the e s f description local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFDescriptionLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFDescriptionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFDescriptionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFDescriptionLocalServiceUtil} to access the e s f description local service.
	 */
	...
	@Override
	public ESFDescription addESFDescription(ESFDescription esfDescription)
		throws SystemException {
		esfDescription.setNew(true);

		return esfDescriptionPersistence.update(esfDescription);
	}
	 ...
	 */
	@Override
	public ESFDescription createESFDescription(long esfDescriptionId) {
		return esfDescriptionPersistence.create(esfDescriptionId);
	}
	...
	@Override
	public ESFDescription deleteESFDescription(long esfDescriptionId)
		throws PortalException, SystemException {
		return esfDescriptionPersistence.remove(esfDescriptionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFDescription deleteESFDescription(ESFDescription esfDescription)
		throws SystemException {
		return esfDescriptionPersistence.remove(esfDescription);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFDescription.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDescriptionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfDescriptionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFDescription fetchESFDescription(long esfDescriptionId)
		throws SystemException {
		return esfDescriptionPersistence.fetchByPrimaryKey(esfDescriptionId);
	}
	 ...
	 */
	@Override
	public ESFDescription getESFDescription(long esfDescriptionId)
		throws PortalException, SystemException {
		return esfDescriptionPersistence.findByPrimaryKey(esfDescriptionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfDescriptionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFDescription> getESFDescriptions(int start, int end)
		throws SystemException {
		return esfDescriptionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFDescriptionsCount() throws SystemException {
		return esfDescriptionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFDescription updateESFDescription(ESFDescription esfDescription)
		throws SystemException {
		return esfDescriptionPersistence.update(esfDescription);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFDescription",
			esfDescriptionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfDescriptionPersistence.getDataSource();
	...
	private ESFDescriptionLocalServiceClpInvoker _clpInvoker = new ESFDescriptionLocalServiceClpInvoker();
}