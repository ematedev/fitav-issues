...
import it.ethica.esf.service.ESFPhoneLocalService;
...
/**
 * Provides the base implementation for the e s f phone local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFPhoneLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFPhoneLocalServiceImpl
 * @see it.ethica.esf.service.ESFPhoneLocalServiceUtil
 * @generated
 */
public abstract class ESFPhoneLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFPhoneLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFPhoneLocalServiceUtil} to access the e s f phone local service.
	 */

	/**
	 * Adds the e s f phone to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfPhone the e s f phone
	 * @return the e s f phone that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPhone addESFPhone(ESFPhone esfPhone) throws SystemException {
		esfPhone.setNew(true);

		return esfPhonePersistence.update(esfPhone);
	}
	 ...
	 */
	@Override
	public ESFPhone createESFPhone(long esfPhoneId) {
		return esfPhonePersistence.create(esfPhoneId);
	}

	/**
	 * Deletes the e s f phone with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfPhoneId the primary key of the e s f phone
	 * @return the e s f phone that was removed
	 * @throws PortalException if a e s f phone with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFPhone deleteESFPhone(long esfPhoneId)
		throws PortalException, SystemException {
		return esfPhonePersistence.remove(esfPhoneId);
	}

	/**
	 * Deletes the e s f phone from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfPhone the e s f phone
	 * @return the e s f phone that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFPhone deleteESFPhone(ESFPhone esfPhone) throws SystemException {
		return esfPhonePersistence.remove(esfPhone);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFPhone.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfPhonePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfPhonePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfPhonePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfPhonePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFPhone fetchESFPhone(long esfPhoneId) throws SystemException {
		return esfPhonePersistence.fetchByPrimaryKey(esfPhoneId);
	}

	/**
	 * Returns the e s f phone with the primary key.
	 *
	 * @param esfPhoneId the primary key of the e s f phone
	 ...
	 */
	@Override
	public ESFPhone getESFPhone(long esfPhoneId)
		throws PortalException, SystemException {
		return esfPhonePersistence.findByPrimaryKey(esfPhoneId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfPhonePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFPhone> getESFPhones(int start, int end)
		throws SystemException {
		return esfPhonePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFPhonesCount() throws SystemException {
		return esfPhonePersistence.countAll();
	}

	/**
	 * Updates the e s f phone in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfPhone the e s f phone
	 * @return the e s f phone that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFPhone updateESFPhone(ESFPhone esfPhone) throws SystemException {
		return esfPhonePersistence.update(esfPhone);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFPhone",
			esfPhoneLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFPhone");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfPhonePersistence.getDataSource();
	...
	private ESFPhoneLocalServiceClpInvoker _clpInvoker = new ESFPhoneLocalServiceClpInvoker();
}