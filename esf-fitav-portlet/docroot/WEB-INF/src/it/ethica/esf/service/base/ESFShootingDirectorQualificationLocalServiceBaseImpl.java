...
import it.ethica.esf.service.ESFShootingDirectorQualificationLocalService;
...
/**
 * Provides the base implementation for the e s f shooting director qualification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFShootingDirectorQualificationLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFShootingDirectorQualificationLocalServiceImpl
 * @see it.ethica.esf.service.ESFShootingDirectorQualificationLocalServiceUtil
 * @generated
 */
public abstract class ESFShootingDirectorQualificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ESFShootingDirectorQualificationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFShootingDirectorQualificationLocalServiceUtil} to access the e s f shooting director qualification local service.
	 */

	/**
	 * Adds the e s f shooting director qualification to the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfShootingDirectorQualification the e s f shooting director qualification
	 * @return the e s f shooting director qualification that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFShootingDirectorQualification addESFShootingDirectorQualification(
		ESFShootingDirectorQualification esfShootingDirectorQualification)
		throws SystemException {
		esfShootingDirectorQualification.setNew(true);

		return esfShootingDirectorQualificationPersistence.update(esfShootingDirectorQualification);
	}
	 ...
	 */
	@Override
	public ESFShootingDirectorQualification createESFShootingDirectorQualification(
		long esfShootingDirectorQualificationId) {
		return esfShootingDirectorQualificationPersistence.create(esfShootingDirectorQualificationId);
	}

	/**
	 * Deletes the e s f shooting director qualification with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a e s f shooting director qualification with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFShootingDirectorQualification deleteESFShootingDirectorQualification(
		long esfShootingDirectorQualificationId)
		throws PortalException, SystemException {
		return esfShootingDirectorQualificationPersistence.remove(esfShootingDirectorQualificationId);
	}

	/**
	 * Deletes the e s f shooting director qualification from the database. Also notifies the appropriate model listeners.
	 *
	 * @param esfShootingDirectorQualification the e s f shooting director qualification
	 * @return the e s f shooting director qualification that was removed
	 * @throws SystemException if a system exception occurred
	...
	public ESFShootingDirectorQualification deleteESFShootingDirectorQualification(
		ESFShootingDirectorQualification esfShootingDirectorQualification)
		throws SystemException {
		return esfShootingDirectorQualificationPersistence.remove(esfShootingDirectorQualification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFShootingDirectorQualification.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShootingDirectorQualificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfShootingDirectorQualificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFShootingDirectorQualification fetchESFShootingDirectorQualification(
		long esfShootingDirectorQualificationId) throws SystemException {
		return esfShootingDirectorQualificationPersistence.fetchByPrimaryKey(esfShootingDirectorQualificationId);
	}

	/**
	 * Returns the e s f shooting director qualification with the primary key.
	 *
	 * @param esfShootingDirectorQualificationId the primary key of the e s f shooting director qualification
	 ...
	 */
	@Override
	public ESFShootingDirectorQualification getESFShootingDirectorQualification(
		long esfShootingDirectorQualificationId)
		throws PortalException, SystemException {
		return esfShootingDirectorQualificationPersistence.findByPrimaryKey(esfShootingDirectorQualificationId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfShootingDirectorQualificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFShootingDirectorQualification> getESFShootingDirectorQualifications(
		int start, int end) throws SystemException {
		return esfShootingDirectorQualificationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFShootingDirectorQualificationsCount()
		throws SystemException {
		return esfShootingDirectorQualificationPersistence.countAll();
	}

	/**
	 * Updates the e s f shooting director qualification in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param esfShootingDirectorQualification the e s f shooting director qualification
	 * @return the e s f shooting director qualification that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFShootingDirectorQualification updateESFShootingDirectorQualification(
		ESFShootingDirectorQualification esfShootingDirectorQualification)
		throws SystemException {
		return esfShootingDirectorQualificationPersistence.update(esfShootingDirectorQualification);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFShootingDirectorQualification",
			esfShootingDirectorQualificationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfShootingDirectorQualificationPersistence.getDataSource();
	...
	private ESFShootingDirectorQualificationLocalServiceClpInvoker _clpInvoker = new ESFShootingDirectorQualificationLocalServiceClpInvoker();
}