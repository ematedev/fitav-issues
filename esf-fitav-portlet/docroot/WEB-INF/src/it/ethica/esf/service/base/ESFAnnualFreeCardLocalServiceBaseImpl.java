...
import it.ethica.esf.service.ESFAnnualFreeCardLocalService;
...
/**
 * Provides the base implementation for the e s f annual free card local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFAnnualFreeCardLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 * @see it.ethica.esf.service.impl.ESFAnnualFreeCardLocalServiceImpl
 * @see it.ethica.esf.service.ESFAnnualFreeCardLocalServiceUtil
 * @generated
 */
public abstract class ESFAnnualFreeCardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ESFAnnualFreeCardLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFAnnualFreeCardLocalServiceUtil} to access the e s f annual free card local service.
	 */
	...
	@Override
	public ESFAnnualFreeCard addESFAnnualFreeCard(
		ESFAnnualFreeCard esfAnnualFreeCard) throws SystemException {
		esfAnnualFreeCard.setNew(true);

		return esfAnnualFreeCardPersistence.update(esfAnnualFreeCard);
	}
	 ...
	 */
	@Override
	public ESFAnnualFreeCard createESFAnnualFreeCard(long annualFreeCardId) {
		return esfAnnualFreeCardPersistence.create(annualFreeCardId);
	}
	...
	@Override
	public ESFAnnualFreeCard deleteESFAnnualFreeCard(long annualFreeCardId)
		throws PortalException, SystemException {
		return esfAnnualFreeCardPersistence.remove(annualFreeCardId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFAnnualFreeCard deleteESFAnnualFreeCard(
		ESFAnnualFreeCard esfAnnualFreeCard) throws SystemException {
		return esfAnnualFreeCardPersistence.remove(esfAnnualFreeCard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFAnnualFreeCard.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfAnnualFreeCardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfAnnualFreeCardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFAnnualFreeCard fetchESFAnnualFreeCard(long annualFreeCardId)
		throws SystemException {
		return esfAnnualFreeCardPersistence.fetchByPrimaryKey(annualFreeCardId);
	}
	 ...
	 */
	@Override
	public ESFAnnualFreeCard getESFAnnualFreeCard(long annualFreeCardId)
		throws PortalException, SystemException {
		return esfAnnualFreeCardPersistence.findByPrimaryKey(annualFreeCardId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfAnnualFreeCardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFAnnualFreeCard> getESFAnnualFreeCards(int start, int end)
		throws SystemException {
		return esfAnnualFreeCardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFAnnualFreeCardsCount() throws SystemException {
		return esfAnnualFreeCardPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFAnnualFreeCard updateESFAnnualFreeCard(
		ESFAnnualFreeCard esfAnnualFreeCard) throws SystemException {
		return esfAnnualFreeCardPersistence.update(esfAnnualFreeCard);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFAnnualFreeCard",
			esfAnnualFreeCardLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfAnnualFreeCardPersistence.getDataSource();
	...
	private ESFAnnualFreeCardLocalServiceClpInvoker _clpInvoker = new ESFAnnualFreeCardLocalServiceClpInvoker();
}