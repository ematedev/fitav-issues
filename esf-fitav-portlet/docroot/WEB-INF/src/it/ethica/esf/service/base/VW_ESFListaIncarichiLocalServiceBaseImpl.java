...
import it.ethica.esf.service.VW_ESFListaIncarichiLocalService;
...
/**
 * Provides the base implementation for the v w_ e s f lista incarichi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.VW_ESFListaIncarichiLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class VW_ESFListaIncarichiLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VW_ESFListaIncarichiLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.VW_ESFListaIncarichiLocalServiceUtil} to access the v w_ e s f lista incarichi local service.
	 */
	...
	@Override
	public VW_ESFListaIncarichi addVW_ESFListaIncarichi(
		VW_ESFListaIncarichi vw_esfListaIncarichi) throws SystemException {
		vw_esfListaIncarichi.setNew(true);

		return vw_esfListaIncarichiPersistence.update(vw_esfListaIncarichi);
	}
	 ...
	 */
	@Override
	public VW_ESFListaIncarichi createVW_ESFListaIncarichi(
		VW_ESFListaIncarichiPK vw_esfListaIncarichiPK) {
		return vw_esfListaIncarichiPersistence.create(vw_esfListaIncarichiPK);
	}
	...
	@Override
	public VW_ESFListaIncarichi deleteVW_ESFListaIncarichi(
		VW_ESFListaIncarichiPK vw_esfListaIncarichiPK)
		throws PortalException, SystemException {
		return vw_esfListaIncarichiPersistence.remove(vw_esfListaIncarichiPK);
	}
	...
	public VW_ESFListaIncarichi deleteVW_ESFListaIncarichi(
		VW_ESFListaIncarichi vw_esfListaIncarichi) throws SystemException {
		return vw_esfListaIncarichiPersistence.remove(vw_esfListaIncarichi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VW_ESFListaIncarichi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vw_esfListaIncarichiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vw_esfListaIncarichiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VW_ESFListaIncarichi fetchVW_ESFListaIncarichi(
		VW_ESFListaIncarichiPK vw_esfListaIncarichiPK)
		throws SystemException {
		return vw_esfListaIncarichiPersistence.fetchByPrimaryKey(vw_esfListaIncarichiPK);
	}
	 ...
	 */
	@Override
	public VW_ESFListaIncarichi getVW_ESFListaIncarichi(
		VW_ESFListaIncarichiPK vw_esfListaIncarichiPK)
		throws PortalException, SystemException {
		return vw_esfListaIncarichiPersistence.findByPrimaryKey(vw_esfListaIncarichiPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vw_esfListaIncarichiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VW_ESFListaIncarichi> getVW_ESFListaIncarichis(int start,
		int end) throws SystemException {
		return vw_esfListaIncarichiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVW_ESFListaIncarichisCount() throws SystemException {
		return vw_esfListaIncarichiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VW_ESFListaIncarichi updateVW_ESFListaIncarichi(
		VW_ESFListaIncarichi vw_esfListaIncarichi) throws SystemException {
		return vw_esfListaIncarichiPersistence.update(vw_esfListaIncarichi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.VW_ESFListaIncarichi",
			vw_esfListaIncarichiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vw_esfListaIncarichiPersistence.getDataSource();
	...
	private VW_ESFListaIncarichiLocalServiceClpInvoker _clpInvoker = new VW_ESFListaIncarichiLocalServiceClpInvoker();
}