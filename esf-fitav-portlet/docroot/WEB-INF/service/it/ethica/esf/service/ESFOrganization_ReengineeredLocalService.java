...
/**
 * Provides the local service interface for ESFOrganization_Reengineered. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFOrganization_ReengineeredLocalServiceUtil
...
public interface ESFOrganization_ReengineeredLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFOrganization_ReengineeredLocalServiceUtil} to access the e s f organization_ reengineered local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFOrganization_ReengineeredLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
