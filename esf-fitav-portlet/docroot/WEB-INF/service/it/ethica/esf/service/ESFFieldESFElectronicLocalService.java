...
/**
 * Provides the local service interface for ESFFieldESFElectronic. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFFieldESFElectronicLocalServiceUtil
...
public interface ESFFieldESFElectronicLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFFieldESFElectronicLocalServiceUtil} to access the e s f field e s f electronic local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFFieldESFElectronicLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
