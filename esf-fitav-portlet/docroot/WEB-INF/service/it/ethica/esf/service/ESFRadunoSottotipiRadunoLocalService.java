...
/**
 * Provides the local service interface for ESFRadunoSottotipiRaduno. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFRadunoSottotipiRadunoLocalServiceUtil
...
public interface ESFRadunoSottotipiRadunoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFRadunoSottotipiRadunoLocalServiceUtil} to access the e s f raduno sottotipi raduno local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFRadunoSottotipiRadunoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
