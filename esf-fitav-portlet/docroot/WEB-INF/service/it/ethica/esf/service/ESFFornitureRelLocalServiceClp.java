 ...
 * @generated
 */
public class ESFFornitureRelLocalServiceClp
	implements ESFFornitureRelLocalService {
	public ESFFornitureRelLocalServiceClp(
	...
	public it.ethica.esf.model.ESFFornitureRel addESFFornitureRel(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfFornitureRel) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFFornitureRel)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.ethica.esf.model.ESFFornitureRel> getESFFornitureRels(
		...
		return (java.util.List<it.ethica.esf.model.ESFFornitureRel>)ClpSerializer.translateOutput(returnObj);
	}
