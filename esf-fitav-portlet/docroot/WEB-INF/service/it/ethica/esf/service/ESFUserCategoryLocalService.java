...
/**
 * Provides the local service interface for ESFUserCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFUserCategoryLocalServiceUtil
...
public interface ESFUserCategoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFUserCategoryLocalServiceUtil} to access the e s f user category local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFUserCategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
