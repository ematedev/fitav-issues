...
/**
 * Provides the local service interface for ESFNational. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFNationalLocalServiceUtil
...
public interface ESFNationalLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFNationalLocalServiceUtil} to access the e s f national local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFNationalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
