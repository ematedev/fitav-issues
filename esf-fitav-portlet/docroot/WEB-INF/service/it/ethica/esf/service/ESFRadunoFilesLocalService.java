...
/**
 * Provides the local service interface for ESFRadunoFiles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFRadunoFilesLocalServiceUtil
...
public interface ESFRadunoFilesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFRadunoFilesLocalServiceUtil} to access the e s f raduno files local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFRadunoFilesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
