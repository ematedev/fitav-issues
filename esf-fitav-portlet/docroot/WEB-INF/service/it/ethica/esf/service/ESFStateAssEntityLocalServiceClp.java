 ...
 * @generated
 */
public class ESFStateAssEntityLocalServiceClp
	implements ESFStateAssEntityLocalService {
	public ESFStateAssEntityLocalServiceClp(
	...
	public it.ethica.esf.model.ESFStateAssEntity createESFStateAssEntity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(esfStateAssEntityPK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFStateAssEntity> getESFStateAssEntities(
		...
		return (java.util.List<it.ethica.esf.model.ESFStateAssEntity>)ClpSerializer.translateOutput(returnObj);
	}
