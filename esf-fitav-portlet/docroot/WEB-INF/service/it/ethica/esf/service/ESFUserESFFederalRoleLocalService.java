...
/**
 * Provides the local service interface for ESFUserESFFederalRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFUserESFFederalRoleLocalServiceUtil
...
public interface ESFUserESFFederalRoleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFUserESFFederalRoleLocalServiceUtil} to access the e s f user e s f federal role local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFUserESFFederalRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
