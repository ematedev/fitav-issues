 ...
 * @generated
 */
public class ESFNationalDelegationLocalServiceClp
	implements ESFNationalDelegationLocalService {
	public ESFNationalDelegationLocalServiceClp(
	...
	public java.util.List<it.ethica.esf.model.ESFNationalDelegation> getESFNationalDelegations(
		...
		return (java.util.List<it.ethica.esf.model.ESFNationalDelegation>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void changeCard(javax.portlet.ActionRequest actionRequest,
		...
		try {
			...
			if (t instanceof javax.portlet.PortletException) {
				throw (javax.portlet.PortletException)t;
			}
