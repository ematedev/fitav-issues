...
/**
 * The persistence utility for the e s f raduno files service. This utility wraps {@link ESFRadunoFilesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ESFRadunoFilesUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ESFRadunoFiles esfRadunoFiles) {
		getPersistence().clearCache(esfRadunoFiles);
	}
	 ...
	 */
	public static List<ESFRadunoFiles> findWithDynamicQuery(
	 ...
	 */
	public static ESFRadunoFiles update(ESFRadunoFiles esfRadunoFiles)
		throws SystemException {
		return getPersistence().update(esfRadunoFiles);
	}
	...
	public static ESFRadunoFiles update(ESFRadunoFiles esfRadunoFiles,
		...
		return getPersistence().update(esfRadunoFiles, serviceContext);
	}
	...
	*/
	public static java.util.List<it.ethica.esf.model.ESFRadunoFiles> findByfindByRaduno(
		long id_esf_raduno)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles findByfindByRaduno_First(
		long id_esf_raduno,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles fetchByfindByRaduno_First(
		long id_esf_raduno,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles findByfindByRaduno_Last(
		long id_esf_raduno,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchRadunoFilesException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles fetchByfindByRaduno_Last(
		long id_esf_raduno,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles[] findByfindByRaduno_PrevAndNext(
		long id_esf_raduno_files, long id_esf_raduno,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchRadunoFilesException {
		return getPersistence()
				   .findByfindByRaduno_PrevAndNext(id_esf_raduno_files,
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(esfRadunoFiles);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(esfRadunoFileses);
	}
	...
	*/
	public static it.ethica.esf.model.ESFRadunoFiles create(
		long id_esf_raduno_files) {
		return getPersistence().create(id_esf_raduno_files);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles remove(
		long id_esf_raduno_files)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchRadunoFilesException {
		return getPersistence().remove(id_esf_raduno_files);
	}

	public static it.ethica.esf.model.ESFRadunoFiles updateImpl(
		it.ethica.esf.model.ESFRadunoFiles esfRadunoFiles)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(esfRadunoFiles);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles findByPrimaryKey(
		long id_esf_raduno_files)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchRadunoFilesException {
		return getPersistence().findByPrimaryKey(id_esf_raduno_files);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFRadunoFiles fetchByPrimaryKey(
		long id_esf_raduno_files)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(id_esf_raduno_files);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.ethica.esf.model.ESFRadunoFiles> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ESFRadunoFilesPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ESFRadunoFilesPersistence)PortletBeanLocatorUtil.locate(it.ethica.esf.service.ClpSerializer.getServletContextName(),
					ESFRadunoFilesPersistence.class.getName());

			ReferenceRegistry.registerReference(ESFRadunoFilesUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ESFRadunoFilesPersistence persistence) {
	}

	private static ESFRadunoFilesPersistence _persistence;
}