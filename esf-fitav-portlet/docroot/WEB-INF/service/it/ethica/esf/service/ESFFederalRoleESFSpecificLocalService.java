...
/**
 * Provides the local service interface for ESFFederalRoleESFSpecific. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFFederalRoleESFSpecificLocalServiceUtil
...
public interface ESFFederalRoleESFSpecificLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFFederalRoleESFSpecificLocalServiceUtil} to access the e s f federal role e s f specific local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFFederalRoleESFSpecificLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
