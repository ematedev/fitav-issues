...
/**
 * Provides the local service interface for ESFDescription. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFDescriptionLocalServiceUtil
...
public interface ESFDescriptionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFDescriptionLocalServiceUtil} to access the e s f description local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFDescriptionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
