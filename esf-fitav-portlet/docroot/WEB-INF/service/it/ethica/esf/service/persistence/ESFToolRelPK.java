 ...
 * @author Ethica
 */
public class ESFToolRelPK implements Comparable<ESFToolRelPK>, Serializable {
	public ESFToolRelPK() {
	}

	public ESFToolRelPK(long esfToolId, String className, long classPK) {
	...
	@Override
	public int compareTo(ESFToolRelPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ESFToolRelPK)) {
			return false;
		}

		ESFToolRelPK pk = (ESFToolRelPK)obj;
