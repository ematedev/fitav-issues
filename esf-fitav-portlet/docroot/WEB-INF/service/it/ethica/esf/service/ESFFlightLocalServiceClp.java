 ...
 * @generated
 */
public class ESFFlightLocalServiceClp implements ESFFlightLocalService {
	public ESFFlightLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName21 = "findFlightsByESFMatchId";

		_methodParameterTypes21 = new String[] { "long" };

		_methodName22 = "findFlightsByFlightCode";

		_methodParameterTypes22 = new String[] { "java.lang.String" };

		_methodName23 = "getByEsfMatchIdEsfUserId";

		_methodParameterTypes23 = new String[] { "long", "long" };

		_methodName24 = "getESFFlightsByEsfMatchId_F_L_L_C_D";
	...
	public it.ethica.esf.model.ESFFlight addESFFlight(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfFlight) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFFlight)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFFlight createESFFlight(long esfFlightId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { esfFlightId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFFlight deleteESFFlight(long esfFlightId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { esfFlightId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFFlight fetchESFFlight(long esfFlightId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { esfFlightId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFFlight getESFFlight(long esfFlightId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { esfFlightId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFFlight> getESFFlights(
		...
		return (java.util.List<it.ethica.esf.model.ESFFlight>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFFlight addEsfFlight(long groupId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(flightCode),
					...
					ClpSerializer.translateInput(departureAirport),
						
					ClpSerializer.translateInput(arrivalAirport),
	...
	public java.util.List<it.ethica.esf.model.ESFFlight> findFlightsByFlightCode(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					...
					new Object[] { ClpSerializer.translateInput(flightCode) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
