...
/**
 * Provides the local service interface for ESFSuspensiveCode. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFSuspensiveCodeLocalServiceUtil
...
public interface ESFSuspensiveCodeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFSuspensiveCodeLocalServiceUtil} to access the e s f suspensive code local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFSuspensiveCodeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
