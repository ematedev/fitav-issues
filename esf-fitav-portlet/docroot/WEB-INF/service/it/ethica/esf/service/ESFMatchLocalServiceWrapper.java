...
public class ESFMatchLocalServiceWrapper implements ESFMatchLocalService,
	...
	*/
	...
	public it.ethica.esf.model.ESFMatch addOrUpdateOldESFMatch(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _esfMatchLocalService.addOrUpdateOldESFMatch(userId, esfMatchId,
			esfAssociationId, code, startDate, endDate, startHour, description,
			note, isDraft, numFields, esfSportTypeId, numDisk, numDiskTeam,
			isIndividualMatch, isTeamMatch, isJuniorMatch, esfMatchTypeId,
			isChangeCategoryMatch, esfShooterCategoryIds,
	...
	public java.util.List<it.ethica.esf.model.ESFMatch> findMatchToDispute(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _esfMatchLocalService.findMatchToDispute(code, isnational,
			start, end);
	}
	...
	public int countMatchToDispute(java.lang.String code, boolean isnational)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _esfMatchLocalService.countMatchToDispute(code, isnational);
	}
