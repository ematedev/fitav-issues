 ...
 * @generated
 */
public class EsfRadunoShootersLocalServiceClp
	implements EsfRadunoShootersLocalService {
	public EsfRadunoShootersLocalServiceClp(
	...
	public it.ethica.esf.model.EsfRadunoShooters addEsfRadunoShooters(
		...
		return (it.ethica.esf.model.EsfRadunoShooters)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.EsfRadunoShooters createEsfRadunoShooters(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(esfRadunoShootersPK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.EsfRadunoShooters> getEsfRadunoShooterses(
		...
		return (java.util.List<it.ethica.esf.model.EsfRadunoShooters>)ClpSerializer.translateOutput(returnObj);
	}
