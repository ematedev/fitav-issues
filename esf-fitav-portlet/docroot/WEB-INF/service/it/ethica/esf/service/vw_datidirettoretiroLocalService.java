...
/**
 * Provides the local service interface for vw_datidirettoretiro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see vw_datidirettoretiroLocalServiceUtil
...
public interface vw_datidirettoretiroLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link vw_datidirettoretiroLocalServiceUtil} to access the vw_datidirettoretiro local service. Add custom service methods to {@link it.ethica.esf.service.impl.vw_datidirettoretiroLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
