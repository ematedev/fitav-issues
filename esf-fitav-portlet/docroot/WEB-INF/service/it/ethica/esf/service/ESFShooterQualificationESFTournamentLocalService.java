...
/**
 * Provides the local service interface for ESFShooterQualificationESFTournament. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFShooterQualificationESFTournamentLocalServiceUtil
...
public interface ESFShooterQualificationESFTournamentLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFShooterQualificationESFTournamentLocalServiceUtil} to access the e s f shooter qualification e s f tournament local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFShooterQualificationESFTournamentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
