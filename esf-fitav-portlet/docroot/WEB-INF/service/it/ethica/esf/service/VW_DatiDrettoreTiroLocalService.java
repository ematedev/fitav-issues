...
/**
 * Provides the local service interface for VW_DatiDrettoreTiro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_DatiDrettoreTiroLocalServiceUtil
...
public interface VW_DatiDrettoreTiroLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_DatiDrettoreTiroLocalServiceUtil} to access the v w_ dati drettore tiro local service. Add custom service methods to {@link it.ethica.esf.service.impl.VW_DatiDrettoreTiroLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
