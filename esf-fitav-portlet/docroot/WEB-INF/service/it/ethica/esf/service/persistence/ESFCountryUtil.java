...
/**
 * The persistence utility for the e s f country service. This utility wraps {@link ESFCountryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ESFCountryPersistenceImpl
 * @generated
 */
public class ESFCountryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ESFCountry esfCountry) {
		getPersistence().clearCache(esfCountry);
	}
	 ...
	 */
	public static List<ESFCountry> findWithDynamicQuery(
	 ...
	 */
	public static ESFCountry update(ESFCountry esfCountry)
		throws SystemException {
		return getPersistence().update(esfCountry);
	}
	...
	public static ESFCountry update(ESFCountry esfCountry,
		...
		return getPersistence().update(esfCountry, serviceContext);
	}
	...
	*/
	public static void cacheResult(it.ethica.esf.model.ESFCountry esfCountry) {
		getPersistence().cacheResult(esfCountry);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<it.ethica.esf.model.ESFCountry> esfCountries) {
		getPersistence().cacheResult(esfCountries);
	}
	...
	*/
	public static it.ethica.esf.model.ESFCountry create(
		java.lang.String idCountry) {
		return getPersistence().create(idCountry);
	}
	...
	*/
	public static it.ethica.esf.model.ESFCountry remove(
		java.lang.String idCountry)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchCountryException {
		return getPersistence().remove(idCountry);
	}

	public static it.ethica.esf.model.ESFCountry updateImpl(
		it.ethica.esf.model.ESFCountry esfCountry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(esfCountry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFCountry findByPrimaryKey(
		java.lang.String idCountry)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchCountryException {
		return getPersistence().findByPrimaryKey(idCountry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFCountry fetchByPrimaryKey(
		java.lang.String idCountry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(idCountry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.ethica.esf.model.ESFCountry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ESFCountryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ESFCountryPersistence)PortletBeanLocatorUtil.locate(it.ethica.esf.service.ClpSerializer.getServletContextName(),
					ESFCountryPersistence.class.getName());

			ReferenceRegistry.registerReference(ESFCountryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ESFCountryPersistence persistence) {
	}

	private static ESFCountryPersistence _persistence;
}