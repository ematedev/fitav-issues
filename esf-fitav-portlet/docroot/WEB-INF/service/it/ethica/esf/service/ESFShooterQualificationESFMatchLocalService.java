...
/**
 * Provides the local service interface for ESFShooterQualificationESFMatch. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFShooterQualificationESFMatchLocalServiceUtil
...
public interface ESFShooterQualificationESFMatchLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFShooterQualificationESFMatchLocalServiceUtil} to access the e s f shooter qualification e s f match local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFShooterQualificationESFMatchLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
