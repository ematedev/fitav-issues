...
/**
 * Provides the local service interface for ESFDocument. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFDocumentLocalServiceUtil
...
public interface ESFDocumentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFDocumentLocalServiceUtil} to access the e s f document local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFDocumentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
