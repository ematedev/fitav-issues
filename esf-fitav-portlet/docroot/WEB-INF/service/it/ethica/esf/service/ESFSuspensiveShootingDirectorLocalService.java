...
/**
 * Provides the local service interface for ESFSuspensiveShootingDirector. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFSuspensiveShootingDirectorLocalServiceUtil
...
public interface ESFSuspensiveShootingDirectorLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFSuspensiveShootingDirectorLocalServiceUtil} to access the e s f suspensive shooting director local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFSuspensiveShootingDirectorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
