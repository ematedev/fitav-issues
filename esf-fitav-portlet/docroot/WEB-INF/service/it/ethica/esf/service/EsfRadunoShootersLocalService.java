...
/**
 * Provides the local service interface for EsfRadunoShooters. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see EsfRadunoShootersLocalServiceUtil
...
public interface EsfRadunoShootersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EsfRadunoShootersLocalServiceUtil} to access the esf raduno shooters local service. Add custom service methods to {@link it.ethica.esf.service.impl.EsfRadunoShootersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
