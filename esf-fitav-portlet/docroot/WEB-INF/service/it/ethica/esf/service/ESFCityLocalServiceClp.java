 ...
 * @generated
 */
public class ESFCityLocalServiceClp implements ESFCityLocalService {
	public ESFCityLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public it.ethica.esf.model.ESFCity addESFCity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfCity) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFCity)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFCity createESFCity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(esfCityPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
