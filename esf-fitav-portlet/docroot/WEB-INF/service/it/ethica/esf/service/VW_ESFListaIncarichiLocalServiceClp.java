 ...
 * @generated
 */
public class VW_ESFListaIncarichiLocalServiceClp
	implements VW_ESFListaIncarichiLocalService {
	public VW_ESFListaIncarichiLocalServiceClp(
	...
	public it.ethica.esf.model.VW_ESFListaIncarichi addVW_ESFListaIncarichi(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(vw_esfListaIncarichi)
					});
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.VW_ESFListaIncarichi)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.VW_ESFListaIncarichi createVW_ESFListaIncarichi(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(vw_esfListaIncarichiPK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.VW_ESFListaIncarichi> getVW_ESFListaIncarichis(
		...
		return (java.util.List<it.ethica.esf.model.VW_ESFListaIncarichi>)ClpSerializer.translateOutput(returnObj);
	}
