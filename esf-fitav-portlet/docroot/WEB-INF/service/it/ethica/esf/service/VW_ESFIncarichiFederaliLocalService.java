...
/**
 * Provides the local service interface for VW_ESFIncarichiFederali. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_ESFIncarichiFederaliLocalServiceUtil
...
public interface VW_ESFIncarichiFederaliLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_ESFIncarichiFederaliLocalServiceUtil} to access the v w_ e s f incarichi federali local service. Add custom service methods to {@link it.ethica.esf.service.impl.VW_ESFIncarichiFederaliLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
