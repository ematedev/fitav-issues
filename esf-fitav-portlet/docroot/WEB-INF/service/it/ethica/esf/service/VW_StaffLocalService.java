...
/**
 * Provides the local service interface for VW_Staff. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_StaffLocalServiceUtil
...
public interface VW_StaffLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_StaffLocalServiceUtil} to access the v w_ staff local service. Add custom service methods to {@link it.ethica.esf.service.impl.VW_StaffLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
