...
/**
 * Provides the local service interface for VW_ESFListaIncarichi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_ESFListaIncarichiLocalServiceUtil
...
public interface VW_ESFListaIncarichiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_ESFListaIncarichiLocalServiceUtil} to access the v w_ e s f lista incarichi local service. Add custom service methods to {@link it.ethica.esf.service.impl.VW_ESFListaIncarichiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
