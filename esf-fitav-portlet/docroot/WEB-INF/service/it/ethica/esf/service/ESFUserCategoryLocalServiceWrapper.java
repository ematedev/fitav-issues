	...
	*/
	...
	public it.ethica.esf.model.ESFUserCategory addEsfUserCategory(long userId,
		...
		return _esfUserCategoryLocalService.addEsfUserCategory(userId,
			esfUserId, esfCategoryId, esfSportTypeId, serviceContext);
	}
	...
	public it.ethica.esf.model.ESFUserCategory updateEsfUserCategory(
		...
		return _esfUserCategoryLocalService.updateEsfUserCategory(userId,
			esfUserCategoryId, esfUserId, esfCategoryId, esfSportTypeId,
			serviceContext);
	}
	...
	public it.ethica.esf.model.ESFUserCategory findByU_C_S(long esfUserId,
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchUserCategoryException {
		return _esfUserCategoryLocalService.findByU_C_S(esfUserId,
	...
	public java.util.List<it.ethica.esf.model.ESFUserCategory> findYouthNotPromoved(
		int year) {
		return _esfUserCategoryLocalService.findYouthNotPromoved(year);
	}
