...
/**
 * Provides the local service interface for Province. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ProvinceLocalServiceUtil
...
public interface ProvinceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProvinceLocalServiceUtil} to access the province local service. Add custom service methods to {@link it.ethica.esf.service.impl.ProvinceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
