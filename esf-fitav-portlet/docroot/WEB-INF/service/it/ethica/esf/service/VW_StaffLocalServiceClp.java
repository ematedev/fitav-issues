 ...
 * @generated
 */
public class VW_StaffLocalServiceClp implements VW_StaffLocalService {
	public VW_StaffLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public it.ethica.esf.model.VW_Staff addVW_Staff(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(vw_Staff) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.VW_Staff)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.VW_Staff createVW_Staff(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(vw_StaffPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.VW_Staff> getVW_Staffs(
		...
		return (java.util.List<it.ethica.esf.model.VW_Staff>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.VW_Staff cercaStaff(long userId)
		...
		try {
			...
			if (t instanceof it.ethica.esf.NoSuchVW_StaffException) {
				throw (it.ethica.esf.NoSuchVW_StaffException)t;
			}
