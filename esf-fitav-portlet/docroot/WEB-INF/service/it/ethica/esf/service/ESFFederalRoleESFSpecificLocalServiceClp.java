 ...
 * @generated
 */
public class ESFFederalRoleESFSpecificLocalServiceClp
	implements ESFFederalRoleESFSpecificLocalService {
	public ESFFederalRoleESFSpecificLocalServiceClp(
		...
		_methodName20 = "findBySpecificId";
	...
	public it.ethica.esf.model.ESFFederalRoleESFSpecific addESFFederalRoleESFSpecific(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(esfFederalRoleESFSpecific)
					});
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFFederalRoleESFSpecific)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.ethica.esf.model.ESFFederalRoleESFSpecific> getESFFederalRoleESFSpecifics(
		...
		return (java.util.List<it.ethica.esf.model.ESFFederalRoleESFSpecific>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.ethica.esf.model.ESFFederalRoleESFSpecific> findBySpecificId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					_methodParameterTypes20, new Object[] { esfSpecificId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
