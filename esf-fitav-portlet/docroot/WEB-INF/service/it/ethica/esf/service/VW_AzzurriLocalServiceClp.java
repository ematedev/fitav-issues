 ...
 * @generated
 */
public class VW_AzzurriLocalServiceClp implements VW_AzzurriLocalService {
	public VW_AzzurriLocalServiceClp(
	...
	public it.ethica.esf.model.VW_Azzurri addVW_Azzurri(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(vw_Azzurri) });
		}
		catch (Throwable t) {
	...
	public it.ethica.esf.model.VW_Azzurri createVW_Azzurri(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(vw_AzzurriPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.VW_Azzurri> getVW_Azzurris(
		...
		return (java.util.List<it.ethica.esf.model.VW_Azzurri>)ClpSerializer.translateOutput(returnObj);
	}
