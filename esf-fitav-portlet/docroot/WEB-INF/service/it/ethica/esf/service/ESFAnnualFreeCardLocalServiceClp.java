 ...
 * @generated
 */
public class ESFAnnualFreeCardLocalServiceClp
	implements ESFAnnualFreeCardLocalService {
	public ESFAnnualFreeCardLocalServiceClp(
	...
	public it.ethica.esf.model.ESFAnnualFreeCard addESFAnnualFreeCard(
		...
		return (it.ethica.esf.model.ESFAnnualFreeCard)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFAnnualFreeCard createESFAnnualFreeCard(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { annualFreeCardId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFAnnualFreeCard deleteESFAnnualFreeCard(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { annualFreeCardId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFAnnualFreeCard fetchESFAnnualFreeCard(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { annualFreeCardId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFAnnualFreeCard getESFAnnualFreeCard(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { annualFreeCardId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFAnnualFreeCard> getESFAnnualFreeCards(
		...
		return (java.util.List<it.ethica.esf.model.ESFAnnualFreeCard>)ClpSerializer.translateOutput(returnObj);
	}
