...
/**
 * Provides the local service interface for ESFAnnualFreeCard. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFAnnualFreeCardLocalServiceUtil
...
public interface ESFAnnualFreeCardLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFAnnualFreeCardLocalServiceUtil} to access the e s f annual free card local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFAnnualFreeCardLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
