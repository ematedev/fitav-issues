...
public class ESFAddressLocalServiceUtil {
	...
	*/
	...
	public static it.ethica.esf.model.ESFAddress newESFAddress() {
		return getService().newESFAddress();
	}
	...
	public static java.lang.String getNameRegion(java.lang.String idRegion)
		throws com.liferay.portal.NoSuchModelException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getNameRegion(idRegion);
	}

	public static java.lang.String getNameProvince(java.lang.String idRegion,
		java.lang.String idProvince)
		throws com.liferay.portal.NoSuchModelException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getNameProvince(idRegion, idProvince);
	}

	public static java.lang.String getNameCity(java.lang.String idRegion,
		java.lang.String idProvince, long idCity)
		throws com.liferay.portal.NoSuchModelException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getNameCity(idRegion, idProvince, idCity);
	}

	public static java.util.List<it.ethica.esf.model.ESFCountry> findAllCountry()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findAllCountry();
	}

	public static java.util.List<it.ethica.esf.model.ESFCountry> findAllCountry(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findAllCountry(start, end);
	}

	public static java.util.List<it.ethica.esf.model.ESFRegion> findAllRegions()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static java.util.List<it.ethica.esf.model.ESFRegion> findByCountry(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByCountry(idCountry);
	}

	public static java.util.List<it.ethica.esf.model.ESFRegion> findByCountry(
		java.lang.String idCountry, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByCountry(idCountry, start, end);
	}
	...
	public static java.util.List<it.ethica.esf.model.ESFProvince> findByC_R(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByC_R(idRegion, idCountry);
	}

	public static java.util.List<it.ethica.esf.model.ESFProvince> findByC_R(
		java.lang.String idRegion, java.lang.String idCountry, int start,
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByC_R(idRegion, idCountry, start, end);
	}
	...
	public static java.util.List<it.ethica.esf.model.ESFCity> findByC_R_P(
		...
		java.lang.String idProvince)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByC_R_P(idCountry, idRegion, idProvince);
	}
	...
	public static it.ethica.esf.model.ESFAddress addESFAddress(long userId,
		...
		return getService()
			...
			esfProvinceId, esfCityId, latitude, type, listTypeId, className,
			classPk, street1, street2, street3, zip, typeId, mailing, primary,
			isNotNational, serviceContext);
	}
	...
	*/
	public static it.ethica.esf.model.ESFAddress updateESFAddress(long userId,
		...
		return getService()
			...
			esfRegionId, esfProvinceId, esfCityId, latitude, longitude, type,
			listTypeId, className, classPk, street1, street2, street3, zip,
			typeId, mailing, primary, isNotNational, serviceContext);
	}
