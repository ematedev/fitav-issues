...
public class ESFEntityStateLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<it.ethica.esf.model.ESFEntityState> findESFEntityStateCName_CPk(
		java.lang.String className, long classPk)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findESFEntityStateCName_CPk(className, classPk);
	}
	...
	*/
	...
	public static java.util.List<it.ethica.esf.model.ESFEntityState> findESShooterLastCardActive(
		long shooterId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findESShooterLastCardActive(shooterId);
	}
