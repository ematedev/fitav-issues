...
/**
 * Provides the local service interface for VW_Shooters. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see VW_ShootersLocalServiceUtil
...
public interface VW_ShootersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VW_ShootersLocalServiceUtil} to access the v w_ shooters local service. Add custom service methods to {@link it.ethica.esf.service.impl.VW_ShootersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
