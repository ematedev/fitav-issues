 ...
 * @generated
 */
public class ESFTournamentLocalServiceClp implements ESFTournamentLocalService {
	public ESFTournamentLocalServiceClp(
		...
		_methodName23 = "findESFTournamentsByState";

		_methodParameterTypes23 = new String[] { "int" };

		_methodName24 = "findESFTournamentsByState";

		_methodParameterTypes24 = new String[] { "int", "int", "int" };

		_methodName25 = "findESFTournamentsByOrganizationId";

		_methodParameterTypes25 = new String[] {
				"long", "boolean", "int", "boolean"
			};

		_methodName26 = "findESFTournamentsByOrganizationId";

		_methodParameterTypes26 = new String[] {
				"long", "boolean", "int", "boolean", "int", "int"
			};

		_methodName27 = "addESFTournament";
		...
		_methodName28 = "deleteESFTournament";

		_methodParameterTypes28 = new String[] {
				"long", "com.liferay.portal.service.ServiceContext"
			};

		_methodName29 = "updateESFTournament";
	...
	public it.ethica.esf.model.ESFTournament addESFTournament(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfTournament) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFTournament)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFTournament createESFTournament(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { esfTournamentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFTournament deleteESFTournament(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { esfTournamentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFTournament fetchESFTournament(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { esfTournamentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFTournament getESFTournament(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName13,
					_methodParameterTypes13, new Object[] { esfTournamentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFTournament> getESFTournaments(
		...
		return (java.util.List<it.ethica.esf.model.ESFTournament>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<it.ethica.esf.model.ESFTournament> findESFTournamentsByState(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					_methodParameterTypes23, new Object[] { state });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFTournament> findESFTournamentsByState(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName24,
					_methodParameterTypes24, new Object[] { state, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFTournament> findESFTournamentsByOrganizationId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					...
					new Object[] { organizationId, isLeaf, state, isNationalMatch });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFTournament addESFTournament(long userId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName27,
					...
					ClpSerializer.translateInput(esfTeams),
	...
	public it.ethica.esf.model.ESFTournament updateESFTournament(long userId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName29,
					...
					ClpSerializer.translateInput(qualifications),
