...
/**
 * The persistence utility for the e s f instructs shooting director service. This utility wraps {@link ESFInstructsShootingDirectorPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ESFInstructsShootingDirectorPersistenceImpl
 * @generated
 */
public class ESFInstructsShootingDirectorUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(esfInstructsShootingDirector);
	}
	 ...
	 */
	public static List<ESFInstructsShootingDirector> findWithDynamicQuery(
	 ...
	 */
	public static ESFInstructsShootingDirector update(
		ESFInstructsShootingDirector esfInstructsShootingDirector)
		throws SystemException {
		return getPersistence().update(esfInstructsShootingDirector);
	}
	...
	public static ESFInstructsShootingDirector update(
		...
		return getPersistence()
				   .update(esfInstructsShootingDirector, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(esfInstructsShootingDirector);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<it.ethica.esf.model.ESFInstructsShootingDirector> esfInstructsShootingDirectors) {
		getPersistence().cacheResult(esfInstructsShootingDirectors);
	}
	...
	*/
	public static it.ethica.esf.model.ESFInstructsShootingDirector create(
		long esfInstructsShootingDirectorId) {
		return getPersistence().create(esfInstructsShootingDirectorId);
	}
	...
	*/
	public static it.ethica.esf.model.ESFInstructsShootingDirector remove(
		long esfInstructsShootingDirectorId)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchInstructsShootingDirectorException {
		return getPersistence().remove(esfInstructsShootingDirectorId);
	}

	public static it.ethica.esf.model.ESFInstructsShootingDirector updateImpl(
		it.ethica.esf.model.ESFInstructsShootingDirector esfInstructsShootingDirector)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(esfInstructsShootingDirector);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFInstructsShootingDirector findByPrimaryKey(
		long esfInstructsShootingDirectorId)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchInstructsShootingDirectorException {
		return getPersistence().findByPrimaryKey(esfInstructsShootingDirectorId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFInstructsShootingDirector fetchByPrimaryKey(
		long esfInstructsShootingDirectorId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(esfInstructsShootingDirectorId);
	}
	...
	*/
	...
	public static ESFInstructsShootingDirectorPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ESFInstructsShootingDirectorPersistence)PortletBeanLocatorUtil.locate(it.ethica.esf.service.ClpSerializer.getServletContextName(),
					ESFInstructsShootingDirectorPersistence.class.getName());

			ReferenceRegistry.registerReference(ESFInstructsShootingDirectorUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(
		ESFInstructsShootingDirectorPersistence persistence) {
	}

	private static ESFInstructsShootingDirectorPersistence _persistence;
}