...
/**
 * Provides the local service interface for ESFConfiguration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFConfigurationLocalServiceUtil
...
public interface ESFConfigurationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFConfigurationLocalServiceUtil} to access the e s f configuration local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFConfigurationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
