...
public class CountryWrapper implements Country, ModelWrapper<Country> {
	...
	*/
	...
	public void setIdCountry(java.lang.String idCountry) {
		_country.setIdCountry(idCountry);
	}
	...
	*/
	...
	@Override
	public int compareTo(it.ethica.esf.model.Country country) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<it.ethica.esf.model.Country> toCacheModel() {
		return _country.toCacheModel();
	}

	@Override
	public it.ethica.esf.model.Country toEscapedModel() {
		return new CountryWrapper(_country.toEscapedModel());
	}

	@Override
	public it.ethica.esf.model.Country toUnescapedModel() {
