...
public class ESFAddressClp extends BaseModelImpl<ESFAddress>
	...
	public void setType(String type) {
		...
		if (_esfAddressRemoteModel != null) {
			try {
				...
				method.invoke(_esfAddressRemoteModel, type);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsNotNational(boolean isNotNational) {
		...
		if (_esfAddressRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIsNotNational",
						boolean.class);

				method.invoke(_esfAddressRemoteModel, isNotNational);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setListTypeId(int listTypeId) {
		...
		if (_esfAddressRemoteModel != null) {
			try {
				...
				method.invoke(_esfAddressRemoteModel, listTypeId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setIsNotNational(getIsNotNational());
