 ...
 * @generated
 */
public class ESFOrganization_ReengineeredSoap implements Serializable {
	public static ESFOrganization_ReengineeredSoap toSoapModel(
		ESFOrganization_Reengineered model) {
		ESFOrganization_ReengineeredSoap soapModel = new ESFOrganization_ReengineeredSoap();
	...
	public static ESFOrganization_ReengineeredSoap[] toSoapModels(
		ESFOrganization_Reengineered[] models) {
		ESFOrganization_ReengineeredSoap[] soapModels = new ESFOrganization_ReengineeredSoap[models.length];
	...
	public static ESFOrganization_ReengineeredSoap[][] toSoapModels(
		ESFOrganization_Reengineered[][] models) {
		ESFOrganization_ReengineeredSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ESFOrganization_ReengineeredSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ESFOrganization_ReengineeredSoap[0][0];
		}
	...
	public static ESFOrganization_ReengineeredSoap[] toSoapModels(
		List<ESFOrganization_Reengineered> models) {
		List<ESFOrganization_ReengineeredSoap> soapModels = new ArrayList<ESFOrganization_ReengineeredSoap>(models.size());

		for (ESFOrganization_Reengineered model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ESFOrganization_ReengineeredSoap[soapModels.size()]);
	}

	public ESFOrganization_ReengineeredSoap() {
	}
