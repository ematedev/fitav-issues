...
public class ESFAddressWrapper implements ESFAddress, ModelWrapper<ESFAddress> {
	...
	*/
	...
	/**
	* Returns the is not national of this e s f address.
	*
	* @return the is not national of this e s f address
	*/
	@Override
	public boolean getIsNotNational() {
		return _esfAddress.getIsNotNational();
	}

	/**
	* Returns <code>true</code> if this e s f address is is not national.
	*
	* @return <code>true</code> if this e s f address is is not national; <code>false</code> otherwise
	*/
	@Override
	public boolean isIsNotNational() {
		return _esfAddress.isIsNotNational();
	}

	/**
	* Sets whether this e s f address is is not national.
	*
	* @param isNotNational the is not national of this e s f address
	*/
	@Override
	public void setIsNotNational(boolean isNotNational) {
		_esfAddress.setIsNotNational(isNotNational);
	}
