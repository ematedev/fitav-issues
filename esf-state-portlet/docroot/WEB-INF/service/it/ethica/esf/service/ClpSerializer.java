...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"esf-state-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "esf-state-portlet";
			}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("it.ethica.esf.ESFEStateDateException")) {
			return new it.ethica.esf.ESFEStateDateException();
		}

		if (className.equals("it.ethica.esf.ESFStateDescriptionException")) {
			return new it.ethica.esf.ESFStateDescriptionException();
		}

		if (className.equals("it.ethica.esf.ESFStateNameException")) {
			return new it.ethica.esf.ESFStateNameException();
		}
