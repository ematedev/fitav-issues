...
public class ESFStatePersistenceImpl extends BasePersistenceImpl<ESFState>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, ESFStateImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, ESFStateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			ESFStateModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ESFState> findByUuid(String uuid) throws SystemException {
	 ...
	 */
	@Override
	public List<ESFState> findByUuid(String uuid, int start, int end)
	...
	public List<ESFState> findByUuid(String uuid, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFState esfState : list) {
				if (!Validator.equals(uuid, esfState.getUuid())) {
					list = null;
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(ESFStateModelImpl.ORDER_BY_JPQL);
			}
	 ...
	 */
	@Override
	public ESFState findByUuid_First(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateException, SystemException {
		ESFState esfState = fetchByUuid_First(uuid, orderByComparator);
	 ...
	 */
	@Override
	public ESFState fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFState> list = findByUuid(uuid, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ESFState findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateException, SystemException {
		ESFState esfState = fetchByUuid_Last(uuid, orderByComparator);
	 ...
	 */
	@Override
	public ESFState fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFState> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFState[] findByUuid_PrevAndNext(long esfStateId, String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStateException, SystemException {
		ESFState esfState = findByPrimaryKey(esfStateId);
		...
		try {
			...
			ESFState[] array = new ESFStateImpl[3];

			array[0] = getByUuid_PrevAndNext(session, esfState, uuid,
					orderByComparator, true);

			array[1] = esfState;

			array[2] = getByUuid_PrevAndNext(session, esfState, uuid,
	...
	protected ESFState getByUuid_PrevAndNext(Session session,
		ESFState esfState, String uuid, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(esfState);
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (ESFState esfState : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "esfState.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "esfState.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(esfState.uuid IS NULL OR esfState.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, ESFStateImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			ESFStateModelImpl.UUID_COLUMN_BITMASK |
			ESFStateModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public ESFState findByUUID_G(String uuid, long groupId)
		throws NoSuchStateException, SystemException {
		ESFState esfState = fetchByUUID_G(uuid, groupId);
	 ...
	 */
	@Override
	public ESFState fetchByUUID_G(String uuid, long groupId)
		throws SystemException {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((esfState.getUuid() == null) ||
							!esfState.getUuid().equals(uuid) ||
							(esfState.getGroupId() != groupId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, esfState);
					}
				}
	 ...
	 */
	@Override
	public ESFState removeByUUID_G(String uuid, long groupId)
		throws NoSuchStateException, SystemException {
		ESFState esfState = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "esfState.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "esfState.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(esfState.uuid IS NULL OR esfState.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "esfState.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, ESFStateImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, ESFStateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			ESFStateModelImpl.UUID_COLUMN_BITMASK |
			ESFStateModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(ESFStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFStateModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ESFState> findByUuid_C(String uuid, long companyId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<ESFState> findByUuid_C(String uuid, long companyId, int start,
	...
	public List<ESFState> findByUuid_C(String uuid, long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFState esfState : list) {
				if (!Validator.equals(uuid, esfState.getUuid()) ||
						(companyId != esfState.getCompanyId())) {
					list = null;
	 ...
	 */
	@Override
	public ESFState findByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchStateException, SystemException {
		ESFState esfState = fetchByUuid_C_First(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFState fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFState> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFState findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchStateException, SystemException {
		ESFState esfState = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFState fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFState> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFState[] findByUuid_C_PrevAndNext(long esfStateId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, esfState, uuid,
					companyId, orderByComparator, true);

			array[1] = esfState;

			array[2] = getByUuid_C_PrevAndNext(session, esfState, uuid,
	...
	protected ESFState getByUuid_C_PrevAndNext(Session session,
		ESFState esfState, String uuid, long companyId,
	...
	public void removeByUuid_C(String uuid, long companyId)
		throws SystemException {
		for (ESFState esfState : findByUuid_C(uuid, companyId,
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "esfState.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "esfState.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(esfState.uuid IS NULL OR esfState.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "esfState.companyId = ?";
	...
	public void cacheResult(ESFState esfState) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { esfState.getUuid(), esfState.getGroupId() }, esfState);
	...
	protected void cacheUniqueFindersCache(ESFState esfState) {
		if (esfState.isNew()) {
			Object[] args = new Object[] {
					esfState.getUuid(), esfState.getGroupId()
				};
	...
	protected void clearUniqueFindersCache(ESFState esfState) {
		...
		Object[] args = new Object[] { esfState.getUuid(), esfState.getGroupId() };
		...
		if ((esfStateModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_UUID_G.getColumnBitmask()) != 0) {
			args = new Object[] {
					esfStateModelImpl.getOriginalUuid(),
					esfStateModelImpl.getOriginalGroupId()
				};
	...
	public ESFState updateImpl(it.ethica.esf.model.ESFState esfState)
		...
		if (Validator.isNull(esfState.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !ESFStateModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfStateModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { esfStateModelImpl.getOriginalUuid() };

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
					args);

				args = new Object[] { esfStateModelImpl.getUuid() };
			...
			if ((esfStateModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						esfStateModelImpl.getOriginalUuid(),
						esfStateModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] {
						esfStateModelImpl.getUuid(),
						esfStateModelImpl.getCompanyId()
					};
	...
	protected ESFState toUnwrappedModel(ESFState esfState) {
		...
		esfStateImpl.setUuid(esfState.getUuid());
		esfStateImpl.setEsfStateId(esfState.getEsfStateId());
		esfStateImpl.setGroupId(esfState.getGroupId());
		esfStateImpl.setCompanyId(esfState.getCompanyId());
		esfStateImpl.setUserId(esfState.getUserId());
		esfStateImpl.setUserName(esfState.getUserName());
		esfStateImpl.setCreateDate(esfState.getCreateDate());
		esfStateImpl.setModifiedDate(esfState.getModifiedDate());
		esfStateImpl.setEsfName(esfState.getEsfName());
		esfStateImpl.setEsfDescription(esfState.getEsfDescription());
