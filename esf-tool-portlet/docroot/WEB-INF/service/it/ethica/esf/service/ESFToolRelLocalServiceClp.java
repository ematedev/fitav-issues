 ...
 * @generated
 */
public class ESFToolRelLocalServiceClp implements ESFToolRelLocalService {
	public ESFToolRelLocalServiceClp(
	...
	public it.ethica.esf.model.ESFToolRel addESFToolRel(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfToolRel) });
		}
		catch (Throwable t) {
	...
	public it.ethica.esf.model.ESFToolRel createESFToolRel(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(esfToolRelPK) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFToolRel> getESFToolRels(
		...
		return (java.util.List<it.ethica.esf.model.ESFToolRel>)ClpSerializer.translateOutput(returnObj);
	}
