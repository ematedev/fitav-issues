...
/**
 * The base model interface for the ESFToolRel service. Represents a row in the &quot;ESF_ESFToolRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link it.ethica.esf.model.impl.ESFToolRelModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link it.ethica.esf.model.impl.ESFToolRelImpl}.
 * </p>
 *
 * @author Ethica
 * @see ESFToolRel
 ...
 * @generated
 */
public interface ESFToolRelModel extends BaseModel<ESFToolRel>,
	StagedGroupedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a e s f tool rel model instance should use the {@link ESFToolRel} interface instead.
	 */
	...
	@Override
	public ESFToolRel toUnescapedModel();
