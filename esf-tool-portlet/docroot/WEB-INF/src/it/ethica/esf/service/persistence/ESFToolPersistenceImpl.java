...
public class ESFToolPersistenceImpl extends BasePersistenceImpl<ESFTool>
	...
	private static final String _FILTER_SQL_SELECT_ESFTOOL_WHERE = "SELECT DISTINCT {esfTool.*} FROM ESF_ESFTool esfTool WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFTOOL_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {ESF_ESFTool.*} FROM (SELECT DISTINCT esfTool.esfToolId FROM ESF_ESFTool esfTool WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFTOOL_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN ESF_ESFTool ON TEMP_TABLE.esfToolId = ESF_ESFTool.esfToolId";
	private static final String _FILTER_SQL_COUNT_ESFTOOL_WHERE = "SELECT COUNT(DISTINCT esfTool.esfToolId) AS COUNT_VALUE FROM ESF_ESFTool esfTool WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "esfTool";
	private static final String _FILTER_ENTITY_TABLE = "ESF_ESFTool";
	private static final String _ORDER_BY_ENTITY_ALIAS = "esfTool.";
	private static final String _ORDER_BY_ENTITY_TABLE = "ESF_ESFTool.";
