...
public class ESFAddressClp extends BaseModelImpl<ESFAddress>
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String esfCityId = (String)attributes.get("esfCityId");
	...
	@Override
	public String getEsfCityId() {
		return _esfCityId;
	}

	@Override
	public void setEsfCityId(String esfCityId) {
		...
		if (_esfAddressRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setEsfCityId", String.class);
