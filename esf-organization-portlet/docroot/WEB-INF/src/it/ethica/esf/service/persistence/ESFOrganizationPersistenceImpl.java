...
public class ESFOrganizationPersistenceImpl extends BasePersistenceImpl<ESFOrganization>
	 ...
	 */
	@Override
	public ESFOrganization findByG_C(String code)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = fetchByG_C(code);
	 ...
	 */
	@Override
	public ESFOrganization fetchByG_C(String code) throws SystemException {
		return fetchByG_C(code, true);
	}
	 ...
	 */
	@Override
	public ESFOrganization fetchByG_C(String code, boolean retrieveFromCache)
		throws SystemException {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFOrganizationPersistenceImpl.fetchByG_C(String, boolean) with parameters (" +
	 ...
	 */
	@Override
	public ESFOrganization removeByG_C(String code)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = findByG_C(code);
	 ...
	 */
	@Override
	public int countByG_C(String code) throws SystemException {
	...
	private static final String _FINDER_COLUMN_G_C_CODE_1 = "esfOrganization.code IS NULL";
	private static final String _FINDER_COLUMN_G_C_CODE_2 = "esfOrganization.code = ?";
	private static final String _FINDER_COLUMN_G_C_CODE_3 = "(esfOrganization.code IS NULL OR esfOrganization.code = '')";
	 ...
	 */
	@Override
	public ESFOrganization findByG_V(String vat)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = fetchByG_V(vat);
	 ...
	 */
	@Override
	public ESFOrganization fetchByG_V(String vat) throws SystemException {
		return fetchByG_V(vat, true);
	}
	 ...
	 */
	@Override
	public ESFOrganization fetchByG_V(String vat, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFOrganizationPersistenceImpl.fetchByG_V(String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
	 ...
	 */
	@Override
	public ESFOrganization removeByG_V(String vat)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = findByG_V(vat);
	 ...
	 */
	@Override
	public int countByG_V(String vat) throws SystemException {
	...
	private static final String _FINDER_COLUMN_G_V_VAT_1 = "esfOrganization.vat IS NULL";
	private static final String _FINDER_COLUMN_G_V_VAT_2 = "esfOrganization.vat = ?";
	private static final String _FINDER_COLUMN_G_V_VAT_3 = "(esfOrganization.vat IS NULL OR esfOrganization.vat = '')";
	 ...
	 */
	@Override
	public ESFOrganization findByG_F(String fiscalCode)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = fetchByG_F(fiscalCode);
	 ...
	 */
	@Override
	public ESFOrganization fetchByG_F(String fiscalCode)
		throws SystemException {
		return fetchByG_F(fiscalCode, true);
	}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFOrganizationPersistenceImpl.fetchByG_F(String, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
	 ...
	 */
	@Override
	public ESFOrganization removeByG_F(String fiscalCode)
		throws NoSuchOrganizationException, SystemException {
		ESFOrganization esfOrganization = findByG_F(fiscalCode);
	 ...
	 */
	@Override
	public int countByG_F(String fiscalCode) throws SystemException {
	...
	private static final String _FINDER_COLUMN_G_F_FISCALCODE_1 = "esfOrganization.fiscalCode IS NULL";
	private static final String _FINDER_COLUMN_G_F_FISCALCODE_2 = "esfOrganization.fiscalCode = ?";
	private static final String _FINDER_COLUMN_G_F_FISCALCODE_3 = "(esfOrganization.fiscalCode IS NULL OR esfOrganization.fiscalCode = '')";
	...
	private static final String _FILTER_SQL_SELECT_ESFORGANIZATION_WHERE = "SELECT DISTINCT {esfOrganization.*} FROM ESF_ESFOrganization esfOrganization WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFORGANIZATION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {ESF_ESFOrganization.*} FROM (SELECT DISTINCT esfOrganization.esfOrganizationId FROM ESF_ESFOrganization esfOrganization WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFORGANIZATION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN ESF_ESFOrganization ON TEMP_TABLE.esfOrganizationId = ESF_ESFOrganization.esfOrganizationId";
	private static final String _FILTER_SQL_COUNT_ESFORGANIZATION_WHERE = "SELECT COUNT(DISTINCT esfOrganization.esfOrganizationId) AS COUNT_VALUE FROM ESF_ESFOrganization esfOrganization WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "esfOrganization";
	private static final String _FILTER_ENTITY_TABLE = "ESF_ESFOrganization";
	private static final String _ORDER_BY_ENTITY_ALIAS = "esfOrganization.";
	private static final String _ORDER_BY_ENTITY_TABLE = "ESF_ESFOrganization.";
