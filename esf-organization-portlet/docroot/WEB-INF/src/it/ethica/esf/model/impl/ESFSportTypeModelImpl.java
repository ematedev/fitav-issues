...
/**
 * The base model implementation for the ESFSportType service. Represents a row in the &quot;ESF_ESFSportType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ESFSportTypeModelImpl extends BaseModelImpl<ESFSportType>
	 ...
	 */
	public static final String TABLE_NAME = "ESF_ESFSportType";
	...
	public static final String TABLE_SQL_CREATE = "create table ESF_ESFSportType (uuid_ VARCHAR(75) null,esfSportTypeId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table ESF_ESFSportType";
	public static final String ORDER_BY_JPQL = " ORDER BY esfSportType.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY ESF_ESFSportType.name ASC";
