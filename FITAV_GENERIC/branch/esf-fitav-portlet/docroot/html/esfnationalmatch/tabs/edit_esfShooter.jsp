...
<%
		...
		boolean show = ESFNationalMatchMPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_VIEW_SHOOTER);
	%>
...
<liferay-ui:error key="esfCard-noFind-reference-error" message="esfCard-noFind-reference-error"/>
	...
	<aui:form action="<%=editESFShooterURL.toString()%>" name="fm">
