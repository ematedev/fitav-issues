...
<liferay-ui:search-container emptyResultsMessage="no-results" iteratorURL="<%=viewassURL %>" curParam="AllShooters">
			...
			<liferay-ui:search-container-results
				results="<%= ESFNationalLocalServiceUtil.findNationalbySportId_MatchId(idSport.get(1), esfMatchId,
						searchContainer.getStart(),searchContainer.getEnd())%>"
				total="<%= ESFNationalLocalServiceUtil.countNationalbySportId_MatchId(idSport.get(1), esfMatchId)%>" />
