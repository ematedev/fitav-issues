...
<portlet:renderURL var="chooseAssociationURL"
	...
	<portlet:param name="mvcPath"
		value='<%="/html/esfnationalmatch/popup/view.jsp"%>'></portlet:param>
</portlet:renderURL>
...
<portlet:actionURL name="changeCard" var="changeCard">
		...
		<portlet:param name="mvcPath"
					value="tabs/edit_esfShooter.jsp"/>
...
<portlet:renderURL var="backURL">
	<portlet:param name="esfUserId" value="<%=String.valueOf(esfUserId)%>" />
		...
		<portlet:param name="organizationId"
				value="<%= String.valueOf(currentOrganizationId)%>" />
		<portlet:param name="mvcPath"
					value='<%=templatePath+"tabs/edit_esfShooter.jsp" %>'/>
		<portlet:param name="op" value="updAddr" />
...
<aui:fieldset>
	<%
		...
		%>
			...
			<aui:input type="hidden" label="associationsID" id="associations" name="associations" required ="required" readonly="true" inlineField="true"/>	
