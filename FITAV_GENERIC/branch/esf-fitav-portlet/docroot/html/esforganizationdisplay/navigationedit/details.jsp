...
<%
	...
	String readOnlyCode="";
	if(ESFOrganizationDisplayPermission.contains(permissionChecker,currentOrganizationId, ActionKeys.ESFORGANIZATIONDISPLAY_UPDATE_CODE)){
		readOnlyCode=readOnly;
	}
		
	String readOnlyName="";
	if(ESFOrganizationDisplayPermission.contains(permissionChecker,currentOrganizationId, ActionKeys.ESFORGANIZATIONDISPLAY_UPDATE_NAME)){
		readOnlyName=readOnly;
	}
	
	boolean readOnlyField=false;
	if(!ESFOrganizationDisplayPermission.contains(permissionChecker,currentOrganizationId, ActionKeys.ESFORGANIZATIONDISPLAY_UPDATE_ADDRESS_FIELD)){
		readOnlyField=true;
	}
	
	String readOnlyAffiliation="";
	if(ESFOrganizationDisplayPermission.contains(permissionChecker,currentOrganizationId, ActionKeys.ESFORGANIZATIONDISPLAY_UPDATE_AFFILIATION)){
		readOnlyAffiliation=readOnly;
	}
	
	String readOnlyFiscalCode="";
		...
		<div class = "span6">
			<div id="idOne">
				...
				<c:if
					...
					<aui:input name="code"   >
						<aui:validator name="required" <%= readOnlyCode %> 
							errorMessage="this-field-is-required" />
					</aui:input>
				</c:if>

				<aui:input name="name" <%= readOnlyName %>>
	...
	<div class="lfr-form-row lfr-form-row-inline">
		<div class="row-fields">	
			<liferay-util:include page='<%= jspAddressTL %>' servletContext="<%= application%>" >
				...
				<liferay-util:param name="readOnly" value="<%= readOnlyField %>"></liferay-util:param>
	...
	<div class="row">
		<div class="span6">
			<div id="idOne">
				...
				<aui:input name="firstAffiliationDate" type="text"  <%= readOnlyAffiliation %>  >
		...
		<div class="span6">
			<div id="idOne">
				...
				<aui:input name="fiscalCode"  <%= readOnlyFiscalCode %> >
					<aui:validator name="required"
						errorMessage="this-field-is-required" />
				</aui:input>
