		...
		<%
			String shooterName = "";
					...
					/*
					 ...
					 if (Validator.isNotNull(gun.getCatridgeCaliber()) ){
					 caneCaliber = String.valueOf(gun.getCatridgeCaliber());
					 }
					 if (Validator.isNotNull(gun.getMeasures()) ){
					 measures = String.valueOf(gun.getMeasures());
					 }
					 if (Validator.isNotNull(gun.getTypeId()) && Validator.isNotNull(ListTypeServiceUtil.getListType(gun.getTypeId())) &&
					 Validator.isNotNull(ListTypeServiceUtil.getListType(gun.getTypeId()).getName())){
					 typology = ListTypeServiceUtil.getListType(gun.getTypeId()).getName();
					 }
					 ...
					 nameGun = gun.getName().toUpperCase();
					 }
					 }
