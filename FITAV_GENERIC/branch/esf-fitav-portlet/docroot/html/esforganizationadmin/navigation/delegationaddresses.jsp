...
%>
	...
	<aui:input name="typeOrg" type="hidden" value="<%= currentType + 1 %>" />
	
	<aui:button name="btnadd" value="add-address" ></aui:button>
		
	<aui:button name="btnrem" value="rem-address" ></aui:button>
