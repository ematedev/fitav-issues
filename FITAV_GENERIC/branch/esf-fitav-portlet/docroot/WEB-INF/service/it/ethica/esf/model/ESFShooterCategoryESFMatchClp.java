 ...
 * @author Ethica
 */
public class ESFShooterCategoryESFMatchClp extends BaseModelImpl<ESFShooterCategoryESFMatch>
	implements ESFShooterCategoryESFMatch {
	public ESFShooterCategoryESFMatchClp() {
	}
	...
	public void setUuid(String uuid) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				Class<?> clazz = _esfShooterCategoryESFMatchRemoteModel.getClass();

				Method method = clazz.getMethod("setUuid", String.class);

				method.invoke(_esfShooterCategoryESFMatchRemoteModel, uuid);
			}
			catch (Exception e) {
	...
	public void setEsfShooterCategoryId(long esfShooterCategoryId) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel,
	...
	public void setEsfMatchId(long esfMatchId) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, esfMatchId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGroupId(long groupId) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCompanyId(long companyId) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_esfShooterCategoryESFMatchRemoteModel != null) {
			try {
				...
				method.invoke(_esfShooterCategoryESFMatchRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getESFShooterCategoryESFMatchRemoteModel() {
		return _esfShooterCategoryESFMatchRemoteModel;
	}

	public void setESFShooterCategoryESFMatchRemoteModel(
		BaseModel<?> esfShooterCategoryESFMatchRemoteModel) {
		_esfShooterCategoryESFMatchRemoteModel = esfShooterCategoryESFMatchRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _esfShooterCategoryESFMatchRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_esfShooterCategoryESFMatchRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			ESFShooterCategoryESFMatchLocalServiceUtil.addESFShooterCategoryESFMatch(this);
		}
		else {
			ESFShooterCategoryESFMatchLocalServiceUtil.updateESFShooterCategoryESFMatch(this);
		}
	}

	@Override
	public ESFShooterCategoryESFMatch toEscapedModel() {
		return (ESFShooterCategoryESFMatch)ProxyUtil.newProxyInstance(ESFShooterCategoryESFMatch.class.getClassLoader(),
			new Class[] { ESFShooterCategoryESFMatch.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		ESFShooterCategoryESFMatchClp clone = new ESFShooterCategoryESFMatchClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ESFShooterCategoryESFMatchClp)) {
			return false;
		}

		ESFShooterCategoryESFMatchClp esfShooterCategoryESFMatch = (ESFShooterCategoryESFMatchClp)obj;
	...
	private BaseModel<?> _esfShooterCategoryESFMatchRemoteModel;
