...
/**
 * The base model interface for the ESFGunKind service. Represents a row in the &quot;ESFGunKind&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link it.ethica.esf.model.impl.ESFGunKindModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link it.ethica.esf.model.impl.ESFGunKindImpl}.
 * </p>
 *
 * @author Ethica
 * @see ESFGunKind
 ...
 * @generated
 */
public interface ESFGunKindModel extends BaseModel<ESFGunKind>,
	StagedGroupedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a e s f gun kind model instance should use the {@link ESFGunKind} interface instead.
	 */
	...
	@Override
	public CacheModel<it.ethica.esf.model.ESFGunKind> toCacheModel();
