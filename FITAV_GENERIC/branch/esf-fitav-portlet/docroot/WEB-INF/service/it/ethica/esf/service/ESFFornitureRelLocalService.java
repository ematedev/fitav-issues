...
/**
 * Provides the local service interface for ESFFornitureRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFFornitureRelLocalServiceUtil
...
public interface ESFFornitureRelLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFFornitureRelLocalServiceUtil} to access the e s f forniture rel local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFFornitureRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
