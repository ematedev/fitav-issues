...
/**
 * The persistence utility for the e s f event type service. This utility wraps {@link ESFEventTypePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ESFEventTypeUtil {
	 ...
	 */
	public static void clearCache(ESFEventType esfEventType) {
		getPersistence().clearCache(esfEventType);
	}
	 ...
	 */
	public static List<ESFEventType> findWithDynamicQuery(
	 ...
	 */
	public static ESFEventType update(ESFEventType esfEventType)
		throws SystemException {
		return getPersistence().update(esfEventType);
	}
	...
	public static ESFEventType update(ESFEventType esfEventType,
		...
		return getPersistence().update(esfEventType, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(esfEventType);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(esfEventTypes);
	}
	...
	*/
	public static it.ethica.esf.model.ESFEventType create(long esfEventTypeId) {
		return getPersistence().create(esfEventTypeId);
	}
	...
	*/
	public static it.ethica.esf.model.ESFEventType remove(long esfEventTypeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchEventTypeException {
		return getPersistence().remove(esfEventTypeId);
	}

	public static it.ethica.esf.model.ESFEventType updateImpl(
		it.ethica.esf.model.ESFEventType esfEventType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(esfEventType);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFEventType findByPrimaryKey(
		long esfEventTypeId)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchEventTypeException {
		return getPersistence().findByPrimaryKey(esfEventTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFEventType fetchByPrimaryKey(
		long esfEventTypeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(esfEventTypeId);
	}
	...
	*/
	...
	public static ESFEventTypePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ESFEventTypePersistence)PortletBeanLocatorUtil.locate(it.ethica.esf.service.ClpSerializer.getServletContextName(),
					ESFEventTypePersistence.class.getName());

			ReferenceRegistry.registerReference(ESFEventTypeUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ESFEventTypePersistence persistence) {
	}

	private static ESFEventTypePersistence _persistence;
}