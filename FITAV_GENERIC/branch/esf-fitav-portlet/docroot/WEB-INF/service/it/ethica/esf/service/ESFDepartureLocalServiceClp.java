 ...
 * @generated
 */
public class ESFDepartureLocalServiceClp implements ESFDepartureLocalService {
	public ESFDepartureLocalServiceClp(
		...
		_methodName20 = "updateEsfDeparture";
		...
		_methodName21 = "findESFDeparturesByESFMatchId";

		_methodParameterTypes21 = new String[] { "long" };

		_methodName22 = "findESFDeparturesByESFMatchId";

		_methodParameterTypes22 = new String[] { "long", "int", "int" };

		_methodName23 = "findDeparturesByCode";

		_methodParameterTypes23 = new String[] { "java.lang.String" };

		_methodName24 = "findDeparturesByCode";

		_methodParameterTypes24 = new String[] { "java.lang.String", "int", "int" };

		_methodName25 = "getByEsfMatchIdEsfUserId";

		_methodParameterTypes25 = new String[] { "long", "long" };

		_methodName26 = "getByEsfMatchIdEsfUserId";

		_methodParameterTypes26 = new String[] { "long", "long", "int", "int" };

		_methodName27 = "getESFDeparturesByEsfMatchId_F_L_L_C_D";
		...
		_methodName28 = "getESFDeparturesByEsfMatchId_F_L_L_C_D";
	...
	public it.ethica.esf.model.ESFDeparture addESFDeparture(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfDeparture) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFDeparture)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFDeparture createESFDeparture(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { esfDepartureId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFDeparture deleteESFDeparture(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { esfDepartureId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFDeparture fetchESFDeparture(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { esfDepartureId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFDeparture getESFDeparture(long esfDepartureId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { esfDepartureId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFDeparture> getESFDepartures(
		...
		return (java.util.List<it.ethica.esf.model.ESFDeparture>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFDeparture addEsfDeparture(long groupId,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(leaveDate),
						
					ClpSerializer.translateInput(arriveDate),
						
					ClpSerializer.translateInput(createDate),
						
					ClpSerializer.translateInput(leaveHour),
						
					ClpSerializer.translateInput(arriveHour),
						
					ClpSerializer.translateInput(companyName),
						
					ClpSerializer.translateInput(departureFrom),
						
					ClpSerializer.translateInput(arrivalTo),
						
					esfMatchId,
						
					returned,
						
					ClpSerializer.translateInput(meetingPlace),
						
					ClpSerializer.translateInput(typeTravel),
						
					ClpSerializer.translateInput(stopover)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFDeparture> findESFDeparturesByESFMatchId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					_methodParameterTypes21, new Object[] { esfMatchId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFDeparture> getByEsfMatchIdEsfUserId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName26,
					...
					new Object[] { esfMatchId, esfUserId, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
