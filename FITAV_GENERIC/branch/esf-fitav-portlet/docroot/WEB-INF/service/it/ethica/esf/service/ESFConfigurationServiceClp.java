 ...
 * @generated
 */
public class ESFConfigurationServiceClp implements ESFConfigurationService {
	public ESFConfigurationServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getAllEsfConfigurations";

		_methodParameterTypes3 = new String[] {  };

		_methodName4 = "getAllEsfConfigurations";

		_methodParameterTypes4 = new String[] { "int", "int" };

		_methodName5 = "getAllEsfConfigurations";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "getAllEsfConfigurations";

		_methodParameterTypes6 = new String[] { "long", "int", "int" };

		_methodName7 = "countByGroupId";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "findESFFornitureTypeByDescription";
