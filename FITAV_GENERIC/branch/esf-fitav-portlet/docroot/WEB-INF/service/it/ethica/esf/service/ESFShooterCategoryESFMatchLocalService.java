...
/**
 * Provides the local service interface for ESFShooterCategoryESFMatch. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFShooterCategoryESFMatchLocalServiceUtil
...
public interface ESFShooterCategoryESFMatchLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFShooterCategoryESFMatchLocalServiceUtil} to access the e s f shooter category e s f match local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFShooterCategoryESFMatchLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
