...
public class ESFGunKindPersistenceImpl extends BasePersistenceImpl<ESFGunKind>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_NAME = new FinderPath(ESFGunKindModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunKindModelImpl.FINDER_CACHE_ENABLED, ESFGunKindImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByname",
			new String[] { String.class.getName() },
			ESFGunKindModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(ESFGunKindModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunKindModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByname",
			new String[] { String.class.getName() });

	/**
	 * Returns the e s f gun kind where name = &#63; or throws a {@link it.ethica.esf.NoSuchGunKindException} if it could not be found.
	 *
	 * @param name the name
	 * @return the matching e s f gun kind
	 * @throws it.ethica.esf.NoSuchGunKindException if a matching e s f gun kind could not be found
	 ...
	 */
	@Override
	public ESFGunKind findByname(String name)
		throws NoSuchGunKindException, SystemException {
		ESFGunKind esfGunKind = fetchByname(name);
	...
	/**
	 * Returns the e s f gun kind where name = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param name the name
	 * @return the matching e s f gun kind, or <code>null</code> if a matching e s f gun kind could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFGunKind fetchByname(String name) throws SystemException {
		return fetchByname(name, true);
	}

	/**
	 * Returns the e s f gun kind where name = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param name the name
	 * @param retrieveFromCache whether to use the finder cache
	 * @return the matching e s f gun kind, or <code>null</code> if a matching e s f gun kind could not be found
	 ...
	 */
	@Override
	public ESFGunKind fetchByname(String name, boolean retrieveFromCache)
		throws SystemException {
		...
		if (result instanceof ESFGunKind) {
			...
			if (!Validator.equals(name, esfGunKind.getName())) {
				result = null;
			}
		}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFGunKindPersistenceImpl.fetchByname(String, boolean) with parameters (" +
	...
	/**
	 * Removes the e s f gun kind where name = &#63; from the database.
	 *
	 * @param name the name
	 * @return the e s f gun kind that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFGunKind removeByname(String name)
		throws NoSuchGunKindException, SystemException {
		ESFGunKind esfGunKind = findByname(name);

		return remove(esfGunKind);
	}

	/**
	 * Returns the number of e s f gun kinds where name = &#63;.
	 *
	 * @param name the name
	 * @return the number of matching e s f gun kinds
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "esfGunKind.name IS NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "esfGunKind.name = ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(esfGunKind.name IS NULL OR esfGunKind.name = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_ESFGUNKINDID = new FinderPath(ESFGunKindModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunKindModelImpl.FINDER_CACHE_ENABLED, ESFGunKindImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByEsfGunKindId",
			new String[] { Long.class.getName() },
			ESFGunKindModelImpl.ESFGUNKINDID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ESFGUNKINDID = new FinderPath(ESFGunKindModelImpl.ENTITY_CACHE_ENABLED,
			ESFGunKindModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByEsfGunKindId",
			new String[] { Long.class.getName() });

	/**
	 * Returns the e s f gun kind where esfGunKindId = &#63; or throws a {@link it.ethica.esf.NoSuchGunKindException} if it could not be found.
	 *
	 ...
	 */
	@Override
	public ESFGunKind findByEsfGunKindId(long esfGunKindId)
		throws NoSuchGunKindException, SystemException {
		ESFGunKind esfGunKind = fetchByEsfGunKindId(esfGunKindId);
	...
	/**
	 * Returns the e s f gun kind where esfGunKindId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param esfGunKindId the esf gun kind ID
	 * @return the matching e s f gun kind, or <code>null</code> if a matching e s f gun kind could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFGunKind fetchByEsfGunKindId(long esfGunKindId)
		throws SystemException {
		return fetchByEsfGunKindId(esfGunKindId, true);
	}

	/**
	 * Returns the e s f gun kind where esfGunKindId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param esfGunKindId the esf gun kind ID
	 * @param retrieveFromCache whether to use the finder cache
	 * @return the matching e s f gun kind, or <code>null</code> if a matching e s f gun kind could not be found
	...
	public ESFGunKind fetchByEsfGunKindId(long esfGunKindId,
		...
		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
					finderArgs, this);
		}
		...
		if (result instanceof ESFGunKind) {
			...
			if ((esfGunKindId != esfGunKind.getEsfGunKindId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
						finderArgs, list);
				}
				else {
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ESFGunKindPersistenceImpl.fetchByEsfGunKindId(long, boolean) with parameters (" +
							StringUtil.merge(finderArgs) +
							") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
					}
					...
					if ((esfGunKind.getEsfGunKindId() != esfGunKindId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
							finderArgs, esfGunKind);
					}
				}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
					finderArgs);
	...
	/**
	 * Removes the e s f gun kind where esfGunKindId = &#63; from the database.
	 *
	 * @param esfGunKindId the esf gun kind ID
	 * @return the e s f gun kind that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public ESFGunKind removeByEsfGunKindId(long esfGunKindId)
		throws NoSuchGunKindException, SystemException {
		ESFGunKind esfGunKind = findByEsfGunKindId(esfGunKindId);

		return remove(esfGunKind);
	}

	/**
	 * Returns the number of e s f gun kinds where esfGunKindId = &#63;.
	 *
	 * @param esfGunKindId the esf gun kind ID
	 * @return the number of matching e s f gun kinds
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_ESFGUNKINDID_ESFGUNKINDID_2 = "esfGunKind.esfGunKindId = ?";
	...
	public void cacheResult(ESFGunKind esfGunKind) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAME,
			new Object[] { esfGunKind.getName() }, esfGunKind);

		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
			new Object[] { esfGunKind.getEsfGunKindId() }, esfGunKind);
	...
	protected void cacheUniqueFindersCache(ESFGunKind esfGunKind) {
		if (esfGunKind.isNew()) {
			...
			args = new Object[] { esfGunKind.getName() };
			...
			args = new Object[] { esfGunKind.getEsfGunKindId() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_ESFGUNKINDID, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID, args,
				esfGunKind);
		}
		else {
			...
			if ((esfGunKindModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { esfGunKind.getName() };
			...
			if ((esfGunKindModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_ESFGUNKINDID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { esfGunKind.getEsfGunKindId() };

				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_ESFGUNKINDID,
					args, Long.valueOf(1));
				FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID,
					args, esfGunKind);
			}
	...
	protected void clearUniqueFindersCache(ESFGunKind esfGunKind) {
		...
		if ((esfGunKindModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_NAME.getColumnBitmask()) != 0) {
			args = new Object[] { esfGunKindModelImpl.getOriginalName() };
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ESFGUNKINDID, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_ESFGUNKINDID, args);

		if ((esfGunKindModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_ESFGUNKINDID.getColumnBitmask()) != 0) {
			args = new Object[] { esfGunKindModelImpl.getOriginalEsfGunKindId() };
