...
/**
 * The extended model implementation for the ESFUser service. Represents a row in the &quot;ESF_ESFUser&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ESFUserImpl extends ESFUserBaseImpl {
	...
	public long getGroupId() throws PortalException, SystemException {
		groupId = UserLocalServiceUtil.getUser(getEsfUserId()).getGroupId();
		return groupId;
	}
