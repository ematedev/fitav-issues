...
public class ESFTournamentLocalServiceClpInvoker {
	public ESFTournamentLocalServiceClpInvoker() {
		...
		_methodName310 = "findESFTournamentsByState";

		_methodParameterTypes310 = new String[] { "int" };

		_methodName311 = "findESFTournamentsByState";

		_methodParameterTypes311 = new String[] { "int", "int", "int" };

		_methodName312 = "findESFTournamentsByOrganizationId";

		_methodParameterTypes312 = new String[] {
				"long", "boolean", "int", "boolean"
			};

		_methodName313 = "findESFTournamentsByOrganizationId";

		_methodParameterTypes313 = new String[] {
				"long", "boolean", "int", "boolean", "int", "int"
			};

		_methodName314 = "addESFTournament";
		...
		_methodName315 = "deleteESFTournament";

		_methodParameterTypes315 = new String[] {
				"long", "com.liferay.portal.service.ServiceContext"
			};

		_methodName316 = "updateESFTournament";
