...
public class ESFgunUserLocalServiceClpInvoker {
	public ESFgunUserLocalServiceClpInvoker() {
		...
		_methodName297 = "getESFGunByLikeC_K_T";

		_methodParameterTypes297 = new String[] {
				"java.lang.String", "long", "int", "int", "int"
			};

		_methodName298 = "countESFGunByLikeC_K_T";

		_methodParameterTypes298 = new String[] {
				"java.lang.String", "long", "int"
			};

		_methodName299 = "getESFGunByLikeS_T";

		_methodParameterTypes299 = new String[] { "long", "int", "int", "int" };

		_methodName300 = "countESFGunByLikeS_T";

		_methodParameterTypes300 = new String[] { "long", "int" };

		_methodName301 = "getESFGunByT";

		_methodParameterTypes301 = new String[] { "int", "int", "int" };

		_methodName302 = "countESFGunByT";

		_methodParameterTypes302 = new String[] { "int" };

		_methodName303 = "findbyESFGunId";

		_methodParameterTypes303 = new String[] { "long" };

		_methodName304 = "findbyESFGunId_Type";

		_methodParameterTypes304 = new String[] { "long", "int" };

		_methodName305 = "findbyCode";

		_methodParameterTypes305 = new String[] { "java.lang.String" };

		_methodName306 = "findbyGunId_Type";

		_methodParameterTypes306 = new String[] { "long", "int", "int", "int" };

		_methodName307 = "countbyGunId_Type";

		_methodParameterTypes307 = new String[] { "long", "int" };

		_methodName308 = "findbyKind_Shooter";

		_methodParameterTypes308 = new String[] {
				"java.lang.String", "java.lang.String", "long", "int", "int"
			};

		_methodName309 = "findCanebyKind_Shooter";
