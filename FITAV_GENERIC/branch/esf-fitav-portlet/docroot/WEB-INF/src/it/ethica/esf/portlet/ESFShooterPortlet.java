...
public class ESFShooterPortlet extends MVCPortlet {
	...
	public void serveResource(
		...
		try {
			...
			if (resourceID.equals("fiscalCode")) {
		...
		try {
			if (resourceID.equals("liv1") || resourceID.equals("liv2") ||
	...
	public void assignCard(
		...
		_log.info("nel metodo");
		long esfCardId = ParamUtil.getLong(actionRequest, "esfCardId");
		_log.info("nel metodo esfCardId="+esfCardId);
	...
	public void removeCard(
		...
		actionResponse.setRenderParameter("mvcPath", "/html/esfshooter/view.jsp");
	}
