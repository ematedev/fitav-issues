...
/**
 * The extended model implementation for the ESFAddress service. Represents a row in the &quot;ESFAddress&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link it.ethica.esf.model.ESFAddress} interface.
 * </p>
 *
 * @author Ethica
 */
public class ESFAddressImpl extends ESFAddressBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a e s f address model instance should use the {@link it.ethica.esf.model.ESFAddress} interface instead.
	 */
	...
	public long getCompanyId()
		...
		if (getEsfAddressId() > 0  && !this.isWrapper) {
			companyId =
