...
public class ESFUserAdminPortlet extends MVCPortlet {
	...
	public JSONObject serveFiscalCode(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String birthcity = ParamUtil.getString(resourceRequest, "birthcity");
		...
		String url = "http://webservices.dotnethell.it/codicefiscale.asmx/CalcolaCodiceFiscale?Nome=" + firstName
