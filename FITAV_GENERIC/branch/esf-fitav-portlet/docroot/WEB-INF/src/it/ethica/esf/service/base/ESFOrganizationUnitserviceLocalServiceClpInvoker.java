...
public class ESFOrganizationUnitserviceLocalServiceClpInvoker {
	public ESFOrganizationUnitserviceLocalServiceClpInvoker() {
		...
		_methodName300 = "getAllESFOrganizationUnitservices";

		_methodParameterTypes300 = new String[] {  };

		_methodName301 = "getAllESFOrganizationUnitservices";

		_methodParameterTypes301 = new String[] { "int", "int" };

		_methodName302 = "getAllESFOrganizationUnitservices";

		_methodParameterTypes302 = new String[] { "long" };

		_methodName303 = "getAllESFOrganizationUnitservices";
		...
		_methodName305 = "findByESFOrganizationId";

		_methodParameterTypes305 = new String[] { "long", "int", "int" };

		_methodName306 = "findByESFOrganizationId";

		_methodParameterTypes306 = new String[] { "long" };

		_methodName307 = "findByESFUnitserviceId";

		_methodParameterTypes307 = new String[] { "long" };

		_methodName308 = "addESFOrganizationUnitservice";
		...
		_methodName309 = "updateESFOrganizationUnitservice";
		...
		_methodName310 = "deleteESFOrganizationUnitservice";
