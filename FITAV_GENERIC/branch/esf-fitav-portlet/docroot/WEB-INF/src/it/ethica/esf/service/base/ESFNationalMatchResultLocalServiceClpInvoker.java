...
public class ESFNationalMatchResultLocalServiceClpInvoker {
	public ESFNationalMatchResultLocalServiceClpInvoker() {
		...
		_methodName296 = "getESFNationalMatchResultsByESFMatchId";

		_methodParameterTypes296 = new String[] { "long" };

		_methodName297 = "getESFNationalMatchResultByESFMatchId_ESFUserId";

		_methodParameterTypes297 = new String[] { "long", "long" };

		_methodName298 = "getESFMatchByEsfMatchResultUserId";

		_methodParameterTypes298 = new String[] { "long" };

		_methodName299 = "getExternalShooter";

		_methodParameterTypes299 = new String[] { "long" };

		_methodName300 = "getESFNationalMatchByEsFMatchId";
