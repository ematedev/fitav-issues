...
public class ESFGunLocalServiceClpInvoker {
	public ESFGunLocalServiceClpInvoker() {
		...
		_methodName310 = "getESFGunByLikeC_K";

		_methodParameterTypes310 = new String[] { "java.lang.String", "long" };

		_methodName311 = "getESFGunByLikeC_K";

		_methodParameterTypes311 = new String[] {
				"java.lang.String", "long", "int", "int"
			};

		_methodName312 = "getESFGunByLikeC_K_U";

		_methodParameterTypes312 = new String[] {
				"java.lang.String", "long", "long"
			};

		_methodName313 = "getESFGunByLikeM_C_K_U";

		_methodParameterTypes313 = new String[] {
				"long", "java.lang.String", "long", "long", "int", "int"
			};

		_methodName314 = "countESFGunByLikeM_C_K_U";

		_methodParameterTypes314 = new String[] {
				"long", "java.lang.String", "long", "long"
			};

		_methodName315 = "getESFGunByLikeM_K";

		_methodParameterTypes315 = new String[] { "long", "long", "int", "int" };

		_methodName316 = "countESFGunByLikeM_K";

		_methodParameterTypes316 = new String[] { "long", "long" };

		_methodName317 = "getESFGunsByUserId";

		_methodParameterTypes317 = new String[] { "long" };

		_methodName318 = "getESFGunsByUserId";

		_methodParameterTypes318 = new String[] { "long", "int", "int" };

		_methodName319 = "getESFGuns";

		_methodParameterTypes319 = new String[] {  };

		_methodName320 = "getESFGuns";

		_methodParameterTypes320 = new String[] { "int", "int" };

		_methodName321 = "getESFGunsByESFGunKind";

		_methodParameterTypes321 = new String[] { "long" };

		_methodName322 = "getESFGunsByESFGunKindCount";

		_methodParameterTypes322 = new String[] { "long" };

		_methodName323 = "getESFGunByLikeC_K_U";

		_methodParameterTypes323 = new String[] {
				"java.lang.String", "long", "long", "int", "int"
			};

		_methodName324 = "getESFGunByLikeC_K_M_U";

		_methodParameterTypes324 = new String[] {
				"java.lang.String", "long", "java.lang.String", "long"
			};

		_methodName325 = "addESFGun";
		...
		_methodName327 = "deleteESFGun";

		_methodParameterTypes327 = new String[] {
				"long", "com.liferay.portal.service.ServiceContext"
			};

		_methodName328 = "getFullName";

		_methodParameterTypes328 = new String[] { "it.ethica.esf.model.ESFGun" };

		_methodName331 = "checkCode";

		_methodParameterTypes331 = new String[] {
				"java.lang.String", "com.liferay.portal.service.ServiceContext"
			};

		_methodName332 = "getNameMod";

		_methodParameterTypes332 = new String[] { "it.ethica.esf.model.ESFGun" };

		_methodName333 = "getNameM";

		_methodParameterTypes333 = new String[] { "it.ethica.esf.model.ESFGun" };

		_methodName334 = "getNameT";

		_methodParameterTypes334 = new String[] { "it.ethica.esf.model.ESFGun" };
	}
