...
/**
 * The implementation of the e s f gun type local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link it.ethica.esf.service.ESFGunTypeLocalService} interface.
 *
 * <p>
...
public class ESFGunTypeLocalServiceImpl extends ESFGunTypeLocalServiceBaseImpl {
	...
	public List<ESFGunType> getESFGunTypes() throws SystemException {
	...
	public ESFGunType addESFGunType(long userId, String name,
		...
		resourceLocalService.addResources(user.getCompanyId(), groupId, userId,
				ESFGunType.class.getName(), esfGunTypeId, false, true, true);

		return esfGunType;

	}

	public ESFGunType updateESFGunType(long userId, long esfGunTypeId,
		...
		resourceLocalService.updateResources(serviceContext.getCompanyId(),
				serviceContext.getScopeGroupId(), name, esfGunTypeId,
	...
	public ESFGunType deleteESFGunType(long esfGunTypeId,
		...
		resourceLocalService.deleteResource(serviceContext.getCompanyId(),
				ESFGunType.class.getName(), ResourceConstants.SCOPE_INDIVIDUAL,
				esfGunTypeId);
