...
import it.ethica.esf.ESFToolCodeException;
import it.ethica.esf.ESFToolDescriptionException;
import it.ethica.esf.ESFToolNameException;
import it.ethica.esf.ESFToolTypeException;
...
/**
 * The implementation of the e s f tool local service. <p> All custom service
 * methods should be put in this class. Whenever methods are added, rerun
 * ServiceBuilder to copy their definitions into the
 * {@link it.ethica.esf.service.ESFToolLocalService} interface. <p> This is a
...
public class ESFToolLocalServiceImpl extends ESFToolLocalServiceBaseImpl {
	 ...
	 * {@link it.ethica.esf.service.ESFToolLocalServiceUtil} to access the e s f
	 * tool local service.
	 */
...
//		validate(code, name, description, type);
	...
	public ESFToolRel addESFToolREL(
		...
		esfToolRel.setUuid(serviceContext.getUuid());
	...
	public ESFToolRel updateESFToolREL(
		...
		ESFToolRel esfToolRel =
			getESFToolRelLocalService().getESFToolRel(esfToolRelPK);
	...
	protected void validate(
		...
		if (Validator.isNull(code)) {
			throw new ESFToolCodeException("Il Campo Code è null");
		}
		if (Validator.isNull(name)) {
			throw new ESFToolNameException("Il campo Name è null");
		}

		if (Validator.isNull(description)) {
			throw new ESFToolDescriptionException("Il campo Descrizione è null");
		}

		if (Validator.isNull(type)) {
			throw new ESFToolTypeException("Il campo Tipo è null");
		}
	}
