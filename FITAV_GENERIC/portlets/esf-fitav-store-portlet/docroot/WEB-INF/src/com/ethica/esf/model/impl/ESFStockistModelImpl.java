...
public class ESFStockistModelImpl extends BaseModelImpl<ESFStockist>
	...
	public static final String TABLE_SQL_CREATE = "create table ESFStockist (esfStockistId LONG not null primary key,name VARCHAR(256) null,email VARCHAR(256) null,phone VARCHAR(256) null,address VARCHAR(2000) null,nameReference VARCHAR(256) null,lastNameReference VARCHAR(256) null,emailReference VARCHAR(256) null,phoneReference VARCHAR(256) null,description VARCHAR(2000) null,other VARCHAR(2000) null)";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
			...
			true);
	public static long ESFSTOCKISTID_COLUMN_BITMASK = 1L;
	...
	public void resetOriginalValues() {
		...
		esfStockistModelImpl._originalEsfStockistId = esfStockistModelImpl._esfStockistId;

		esfStockistModelImpl._setOriginalEsfStockistId = false;
