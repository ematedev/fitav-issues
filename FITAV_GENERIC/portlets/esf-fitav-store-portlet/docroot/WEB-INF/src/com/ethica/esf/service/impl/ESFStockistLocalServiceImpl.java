...
/**
 * The implementation of the e s f stockist local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are
 * added, rerun ServiceBuilder to copy their definitions into the
 * {@link com.ethica.esf.service.ESFStockistLocalService} interface.
 *
 * <p>
 ...
 */
public class ESFStockistLocalServiceImpl extends
		ESFStockistLocalServiceBaseImpl {
	public ESFStockist checkName(String name, ServiceContext serviceContext)
			throws PortalException, SystemException {

		if (Validator.isNotNull(name) && !Validator.isBlank(name)) {
			return esfStockistPersistence.fetchByStockistName(name);
		}

		return null;
	}

	public ESFStockist addESFStockist(String name, String email, String phone,
			...
			String other, ServiceContext serviceContext)
			throws PortalException, SystemException {
		...
		esfStockist.setExpandoBridgeAttributes(serviceContext);
	 ...
	 * {@link com.ethica.esf.service.ESFStockistLocalServiceUtil} to access the e
	 * s f stockist local service.
	 */
	public List<ESFStockist> getESFStockists() throws SystemException {

		return esfStockistPersistence.findAll();
	}

	public ESFStockist updateESFStockist(long esfStockistId, String name,
			String email, String phone, String address, String nameReference,
			String lastNameReference, String emailReference,
