...
public class ESFCardClp extends BaseModelImpl<ESFCard> implements ESFCard {
	...
	public void setTemporary(String temporary) {
		...
		if (_esfCardRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setTemporary", String.class);

				method.invoke(_esfCardRemoteModel, temporary);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setTemporary(getTemporary());
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>temporary</column-name><column-value><![CDATA[");
		sb.append(getTemporary());
		sb.append("]]></column-value></column>");
		sb.append(
