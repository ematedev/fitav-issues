...
public class ESFCardLocalServiceWrapper implements ESFCardLocalService,
	...
	*/
	...
	public java.util.List<it.ethica.esf.model.ESFCard> getAllESFCardsByEsfUserId(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _esfCardLocalService.getAllESFCardsByEsfUserId(esfUserId);
	}
	...
	/**
	* Effettua l'update dell'entitÃ¯Â¿Â½ ESFCard. Nel caso in cui viene fatto il
	...
	* sulla scelta di uno stato differente a quello giÃ¯Â¿Â½ assegnato
	* all'entitÃ¯Â¿Â½. Questo perchÃ¯Â¿Â½ delle volte bisogna creare un riferimento
	...
	*/
	...
	/**
	* Cerca la Card che ha uno stato [attivo o disattivo] e che Ã¯Â¿Â½ associata
	...
	*/
	...
	public it.ethica.esf.model.ESFCard findShooterByCardActiveInMatch(
		...
		return _esfCardLocalService.findShooterByCardActiveInMatch(cardCode,
			startDate, endDate);
	}
	...
	public it.ethica.esf.model.ESFCard addESFCardOldCode(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _esfCardLocalService.addESFCardOldCode(oldCode, userId, code,
			codeAlfa, codeNum, esfEntityState, esfUserId, esfOrganizationId,
			serviceContext);
	}
