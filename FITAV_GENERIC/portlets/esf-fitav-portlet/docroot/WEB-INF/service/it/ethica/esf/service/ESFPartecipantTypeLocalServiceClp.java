 ...
 * @generated
 */
public class ESFPartecipantTypeLocalServiceClp
	implements ESFPartecipantTypeLocalService {
	public ESFPartecipantTypeLocalServiceClp(
	...
	public it.ethica.esf.model.ESFPartecipantType addESFPartecipantType(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(esfPartecipantType)
					});
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFPartecipantType)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFPartecipantType createESFPartecipantType(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { esfPartecipantTypeId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFPartecipantType> getESFPartecipantTypes(
		...
		return (java.util.List<it.ethica.esf.model.ESFPartecipantType>)ClpSerializer.translateOutput(returnObj);
	}
