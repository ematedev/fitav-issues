...
public class ESFOrganizationWrapper implements ESFOrganization,
	...
	*/
	...
	/**
	* Returns the constitutive act of this e s f organization.
	*
	* @return the constitutive act of this e s f organization
	*/
	@Override
	public boolean getConstitutiveAct() {
		return _esfOrganization.getConstitutiveAct();
	}

	/**
	* Returns <code>true</code> if this e s f organization is constitutive act.
	*
	* @return <code>true</code> if this e s f organization is constitutive act; <code>false</code> otherwise
	*/
	@Override
	public boolean isConstitutiveAct() {
		return _esfOrganization.isConstitutiveAct();
	}

	/**
	* Sets whether this e s f organization is constitutive act.
	*
	* @param constitutiveAct the constitutive act of this e s f organization
	*/
	@Override
	public void setConstitutiveAct(boolean constitutiveAct) {
		_esfOrganization.setConstitutiveAct(constitutiveAct);
	}

	/**
	* Returns the registered status of this e s f organization.
	*
	* @return the registered status of this e s f organization
	*/
	@Override
	public boolean getRegisteredStatus() {
		return _esfOrganization.getRegisteredStatus();
	}

	/**
	* Returns <code>true</code> if this e s f organization is registered status.
	*
	* @return <code>true</code> if this e s f organization is registered status; <code>false</code> otherwise
	*/
	@Override
	public boolean isRegisteredStatus() {
		return _esfOrganization.isRegisteredStatus();
	}

	/**
	* Sets whether this e s f organization is registered status.
	*
	* @param registeredStatus the registered status of this e s f organization
	*/
	@Override
	public void setRegisteredStatus(boolean registeredStatus) {
		_esfOrganization.setRegisteredStatus(registeredStatus);
	}

	/**
	* Returns the planimetry sports stand of this e s f organization.
	*
	* @return the planimetry sports stand of this e s f organization
	*/
	@Override
	public boolean getPlanimetrySportsStand() {
		return _esfOrganization.getPlanimetrySportsStand();
	}

	/**
	* Returns <code>true</code> if this e s f organization is planimetry sports stand.
	*
	* @return <code>true</code> if this e s f organization is planimetry sports stand; <code>false</code> otherwise
	*/
	@Override
	public boolean isPlanimetrySportsStand() {
		return _esfOrganization.isPlanimetrySportsStand();
	}

	/**
	* Sets whether this e s f organization is planimetry sports stand.
	*
	* @param planimetrySportsStand the planimetry sports stand of this e s f organization
	*/
	@Override
	public void setPlanimetrySportsStand(boolean planimetrySportsStand) {
		_esfOrganization.setPlanimetrySportsStand(planimetrySportsStand);
	}

	/**
	* Returns the certificate f i t a v of this e s f organization.
	*
	* @return the certificate f i t a v of this e s f organization
	*/
	@Override
	public boolean getCertificateFITAV() {
		return _esfOrganization.getCertificateFITAV();
	}

	/**
	* Returns <code>true</code> if this e s f organization is certificate f i t a v.
	*
	* @return <code>true</code> if this e s f organization is certificate f i t a v; <code>false</code> otherwise
	*/
	@Override
	public boolean isCertificateFITAV() {
		return _esfOrganization.isCertificateFITAV();
	}

	/**
	* Sets whether this e s f organization is certificate f i t a v.
	*
	* @param certificateFITAV the certificate f i t a v of this e s f organization
	*/
	@Override
	public void setCertificateFITAV(boolean certificateFITAV) {
		_esfOrganization.setCertificateFITAV(certificateFITAV);
	}

	/**
	* Returns the note of this e s f organization.
	*
	* @return the note of this e s f organization
	*/
	@Override
	public java.lang.String getNote() {
		return _esfOrganization.getNote();
	}

	/**
	* Sets the note of this e s f organization.
	*
	* @param note the note of this e s f organization
	*/
	@Override
	public void setNote(java.lang.String note) {
		_esfOrganization.setNote(note);
	}

	/**
	* Returns the is simply organizzation of this e s f organization.
	*
	* @return the is simply organizzation of this e s f organization
	*/
	@Override
	public boolean getIsSimplyOrganizzation() {
		return _esfOrganization.getIsSimplyOrganizzation();
	}

	/**
	* Returns <code>true</code> if this e s f organization is is simply organizzation.
	*
	* @return <code>true</code> if this e s f organization is is simply organizzation; <code>false</code> otherwise
	*/
	@Override
	public boolean isIsSimplyOrganizzation() {
		return _esfOrganization.isIsSimplyOrganizzation();
	}

	/**
	* Sets whether this e s f organization is is simply organizzation.
	*
	* @param isSimplyOrganizzation the is simply organizzation of this e s f organization
	*/
	@Override
	public void setIsSimplyOrganizzation(boolean isSimplyOrganizzation) {
		_esfOrganization.setIsSimplyOrganizzation(isSimplyOrganizzation);
	}

	/**
	* Returns the web site of this e s f organization.
	*
	* @return the web site of this e s f organization
	*/
	@Override
	public java.lang.String getWebSite() {
		return _esfOrganization.getWebSite();
	}

	/**
	* Sets the web site of this e s f organization.
	*
	* @param webSite the web site of this e s f organization
	*/
	@Override
	public void setWebSite(java.lang.String webSite) {
		_esfOrganization.setWebSite(webSite);
	}

	/**
	* Returns the include coni report of this e s f organization.
	*
	* @return the include coni report of this e s f organization
	*/
	@Override
	public boolean getIncludeConiReport() {
		return _esfOrganization.getIncludeConiReport();
	}

	/**
	* Returns <code>true</code> if this e s f organization is include coni report.
	*
	* @return <code>true</code> if this e s f organization is include coni report; <code>false</code> otherwise
	*/
	@Override
	public boolean isIncludeConiReport() {
		return _esfOrganization.isIncludeConiReport();
	}

	/**
	* Sets whether this e s f organization is include coni report.
	*
	* @param includeConiReport the include coni report of this e s f organization
	*/
	@Override
	public void setIncludeConiReport(boolean includeConiReport) {
		_esfOrganization.setIncludeConiReport(includeConiReport);
	}

	/**
	* Returns the organizzation category of this e s f organization.
	*
	* @return the organizzation category of this e s f organization
	*/
	@Override
	public java.lang.String getOrganizzationCategory() {
		return _esfOrganization.getOrganizzationCategory();
	}

	/**
	* Sets the organizzation category of this e s f organization.
	*
	* @param organizzationCategory the organizzation category of this e s f organization
	*/
	@Override
	public void setOrganizzationCategory(java.lang.String organizzationCategory) {
		_esfOrganization.setOrganizzationCategory(organizzationCategory);
	}
