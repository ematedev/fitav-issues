...
/**
 * Provides the local service interface for ESFShootingDirector. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFShootingDirectorLocalServiceUtil
...
public interface ESFShootingDirectorLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFShootingDirectorLocalServiceUtil} to access the e s f shooting director local service. Add custom service methods to {@link it.ethica.esf.service.impl.ESFShootingDirectorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
