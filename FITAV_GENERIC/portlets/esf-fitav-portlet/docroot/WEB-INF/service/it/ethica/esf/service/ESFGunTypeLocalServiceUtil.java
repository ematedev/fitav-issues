...
public class ESFGunTypeLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<it.ethica.esf.model.ESFGunType> getisCatridgeProductor(
		boolean isCatridgeProductor)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchGunTypeException {
		return getService().getisCatridgeProductor(isCatridgeProductor);
	}
	...
	public static it.ethica.esf.model.ESFGunType addESFGunType(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addESFGunType(userId, name, description,
	...
	public static it.ethica.esf.model.ESFGunType checkNome(
