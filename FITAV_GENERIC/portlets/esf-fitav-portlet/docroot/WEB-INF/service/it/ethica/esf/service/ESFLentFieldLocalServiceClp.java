 ...
 * @generated
 */
public class ESFLentFieldLocalServiceClp implements ESFLentFieldLocalService {
	public ESFLentFieldLocalServiceClp(
		...
		_methodName19 = "findESFLentFieldbyF_S";

		_methodParameterTypes19 = new String[] { "long", "long" };

		_methodName20 = "findESFLentFieldsbyF_S";

		_methodParameterTypes20 = new String[] { "long", "long" };

		_methodName21 = "addESFLentField";
	...
	public it.ethica.esf.model.ESFLentField addESFLentField(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(esfLentField) });
		}
		catch (Throwable t) {
		...
		return (it.ethica.esf.model.ESFLentField)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFLentField createESFLentField(long lentFieldId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { lentFieldId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFLentField deleteESFLentField(long lentFieldId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { lentFieldId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFLentField fetchESFLentField(long lentFieldId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { lentFieldId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public it.ethica.esf.model.ESFLentField getESFLentField(long lentFieldId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { lentFieldId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFLentField> getESFLentFields(
		...
		return (java.util.List<it.ethica.esf.model.ESFLentField>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public it.ethica.esf.model.ESFLentField findESFLentFieldbyF_S(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { esfFieldId, esfEntityStateId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<it.ethica.esf.model.ESFLentField> findESFLentFieldsbyF_S(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { esfStateId, realOwnerId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
