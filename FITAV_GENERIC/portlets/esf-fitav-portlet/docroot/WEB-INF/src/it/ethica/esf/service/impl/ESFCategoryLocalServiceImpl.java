...
public class ESFCategoryLocalServiceImpl extends ESFCategoryLocalServiceBaseImpl {
	...
	@Override
	public ESFCategory addESFCategory(String name, String description)
			throws SystemException {
		long esfCategoryId = counterLocalService.increment();

		ESFCategory esfCategory = esfCategoryPersistence.create(esfCategoryId);

		esfCategory.setName(name);
		esfCategory.setDescription(description);

		esfCategoryPersistence.update(esfCategory);

		return esfCategory;
	}

	@Override
	public ESFCategory updateESFCategory(long esfCategoryId, String name,
			String description) throws PortalException, SystemException {
		ESFCategory esfCategory = esfCategoryLocalService
				.getESFCategory(esfCategoryId);

		esfCategory.setName(name);
		esfCategory.setDescription(description);

		esfCategoryLocalService.updateESFCategory(esfCategory);
