...
public class ESFCardModelImpl extends BaseModelImpl<ESFCard>
	...
	public static ESFCard toModel(ESFCardSoap soapModel) {
		...
		model.setTemporary(soapModel.getTemporary());
	...
	public Object clone() {
		...
		esfCardImpl.setTemporary(getTemporary());
	...
	public CacheModel<ESFCard> toCacheModel() {
		...
		esfCardCacheModel.temporary = getTemporary();

		String temporary = esfCardCacheModel.temporary;

		if ((temporary != null) && (temporary.length() == 0)) {
			esfCardCacheModel.temporary = null;
		}
