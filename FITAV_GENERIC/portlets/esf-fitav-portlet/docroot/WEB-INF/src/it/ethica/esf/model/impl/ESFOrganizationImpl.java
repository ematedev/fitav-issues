...
public class ESFOrganizationImpl extends ESFOrganizationBaseImpl {
	...
	public boolean isRoot() {
		...
		return this.getType() == ESFKeys.ESFOrganizationTypeId.FITAV;
	}

	public boolean isRegion() {

		return this.getType() == ESFKeys.ESFOrganizationTypeId.REGION;
	}

	public boolean isProvince() {

		return this.getType() == ESFKeys.ESFOrganizationTypeId.PROVINCE;
	}

	public boolean isAssociation() {

		return this.getType() == ESFKeys.ESFOrganizationTypeId.ASSOCIATION;
	}
	...
	public long getDefaultLayoutSetPrototypeId(boolean publicLayout) {
		...
		String labelType = StringPool.BLANK;
		
		if (type > 0 && type < ESFKeys.ESFOrganizationTypeLabel.length) {
			
			labelType = ESFKeys.ESFOrganizationTypeLabel[type];

			if (publicLayout) {

				return GetterUtil.getLong(PortletProps
						.get("public-" + labelType + "-site-template-id"));
			}
			else {

				return GetterUtil.getLong(PortletProps
						.get("private-" + labelType + "-site-template-id"));
			}
		}
