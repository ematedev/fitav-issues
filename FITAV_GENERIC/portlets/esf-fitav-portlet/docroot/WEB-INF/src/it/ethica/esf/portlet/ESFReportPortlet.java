...
public class ESFReportPortlet extends MVCPortlet {
	...
	public void serveResource(ResourceRequest request, ResourceResponse response)
		...
		String givenDateStr = ParamUtil.getString(request, "givenDate");
		...
		if(generateSummaryShooterYearReportReport){
			...
			Date givenDate = null;
			if(givenDateStr!=null){
				SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
				try {
					givenDate = sdf.parse(givenDateStr);
					cal.setTimeInMillis(givenDate.getTime());
					thisYearStart = cal.get(Calendar.YEAR)+"-"+cal.get(Calendar.MONTH)+"-"+cal.get(Calendar.DAY_OF_MONTH);
					Year_1Start = (cal.get(Calendar.YEAR)-1)+"-"+cal.get(Calendar.MONTH)+"-"+cal.get(Calendar.DAY_OF_MONTH);
					Year_2Start = (cal.get(Calendar.YEAR)-2)+"-"+cal.get(Calendar.MONTH)+"-"+cal.get(Calendar.DAY_OF_MONTH);
					Year_3Start = (cal.get(Calendar.YEAR)-3)+"-"+cal.get(Calendar.MONTH)+"-"+cal.get(Calendar.DAY_OF_MONTH);
					year = cal.get(Calendar.YEAR);
				} catch (ParseException e) {
					_log.warn(e.getMessage());
				}
			}
			_log.info("Start date: "+thisYearStart);
			...
			map.put("givenDate", cal.get(Calendar.DAY_OF_MONTH)+"-"+(cal.get(Calendar.MONTH)+1)+"-"+cal.get(Calendar.YEAR));
