...
public class ESFCardLocalServiceImpl extends ESFCardLocalServiceBaseImpl {
	...
	public ESFCard addESFCard(long userId, String code, String codeAlfa,
		...
		esfCard.setCreateDate(now);
		esfCard.setModifiedDate(now);
...
//			indexer.reindex(esfCard);
	...
	public List<ESFCard> getAllESFCardsByEsfUserId(long esfUserId)throws PortalException,
	SystemException
	{
		return esfCardPersistence.findByEsfUser(esfUserId);
	}
	/*
 ...
 */
	...
	public List<ESFCard> findAllESFCardsByU_S_Y(long userId, Date date)
		...
		if (esfCards != null) {
			for (ESFCard e : esfCards) {
				...
				ESFEntityState eSFEntityState = null;
				 try {
					 eSFEntityState = ESFEntityStateLocalServiceUtil
	...
	public ESFCard findShooterByCardActiveInMatch(String cardCode, String startDate, String endDate){
		...
		card = ESFCardFinderUtil.findShooterByCardActiveInMatch(cardCode, startDate, endDate);

		return card ;
	}
	
	public ESFCard addESFCardOldCode(String oldCode, long userId, String code, String codeAlfa,
		long codeNum, ESFEntityState esfEntityState, long esfUserId,
		long esfOrganizationId, ServiceContext serviceContext)
		throws PortalException, SystemException {
		...
		ESFEntityState esf =
			ESFEntityStateLocalServiceUtil.addEntityState(
				serviceContext.getUserId(), ESFCard.class.getName(), esfCardId,
				esfEntityState.getEsfStateId(), esfEntityState.getStartDate(),
				esfEntityState.getEndDate(), serviceContext);
		esf.setEsfStateId(esfEntityState.getEsfStateId());
		ESFEntityStateLocalServiceUtil.updateESFEntityState(esf);

//		try {
//			resourceLocalService.addResources(
//				esfCard.getCompanyId(), groupId, userId,
//				ESFCard.class.getName(), esfCardId, false, true, true);
//
...
//
//			Indexer indexer =
//				IndexerRegistryUtil.nullSafeGetIndexer(ESFCard.class);
//
//			indexer.reindex(esfCard);
//		}
//		catch (Exception ex) {
