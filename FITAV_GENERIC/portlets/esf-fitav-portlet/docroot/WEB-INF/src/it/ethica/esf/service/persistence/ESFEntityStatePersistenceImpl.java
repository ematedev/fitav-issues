...
public class ESFEntityStatePersistenceImpl extends BasePersistenceImpl<ESFEntityState>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK =
		new FinderPath(ESFEntityStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFEntityStateModelImpl.FINDER_CACHE_ENABLED,
			ESFEntityStateImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByESFEntityStateCName_CPk",
			new String[] {
				String.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK =
		new FinderPath(ESFEntityStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFEntityStateModelImpl.FINDER_CACHE_ENABLED,
			ESFEntityStateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			...
			ESFEntityStateModelImpl.CLASSNAME_COLUMN_BITMASK |
			ESFEntityStateModelImpl.CLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ESFENTITYSTATECNAME_CPK = new FinderPath(ESFEntityStateModelImpl.ENTITY_CACHE_ENABLED,
			ESFEntityStateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByESFEntityStateCName_CPk",
			new String[] { String.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<ESFEntityState> findByESFEntityStateCName_CPk(
		String className, long classPK) throws SystemException {
		return findByESFEntityStateCName_CPk(className, classPK,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ESFEntityState> findByESFEntityStateCName_CPk(
		...
		throws SystemException {
		return findByESFEntityStateCName_CPk(className, classPK, start, end,
			null);
	}
	...
	public List<ESFEntityState> findByESFEntityStateCName_CPk(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK;
			finderArgs = new Object[] { className, classPK };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK;
			finderArgs = new Object[] {
					className, classPK,
		...
		if (list == null) {
			...
			if (className == null) {
				query.append(_FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_1);
			}
			else if (className.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_3);
			}
			else {
				bindClassName = true;

				query.append(_FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_2);
			}

			query.append(_FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSPK_2);
	 ...
	 */
	@Override
	public ESFEntityState findByESFEntityStateCName_CPk_First(
		String className, long classPK, OrderByComparator orderByComparator)
		throws NoSuchEntityStateException, SystemException {
		ESFEntityState esfEntityState = fetchByESFEntityStateCName_CPk_First(className,
	 ...
	 */
	@Override
	public ESFEntityState fetchByESFEntityStateCName_CPk_First(
		String className, long classPK, OrderByComparator orderByComparator)
		throws SystemException {
		List<ESFEntityState> list = findByESFEntityStateCName_CPk(className,
	 ...
	 */
	@Override
	public ESFEntityState findByESFEntityStateCName_CPk_Last(String className,
		long classPK, OrderByComparator orderByComparator)
		throws NoSuchEntityStateException, SystemException {
		ESFEntityState esfEntityState = fetchByESFEntityStateCName_CPk_Last(className,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public ESFEntityState fetchByESFEntityStateCName_CPk_Last(
		String className, long classPK, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByESFEntityStateCName_CPk(className, classPK);
	 ...
	 */
	@Override
	public ESFEntityState[] findByESFEntityStateCName_CPk_PrevAndNext(
		long esfEntityStateId, String className, long classPK,
		OrderByComparator orderByComparator)
		throws NoSuchEntityStateException, SystemException {
		ESFEntityState esfEntityState = findByPrimaryKey(esfEntityStateId);
		...
		try {
			...
			array[0] = getByESFEntityStateCName_CPk_PrevAndNext(session,
					esfEntityState, className, classPK, orderByComparator, true);

			array[1] = esfEntityState;

			array[2] = getByESFEntityStateCName_CPk_PrevAndNext(session,
					esfEntityState, className, classPK, orderByComparator, false);
	...
	protected ESFEntityState getByESFEntityStateCName_CPk_PrevAndNext(
		Session session, ESFEntityState esfEntityState, String className,
	 ...
	 */
	@Override
	public void removeByESFEntityStateCName_CPk(String className, long classPK)
		throws SystemException {
		for (ESFEntityState esfEntityState : findByESFEntityStateCName_CPk(
	 ...
	 */
	@Override
	public int countByESFEntityStateCName_CPk(String className, long classPK)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ESFENTITYSTATECNAME_CPK;
	...
	private static final String _FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_1 =
		"esfEntityState.className IS NULL AND ";
	private static final String _FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_2 =
		"esfEntityState.className = ? AND ";
	private static final String _FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSNAME_3 =
		"(esfEntityState.className IS NULL OR esfEntityState.className = '') AND ";
	private static final String _FINDER_COLUMN_ESFENTITYSTATECNAME_CPK_CLASSPK_2 =
	...
	public ESFEntityState updateImpl(
		...
		if (isNew || !ESFEntityStateModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfEntityStateModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfEntityStateModelImpl.getOriginalClassName(),
						esfEntityStateModelImpl.getOriginalClassPK()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ESFENTITYSTATECNAME_CPK,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ESFENTITYSTATECNAME_CPK,
					args);
