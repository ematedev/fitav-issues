...
public class ESFRenewalPersistenceImpl extends BasePersistenceImpl<ESFRenewal>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PAYMENTRECEIVED =
		new FinderPath(ESFRenewalModelImpl.ENTITY_CACHE_ENABLED,
			ESFRenewalModelImpl.FINDER_CACHE_ENABLED, ESFRenewalImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByPaymentReceived",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PAYMENTRECEIVED =
		new FinderPath(ESFRenewalModelImpl.ENTITY_CACHE_ENABLED,
			ESFRenewalModelImpl.FINDER_CACHE_ENABLED, ESFRenewalImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByPaymentReceived",
			new String[] { Boolean.class.getName() },
			ESFRenewalModelImpl.PAYMENTRECEIVED_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PAYMENTRECEIVED = new FinderPath(ESFRenewalModelImpl.ENTITY_CACHE_ENABLED,
			ESFRenewalModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByPaymentReceived", new String[] { Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<ESFRenewal> findByPaymentReceived(boolean paymentReceived)
		throws SystemException {
		return findByPaymentReceived(paymentReceived, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ESFRenewal> findByPaymentReceived(boolean paymentReceived,
		int start, int end) throws SystemException {
		return findByPaymentReceived(paymentReceived, start, end, null);
	}
	...
	public List<ESFRenewal> findByPaymentReceived(boolean paymentReceived,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PAYMENTRECEIVED;
			finderArgs = new Object[] { paymentReceived };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_PAYMENTRECEIVED;
			finderArgs = new Object[] {
					paymentReceived,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFRenewal esfRenewal : list) {
				if ((paymentReceived != esfRenewal.getPaymentReceived())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PAYMENTRECEIVED_PAYMENTRECEIVED_2);
	 ...
	 */
	@Override
	public ESFRenewal findByPaymentReceived_First(boolean paymentReceived,
		OrderByComparator orderByComparator)
		throws NoSuchRenewalException, SystemException {
		ESFRenewal esfRenewal = fetchByPaymentReceived_First(paymentReceived,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRenewal fetchByPaymentReceived_First(boolean paymentReceived,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFRenewal> list = findByPaymentReceived(paymentReceived, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRenewal findByPaymentReceived_Last(boolean paymentReceived,
		OrderByComparator orderByComparator)
		throws NoSuchRenewalException, SystemException {
		ESFRenewal esfRenewal = fetchByPaymentReceived_Last(paymentReceived,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFRenewal fetchByPaymentReceived_Last(boolean paymentReceived,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByPaymentReceived(paymentReceived);

		if (count == 0) {
			return null;
		}

		List<ESFRenewal> list = findByPaymentReceived(paymentReceived,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public ESFRenewal[] findByPaymentReceived_PrevAndNext(long esfRenewalId,
		boolean paymentReceived, OrderByComparator orderByComparator)
		throws NoSuchRenewalException, SystemException {
		ESFRenewal esfRenewal = findByPrimaryKey(esfRenewalId);
		...
		try {
			...
			array[0] = getByPaymentReceived_PrevAndNext(session, esfRenewal,
					paymentReceived, orderByComparator, true);

			array[1] = esfRenewal;

			array[2] = getByPaymentReceived_PrevAndNext(session, esfRenewal,
					paymentReceived, orderByComparator, false);
	...
	protected ESFRenewal getByPaymentReceived_PrevAndNext(Session session,
		ESFRenewal esfRenewal, boolean paymentReceived,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByPaymentReceived(boolean paymentReceived)
		throws SystemException {
		for (ESFRenewal esfRenewal : findByPaymentReceived(paymentReceived,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(esfRenewal);
		}
	}
	...
	public int countByPaymentReceived(boolean paymentReceived)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_PAYMENTRECEIVED;

		Object[] finderArgs = new Object[] { paymentReceived };
	...
	private static final String _FINDER_COLUMN_PAYMENTRECEIVED_PAYMENTRECEIVED_2 =
		"esfRenewal.paymentReceived = ?";
	...
	public ESFRenewal updateImpl(it.ethica.esf.model.ESFRenewal esfRenewal)
		...
		if (isNew || !ESFRenewalModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfRenewalModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PAYMENTRECEIVED.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfRenewalModelImpl.getOriginalPaymentReceived()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_PAYMENTRECEIVED,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PAYMENTRECEIVED,
					args);

				args = new Object[] { esfRenewalModelImpl.getPaymentReceived() };
