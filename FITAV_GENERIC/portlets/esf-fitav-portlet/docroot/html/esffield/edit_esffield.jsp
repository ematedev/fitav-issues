...
<aui:form action="<%= editESFFieldURL %>" name="<portlet:namespace />fm">
		...
		<aui:fieldset>
			...
			<c:choose>
				<c:when test="<%=(esfFieldId>0)?ESFFieldPermission.contains(permissionChecker, esfFieldId, ActionKeys.ESFFIELD_UPDATE_STATE)
						:ESFFieldModelPermission.contains(permissionChecker, group.getGroupId(),  ActionKeys.ESFFIELD_UPDATE_STATE)
					 %>">
