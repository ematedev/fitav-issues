...
viewassURL.setParameter(
	"mvcPath", "/html/esfnationalmatch/tabs/navigation/roles.jsp");
...
<liferay-ui:search-container emptyResultsMessage="no-result" iteratorURL="<%=viewassURL %>">
	...
	<liferay-ui:search-container-row 
		...
		<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_ROLE_DELETE) %>">	
			<liferay-ui:search-container-column-jsp
					path='<%="/html/esfnationalmatch/tabs/navigation/roleRemove_actions.jsp"%>' align="right" />
		</c:if>
...
<liferay-ui:search-container orderByType="<%=orderByType%>" emptyResultsMessage="no-results"  curParam= "sc2">
	...
	<liferay-ui:search-container-row
		...
		<liferay-ui:search-container-column-text property="description"
			...
			<liferay-ui:search-container-column-jsp
					path='<%="/html/esfnationalmatch/tabs/navigation/esfUserRole_action.jsp"%>' align="right" />
	</liferay-ui:search-container-row>
