...
<%
	...
	portletURL.setParameter("mvcPath","/html/esfnationalmatch/tabs/navigation/guns.jsp");
...
%>
	<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_ADD) %>">	
						
		<portlet:renderURL var="addESFRifleURL">
			<portlet:param name="mvcPath" value='<%= "/html/esfnationalmatch/edit_esfRifle.jsp" %>' />
	...
	<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_CANE_ADD) %>">	
		<portlet:renderURL var="addESFCaneURL">
			<portlet:param name="mvcPath" value='<%= "/html/esfnationalmatch/edit_esfCane.jsp" %>' />
			<portlet:param name="esfUserId" value="<%=String.valueOf(esfUserId) %>" />
			<portlet:param name="modifyMode" value="false"/>
		</portlet:renderURL>
	...
	<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_CATRIDGE_ADD) %>">	
		<portlet:renderURL var="addESFCatridgeURL">
			<portlet:param name="mvcPath" value='<%= "/html/esfnationalmatch/edit_esfCatridge.jsp" %>' />
			<portlet:param name="esfUserId" value="<%=String.valueOf(esfUserId) %>" />
			<portlet:param name="modifyMode" value="false"/>
		</portlet:renderURL>
...
<liferay-ui:search-container emptyResultsMessage="no-results" delta="5"  curParam= "sc1">	
		<liferay-ui:search-container-results>
			...
			%>
					...
					<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_VIEW) %>">	
						
						<liferay-ui:search-container-column-jsp
						path='<%="/html/esfnationalmatch/tabs/navigation/guns_actions.jsp"%>' align="right" cssClass="gun_actions_button"/>	
					</c:if>
...
<h3> <liferay-ui:message key="CANES"/> </h3>		
	<liferay-ui:search-container emptyResultsMessage="no-results" delta="5"  curParam= "sc2">
			...
			%>
					...
					<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_CANE_VIEW) %>">	
						
						<liferay-ui:search-container-column-jsp
						path='<%="/html/esfnationalmatch/tabs/navigation/esfCane_actions.jsp"%>' align="right" cssClass="gun_actions_button"/>	
					</c:if>
...
<liferay-ui:search-container emptyResultsMessage="no-results" delta="5"  curParam= "sc3">
			...
			<liferay-ui:search-container-row
				...
				%>
					...
					<c:if test="<%= ESFNationalMatchPermission.contains(permissionChecker,esfMatchId, ActionKeys.ESFNATIONALMATCH_GUN_CATRIDGE_VIEW) %>">	
						<liferay-ui:search-container-column-jsp
							path='<%="/html/esfnationalmatch/tabs/navigation/esfCatridge_actions.jsp"%>' align="right" cssClass="gun_actions_button"/>	
					</c:if>
