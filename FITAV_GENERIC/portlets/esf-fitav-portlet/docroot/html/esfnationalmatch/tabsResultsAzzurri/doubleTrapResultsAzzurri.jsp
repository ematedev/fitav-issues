<%	
	sportTypeid= 
	ESFSportTypeLocalServiceUtil.findESFSportTypeByName("Double Trap").get(0).getEsfSportTypeId();
...
%>
		<table class="aui" name="fmdoubletrap">
		<thead>
			<tr>
			...
			%>
				<tr>
					...
					<td>
						...
						if(!isExternalShooter){
						%>
							<aui:input type="text" name='<%="userNationality" + nameSuffix%>'  value = "<%= res.getString(\"italy\") %>" label="" readonly="true">
							</aui:input>
