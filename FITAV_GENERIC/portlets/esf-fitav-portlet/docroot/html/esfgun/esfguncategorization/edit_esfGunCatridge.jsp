...
<portlet:actionURL name="editESFCatridge" var="editESFGunCatridgeURL">
...
<% if(0 == esfGunTypeId){%>
			<aui:select name="esfGunTypeId" label="esf-gunType-select" >
...
<%}else{
	...
	%>
		<aui:input name="esfGunTypeId" value="<%= esfGunTypeId%>" type="hidden"  >
		</aui:input>
		<aui:input name="esfGunTypeName"  value="<%= typeName%>" type="text" readonly="true">
		</aui:input>
<%} %>
			
			<aui:input name="catridgeModel" value="<%=name %>">
				<aui:validator name="required"/>
			</aui:input>
			
			<aui:input name="catridgeCaliber" type="text" value="<%=caliber %>">
				<aui:validator name="digits"></aui:validator>
				<aui:validator name="min">0</aui:validator>
			</aui:input>
			
			<aui:input name="note" type="textarea" value="<%=description %>"/>
