...
public class ESFUserRolePersistenceImpl extends BasePersistenceImpl<ESFUserRole>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			...
			ESFUserRoleModelImpl.NAME_COLUMN_BITMASK);
	...
	/**
	 * Returns all the e s f user roles that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching e s f user roles that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<ESFUserRole> filterFindByGroupId(long groupId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the e s f user roles that the user has permission to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFUserRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param start the lower bound of the range of e s f user roles
	 * @param end the upper bound of the range of e s f user roles (not inclusive)
	 * @return the range of matching e s f user roles that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<ESFUserRole> filterFindByGroupId(long groupId, int start,
		int end) throws SystemException {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the e s f user roles that the user has permissions to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFUserRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param end the upper bound of the range of e s f user roles (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching e s f user roles that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<ESFUserRole> filterFindByGroupId(long groupId, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_ESFUSERROLE_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_ESFUSERROLE_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_ESFUSERROLE_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(ESFUserRoleModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, ESFUserRoleImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, ESFUserRoleImpl.class);
			}
			...
			return (List<ESFUserRole>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	/**
	 * Returns the e s f user roles before and after the current e s f user role in the ordered set of e s f user roles that the user has permission to view where groupId = &#63;.
	 *
	 * @param esfUserRoleId the primary key of the current e s f user role
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFUserRole[] filterFindByGroupId_PrevAndNext(long esfUserRoleId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchUserRoleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(esfUserRoleId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, esfUserRole,
					groupId, orderByComparator, true);

			array[1] = esfUserRole;

			array[2] = filterGetByGroupId_PrevAndNext(session, esfUserRole,
	...
	protected ESFUserRole filterGetByGroupId_PrevAndNext(Session session,
		ESFUserRole esfUserRole, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns the number of e s f user roles that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching e s f user roles that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_ESFUSERROLE_WHERE);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME = new FinderPath(ESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			ESFUserRoleModelImpl.FINDER_CACHE_ENABLED, ESFUserRoleImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_NAME = new FinderPath(ESFUserRoleModelImpl.ENTITY_CACHE_ENABLED,
			ESFUserRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByName",
			new String[] { String.class.getName() });

	/**
	 * Returns all the e s f user roles where name LIKE &#63;.
	 *
	 * @param name the name
	 * @return the matching e s f user roles
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<ESFUserRole> findByName(String name) throws SystemException {
		return findByName(name, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the e s f user roles where name LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFUserRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<ESFUserRole> findByName(String name, int start, int end)
		throws SystemException {
		return findByName(name, start, end, null);
	}

	/**
	 * Returns an ordered range of all the e s f user roles where name LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link it.ethica.esf.model.impl.ESFUserRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ESFUserRole> findByName(String name, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFUserRole esfUserRole : list) {
				if (!StringUtil.wildcardMatches(esfUserRole.getName(), name,
	...
	/**
	 * Returns the first e s f user role in the ordered set where name LIKE &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching e s f user role
	 ...
	 */
	@Override
	public ESFUserRole findByName_First(String name,
		OrderByComparator orderByComparator)
		throws NoSuchUserRoleException, SystemException {
		ESFUserRole esfUserRole = fetchByName_First(name, orderByComparator);
	 ...
	 */
	@Override
	public ESFUserRole fetchByName_First(String name,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFUserRole> list = findByName(name, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last e s f user role in the ordered set where name LIKE &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching e s f user role
	 ...
	 */
	@Override
	public ESFUserRole findByName_Last(String name,
		OrderByComparator orderByComparator)
		throws NoSuchUserRoleException, SystemException {
		ESFUserRole esfUserRole = fetchByName_Last(name, orderByComparator);
	 ...
	 */
	@Override
	public ESFUserRole fetchByName_Last(String name,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFUserRole> list = findByName(name, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the e s f user roles before and after the current e s f user role in the ordered set where name LIKE &#63;.
	 *
	 * @param esfUserRoleId the primary key of the current e s f user role
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ESFUserRole[] findByName_PrevAndNext(long esfUserRoleId,
		...
		try {
			...
			array[0] = getByName_PrevAndNext(session, esfUserRole, name,
					orderByComparator, true);

			array[1] = esfUserRole;

			array[2] = getByName_PrevAndNext(session, esfUserRole, name,
					orderByComparator, false);
	...
	protected ESFUserRole getByName_PrevAndNext(Session session,
		ESFUserRole esfUserRole, String name,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the e s f user roles where name LIKE &#63; from the database.
	 *
	 * @param name the name
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByName(String name) throws SystemException {
		for (ESFUserRole esfUserRole : findByName(name, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(esfUserRole);
		}
	}
	...
	/**
	 * Returns the number of e s f user roles where name LIKE &#63;.
	 *
	 * @param name the name
	 * @return the number of matching e s f user roles
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "esfUserRole.name LIKE NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "esfUserRole.name LIKE ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(esfUserRole.name IS NULL OR esfUserRole.name LIKE '')";
	...
	protected ESFUserRole toUnwrappedModel(ESFUserRole esfUserRole) {
		...
		esfUserRoleImpl.setName(esfUserRole.getName());
		esfUserRoleImpl.setDescription(esfUserRole.getDescription());
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "esfUserRole.esfUserRoleId";
	private static final String _FILTER_SQL_SELECT_ESFUSERROLE_WHERE = "SELECT DISTINCT {esfUserRole.*} FROM ESFUserRole esfUserRole WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFUSERROLE_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {ESFUserRole.*} FROM (SELECT DISTINCT esfUserRole.esfUserRoleId FROM ESFUserRole esfUserRole WHERE ";
	private static final String _FILTER_SQL_SELECT_ESFUSERROLE_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN ESFUserRole ON TEMP_TABLE.esfUserRoleId = ESFUserRole.esfUserRoleId";
	private static final String _FILTER_SQL_COUNT_ESFUSERROLE_WHERE = "SELECT COUNT(DISTINCT esfUserRole.esfUserRoleId) AS COUNT_VALUE FROM ESFUserRole esfUserRole WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "esfUserRole";
	private static final String _FILTER_ENTITY_TABLE = "ESFUserRole";
	private static final String _ORDER_BY_ENTITY_ALIAS = "esfUserRole.";
	private static final String _ORDER_BY_ENTITY_TABLE = "ESFUserRole.";
