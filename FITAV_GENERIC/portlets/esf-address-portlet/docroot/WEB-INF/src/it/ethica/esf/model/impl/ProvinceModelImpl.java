...
/**
 * The base model implementation for the Province service. Represents a row in the &quot;ESF_Province&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ProvinceModelImpl extends BaseModelImpl<Province>
	 ...
	 */
	public static final String TABLE_NAME = "ESF_Province";
	...
	public static final String TABLE_SQL_CREATE = "create table ESF_Province (idProvince VARCHAR(75) not null,idRegion VARCHAR(75) not null,idCountry VARCHAR(75) not null,name VARCHAR(75) null,primary key (idProvince, idRegion, idCountry))";
	public static final String TABLE_SQL_DROP = "drop table ESF_Province";
	...
	public static final String ORDER_BY_SQL = " ORDER BY ESF_Province.idProvince ASC, ESF_Province.idRegion ASC, ESF_Province.idCountry ASC";
