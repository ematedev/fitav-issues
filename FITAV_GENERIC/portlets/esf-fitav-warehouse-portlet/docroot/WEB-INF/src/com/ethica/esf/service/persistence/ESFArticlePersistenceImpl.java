...
public class ESFArticlePersistenceImpl extends BasePersistenceImpl<ESFArticle>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_NAME = new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public List<ESFArticle> findByName(String name, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFArticle esfArticle : list) {
				if (!StringUtil.wildcardMatches(esfArticle.getName(), name,
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "esfArticle.name LIKE NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "esfArticle.name LIKE ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(esfArticle.name IS NULL OR esfArticle.name LIKE '')";
	 ...
	 */
	@Override
	public List<ESFArticle> findByDescription(String description)
		throws SystemException {
	 ...
	 */
	@Override
	public List<ESFArticle> findByDescription(String description, int start,
	...
	public List<ESFArticle> findByDescription(String description, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFArticle esfArticle : list) {
				if (!StringUtil.wildcardMatches(esfArticle.getDescription(),
	 ...
	 */
	@Override
	public ESFArticle findByDescription_First(String description,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = fetchByDescription_First(description,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle fetchByDescription_First(String description,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFArticle> list = findByDescription(description, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle findByDescription_Last(String description,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = fetchByDescription_Last(description,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle fetchByDescription_Last(String description,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ESFArticle> list = findByDescription(description, count - 1,
	 ...
	 */
	@Override
	public ESFArticle[] findByDescription_PrevAndNext(long esfArticleId,
		...
		try {
			...
			array[0] = getByDescription_PrevAndNext(session, esfArticle,
					description, orderByComparator, true);

			array[1] = esfArticle;

			array[2] = getByDescription_PrevAndNext(session, esfArticle,
	...
	protected ESFArticle getByDescription_PrevAndNext(Session session,
		ESFArticle esfArticle, String description,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByDescription(String description)
		throws SystemException {
		for (ESFArticle esfArticle : findByDescription(description,
	...
	private static final String _FINDER_COLUMN_DESCRIPTION_DESCRIPTION_1 = "esfArticle.description LIKE NULL";
	private static final String _FINDER_COLUMN_DESCRIPTION_DESCRIPTION_2 = "esfArticle.description LIKE ?";
	private static final String _FINDER_COLUMN_DESCRIPTION_DESCRIPTION_3 = "(esfArticle.description IS NULL OR esfArticle.description LIKE '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DISABLED = new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, ESFArticleImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDisabled",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DISABLED =
		new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, ESFArticleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByDisabled",
			new String[] { Boolean.class.getName() },
			ESFArticleModelImpl.DISABLED_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_DISABLED = new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByDisabled",
			new String[] { Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<ESFArticle> findByDisabled(boolean disabled)
		throws SystemException {
		return findByDisabled(disabled, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<ESFArticle> findByDisabled(boolean disabled, int start, int end)
		throws SystemException {
		return findByDisabled(disabled, start, end, null);
	}
	 ...
	 */
	@Override
	public List<ESFArticle> findByDisabled(boolean disabled, int start,
		int end, OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DISABLED;
			finderArgs = new Object[] { disabled };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_DISABLED;
			finderArgs = new Object[] { disabled, start, end, orderByComparator };
		}
		...
		if ((list != null) && !list.isEmpty()) {
			for (ESFArticle esfArticle : list) {
				if ((disabled != esfArticle.getDisabled())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_DISABLED_DISABLED_2);
	 ...
	 */
	@Override
	public ESFArticle findByDisabled_First(boolean disabled,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = fetchByDisabled_First(disabled,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle fetchByDisabled_First(boolean disabled,
		OrderByComparator orderByComparator) throws SystemException {
		List<ESFArticle> list = findByDisabled(disabled, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle findByDisabled_Last(boolean disabled,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = fetchByDisabled_Last(disabled, orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle fetchByDisabled_Last(boolean disabled,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByDisabled(disabled);

		if (count == 0) {
			return null;
		}

		List<ESFArticle> list = findByDisabled(disabled, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ESFArticle[] findByDisabled_PrevAndNext(long esfArticleId,
		...
		try {
			...
			array[0] = getByDisabled_PrevAndNext(session, esfArticle, disabled,
					orderByComparator, true);

			array[1] = esfArticle;

			array[2] = getByDisabled_PrevAndNext(session, esfArticle, disabled,
					orderByComparator, false);
	...
	protected ESFArticle getByDisabled_PrevAndNext(Session session,
		ESFArticle esfArticle, boolean disabled,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByDisabled(boolean disabled) throws SystemException {
		for (ESFArticle esfArticle : findByDisabled(disabled,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(esfArticle);
		}
	}
	 ...
	 */
	@Override
	public int countByDisabled(boolean disabled) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_DISABLED;

		Object[] finderArgs = new Object[] { disabled };
	...
	private static final String _FINDER_COLUMN_DISABLED_DISABLED_2 = "esfArticle.disabled = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_CODE = new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, ESFArticleImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByCode",
			new String[] { String.class.getName() },
			ESFArticleModelImpl.CODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CODE = new FinderPath(ESFArticleModelImpl.ENTITY_CACHE_ENABLED,
			ESFArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public ESFArticle findByCode(String code)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = fetchByCode(code);
	 ...
	 */
	@Override
	public ESFArticle fetchByCode(String code) throws SystemException {
	 ...
	 */
	@Override
	public ESFArticle fetchByCode(String code, boolean retrieveFromCache)
		throws SystemException {
	 ...
	 */
	@Override
	public ESFArticle removeByCode(String code)
		throws NoSuchArticleException, SystemException {
		ESFArticle esfArticle = findByCode(code);
	...
	private static final String _FINDER_COLUMN_CODE_CODE_1 = "esfArticle.code IS NULL";
	private static final String _FINDER_COLUMN_CODE_CODE_2 = "esfArticle.code = ?";
	private static final String _FINDER_COLUMN_CODE_CODE_3 = "(esfArticle.code IS NULL OR esfArticle.code = '')";
	...
	public ESFArticle updateImpl(com.ethica.esf.model.ESFArticle esfArticle)
		...
		if (isNew || !ESFArticleModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((esfArticleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DISABLED.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						esfArticleModelImpl.getOriginalDisabled()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_DISABLED, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DISABLED,
					args);

				args = new Object[] { esfArticleModelImpl.getDisabled() };
	...
	protected ESFArticle toUnwrappedModel(ESFArticle esfArticle) {
		...
		esfArticleImpl.setTotalQty(esfArticle.getTotalQty());
		esfArticleImpl.setDisabled(esfArticle.isDisabled());
