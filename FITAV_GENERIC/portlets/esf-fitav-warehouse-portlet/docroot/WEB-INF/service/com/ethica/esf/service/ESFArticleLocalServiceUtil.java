	...
	*/
	...
	public static com.ethica.esf.model.ESFArticle addESFArticle(
		...
		return getService()
			...
			xlQty, lQty, mQty, sQty, xsQty, xxsQty, otherQty, totalQty,
			disabled, esfArticleTypeId);
	}
	...
	public static java.util.List<com.ethica.esf.model.ESFArticle> getEnabledESFArticles()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEnabledESFArticles();
	}

	public static java.util.List<com.ethica.esf.model.ESFArticle> getEnabledESFArticles(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEnabledESFArticles(start, end);
	}

	public static java.util.List<com.ethica.esf.model.ESFArticle> getDisabledESFArticles()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDisabledESFArticles();
	}

	public static java.util.List<com.ethica.esf.model.ESFArticle> getDisabledESFArticles(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDisabledESFArticles(start, end);
	}
