...
public class ESFStockistClp extends BaseModelImpl<ESFStockist>
	...
	public void setVatNumber(String vatNumber) {
		...
		if (_esfStockistRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setVatNumber", String.class);

				method.invoke(_esfStockistRemoteModel, vatNumber);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIban(String iban) {
		...
		if (_esfStockistRemoteModel != null) {
			try {
				...
				method.invoke(_esfStockistRemoteModel, iban);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setVatNumber(getVatNumber());
