...
/**
 * Provides the local service interface for ESFArticle_ESFUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFArticle_ESFUserLocalServiceUtil
...
public interface ESFArticle_ESFUserLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFArticle_ESFUserLocalServiceUtil} to access the e s f article_ e s f user local service. Add custom service methods to {@link com.ethica.esf.service.impl.ESFArticle_ESFUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
