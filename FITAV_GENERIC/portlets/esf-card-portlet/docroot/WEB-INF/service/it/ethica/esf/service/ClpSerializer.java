...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"esf-card-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "esf-card-portlet";
			}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("it.ethica.esf.ESFCardEndDateException")) {
			return new it.ethica.esf.ESFCardEndDateException();
		}

		if (className.equals("it.ethica.esf.ESFCardStartDateException")) {
			return new it.ethica.esf.ESFCardStartDateException();
		}
