...
public class ESFCardWrapper implements ESFCard, ModelWrapper<ESFCard> {
	...
	*/
	...
	/**
	* Returns the start date of this e s f card.
	*
	* @return the start date of this e s f card
	*/
	@Override
	public java.util.Date getStartDate() {
		return _esfCard.getStartDate();
	}

	/**
	* Sets the start date of this e s f card.
	*
	* @param startDate the start date of this e s f card
	*/
	@Override
	public void setStartDate(java.util.Date startDate) {
		_esfCard.setStartDate(startDate);
	}

	/**
	* Returns the end date of this e s f card.
	*
	* @return the end date of this e s f card
	*/
	@Override
	public java.util.Date getEndDate() {
		return _esfCard.getEndDate();
	}

	/**
	* Sets the end date of this e s f card.
	*
	* @param endDate the end date of this e s f card
	*/
	@Override
	public void setEndDate(java.util.Date endDate) {
		_esfCard.setEndDate(endDate);
	}
