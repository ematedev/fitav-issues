...
/**
 * The base model implementation for the ESFAddress service. Represents a row in the &quot;ESF_ESFAddress&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ESFAddressModelImpl extends BaseModelImpl<ESFAddress>
	 ...
	 */
	public static final String TABLE_NAME = "ESF_ESFAddress";
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "esfCityId", Types.VARCHAR },
			{ "groupId", Types.BIGINT }
		};
	public static final String TABLE_SQL_CREATE = "create table ESF_ESFAddress (uuid_ VARCHAR(75) null,esfAddressId LONG not null primary key,latitude DOUBLE,longitude DOUBLE,esfCountryId VARCHAR(75) null,esfRegionId VARCHAR(75) null,esfProvinceId VARCHAR(75) null,esfCityId VARCHAR(75) null,groupId LONG)";
	public static final String TABLE_SQL_DROP = "drop table ESF_ESFAddress";
	public static final String ORDER_BY_JPQL = " ORDER BY esfAddress.esfAddressId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY ESF_ESFAddress.esfAddressId ASC";
	...
	public CacheModel<ESFAddress> toCacheModel() {
		...
		String esfCityId = esfAddressCacheModel.esfCityId;

		if ((esfCityId != null) && (esfCityId.length() == 0)) {
			esfAddressCacheModel.esfCityId = null;
		}
