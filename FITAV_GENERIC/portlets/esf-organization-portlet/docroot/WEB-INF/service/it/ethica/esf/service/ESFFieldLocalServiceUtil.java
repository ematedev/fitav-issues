...
public class ESFFieldLocalServiceUtil {
	...
	*/
	...
	public static int getESFFieldsCount(long groupId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFFieldsCount(groupId);
	}

	public static java.util.List<it.ethica.esf.model.ESFField> getESFFields(
		long groupId, long esfOrganizationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFFields(groupId, esfOrganizationId);
	}

	public static java.util.List<it.ethica.esf.model.ESFField> getESFFields(
		long groupId, long esfOrganizationId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFFields(groupId, esfOrganizationId, start, end);
	}

	public static int getESFFieldsCount(long groupId, long esfOrganizationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFFieldsCount(groupId, esfOrganizationId);
	}

	public static java.util.List<it.ethica.esf.model.ESFField> getESFFieldsByESFSportType(
		long esfSportTypeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFFieldsByESFSportType(esfSportTypeId);
	}
	...
	public static it.ethica.esf.model.ESFField addESFField(long userId,
		...
		return getService()
			...
			esfAddressIdId, esfSportTypeIds, serviceContext);
	}
