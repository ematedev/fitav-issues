...
<liferay-ui:icon-menu>
	...
	<portlet:renderURL var="editURL">
		...
		<portlet:param name="mvcPath" value="/html/esfuseradmin/edit_navigation.jsp" />
	</portlet:renderURL>
	<liferay-ui:icon image="edit" message="Edit" url="<%= editURL.toString() %>"/>
	<% } %>
	<% if (ESFUserPermission.contains(permissionChecker, scopeGroupId, esfUser.getEsfUserId(), ActionKeys.DELETE_ESFUSER)) { %>
