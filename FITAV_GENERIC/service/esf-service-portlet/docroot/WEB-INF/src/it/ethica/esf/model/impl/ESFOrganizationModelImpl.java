...
public class ESFOrganizationModelImpl extends BaseModelImpl<ESFOrganization>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "portalOrganizationId", Types.BIGINT }
		};
	public static final String TABLE_SQL_CREATE = "create table ESFOrganization (uuid_ VARCHAR(75) null,esfOrganizationId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,portalOrganizationId LONG)";
	...
	public Object clone() {
		...
		esfOrganizationImpl.setCompanyId(getCompanyId());
		esfOrganizationImpl.setUserId(getUserId());
		esfOrganizationImpl.setUserName(getUserName());
		esfOrganizationImpl.setCreateDate(getCreateDate());
		esfOrganizationImpl.setModifiedDate(getModifiedDate());
		esfOrganizationImpl.setPortalOrganizationId(getPortalOrganizationId());
	...
	public void resetOriginalValues() {
		...
		esfOrganizationModelImpl._originalCompanyId = esfOrganizationModelImpl._companyId;

		esfOrganizationModelImpl._setOriginalCompanyId = false;
	...
	public CacheModel<ESFOrganization> toCacheModel() {
		...
		esfOrganizationCacheModel.companyId = getCompanyId();

		esfOrganizationCacheModel.userId = getUserId();

		esfOrganizationCacheModel.userName = getUserName();

		String userName = esfOrganizationCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			esfOrganizationCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			esfOrganizationCacheModel.createDate = createDate.getTime();
		}
		else {
			esfOrganizationCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			esfOrganizationCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			esfOrganizationCacheModel.modifiedDate = Long.MIN_VALUE;
		}

		esfOrganizationCacheModel.portalOrganizationId = getPortalOrganizationId();
