...
/**
 * Provides the local service utility for ESFType. This utility wraps
 * {@link it.ethica.esf.service.impl.ESFTypeLocalServiceImpl} and is the
 ...
 * @generated
 */
public class ESFTypeLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.ethica.esf.service.impl.ESFTypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.ethica.esf.model.ESFType addESFType(
		it.ethica.esf.model.ESFType esfType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addESFType(esfType);
	}
	...
	*/
	public static it.ethica.esf.model.ESFType createESFType(long esfTypeId) {
		return getService().createESFType(esfTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFType deleteESFType(long esfTypeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteESFType(esfTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFType deleteESFType(
		it.ethica.esf.model.ESFType esfType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteESFType(esfType);
	}
	...
	*/
	...
	public static it.ethica.esf.model.ESFType fetchESFType(long esfTypeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchESFType(esfTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFType getESFType(long esfTypeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFType(esfTypeId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.ethica.esf.model.ESFType> getESFTypes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFTypes(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getESFTypesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getESFTypesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.ethica.esf.model.ESFType updateESFType(
		it.ethica.esf.model.ESFType esfType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateESFType(esfType);
	}
	...
	*/
	...
	public static java.util.List<it.ethica.esf.model.ESFType> findByClassName(
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchTypeException {
		return getService().findByClassName(className, start, end);
	}

	public static int countByClassName(java.lang.String className)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchTypeException {
		return getService().countByClassName(className);
	}
	...
	public static java.util.List<it.ethica.esf.model.ESFType> findByTypeParentId(
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchTypeException {
		return getService().findByTypeParentId(parentId);
	}
	...
	public static java.util.List<it.ethica.esf.model.ESFType> findByTypeParentId(
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchTypeException {
		return getService().findByTypeParentId(parentId, start, end);
	}

	public static int countByTypeParentId(long parentId)
		throws com.liferay.portal.kernel.exception.SystemException,
			it.ethica.esf.NoSuchTypeException {
		return getService().countByTypeParentId(parentId);
	}

	public static it.ethica.esf.model.ESFType addESFType(long userId,
		...
		return getService()
				   .addESFType(userId, code, name, description, className,
			status, typeParentId, serviceContext);
	}
	...
	public static it.ethica.esf.model.ESFType deleteESFType(long esfTypeId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteESFType(esfTypeId, serviceContext);
	}

	public static it.ethica.esf.model.ESFType updateESFType(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateESFType(userId, esfTypeId, code, name, description,
	...
	public static ESFTypeLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					ESFTypeLocalService.class.getName());

			if (invokableLocalService instanceof ESFTypeLocalService) {
				_service = (ESFTypeLocalService)invokableLocalService;
			}
			else {
				_service = new ESFTypeLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(ESFTypeLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(ESFTypeLocalService service) {
	}

	private static ESFTypeLocalService _service;
}