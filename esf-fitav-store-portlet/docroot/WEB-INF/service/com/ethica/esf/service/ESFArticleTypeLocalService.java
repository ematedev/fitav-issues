...
/**
 * Provides the local service interface for ESFArticleType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFArticleTypeLocalServiceUtil
...
public interface ESFArticleTypeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFArticleTypeLocalServiceUtil} to access the e s f article type local service. Add custom service methods to {@link com.ethica.esf.service.impl.ESFArticleTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
