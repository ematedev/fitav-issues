...
/**
 * Provides the local service interface for ESFBill. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ethica
 * @see ESFBillLocalServiceUtil
...
public interface ESFBillLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ESFBillLocalServiceUtil} to access the e s f bill local service. Add custom service methods to {@link com.ethica.esf.service.impl.ESFBillLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
