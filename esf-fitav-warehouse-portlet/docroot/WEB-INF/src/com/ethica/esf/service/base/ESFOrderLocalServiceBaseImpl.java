...
import com.ethica.esf.service.ESFOrderLocalService;
...
/**
 * Provides the base implementation for the e s f order local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ethica.esf.service.impl.ESFOrderLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFOrderLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFOrderLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ethica.esf.service.ESFOrderLocalServiceUtil} to access the e s f order local service.
	 */
	...
	@Override
	public ESFOrder addESFOrder(ESFOrder esfOrder) throws SystemException {
		esfOrder.setNew(true);

		return esfOrderPersistence.update(esfOrder);
	}
	 ...
	 */
	@Override
	public ESFOrder createESFOrder(long esfOrderId) {
		return esfOrderPersistence.create(esfOrderId);
	}
	...
	public ESFOrder deleteESFOrder(long esfOrderId)
		...
		return esfOrderPersistence.remove(esfOrderId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFOrder deleteESFOrder(ESFOrder esfOrder) throws SystemException {
		return esfOrderPersistence.remove(esfOrder);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFOrder.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfOrderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfOrderPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfOrderPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfOrderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ESFOrder fetchESFOrder(long esfOrderId) throws SystemException {
		return esfOrderPersistence.fetchByPrimaryKey(esfOrderId);
	}
	 ...
	 */
	@Override
	public ESFOrder getESFOrder(long esfOrderId)
		throws PortalException, SystemException {
		return esfOrderPersistence.findByPrimaryKey(esfOrderId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfOrderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFOrder> getESFOrders(int start, int end)
		throws SystemException {
		return esfOrderPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFOrdersCount() throws SystemException {
		return esfOrderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFOrder updateESFOrder(ESFOrder esfOrder) throws SystemException {
		return esfOrderPersistence.update(esfOrder);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ethica.esf.model.ESFOrder",
			esfOrderLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ethica.esf.model.ESFOrder");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfOrderPersistence.getDataSource();
	...
	private ESFOrderLocalServiceClpInvoker _clpInvoker = new ESFOrderLocalServiceClpInvoker();
}