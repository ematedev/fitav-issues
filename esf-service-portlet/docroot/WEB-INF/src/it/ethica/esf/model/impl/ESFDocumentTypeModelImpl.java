...
public class ESFDocumentTypeModelImpl extends BaseModelImpl<ESFDocumentType>
	...
	public static final String TABLE_SQL_CREATE = "create table ESFDocumentType (esfDocumentTypeId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,esfDocumentId LONG,esfTypeId LONG)";
	...
	public Object clone() {
		...
		esfDocumentTypeImpl.setGroupId(getGroupId());
		esfDocumentTypeImpl.setCompanyId(getCompanyId());
		esfDocumentTypeImpl.setUserId(getUserId());
		esfDocumentTypeImpl.setUserName(getUserName());
		esfDocumentTypeImpl.setCreateDate(getCreateDate());
		esfDocumentTypeImpl.setModifiedDate(getModifiedDate());
		esfDocumentTypeImpl.setEsfDocumentId(getEsfDocumentId());
		esfDocumentTypeImpl.setEsfTypeId(getEsfTypeId());
	...
	public CacheModel<ESFDocumentType> toCacheModel() {
		...
		esfDocumentTypeCacheModel.groupId = getGroupId();

		esfDocumentTypeCacheModel.companyId = getCompanyId();

		esfDocumentTypeCacheModel.userId = getUserId();

		esfDocumentTypeCacheModel.userName = getUserName();

		String userName = esfDocumentTypeCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			esfDocumentTypeCacheModel.userName = null;
		}
		...
		esfDocumentTypeCacheModel.esfDocumentId = getEsfDocumentId();

		esfDocumentTypeCacheModel.esfTypeId = getEsfTypeId();
