...
import it.ethica.esf.service.ESFTypeLocalService;
...
/**
 * Provides the base implementation for the e s f type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.ethica.esf.service.impl.ESFTypeLocalServiceImpl}.
 * </p>
 *
 * @author Ethica
 ...
 * @generated
 */
public abstract class ESFTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ESFTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.ethica.esf.service.ESFTypeLocalServiceUtil} to access the e s f type local service.
	 */
	...
	@Override
	public ESFType addESFType(ESFType esfType) throws SystemException {
		esfType.setNew(true);

		return esfTypePersistence.update(esfType);
	}
	 ...
	 */
	@Override
	public ESFType createESFType(long esfTypeId) {
		return esfTypePersistence.create(esfTypeId);
	}
	...
	@Override
	public ESFType deleteESFType(long esfTypeId)
		throws PortalException, SystemException {
		return esfTypePersistence.remove(esfTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESFType deleteESFType(ESFType esfType) throws SystemException {
		return esfTypePersistence.remove(esfType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ESFType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return esfTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return esfTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return esfTypePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return esfTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return esfTypePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESFType fetchESFType(long esfTypeId) throws SystemException {
		return esfTypePersistence.fetchByPrimaryKey(esfTypeId);
	}
	 ...
	 */
	@Override
	public ESFType getESFType(long esfTypeId)
		throws PortalException, SystemException {
		return esfTypePersistence.findByPrimaryKey(esfTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return esfTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESFType> getESFTypes(int start, int end)
		throws SystemException {
		return esfTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getESFTypesCount() throws SystemException {
		return esfTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESFType updateESFType(ESFType esfType) throws SystemException {
		return esfTypePersistence.update(esfType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("it.ethica.esf.model.ESFType",
			esfTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"it.ethica.esf.model.ESFType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = esfTypePersistence.getDataSource();
	...
	private ESFTypeLocalServiceClpInvoker _clpInvoker = new ESFTypeLocalServiceClpInvoker();
}